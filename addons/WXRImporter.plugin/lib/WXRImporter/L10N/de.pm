...
## plugins/WXRImporter/lib/WXRImporter/WXRHandler.pm
    ...
    'Creating new tag (\'[_1]\')...' =>
      'Lege neuen Tag (\'[_1]\') an...',    # Translate - New # OK
    'Saving tag failed: [_1]' =>
      'Speichern des Tags fehlgeschlagen: [_1]',    # Translate - New # OK
...
## plugins/WXRImporter/tmpl/options.tmpl
    'Before you import WordPress posts to Movable Type, we recommend that you <a href=\'[_1]\'>configure your blog\'s publishing paths</a> first.'
      => 'Bevor Sie WordPress-Einträge in Movable Type importieren, sollten Sie zuerst die <a href=\'[_1]\'>Veröffentlichungspfade Ihres Weblogs einstellen</a>.',
