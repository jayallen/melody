...
## plugins/WXRImporter/lib/WXRImporter/WXRHandler.pm
    ...
    'Creating new tag (\'[_1]\')...' =>
      'Création d\'un nouveau tag (\'[_1]\')...',    # Translate - New
    'Saving tag failed: [_1]' =>
      'L\'enregistrement du tag a échoué : [_1]',    # Translate - New
...
## plugins/WXRImporter/tmpl/options.tmpl
    'Before you import WordPress posts to Movable Type, we recommend that you <a href=\'[_1]\'>configure your blog\'s publishing paths</a> first.'
      => 'Avant d\'importer des notes Wordpress dans Movable Type, nous vous recommandons d\'abord de <a href=\'[_1]\'>configurer les chemins de publication de votre blog</a>.',
