...
my @CORE_REQ = (
    ...
    [ 'File::Copy::Recursive', 0.23, 1, translate('')],
    [ 'HTML::Diff', 0.561, 1, translate('')],
    [ 'HTML::Entities', 3.64, 1, translate('HTML::Entities is needed to encode some characters, but this feature can be turned off using the NoHTMLEntities option in the configuration file.') ],
    [ 'HTML::Parser', 3.66, 0, translate('HTML::Parser is optional; It is needed if you wish to use the TrackBack system, the weblogs.com ping, or the Melody Recently Updated ping.') ],
    [ 'Heap::Fibonacci', 0.71, 1, translate('')],
    ...
    [ 'JSON', 2.12, 1, translate('')],
    [ 'Jcode', 0.88, 1, translate('')],
    [ 'LWP', 5.831, 1, translate('LWP is optional; It is needed if you wish to use the TrackBack system, the weblogs.com ping, or the Melody Recently Updated ping.') ],
    [ 'Locale::Maketext', 1.13, 1, translate('')],
    [ 'Log::Dispatch', 2.26, 1, translate('')],
    [ 'Log::Log4Perl', 1.30, 1, translate('')],
    [ 'Lucene::QueryParser', 1.04, 1, translate('')],
    [ 'Math::BigInt', 1.63, 1, translate('')],
    [ 'Param::Validate', 0.73, 1, translate('')],
    [ 'Sub::Install', 0.925, 1, translate('')],
...
my @CORE_OPT = (
    ...
    [ 'MIME::Charset', 0.044, 1, translate('')],
    [ 'MIME::EncWords', 0.96, 1, translate('')],
    [ 'Mail::Sendmail', 0, 1, translate('Mail::Sendmail is required for sending mail via SMTP Server.')],
    ...
    [ 'XML::Parser', 0, 0, translate('')],
    [ 'XML::SAX', 0.96, 0, translate('')],
    [ 'XML::Simple', 2.14, 0, translate('')],
    [ 'XML::XPath', 0, 0, translate('')],
);
