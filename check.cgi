...
my @CORE_REQ = (
    ...
    [ 'Digest::SHA1', 0.06, 1, translate('Data::ObjectDriver is required for all Melody application functionality.') ],
    ...
    [ 'Params::Validate', 0.73, 1, translate('')],
...
my @CORE_OPT = (
    ...
    [ 'bignum', 0.17, 0, translate('')], # was 0.23 but as core that was problematic.
