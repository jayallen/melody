...
my $start_link
  = "http://localhost" 
  . $cgipath
  . "/index.cgi?username=$username&password=$password";
...
while ( keys %link_queue && $count < 500 ) {
    ...
    unless ( $links_checked{$curr_link} ) {
        ...
        my $content = $resp->content();
        {
            ...
            like( $content, $good_pattern,
                  "checking $curr_link for $good_pattern" );
    ...
    } ## end unless ( $links_checked{$curr_link...})
} ## end while ( keys %link_queue ...)
