...
ok(
    $out !~ /Publish selected templates/i,
    "No Publish templates button is present for global template search results"
);
...
ok( $out =~ /Publish selected comments/i,
    "Publish comments button is present" );
ok( $out =~ /Delete selected comments/i,
    "Delete comments button is present" );
ok( $out =~ /Report selected comments as spam/i,
    "Spam comments button is present" );
ok( $out =~ /Unpublish comment\(s\)/i,
    "Unpublish comments dropdown is present" );
ok( $out =~ /Trust commenter\(s\)/i, "Trust commenter dropdown is present" );
ok( $out =~ /Untrust commenter\(s\)/i,
    "Untrust commenter dropdown is present" );
