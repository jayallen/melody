...
# post_save triggers for summary expiration
    ...
    for my $class_type ( keys %$summaries ) {
        ...
        for my $summary_class ( keys %{ $summaries->{$class_type} } ) {
            ...
            } ## end for my $class ( keys %$expires)
        } ## end for my $summary_class (...)
    } ## end for my $class_type ( keys...)
    ...
    } ## end for my $class ( keys %class_triggers)
} ## end sub post_init_add_triggers
