...
## php/lib/function.mtwidgetmanager.php
    'Error: widgetset [_1] is empty.' =>
      'Fehler: Die Widgetgruppe \'[_1]\' ist leer.',
    'Error compiling widgetset [_1]' =>
      'Fehler bei Kompilierung der Widgetgruppe \'[_1]\'',

## php/lib/function.mtvar.php
    'You used a [_1] tag without a valid name attribute.' =>
      '\'[_1]\'-Befehl ohne gültiges Namensattribut verwendet.',
...
## php/lib/thumbnail_lib.php
    'GD support has not been available. Please install GD support.' =>
      'Keine GD-Unterstützung vorhanden. Bitte installieren Sie die GD-Bibliothek.',
...
## default_templates/comments.mtml
    ...
    'The data is modified by the paginate script' =>
      'Diese Daten werden durch das Paginierungs-Skript geändert'
    ,    # Translate - New # OK
...
## default_templates/notify-entry.mtml
    'A new [lc,_3] entitled \'[_1]\' has been published to [_2].' =>
      'Ein neuer [_3] namens \'[_1]\' wurde auf [_2] veröffentlicht.',
...
## default_templates/main_index_widgets_group.mtml
    'This is a custom set of widgets that are conditioned to only appear on the homepage (or "main_index"). More info: [_1]'
      => 'Dies ist eine spezielle Widgetgrupe, die nur auf der Startseite angezeigt wird.',
...
## default_templates/comment_response.mtml
    ...
    'Your comment has been received and held for approval by the blog owner.'
      => 'Ihr Kommentar wurde abgeschickt. Er erscheint, sobald der Blogbetreiber ihn freigeschaltet hat.',
...
## default_templates/commenter_notify.mtml
    'This email is to notify you that a new user has successfully registered on the blog \'[_1]\'. Listed below you will find some useful information about this new user.'
      => 'Ein neuer Benutzer hat sich erfolgreich für das Blog \'[_1]\' registriert. Unten finden Sie nähere Informationen über diesen Benutzer.',
    ...
    'To view or edit this user, please click on or cut and paste the following URL into a web browser:'
      => 'Um alle Benutzerdaten zu sehen oder zu bearbeiten, klicken Sie bitte auf folgende Adresse (oder kopieren Sie sie und fügen Sie sie in Adresszeile Ihres Web-Browsers ein):',
...
## default_templates/archive_widgets_group.mtml
    'This is a custom set of widgets that are conditioned to serve different content based upon what type of archive it is included. More info: [_1]'
      => 'Dies ist eine spezielle Widgetgruppe, die vom jeweiligen Archivtyp abhängige Inhalte ausgibt.',
    'Current Category Monthly Archives' =>
      'Monatsarchive der aktuellen Kategorie',
...
## default_templates/verify-subscribe.mtml
    'Thanks for subscribing to notifications about updates to [_1]. Follow the link below to confirm your subscription:'
      => 'Vielen Dank, daß Sie die die Benachrichtungen über Aktualisierungen von [_1] abonniert haben. Bitte klicken Sie zur Bestätigung auf folgenden Link:',
    'If the link is not clickable, just copy and paste it into your browser.'
      => 'Wenn der Link nicht anklickbar ist, kopieren Sie ihn einfach und fügen ihn in der Adresszeile Ihres Browers ein.',
...
## default_templates/new-ping.mtml
    'An unapproved TrackBack has been posted on your blog [_1], for entry #[_2] ([_3]). You need to approve this TrackBack before it will appear on your site.'
      => 'In Ihrem Weblog [_1] ist ein noch nicht freigeschaltetes TrackBack zum Eintrag [_3] (#[_2]) eingegangen. Schalten Sie das TrackBack frei, damit es auf Ihrem Weblog erscheint.',
    'An unapproved TrackBack has been posted on your blog [_1], for category #[_2], ([_3]). You need to approve this TrackBack before it will appear on your site.'
      => 'In Ihrem Weblog [_1] ist ein noch nicht freigeschaltetes TrackBack für die Kategorie [_3] (#[_2]) eingegangen. Schalten Sie das TrackBack frei, damit es auf Ihrem Weblog erscheint.',
    'A new TrackBack has been posted on your blog [_1], on entry #[_2] ([_3]).'
      => 'In Ihrem Weblog [_1] ist ein neuer TrackBack zum Eintrag [_3] (#[_2]) eingegangen.',
    'A new TrackBack has been posted on your blog [_1], on category #[_2] ([_3]).'
      => 'In Ihrem Weblog [_1] ist ein neuer TrackBack für die Kategorie [_3] (#[_2]) eingegangen.',
...
## default_templates/banner_footer.mtml
    '_POWERED_BY' =>
      'Powered by<br /><a href="http://www.movabletype.org/sitede/"><$MTProductName$></a>',
...
## default_templates/search_results.mtml
    ...
    'By default, this search engine looks for all words in any order. To search for an exact phrase, enclose the phrase in quotes:'
      => 'Die Suchfunktion sucht nach allen angebenen Begriffen in beliebiger Reihenfolge. Um nach einem exakten Ausdruck zu suchen, setzen Sie diesen bitte in Anführungszeichen:',
    'movable type' => 'Melody',
...
## default_templates/recent_comments.mtml
    '<strong>[_1]:</strong> [_2] <a href="[_3]" title="full comment on: [_4]">read more</a>'
      => '<strong>[_1]:</strong> [_2] <a href="[_3]" title="Vollständiger Kommentar zu: [_4]">weiter lesen</a>',
...
## default_templates/technorati_search.mtml
    ...
    '<a href=\'http://www.technorati.com/\'>Technorati</a> search' =>
      '<a href=\'http://www.technorati.com/\'>Technorati</a>-Suche',
...
## default_templates/comment_throttle.mtml
    'If this was a mistake, you can unblock the IP address and allow the visitor to add it again by logging in to your Melody installation, going to Blog Config - IP Banning, and deleting the IP address [_1] from the list of banned addresses.'
      => 'Sie können die Sperrung dieser Adresse aufheben, indem Sie den Eintrag [_1] aus der Sperrliste unter Konfigurieren > Blog > IP-Sperren entfernen.',
    'A visitor to your blog [_1] has automatically been banned by adding more than the allowed number of comments in the last [_2] seconds.'
      => 'Die IP-Adrese eines Besuchers Ihres Weblogs [_1] wurde automatisch gesperrt, da er in den letzten [_2] Sekunden mehr Kommentare als zulässig zu veröffentlichen versucht hat.',
    'This has been done to prevent a malicious script from overwhelming your weblog with comments. The banned IP address is'
      => 'Dadurch wird verhindert, daß bosärtige Skripte Ihr Blog mit Spam-Kommentaren fluten können. Die gesperrte IP-Adresse lautet',
...
## default_templates/new-comment.mtml
    'An unapproved comment has been posted on your blog [_1], for entry #[_2] ([_3]). You need to approve this comment before it will appear on your site.'
      => 'In Ihrem Weblog [_1] ist ein noch nicht freigeschalteter Kommentar zum Eintrag "[_3]" (#[_2]) eingegangen. Schalten Sie den Kommentar frei, damit er auf Ihrem Weblog erscheint.',
    'A new comment has been posted on your blog [_1], on entry #[_2] ([_3]).'
      => 'In Ihrem Weblog [_1] ist ein neuer Kommentar zum Eintrag "[_3]" (#[_2]) eingegangen:',
...
## default_templates/about_this_page.mtml
    ...
    'Find recent content on the <a href="[_1]">main index</a> or look in the <a href="[_2]">archives</a> to find all content.'
      => 'Aktuelle Einträge finden Sie auf der <a href="[_1]">Startseite</a>, alle Einträge in den <a href="[_2]">Archiven</a>.',
...
## default_templates/recover-password.mtml
    'A request has been made to change your password in Melody. To complete this process click on the link below to select a new password.'
      => 'Es wurde eine Anfrage zur Änderung Ihres Passwortes in Melody gestellt. Bitte klicken Sie auf untenstehenden Link und wählen Sie ein neues Passwort aus um diesen Prozess abzuschließen.',
    'If you did not request this change, you can safely ignore this email.' =>
      'Wenn Sie diese Änderung nicht wünschen können Sie diese E-Mail bedenkenlos ignorieren.',
...
## default_templates/calendar.mtml
    'Monthly calendar with links to daily posts' =>
      'Monatskalender mit Link zu Tagesarchiven',
    'Sunday'    => 'Sonntag',
    'Sun'       => 'So',
    'Monday'    => 'Montag',
    'Mon'       => 'Mo',
...
## default_templates/sidebar.mtml
    ...
    '3-column layout - Primary Sidebar' =>
      '3-spaltiges Layout - Primär-Seitenleiste',
    '3-column layout - Secondary Sidebar' =>
      '3-spaltiges Layout - Sekundär-Seitenleiste',
...
## default_templates/commenter_confirm.mtml
    'Thank you registering for an account to comment on [_1].' =>
      'Danke, daß Sie sich zum Kommentieren von [_1] registriert haben.',
    'For your own security and to prevent fraud, we ask that you please confirm your account and email address before continuing. Once confirmed you will immediately be allowed to comment on [_1].'
      => 'Zu Ihrer eigenen Sicherheit und zur Vermeidung von Mißbrauch bestätigen Sie bitte Ihre Anmeldung und Ihre E-Mail-Adresse.',
    'To confirm your account, please click on or cut and paste the following URL into a web browser:'
      => 'Klicken Sie dazu auf folgenden Link (oder kopieren Sie Adresse und fügen Sie sie in Adresszeile Ihres Web-Browsers ein):',
    'If you did not make this request, or you don\'t want to register for an account to comment on [_1], then no further action is required.'
      => 'Sollten Sie sich nicht angemeldet haben oder sollten Sie sich doch nicht registrieren wollen, brauchen Sie nichts weiter zu tun.',
...
## lib/MT/Asset/Image.pm
    ...
    'Error creating thumbnail file: [_1]' =>
      'Fehler beim Erzeugen des Vorschaubilds: [_1]',
...
## lib/MT/Import.pm
    ...
    'No readable files could be found in your import directory [_1].' =>
      'Im Import-Verzeichnis [_1] konnten keine lesbaren Dateien gefunden werden.',
    'Importing entries from file \'[_1]\'' =>
      'Importieren der Einträge aus Datei \'[_1]\'',
    'Couldn\'t resolve import format [_1]' =>
      'Kann Importformat [_1] nicht auflösen',
    'Melody'                         => 'Melody',
    'Another system (Melody format)' => 'Anderes System (Melody-Format)',
...
## lib/MT/TaskMgr.pm
    'Unable to secure lock for executing system tasks. Make sure your TempDir location ([_1]) is writable.'
      => 'Konnte Lock für Systemtask nicht setzen. Stellen Sie sicher, daß Schreibrechte für das temporäre Verzeichnis ([_1]) vorhanden sind.',
...
## lib/MT/Page.pm
    ...
    'Load of blog failed: [_1]' =>
      'Das Weblog konnte nicht geladen werden: [_1]',
...
## lib/MT/AtomServer.pm
    ...
    'Perl module Image::Size is required to determine width and height of uploaded images.'
      => 'Das Perl-Modul Image::Size ist zur Bestimmung von Höhe und Breite hochgeladener Bilddateien erforderlich.',
...
## lib/MT/Asset.pm
    ...
    'Could not remove asset file [_1] from filesystem: [_2]' =>
      'Konnte Asset-Datei [_1] nicht aus dem Dateisystem löschen: [_2]',
...
## lib/MT/Image.pm
    ...
    'Converting to [_1] failed: [_2]' =>
      'Bei der Konvertierung in [_1] ist ein Fehler aufgetreten: [_2]',
...
## lib/MT/Template/Context.pm
    'The attribute exclude_blogs cannot take \'all\' for a value.' =>
      '\'all\' ist kein gültiger Wert fpr das Attribzt exclude_blogs.',
...
## lib/MT/Template/ContextHandlers.pm
    ...
    'Invalid tag [_1] specified.' =>
      'Ungültiger Vorlagenbefehl [_1] angegeben.',
    ...
    'Can\'t find included template [_1] \'[_2]\'' =>
      'Kann verwendete Vorlage [_1] \'[_2]\' nicht finden',
    'Error making path \'[_1]\': [_2]' =>
      'Fehler beim Anlegen des Ordners \'[_1]\': [_2]',
    'Writing to \'[_1]\' failed: [_2]' =>
      'Auf \'[_1]\' konnte nicht geschrieben werden: [_2]',
    'Can\'t find blog for id \'[_1]' =>
      'Kann Blog für ID \'[_1]\' nicht finden',
    ...
    'The \'[_2]\' attribute will only accept an integer: [_1]' =>
      'Das Attribut  \'[_2]\' erfordert eine Ganzzahl (Integer): [_1]'
    ,    # Translate - New # OK
    ...
    'You used an [_1] tag for linking into \'[_2]\' archives, but that archive type is not published.'
      => 'Sie haben mit einem [_1]-Vorlagenbefehl \'[_2]\'-Archive verlinkt, ohne diese vorher zu veröffentlichen.',
    ...
    'To enable comment registration, you need to add a TypePad token in your weblog config or user profile.'
      => 'Um Kommentarregistrierung zu verwenden, geben Sie in Ihrer Weblog-Konfiguration oder Ihrem Benutzer-Profil einen TypePad-Schlüssel ein.',
    'The MTCommentFields tag is no longer available; please include the [_1] template module instead.'
      => 'Der MTCommentFields-Befehl ist nicht mehr verfügbar. Bitte verwenden Sie stattdessen das [_1]-Vorlagenmodul.',
    ...
    'Can\'t find included template widget \'[_1]\'' =>
      'Kann in Vorlage angegebenes Widget \'[_1]\' nicht finden',
...
## lib/MT/WeblogPublisher.pm
    ...
    'Archive type \'[_1]\' is not a chosen archive type' =>
      'Archivtyp \'[_1]\' wurde vorher nicht ausgewählt',
    ...
    'Blog, BlogID or Template param must be specified.' =>
      'Blog, BlogID oder Template Parameter müssen spezifiziert werden.',
...
## lib/MT/Upgrade.pm
    ...
    'This role was generated by Melody upon upgrade.' =>
      'Diese Rolle wurde von Melody während eines Upgrades angelegt.',
    ...
    'Creating initial blog and user records...' =>
      'Erzeuge erstes Blog und Benutzerkonten...',
    ...
    'I just finished installing Melody [_1]!' =>
      'Ich habe soeben Melody [_1] installiert!',
    'Welcome to my new blog powered by Melody. This is the first post on my blog and was created for me automatically when I finished the installation process. But that is ok, because I will soon be creating posts of my own!'
      => 'Willkommen zu meinem neuen Melody-Blog. Dieser Eintrag hier ist nur ein automatisch erzeugter Platzhalter, damit hier etwas steht, bis ich meine ersten eigenen Einträge geschrieben habe.',
    'Melody also created a comment for me as well so that I could see what a comment will look like on my blog once people start submitting comments on all the posts I will write.'
      => 'Ein Beispielkommentar wurde auch gleich angelegt, so daß man sehen kann, wie die Kommentare von Lesern dargestellt werden werden.',
    ...
    'Can upload files, edit all entries/categories/tags on a blog and publish the blog.'
      => 'Kann alle Einträge, Kategorien und Tags bearbeiten, Dateien hochladen und das Blog veröffentlichen',
    'Can create entries, edit their own, upload files and publish.' =>
      'Kann Einträge anlegen und veröffentlichen, eigene Einträge bearbeiten und Dateien hochladen',
    'Designer' => 'Designer',
    'Can edit, manage and publish blog templates.' =>
      'Kann Vorlagen bearbeiten, verwalten und veröffentlichen',
    'Webmaster' => 'Webmaster',
    'Can manage pages and publish blog templates.' =>
      'Kann Seiten verwalten und Vorlagen veröffentlichen',
    'Contributor' => 'Gastautor',
    'Can create entries, edit their own and comment.' =>
      'Kann Einträge anlegen, kommentieren und eigene Einträge bearbeiten',
    'Moderator' => 'Moderator',
    ...
    'Mapping templates to blog archive types...' =>
      'Verknüpfe Vorlagen mit Archiven...',
    ...
    'Database has been upgraded to version [_1].' =>
      'Datenbank auf Melody-Version [_1] aktualisiert',
    'User \'[_1]\' upgraded database to version [_2]' =>
      'Benutzer \'[_1]\' hat ein Upgrade auf Version [_2] durchgeführt',
    ...
    'User \'[_1]\' upgraded plugin \'[_2]\' to version [_3] (schema version [_4]).'
      => 'Benutzer \'[_1]\' hat für Plugin \'[_2]\' ein Upgrade auf Version [_3] (Schemaversion [_4]) durchgeführt',
    ...
    'User \'[_1]\' installed plugin \'[_2]\', version [_3] (schema version [_4]).'
      => 'Benutzer \'[_1]\' hat Plugin \'[_2]\' mit Version [_3] (Schema version [_4]) installiert',
    'Setting your permissions to administrator.' =>
      'Setze Benutzerrechte auf \'Administrator\'...',
    ...
    'Assigning comment/moderation settings...' =>
      'Weise Kommentierungseinstellungen zu...',
...
## lib/MT/Comment.pm
    ...
    'Load of entry \'[_1]\' failed: [_2]' =>
      'Der Eintrag \'[_1]\' konnte nicht geladen werden: [_2]',
...
## lib/MT/Core.pm
    ...
    'Error creating performance logs directory, [_1]. Please either change the permissions to make it writable or specify an alternate using the PerformanceLoggingPath configuration directive: [_2]'
      => 'Beim Anlegen des Leistungsprotrokolls-Verzeichnis ist ein Fehler aufgetreten - [_1]. Bitte vergeben Sie entweder Schreibrechte für das Verzeichnis oder geben Sie mittels PerformanceLoggingPath ein anderes an: [_2]',
    'Error creating performance logs: PerformanceLoggingPath setting must be a directory path, not a file: [_1]'
      => 'Beim Anlegen des Leistungsprotrokolls ist ein Fehler aufgetreten: PerformanceLoggingPath muss auf ein Verzeichnis, nicht auf eine Datei zeigen',
    'Error creating performance logs: PerformanceLoggingPath directory exists but is not writeable: [_1]'
      => 'Beim Anlegen des Leistungsprotrokolls ist ein Fehler aufgetreten: das PerformanceLoggingPath-Verzeichnis ist vorhanden, kann aber nicht beschrieben werden - [_1]',
    ...
    'Melody Default'       => 'Melody-Standard',
    ...
    'Refreshes object summaries.' =>
      'Objekt-Zusammenfassungen zurücksetzen',    # Translate - New # OK
    'Adds Summarize workers to queue.' =>
      'Summarize-Worker zur Warteschlange hinzufügen', # Translate - New # OK
    'zip'                       => 'ZIP',
    'tar.gz'                    => 'tar.gz',
    ...
    'Add Summary Watcher to queue' =>
      'Summary-Watcher zur Warteschlange hinzufügen',  # Translate - New # OK
...
## lib/MT/App/NotifyList.pm
    ...
    'An invalid redirect parameter was provided. The weblog owner needs to specify a path that matches with the domain of the weblog.'
      => 'Ungültiges Redirect-Parameter. Sie müssen einen zur verwendeten Domain gehörenden Pfad angeben.',
    'The email address \'[_1]\' is already in the notification list for this weblog.'
      => 'Die E-Mail-Adresse \'[_1]\' ist bereits in der Benachrichtigunsliste für dieses Weblog.',
    'Please verify your email to subscribe' =>
      'Bitte bestätigen Sie Ihre E-Mail-Adresse',
    '_NOTIFY_REQUIRE_CONFIRMATION' =>
      'Um den Vorgang abzuschließen, klicken Sie bitte auf den Link in der E-Mail, die an [_1] verschickt wurde. Damit stellen Sie sicher, daß die E-Mail-Adresse korrekt eingegeben wurde und wirklich Ihnen gehört.',
    'The address [_1] was not subscribed.' =>
      'Die Adresse [_1] wurde hinzugefügt.',
    'The address [_1] has been unsubscribed.' =>
      'Die Adresse [_1] wurde entfernt.',
...
## lib/MT/App/Comments.pm
    ...
    'Invalid commenter login attempt from [_1] to blog [_2](ID: [_3]) which does not allow Melody native authentication.'
      => 'Ungültiger Anmeldeversuch von Kommentarautor [_1] an Weblog [_2](ID: [_3]) - native Melody-Authentifizierung bei diesem Weblog nicht zulässig.',
    ...
    'Successfully authenticated but signing up is not allowed.  Please contact system administrator.'
      => 'Authentifizierung erfolgreich, aber Registrierung nicht erlaubt. Bitte wenden Sie sich an den Systemadministrator.',
    ...
    'Login failed: password was wrong for user \'[_1]\'' =>
      'Anmeldung fehlgeschlagen: Passwort für Benutzer \'[_1]\' falsch',
    ...
    'Melody Account Confirmation' => 'Melody-Anmeldungsbestätigung',
    'System Email Address is not configured.' =>
      'System-E-Mail-Adresse nicht konfiguriert.',
    ...
    'Comments are not allowed on this entry.' =>
      'Bei diesem Eintrag sind Kommentare nicht erlaubt.',
    ...
    'Text entered was wrong.  Try again.' =>
      'Der eingegebene Text ist falsch. Bitte versuchen Sie es erneut.',
    ...
    'Failed comment attempt by pending registrant \'[_1]\'' =>
      'Fehlgeschlagener Kommentierungsversuch durch schwebenden Kommentarautoren \'[_1]\'',
    ...
    '[_1] contains an invalid character: [_2]' =>
      '[_1] beinhaltet ein ungültiges Schriftzeichen: [_2]',
    ...
    'Commenter profile has successfully been updated.' =>
      'Kommentarautorenprofil erfolgreich aktualisiert.',
    'Commenter profile could not be updated: [_1]' =>
      'Kommentarautorenprofil konnte nicht aktualisiert werden: [_1]',
...
## lib/MT/App/Search.pm
    ...
    'Search: failed storing results in cache.  [_1] is not available: [_2]' =>
      'Suche: konnte Ergebnisse nicht zwischenspeichern. [_1] ist nicht verfügbar: [_2]',
    ...
    'No alternate template is specified for the Template \'[_1]\'' =>
      'Keine alternative Vorlage für Vorlage \'[_1]\' angegeben',
    'Opening local file \'[_1]\' failed: [_2]' =>
      'Die lokale Datei \'[_1]\' konnte nicht veröffentlicht werden: [_2]',
...
## lib/MT/App/Trackback.pm
    ...
    'You are pinging trackbacks too quickly. Please try again later.' =>
      'Sie senden zu viele TrackBack-Pings zu schnell hintereinander. Bitte versuchen Sie es später erneut.',
    ...
    'Can\'t create RSS feed \'[_1]\': ' =>
      'RSS-Feed kann nicht angelegt werden \'[_1]\': ',
    'New TrackBack Ping to Entry [_1] ([_2])' =>
      'Neuer TrackBack-Ping für Eintrag [_2] (#[_1])',
    'New TrackBack Ping to Category [_1] ([_2])' =>
      'Neuer TrackBack-Ping für Kategorie [_2] (#[_1])',

## lib/MT/App/Upgrader.pm
    'Failed to authenticate using given credentials: [_1].' =>
      'Authentifizierung mit angegebenen Anmeldedaten fehlgeschlagen: [_1].',
...
## lib/MT/App/Search/Legacy.pm
    'You are currently performing a search. Please wait until your search is completed.'
      => 'Die Suche wird ausgeführt. Bitte warten Sie, bis Ihre Anfrage abgeschlossen ist.',
    ...
    'Publishing results failed: [_1]' =>
      'Die Suchergebnisse konnten nicht veröffentlicht werden: [_1]',
...
## lib/MT/App/Wizard.pm
    ...
    'The [_1] driver is required to use [_2].' =>
      'Ein [_1]-Treiber ist erforderlich, um [_2] zu nutzen.',
    'An error occurred while attempting to connect to the database.  Check the settings and try again.'
      => 'Es konnte keine Verbindung zur Datenbank aufgebaut werden. Bitte überprüfen Sie die Einstellungen und versuchen Sie es erneut.',
    'SMTP Server' => 'SMTP-Server',
    'Sendmail'    => 'Sendmail',
    'Test email from Melody Configuration Wizard' =>
      'Testmail vom Melody-Konfigurationshelfer',
    'This is the test email sent by your new installation of Melody.' =>
      'Diese Testmail wurde von Ihrer neuen Melody-Installation verschickt.',
    'This module is needed to encode special characters, but this feature can be turned off using the NoHTMLEntities option in config.cgi.'
      => 'Dieses Modul ist zur Sonderzeichenkodierung erforderlich. Sonderzeichenkodierung kann über den Schalter NoHTMLEntities in config.cgi abgeschaltet werden.',
    'This module is needed if you wish to use the TrackBack system, the weblogs.com ping, or the MT Recently Updated ping.'
      => 'Dieses Modul ist zur Nutzung von TrackBacks, weblogs.com-Pings und dem MT-Kürzlich-Aktualisiert-Ping erforderlich.',
    'HTML::Parser is optional; It is needed if you wish to use the TrackBack system, the weblogs.com ping, or the MT Recently Updated ping.'
      => 'HTML::Parser ist optional und erforderlich, wenn Sie das TrackBack-System, weblogs.com-Pings und andere Aktualisierungs-Benachrichtigungen verwenden wollen.',
    'This module is needed if you wish to use the MT XML-RPC server implementation.'
      => 'Dieses Modul ist zur Verwendung des XML-RPC-Servers notwendig.',
    ...
    'List::Util is optional; It is needed if you want to use the Publish Queue feature.'
      => 'List::Util ist optional. Erforderlich zur Nutzung der Veröffentlichungs-Warteschlange.',
    'Scalar::Util is optional; It is needed if you want to use the Publish Queue feature.'
      => 'Scalar::Util ist optional. Erforderlich zur Nutzung der Veröffentlichungs-Warteschlange.',
    ...
    'This module is needed to enable comment registration.' =>
      'Dieses Modul ermöglicht die Registrierung von Kommentarautoren.',
    ...
    'This module is required in order to archive files in backup/restore operation.'
      => 'Dieses Modul ist zur Archivierung von Dateien bei der Erstellung und Wiederherstellung von Sicherheitskopien erforderlich.',
    'This module is required in order to compress files in backup/restore operation.'
      => 'Dieses Modul ist zur Komprimierung von Dateien bei der Erstellung und Wiederherstellung von Sicherheitskopien erforderlich.',
    'This module is required in order to decompress files in backup/restore operation.'
      => 'Dieses Modul ist zum Entpacken von Dateien bei der Erstellung und Wiederherstellung von Sicherheitskopien erforderlich.',
    'This module and its dependencies are required in order to restore from a backup.'
      => 'Dieses Modul und seine Abhängigkeiten sind zur Wiederherstellung von Sicherheitskopien erforderlich.',
    'This module and its dependencies are required in order to allow commenters to be authenticated by OpenID providers including Vox and LiveJournal.'
      => 'Dieses Modul und seine Abhängigkeiten sind zur Authentifizierung von Kommentarautoren mittels OpenID erforderlich (incl. OpenID via LiveJournal und Vox).',
    'This module is required for sending mail via SMTP Server.' =>
      'Dieses Modul ist zum Verschicken von E-Mails über SMTP-Server erforderlich.',
    'This module is used in test attribute of MTIf conditional tag.' =>
      'Dieses Modul ist für das test-Attribut des MTif conditional-Befehls erforderlich.',
    ...
    'This module is required in search.cgi if you are running Melody on Perl older than Perl 5.8.'
      => 'Dieses Modul ist für search.cgi erforderlich, wenn Sie Melody unter Perl älter als Version 5.8 ausführen.',
    ...
    'CGI is required for all Melody application functionality.' =>
      'CGI ist für sämtliche Melody-Funktionen erforderlich.',
    'File::Spec is required for path manipulation across operating systems.'
      => 'File::Spec ist zur Vereinheitlichung von Pfadangaben über Betriebssystemgrenzen hinweg erforerlich. ',

## lib/MT/App/Viewer.pm
    'Loading blog with ID [_1] failed' =>
      'Das Blog mit der ID [_1] konte nicht geladen werden',
    'Template publishing failed: [_1]' =>
      'Die Vorlage konnte nicht veröffentlicht werden: [_1]',
    ...
    'Archive publishing failed: [_1]' =>
      'Das Archiv konnte nicht veröffentlicht werden: [_1]',
...
## lib/MT/App/CMS.pm
    '_WARNING_PASSWORD_RESET_MULTI' =>
      'Sie sind dabei Email(s) an ausgewählte Nutzer zu senden um deren Password zurück zu setzen. Möchten Sie fortfahren?',
    '_WARNING_DELETE_USER_EUM' =>
      'Löschen eines Benutzerkontos kann nicht rückgängig gemacht werden und führt zu verwaisten Einträgen. Es wird daher empfohlen, das Benutzerkonto zu belassen und stattdessen dem Benutzer alle Berechtigungen zu entziehen. Möchten Sie das Konto dennoch löschen?\nGelöschte Benutzer können ihre Benutzerkonten selbst solange wiederherstellen, wie sie noch im externen Verzeichnis aufgeführt sind.',
    '_WARNING_DELETE_USER' =>
      'Löschen eines Benutzerkontos kann nicht rückgängig gemacht werden und führt zu verwaisten Einträgen. Es wird daher empfohlen, das Benutzerkonto zu belassen und stattdessen dem Benutzer alle Berechtigungen zu entziehen. Möchten Sie das Konto dennoch löschen?',
    '_WARNING_REFRESH_TEMPLATES_FOR_BLOGS' =>
      'Mit dieser Aktion werden die Vorlagen der gewählten Blogs auf die werkseitig ausgelieferten Standardvorlagen zurückgesetzt. Möchten Sie die Vorlagen der gewählten Blogs wirklich zurücksetzen?',
    ...
    '[_1] with comments in the last 7 days' =>
      '[_1] mit Kommentaren in den letzten 7 Tagen',
    '[_1] posted between [_2] and [_3]' =>
      'Zwischen dem [_2] und dem [_3] veröffentlichte [_1]',
    '[_1] posted since [_2]' => 'Seit dem [_2] veröffentlichte [_1]',
    '[_1] posted on or before [_2]' =>
      'Am oder vor dem [_2] veröffentlichte [_1]',
    ...
    'Tags to add to selected entries' =>
      'Zu gewählten Einträgen hinzuzufügende Tags',
    'Remove Tags...' => 'Tags entfernen...',
    'Tags to remove from selected entries' =>
      'Von gewählten Einträgen zu entfernende Tags',
    ...
    'Tags to add to selected pages' =>
      'Zu gewählten Seiten hinzuzufügende Tags',
    'Tags to remove from selected pages' =>
      'Von gewählten Seiten zu entfernende Tags',
    'Batch Edit Pages' => 'Mehrere Seiten bearbeiten',
    'Tags to add to selected assets' =>
      'Zu gewählten Assets hinzuzufügende Tags',
    'Tags to remove from selected assets' =>
      'Von gewählten Assets zu entfernende Tags',
    ...
    'All TrackBacks in the last 7 days' =>
      'Alle TrackBacks der letzten 7 Tage',
...
## lib/MT/App/ActivityFeeds.pm
    ...
    'An error occurred while generating the activity feed: [_1].' =>
      'Fehler beim Anlegen des Aktivitäts-Feeds: [_1].',
    ...
    'Melody System Activity' => 'Melody Systemaktivität',
    'Melody Debug Activity'  => 'Melody Debug-Aktivität',
...
## lib/MT/Author.pm
    'The approval could not be committed: [_1]' =>
      'Freigabe Konnte nicht übernommen werden: [_1]',
...
## lib/MT/Util/Captcha.pm
    'Melody default CAPTCHA provider requires Image::Magick.' =>
      'Zur Nutzung der in Melody integrierten CAPTCHA-Quelle ist Image::Magick erforderlich.',
...
## lib/MT/FileMgr/FTP.pm
    'Creating path \'[_1]\' failed: [_2]' =>
      'Der Ordner \'[_1]\' konnte nicht angelegt werden: [_2]',
...
## lib/MT/BackupRestore.pm
    ...
    'Manifest file [_1] was not a valid Melody backup manifest file.' =>
      'Manifest-Datei [_1] ist keine gültige Melody Backup-Manifest-Datei.',
    'Manifest file: [_1]' => 'Manifest-Datei: [_1]',
    'Path was not found for the file ([_1]).' =>
      'Pfad zu Datei ([_1]) nicht gefunden.',
...
## lib/MT/DefaultTemplates.pm
    ...
    'Comment Listing (Dynamic)' =>
      'Kommentarliste (dynamisch)',    # Translate - New # OK
    'Improved listing of comments.' =>
      'Verbesserte Kommentarliste',    # Translate - New # OK
    ...
    'Displays preview of comment.' =>
      'Zeigt eine Vorschau des Kommentars an.',
    'Dynamic Error' => 'Dynamischer Fehler',
    'Displays errors for dynamically published templates.' =>
      'Zeigt Fehlermeldungen für dynamisch veröffentlichte Vorlagen an.',
...
## lib/MT/XMLRPCServer.pm
    ...
    'No web services password assigned.  Please see your user profile to set it.'
      => 'Kein Passwort für Webdienste vergeben. Das Passwort kann im Benutzerprofil angegeben werden.',
    ...
    'Saving placement failed: [_1]' =>
      'Die Platzierung konnte nicht geladen werden: [_1]',
    ...
    'Not privileged to set entry categories' =>
      'Keine Rechte zur Vergabe von Kategorien',
...
## lib/MT/Template.pm
    ...
    'Template with the same name already exists in this blog.' =>
      'Es ist bereits eine Vorlage mit gleichem Namen in diesem Weblog vorhanden.',
...
## lib/MT/Auth/TypeKey.pm
    ...
    'This weblog requires commenters to pass an email address. If you\'d like to do so you may log in again, and give the authentication service permission to pass your email address.'
      => 'Kommentarautoren müssen eine E-Mail-Adresse angeben. Wenn Sie das tun möchten, melden Sie sich an und erlauben Sie dem Authentifizierungsdienst, Ihre E-Mail-Adresse weiterzuleiten.',
    'Couldn\'t save the session' => 'Session konnte nicht gespeichert werden',
    'Couldn\'t get public key from url provided' =>
      'Public Key konnte von der angegebenen Adresse nicht gelesen werden',
    ...
    'TypePad signature verif\'n returned [_1] in [_2] seconds verifying [_3] with [_4]'
      => 'Die Überprüfung der TypePad-Signatur ergab binnen [_2] Sekunden [_1], [_3] wurde mit [_4] verifiziert.',
    'The TypePad signature is out of date ([_1] seconds old). Ensure that your server\'s clock is correct'
      => 'Die TypePad-Signatur ist zu alt ([_1] Sekunden). Bitte stellen Sie sicher, daß die Uhr Ihres Servers richtig gestellt ist',
...
## lib/MT/Auth/OpenID.pm
    ...
    'The address entered does not appear to be an OpenID' =>
      'Die eingegebene Adresse scheint keine OpenID zu sein',
    'The text entered does not appear to be a web address' =>
      'Der eingegebene Text scheint keine Webadresse zu sein',
    'Unable to connect to [_1]: [_2]' =>
      'Es konnte keine Verbindung zu [_1] hergestellt werden: [_2]',
    'Could not verify the OpenID provided: [_1]' =>
      'Die angegebene OpenID konnte nicht verifiziert werden: [_1]',

## lib/MT/Auth/MT.pm
    'Failed to verify current password.' =>
      'Kann Passwort nicht überprüfen.',
...
## lib/MT/Mail.pm
    ...
    'Sending mail via SMTP requires that your server have Mail::Sendmail installed: [_1]'
      => 'Für das Versenden von E-Mail mittels SMTP ist Mail::Sendmail erforderlich: [_1]',
...
## lib/MT/CMS/Search.pm
    ...
    'Saving object failed: [_2]' =>
      'Das Objekt konnte nicht gespeichert werden: [_2]',
...
## lib/MT/CMS/Import.pm
    ...
    'You do not have permission to create users' =>
      'Keine Rechte zum Anlegen neuer Benutzer',
...
## lib/MT/CMS/Folder.pm
    'The folder \'[_1]\' conflicts with another folder. Folders with the same parent must have unique basenames.'
      => 'Der Ordner \'[_1]\' steht im Konflikt mit einem anderen Ordner. Ordner im gleichen Unterordner müssen unterschiedliche Basisnamen haben.',
...
## lib/MT/CMS/Template.pm
    ...
    'Create template requires type' =>
      'Zum Anlegen einer Vorlage muss deren gewünschter Typ angegeben werden.',
    ...
    'Can\'t locate host template to preview module/widget.' =>
      'Kann Host-Vorlage für Vorschaumodul/Vorschauwidget nicht finden.',
    ...
    'Setting up mappings failed: [_1]' =>
      'Die Verknüpfung konnte nicht angelegt werden: [_1]',
    'Saving map failed: [_1]' =>
      'Die Verknüpfung konnte nicht gespeichert werden: [_1]',
    'You should not be able to enter 0 as the time.' =>
      '0 sollte nicht als Zeit eingegeben werden können.',
    'You must select at least one event checkbox.' =>
      'Bitte wählen Sie mindestens ein Ereignis-Auswahlkästchen an',
    ...
    'Skipping template \'[_1]\' since it appears to be a custom template.' =>
      'Überspringe Vorlage \'[_1]\', da es ein Custom Template zu sein scheint.',
    ...
    'Cannot publish a global template.' =>
      'Eine globale Vorlage kann nicht veröffentlicht werden.'
    ,    # Translate - New # OK
...
## lib/MT/CMS/Category.pm
    ...
    'Category name cannot be blank.' =>
      'Die Bezeichnung einer Kategorie darf nicht leer sein.',
    'The category name \'[_1]\' conflicts with another category. Top-level categories and sub-categories with the same parent must have unique names.'
      => 'Der Kategoriename \'[_1]\' steht im Konflikt mit einem anderen Kategorienamen. Hauptkategorien und Unterkategorien der gleichen Ebene müssen unterschiedliche Namen haben.',
    'The category basename \'[_1]\' conflicts with another category. Top-level categories and sub-categories with the same parent must have unique basenames.'
      => 'Der Kategorie-Basisname \'[_1]\' steht im Konflikt mit einem anderen Kategorienamen. Hauptkategorien und Unterkategorien der gleichen Ebene müssen unterschiedliche Basisnamen haben.',
...
## lib/MT/CMS/User.pm
    ...
    'You cannot define a role without permissions.' =>
      'Sie können keine Rollen ohne Berechtigungen definieren.',
    'General Settings' => 'Allgemeine Einstellungen',
    'Invalid ID given for personal blog clone source ID.' =>
      'Ungültige ID für Klonvorlage für persönliche Weblogs',
    'If personal blog is set, the default site URL and root are required.' =>
      'Standard-Site URL und Site Root für persönliche Weblogs erforderlich.',
    ...
    'You have no permission to delete the user [_1].' =>
      'Keine Rechte zum Löschen von Benutzer [_1].',
    ...
    'Email Address is required for password recovery' =>
      'E-Mail-Adresse erforderlich (für Passwort-Anforderungen)',
...
## lib/MT/CMS/Asset.pm
    ...
    'File \'[_1]\' (ID:[_2]) deleted by \'[_3]\'' =>
      'Datei \'[_1]\' (ID:[_2]) gelöschen von \'[_3]\'',
    'All Assets'   => 'Alle Assets',
    'Untitled'     => 'Ohne Name',
    'Archive Root' => 'Archiv-Wurzel',
    'Please select a file to upload.' =>
      'Bitte wählen Sie eine hochzuladende Datei aus.',
    'Please select an audio file to upload.' =>
      'Bitte wählen Sie aus, welche Audiodatei hochgeladen werden soll.',
    'Please select an image to upload.' =>
      'Bitte wählen Sie aus, welche Bilddatei hochgeladen werden soll.',
    'Please select a video to upload.' =>
      'Bitte wählen Sie aus, welches Video hochgeladen werden soll.',
    'Before you can upload a file, you need to publish your blog.' =>
      'Bevor Sie eine Datei hochladen können, müssen Sie das Blog zuerst veröffentlichen.',
    ...
    'File with name \'[_1]\' already exists. (Install File::Temp if you\'d like to be able to overwrite existing uploaded files.)'
      => 'Es ist bereits eine Datei namens \'[_1]\' vorhanden. (Um bereits vorhandene hochgeladene Dateien überschreiben zu können, installieren Sie File::Temp.)',
    'Error creating temporary file; please check your TempDir setting in your coniguration file (currently \'[_1]\') this location should be writable.'
      => 'Fehler beim Anlegen der temporären Datei. Bitte überprüfen Sie, ob das in der Konfigurationsdatei eingestellte TempDir (derzeit \'[_1]\') beschreibbar ist.',
    'unassigned' => 'nicht vergeben',
    'File with name \'[_1]\' already exists; Tried to write to tempfile, but open failed: [_2]'
      => 'Es ist bereits eine Datei namens \'[_1]\' vorhanden. Die angelegte temporäre Datei konnte nicht geöffnet werden: [_2]',
    'Could not create upload path \'[_1]\': [_2]' =>
      'Konnte Hochladepfad \'[_1]\' nicht anlegen: [_2]',
...
## lib/MT/CMS/Blog.pm
    ...
    'Saved Blog Changes' =>
      'Blog-Änderungen speichern',    # Translate - New # OK
    'Saving permissions failed: [_1]' =>
      'Die Rechte konnten nicht gespeichert werden: [_1]',
    'Blog \'[_1]\' (ID:[_2]) created by \'[_3]\'' =>
      'Weblog \'[_1]\' (ID:[_2]) angelegt von \'[_3]\'',
    ...
    'Error: Melody cannot write to the template cache directory. Please check the permissions for the directory called <code>[_1]</code> underneath your blog directory.'
      => 'Fehler: Melody kann nicht in den Vorlagen-Cache-Ordner schreiben. Bitte überprüfen Sie die Rechte für den Ordner <code>[_1]</code> in Ihrem Weblog-Verzeichnis.',
    'Error: Melody was not able to create a directory to cache your dynamic templates. You should create a directory called <code>[_1]</code> underneath your blog directory.'
      => 'Fehler: Melody konnte kein Verzeichnis zur Zwischenspeicherung Ihrer dynamischen Vorlagen anlegen. Legen Sie daher manuell einen Ordner namens <code>[_1]</code> in Ihrem Weblog-Verzeichnis an.',

## lib/MT/CMS/TrackBack.pm
    'Junk TrackBacks' => 'TrackBacks als Spam behandeln',
    'TrackBacks where <strong>[_1]</strong> is &quot;[_2]&quot;.' =>
      'TrackBacks, mit <strong>[_1]</strong> &quot;[_2]&quot;',
...
## lib/MT/CMS/Dashboard.pm
    ...
    'Melody has undergone a significant overhaul in all aspects of performance. Memory utilization has been reduced, publishing times have been increased significantly and search is now 100x faster!'
      => 'Melody wurde in sämtlichen Perfomance-Aspekten grundlegend verbessert. Sie profitieren von reduzierter Speicherauslastung, signifikant schnelleren Veröffentlichung und bis zu hundertfach schnelleren Suche.',
    ...
    'Template module and widget content can now be cached in the database to dramatically speed up publishing.'
      => 'Vorlagenmodule und Widget-Inhalte können jetzt in der Datenbank zwischengespeichert werden. Das bedeutet dramatisch beschleunigte Veröffentlichungsvorgänge.',
    'Improved Template and Design Management' =>
      'Verbesserte Vorlagen- und Design-Verwaltung',
    'The template editing interface has been enhanced to make designers more efficient at updating their site\'s design. The default templates have also been dramatically simplified to make it easier for you to edit and create the site you want.'
      => 'Mit der verbesserten Vorlagenbearbeitung können Designs effizienter umgesetzt werden. Die drastisch Vereinfachung des Quellcodes der Standardvorlagen beschleunigt die Umsetzung eigener Designs zusätzlich.',
    ...
    'Allow commenters on your blog to reply to each other increasing user engagement and creating more dynamic conversations.'
      => 'Kommentautoren können jetzt direkt auf andere Kommentare antworten. So können Konversationen dynamischer geführt und die Nutzerbeteiliung erhöht werden.',
...
## lib/MT/CMS/Common.pm
    ...
    'Finished! You can <a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">return to the blog listing</a> or <a href="javascript:void(0);" onclick="closeDialog(\'[_2]\');">configure the Site root and URL of the new blog</a>.'
      => 'Fertig! Zurück zur <a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">Liste aller Blogs</a> oder <a href="javascript:void(0);" onclick="closeDialog(\'[_2]\');">Pfade und Adressen des neuen Blogs konfigurieren</a>.',
    'Close'              => 'Schließen',
    'Permisison denied.' => 'Zugriff verweigert.',
    'The Template Name and Output File fields are required.' =>
      'Die Felder Vorlagennamen und Dateiname sind erforderlich.',
    'Invalid type [_1]' => 'Ungültiger Typ [_1]',
    'Invalid parameter' => 'Ungültiges Parameter',
    'Notification List' => 'Mitteilungssliste',
    'Removing tag failed: [_1]' =>
      'Der Tag konnte nicht entfernt werden: [_1]',
    ...
    'This action can only be run on a single blog at a time.' =>
      'Diese Aktion kann nur für jeweils ein Blog ausgeführt werden.'
    ,    # Translate - New # OK
    'Invalid blog_id' => 'Ungültige blog_id',
    'The Site URL matches the original blog' =>
      'Die Site-URL entspricht der des Ursprungsblogs', # Translate - New # OK
    'You need to specify a Site URL' =>
      'Geben Sie eine Site-URL an',                     # Translate - New # OK
    'The Site Path matches the original blog' =>
      'Der Site-Path entspricht dem des Ursprungsblogs'
    ,                                                   # Translate - New # OK
    'You need to specify a Site Path' =>
      'Geben Sie einen Site-Path an.',                  # Translate - New # OK
    'Entries must be cloned if trackbacks or comments are cloned' =>
      'Zum Klonen von TrackBacks oder Kommentaren müssen auch die Einträge geklont werden.'
    ,                                                   # Translate - New # OK
    'Entries must be cloned if comments are cloned' =>
      'Zum Klonen von Kommentarren müssen auch die Einträge geklont werden.'
    ,                                                   # Translate - New # OK
...
## lib/MT/CMS/Tools.pm
    ...
    'Error sending mail ([_1]); please fix the problem, then try again to recover your password.'
      => 'Beim Mailversand ist ein Fehler aufgetreten ([_1]). Überprüfen Sie die entsprechenden Einstellungen und versuchen Sie dann erneut, ein neues Passwort anzufordern.',
    'Password reset token not found' =>
      'Der Passwort Reset Token wurde nicht gefunden',
    'Email address not found' => 'Diese E-Mail-Adresse wurde nicht gefunden',
    'Your request to change your password has expired.' =>
      'Ihre Anfrage auf Änderung Ihres Passwortes ist ausgelaufen.',
    ...
    'You don\'t have a system email address configured.  Please set this first, save it, then try the test email again.'
      => 'Sie haben noch nicht die Mail-Adresse angegeben, die vom System verwendet werden soll. Bitte geben Sie sie ein und speichern sie und versuchen Sie dann erneut, die Testmail zu verschicken.'
    ,    # Translate - New # OK
    'Please enter a valid email address' =>
      'Bitte geben Sie eine gültige E-Mail-Adresse ein'
    ,    # Translate - New # OK
    'Test email from Melody' => 'Testmail von Melody',  # Translate - New # OK
    'This is the test email sent by your installation of Melody.' =>
      'Diese Testmail wurde von Ihrer Melody-Installation verschickt.'
    ,                                                   # Translate - New # OK
    'Mail was not properly sent' =>
      'Die Mail konnte nicht korrekt verschickt werden'
    ,                                                   # Translate - New # OK
    'Invalid password recovery attempt; can\'t recover password in this configuration'
      => 'Ungültiger Versuch der Passwortanforderung. Passwörter können in dieser Konfiguration nicht angefordert werden.',
    ...
    'Temporary directory needs to be writable for backup to work correctly.  Please check TempDir configuration directive.'
      => 'Das temporäre Verzeichnis muss zur Durchführung der Sicherung beschreibbar sein. Bitte überprüfen Sie Ihre TempDir-Einstellung.',
    'Temporary directory needs to be writable for restore to work correctly.  Please check TempDir configuration directive.'
      => 'Das temporäre Verzeichnis muss zur Durchführung der Wiederherstellung beschreibbar sein. Bitte überprüfen Sie Ihre TempDir-Einstellung.',
    ...
    '[_1] has canceled the multiple files restore operation prematurely.' =>
      '[_1] hat die Vorgang zur Wiederherstellung mehrerer Dateien vorzeitig abgebrochen.',
    'Changing Site Path for the blog \'[_1]\' (ID:[_2])...' =>
      'Ändere Sitepfad für Weblog\'[_1]\' (ID:[_2])...',
    'Removing Site Path for the blog \'[_1]\' (ID:[_2])...' =>
      'Entferne Sitepfad für Weblog \'[_1]\' (ID:[_2])...',
    'Changing Archive Path for the blog \'[_1]\' (ID:[_2])...' =>
      'Ändere Archivpfad für Weblog \'[_1]\' (ID:[_2])...',
    'Removing Archive Path for the blog \'[_1]\' (ID:[_2])...' =>
      'Entferne Archivpfadfür Weblog \'[_1]\' (ID:[_2])...',
    ...
    'Successfully restored objects to Melody system by user \'[_1]\'' =>
      'Objekte erfolgreich wiederhergestellt von Benutzer \'[_1]\'',
    ...
    'User has not set pasword hint; cannot recover password' =>
      'Erinnerungsfrage nicht gesetzt; neues Passwort kann deshalb nicht angefordert werden',
    ...
    'Some objects were not restored because their parent objects were not restored.  Detailed information is in the <a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">activity log</a>.'
      => 'Einige Objekte wurden nicht wiederhergestellt, da ihre Elternobjekte ebenfalls nicht widerhergestellt wurden. Details finden Sie im <a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">Aktivitätsprotokoll</a>.',
    ...
    'Uploaded file was not a valid Melody backup manifest file.' =>
      'Die hochgeladene Datei ist keine gültige Melody Backup-Manifest-Datei.',
    ...
    'Melody system was successfully backed up by user \'[_1]\'' =>
      'Melody-System erfolgreich gesichert von Benutzer \'[_1]\'',
...
## lib/MT/CMS/Entry.pm
    ...
    'Same Basename has already been used. You should use an unique basename.'
      => 'Dieser Basisname wird bereits verwendet. Bitte verwenden Sie einen eindeutigen Basisnamen.',
    ...
    'Invalid date \'[_1]\'; authored on dates must be in the format YYYY-MM-DD HH:MM:SS.'
      => 'Datum \'[_1]\' ungültig; erforderliches Formst ist JJJJ-MM-TT SS:MM:SS.',
    'Invalid date \'[_1]\'; authored on dates should be real dates.' =>
      'Ungültiges Datum \'[_1]\'; das Datum muss existieren.',
    ...
    '<a href="[_1]">QuickPost to [_2]</a> - Drag this link to your browser\'s toolbar then click it when you are on a site you want to blog about.'
      => '<a href="[_1]">QuickPost für [_2]</a> - Ziehen Sie diesen Link in die Lesezeichenleiste Ihres Browsers und klicken Sie darauf, wenn Sie sich auf einer Website befinden, über die Sie bloggen möchten.',
    'Entry \'[_1]\' (ID:[_2]) deleted by \'[_3]\'' =>
      'Eintrag \'[_1]\' (ID:[_2]) gelöscht von \'[_3]\'',
    ...
    'One of the entries ([_1]) did not actually exist' =>
      'Einer der Einträge ([_1]) ist nicht vorhanden',
...
## lib/MT/CMS/Comment.pm
    ...
    'Parent comment id was not specified.' =>
      'ID des Elternkommentars nicht angegeben.',
    'Parent comment was not found.' => 'Elternkommentar nicht gefunden.',
    'You can\'t reply to unapproved comment.' =>
      'Sie können auf nicht freigegebene Kommentare nicht antworten.',
    ...
    'You don\'t have permission to approve this comment.' =>
      'Sie haben keine Berechtigung zur Freischaltung dieses Kommentars.',
    'Comment on missing entry!' => 'Kommentar gehört zu fehlendem Eintrag',
    'You can\'t reply to unpublished comment.' =>
      'Sie können nicht auf Kommentare antworten, die noch nicht veröffentlicht wurden.',
...
## lib/MT/App.pm
    'Invalid request: corrupt character data for character set [_1]' =>
      'Ungültige Anfrage: Zeichenkette enthält ungültige Zeichen für Zeichensatz [_1]',
    'First Weblog' => 'Erstes Weblog',
    'Error loading blog #[_1] for user provisioning. Check your NewUserTemplateBlogId setting.'
      => 'Fehler beim Laden von Blog #[_1] zur Nutzerbereitstellug. Bitte überprüfen Sie Ihre NewUserTemplateBlogId-Einstellung.',
    'Error provisioning blog for new user \'[_1]\' using template blog #[_2].'
      => 'Fehler bei Bereitstellung des Blogs für neuen Benutzer \'[_1]\' nach Vorlage Blog #[_2].',
    'Error creating directory [_1] for blog #[_2].' =>
      'Fehler beim Anlegen des Ordners [_1] für Blog #[_2])',
    ...
    'Our apologies, but you do not have permission to access any blogs within this installation. If you feel you have reached this message in error, please contact your Melody system administrator.'
      => 'Sie haben leider keine Berechtigung, auf Blogs dieser Melody-Installation zuzugreifen. Sollte diese Meldung irrtümlich angezeigt werden, wenden Sie sich bitte an Ihren Administrator.',
    'This account has been disabled. Please see your system administrator for access.'
      => 'Dieses Benutzerkonto wurde gesperrt. Bitte wenden Sie sich an den Administrator.',
    'Failed login attempt by pending user \'[_1]\'' =>
      'Fehlgeschlagener Anmeldeversuch von schwebendem Benutzer \'[_1]\'',
    'This account has been deleted. Please see your system administrator for access.'
      => 'Dieses Benutzerkonto wurde gelöscht. Bitte wenden Sie sich an den Administrator.',
    ...
    'User \'[_1]\' (ID:[_2]) logged in successfully' =>
      'Benutzerkonto \'[_1]\' (ID:[_2]) erfolgreich angemeldet',
    ...
    'Something wrong happened when trying to process signup: [_1]' =>
      'Bei der Bearbeitung der Registrierung ist ein Fehler aufgetreten: [_1]',
...
## lib/MT/BackupRestore/BackupFileHandler.pm
    'Uploaded file was backed up from Melody but the different schema version ([_1]) from the one in this system ([_2]).  It is not safe to restore the file to this version of Melody.'
      => 'Die hochgeladene Sicherungsdatei stammt aus einer Melody-Installation mit anderer Schema-Version ([_1]) wie diese Installation ([_2]). Wir raten daher ausdrücklich davor ab, die Datei in diese Melody-Version einzuspielen.',
    '[_1] is not a subject to be restored by Melody.' =>
      '[_1] wird von Melody nicht wiederhergestellt.',
    ...
    'User with the same name as the name of the currently logged in ([_1]) found.  Skipped the record.'
      => 'Benutzer mit dem Namen des derzeit angemeldeten Benutzers ([_1]) gefunden. Eintrag übersprungen.',
    'User with the same name \'[_1]\' found (ID:[_2]).  Restore replaced this user with the data backed up.'
      => 'Benutzer mit gleichem Namen \'[_1]\' gefunden (ID:[_2]).  Die Benutzerdaten wurden entsprechend ersetzt.',
...
## lib/MT.pm.pre
    ...
    'http://www.sixapart.com/movabletype/' =>
      'http://www.movabletype.org/sitede',
    'OpenID URL' => 'OpenID-URL',
    'Sign in using your OpenID identity.' =>
      'Mit Ihrer OpenID-Kennung anmelden',
    'OpenID is an open and decentralized single sign-on identity system.' =>
      'OpenID ist ein offenes und dezentrales Single Sign On-System',
    'Sign in'                          => 'Anmelden',
    'Learn more about OpenID.'         => 'Mehr über OpenID erfahren',
    ...
    'Sign in to Melody with your[_1] Account[_2]' =>
      'Bei Melody mit Ihrem[_1]-Konto[_2] anmelden',
    ...
    'Sign in or register with TypePad.' =>
      'Registrieren oder anmelden mit TypePad',
    ...
    'If present, 3rd argument to add_callback must be an object of type MT::Component or MT::Plugin'
      => 'Falls vorhanden, muss das drite Argument von add_callback ein MT::Component-Objekt oder ein MT::Plugin sein',
    '4th argument to add_callback must be a CODE reference.' =>
      'Viertes Argument von add_callback muss eine CODE-Referenz sein.',
    ...
    'Missing configuration file. Maybe you forgot to move config.cgi-original to config.cgi?'
      => 'Keine Konfigurationsdatei gefunden. Haben Sie möglicheweise vergessen, config.cgi-original in config.cgi umzubennen?',
...
## mt-static/mt.js
    ...
    'The tag \'[_2]\' already exists. Are you sure you want to merge \'[_1]\' with \'[_2]\'?'
      => 'Der Tag \'[_2]\' ist bereits vorhanden. Soll \'[_1]\' wirklich mit \'[_2]\' zusammengeführt werden?',
    'The tag \'[_2]\' already exists. Are you sure you want to merge \'[_1]\' with \'[_2]\' across all weblogs?'
      => 'Der Tag \'[_2]\' ist bereits vorhanden. Soll \'[_1]\' wirklich in allen Weblogs mit \'[_2]\' zusammengeführt werden?',
    'Loading...'                => 'Lade...',
...
## search_templates/default.tmpl
    'SEARCH FEED AUTODISCOVERY LINK PUBLISHED ONLY WHEN A SEARCH HAS BEEN EXECUTED'
      => 'SEARCH FEED AUTODISCOVERY-LINK WIRD NUR ANGEZEIGT, WENN EINE SUCHE AUSGEFÜHRT WURDE',
    'Blog Search Results' => 'Suchergebnisse',
    'Blog search'         => 'Blogsuche',
    'STRAIGHT SEARCHES GET THE SEARCH QUERY FORM' =>
      'EINFACHE SUCHEN - EINFACHES FORMULAR',
    ...
    'Entries from [_1] tagged with \'[_2]\'' =>
      'Mit \'[_2]\' getaggte Einträge aus [_1]',
    ...
    'No pages were found containing \'[_1]\'.' =>
      'Keine Seiten mit \'[_1]\' gefunden.',
    'By default, this search engine looks for all words in any order. To search for an exact phrase, enclose the phrase in quotes'
      => 'Die Suchfunktion sucht standardmäßig nach allen angebenen Begriffen in beliebiger Reihenfolge. Um nach einem exakten Ausdruck zu suchen, setzen Sie diesen bitte in Anführungszeichen.',
    'The search engine also supports AND, OR, and NOT keywords to specify boolean expressions'
      => 'Die boolschen Operatoren AND, OR und NOT werden unterstützt.',
    ...
    'If you use an RSS reader, you can subscribe to a feed of all future entries tagged \'[_1]\'.'
      => 'Wenn Sie einen Feedreader verwenden, können Sie einen Feed aller neuen mit \'[_1]\' getaggten Einträge abonnieren.',
    'If you use an RSS reader, you can subscribe to a feed of all future entries matching \'[_1]\'.'
      => 'Wenn Sie einen Feedreader verwenden, können Sie einen Feed aller neuen Einträge mit \'[_1]\' abonnieren.',
...
## search_templates/comments.tmpl
    ...
    'Select the time interval that you\'d like to search in, then click \'Find new comments\''
      => 'Wählen Sie den gewünschten Zeitraum und klicken Sie dann auf \'Neue Kommentare finden\'.',
...
## tmpl/wizard/optional.tmpl
    ...
    'Periodically Melody will send email to inform users of new comments as well as other other events. For these emails to be sent properly, you must instruct Melody how to send email.'
      => 'Geben Sie an, auf welchem Wege Melody E-Mails verschicken soll. E-Mails werden beispielsweise zur Benachrichtigung über neue Kommentare verschickt.',
...
## tmpl/wizard/complete.tmpl
    ...
    'Please use the configuration text below to create a file named \'config.cgi\' in the root directory of [_1] (the same directory in which index.cgi is found).'
      => 'Kopieren Sie folgenden Text in eine Datei namens \'config.cgi\' und legen diese im Melody-Hauptverzeichnis ab (das Verzeichnis, in dem sich auch die Datei index.cgi befindet)',
    ...
    'Confirm your [_1] home directory (the directory that contains index.cgi) is writable by your web server and then click \'Retry\'.'
      => 'Bitte überprüfen Sie, ob der Webserver Schreibrechte für Ihr [_1]-Hauptverzeichnis hat und klicken Sie dann auf "Erneut versuchen".',
    'Congratulations! You\'ve successfully configured [_1].' =>
      'Herzlichen Glückwunsch! Sie haben die [_1] erfolgreich konfiguriert.',
    'Your configuration settings have been written to the following file:' =>
      'Ihre Einstellungen wurden in folgender Datei gespeichert:',
    'To reconfigure the settings, click the \'Back\' button below.' =>
      'Um Änderungen an den Einstellungen vorzunehmen, klicken Sie auf \'Zurück\'.',
    'Show the config.cgi file generated by the wizard' =>
      'Vom Konfigurationshelfer erzeugte config.cgi-Datei anzeigen',
    'The config.cgi file has been created manually.' =>
      'Die config.cgi-Konfigurationsdatei wurde manuell erstellt.',
...
## tmpl/wizard/cfg_dir.tmpl
    ...
    'Your TempDir has been successfully configured. Click \'Continue\' below to continue configuration.'
      => 'TempDir erfolgreich konfiguriert. Sie können die Konfigurierung nun fortsetzen.',
...
## tmpl/wizard/start.tmpl
    'Welcome to Melody' => 'Willkommen zu Melody',
    ...
    'A configuration (config.cgi) file already exists, <a href="[_1]">sign in</a> to Melody.'
      => 'Es ist bereits eine Konfigurationsdatei (config.cgi) vorhanden. Sie können sich daher sofort <a href="[_1]">bei Melody anmelden</a>.',
    'To create a new configuration file using the Wizard, remove the current configuration file and then refresh this page'
      => 'Um mit dem Konfigurationshelfer eine neue Konfigurationsdatei zu erzeugen, entfernen Sie die vorhandene Konfigurationsdatei und laden Sie diese Seite neu.',
    'Melody requires that you enable JavaScript in your browser. Please enable it and refresh this page to proceed.'
      => 'Melody erfordert JavaScript. Bitte aktivieren Sie es in Ihren Browsereinstellungen und laden diese Seite dann neu.',
    'This wizard will help you configure the basic settings needed to run Melody.'
      => 'Dieser Konfigurationshelfer hilft Ihnen, die zum Betrieb von Melody erforderlichen Grundeinstellungen vorzunehmen.',
    '<strong>Error: \'[_1]\' could not be found.</strong>  Please move your static files to the directory first or correct the setting if it is incorrect.'
      => '<strong>Fehler: \'[_1]\' nicht gefunden.</strong> Bitte verschieben Sie die statischen Dateien erst in das Verzeichnis oder überprüfen Sie die Einstellungen.',
    ...
    'Melody ships with directory named [_1] which contains a number of important files such as images, javascript files and stylesheets.'
      => 'Melody wird mit einem Verzeichnis namens [_1] ausgeliefert, das einige wichtige Bild-, JavaScript- und Stylesheet-Dateien enthält.',
    'The [_1] directory is in the main Melody directory which this wizard script resides, but due to your web server\'s configuration, the [_1] directory is not accessible in this location and must be moved to a web-accessible location (e.g., your web document root directory).'
      => 'Der [_1]-Ordner befindet sich im Hauptverzeichnis von Melody, ist aufgrund der Serverkonfiguration vom Webserver aber nicht erreichbar. Verschieben Sie den Ordner [_1] daher an einen Ort, auf dem der Webserver zugreifen kann (z.B. Document Root).',
    'This directory has either been renamed or moved to a location outside of the Melody directory.'
      => 'Das Verzeichnis wurde entweder umbenannt oder an einen Ort außerhalb des Melody-Verzeichnisses verschoben.',
...
## tmpl/wizard/packages.tmpl
    ...
    'The following Perl modules are required in order to make a database connection.  Melody requires a database in order to store your blog\'s data.  Please install one of the packages listed here in order to proceed.  When you are ready, click the \'Retry\' button.'
      => 'Die folgenden Perl-Module sind zur Herstellung einer Datenbankverbindung erforderlich (Melody speichert Ihre Daten in einer Datenbank). Bitte installieren Sie die hier genannten Pakete und klicken Sie danach auf \'Erneut versuchen\'.',
    ...
    'You are ready to proceed with the installation of Melody.' =>
      'Sie können die Installation von Melody fortsetzen.',
    ...
    'One or more Perl modules required by Melody could not be found.' =>
      'Mindestens ein von Melody erforderliche Perl-Modul wurde nicht gefunden.',
    'The following Perl modules are required for Melody to run properly. Once you have met these requirements, click the \'Retry\' button to re-test for these packages.'
      => 'Die folgenden Pakete sind nicht vorhanden, zur Ausführung von Melody aber erforderlich. Bitte installieren Sie sie und klicken dann auf \'Erneut versuchen\'.',
    'Some optional Perl modules could not be found. You may continue without installing these optional Perl modules. They may be installed at any time if they are needed. Click \'Retry\' to test for the modules again.'
      => 'Einige optionale Perl-Module wurden nicht gefunden. Die Installation kann ohne diese Module fortgesetzt werden. Sie können jederzeit bei Bedarf nachinstalliert werden. \'Erneut versuchen\' wiederholt die Modulsuche.',
...
## tmpl/wizard/configure.tmpl
    ...
    'Is your preferred database not listed? View the <a href="[_1]" target="_blank">Melody System Check</a> see if additional modules are necessary.'
      => 'Wird Ihr Datenbanksystem nicht aufgeführt? Führen Sie die <a href="[_1]" target="_blank">Melody Systemüberprüfung</a> durch, um zu erfahren, ob zusätzliche Module erforderlich sind.',
    ...
    'MS SQL Server driver must use either Shift_JIS or ISO-8859-1.  MS SQL Server driver does not support UTF-8 or any other character set.'
      => 'Der Microsoft SQL Server-Treiber unterstützt ausschließlich die Zeichenkodierungen Shift_JIS und ISO-8859-1. UTF-8 oder andere Kodierungen können nicht verwendet werden.',
...
## tmpl/wizard/blog.tmpl
    ...
    'In order to properly publish your blog, you must provide Melody with your blog\'s URL and the path on the filesystem where its files should be published.'
      => 'Damit Ihr Blog veröffentlicht werden kann, geben Sie bitte die Webadresse (URL), unter der der Blog erscheinen soll, und den Pfad im Dateisystem, unter dem Melody die Dateien dieses Blog ablegen soll, an.',
    ...
    'Your \'Publishing Path\' is the path on your web server\'s file system where Melody will publish all the files for your blog. Your web server must have write access to this directory.'
      => 'Der Veröffentlichungspfad ist der Pfad auf Ihrem Webserver, in dem Melody die Dateien dieses Blogs ablegt.',
...
## tmpl/cms/edit_role.tmpl
    ...
    '[quant,_1,User,Users] with this role' =>
      '[quant,_1,Benutzer,Benutzer] mit dieser Rolle',
    'You have changed the privileges for this role. This will alter what it is that the users associated with this role will be able to do. If you prefer, you can save this role with a different name.  Otherwise, be aware of any changes to users with this role.'
      => 'Sie haben die Berechtigungen dieser Rolle geändert. Dadurch werden auch die Rechte der mit dieser Rolle verknüpften Benutzer beeinflusst. Wenn Sie möchten, können Sie daher die Rolle unter neuem Namen speichern.',
...
## tmpl/cms/list_association.tmpl
    ...
    'You have successfully granted the given permission(s).' =>
      'Berechtigungen erfolgreich vergeben',
...
## tmpl/cms/cfg_plugin.tmpl
    ...
    'Manually enable or disable plugin-system functionality. Re-enabling plugin-system functionality, will return all plugins to their original state.'
      => 'Das Plugin-System kann manuell aktiviert oder deaktiviert werden. Reaktivierung der Plugin-Funktion setzt alle Plugins in ihren Ausgangszustand zurück.',
    ...
    'Your plugins have been reconfigured. Since you\'re running mod_perl, you will need to restart your web server for these changes to take effect.'
      => 'Einstellungen übernommen. Da Sie mod_perl verwenden, müssen Sie Ihren Webserver neu starten, damit die Änderungen wirksam werden.',
    ...
    'Are you sure you want to disable plugin functionality?' =>
      'Plugin-Funktion wirklich deaktivieren?',
    ...
    'Are you sure you want to enable plugin functionality? (This will re-enable any plugins that were not individually disabled.)'
      => 'Plugin-Funktion wirklich aktivieren? (Reaktiviert alle Plugins, die nicht separat deaktiviert worden sind.)',
    ...
    'This plugin has not been upgraded to support Melody [_1]. As such, it may not be 100% functional. Furthermore, it will require an upgrade once you have upgraded to the next Melody major release (when available).'
      => 'Dieses Plugin wurde noch nicht für Melody [_1] portiert. Daher funktioniert es möglicherweise nicht fehlerfrei. Außerdem erfordert es nach Installation der nächsten Melody-Version eine zusätzliche Aktualisierung.',
...
## tmpl/cms/edit_asset.tmpl
    ...
    'This asset has not been used.' =>
      'Dieses Asset wurde noch nicht verwendet.',
...
## tmpl/cms/edit_template.tmpl
    ...
    'Error occurred while updating archive maps.' =>
      'Bei der Aktualisierung der Archivverknüpfungen ist ein Fehler aufgetreten.',
    'Archive map has been successfully updated.' =>
      'Archivverknüpfung erfolgreich aktualisiert.',
    'Are you sure you want to remove this template map?' =>
      'Archivverknüpfung wirklich löschen?',
...
## tmpl/cms/list_category.tmpl
    'Your category changes and additions have been made.' =>
      'Kategorieänderungen gespeichert.',
    'You have successfully deleted the selected category.' =>
      'Gewählte Kategorie erfolgreich gelöscht.',
    'categories'                      => 'Kategorien',
...
## tmpl/cms/dashboard.tmpl
    ...
    'The directory you have configured for uploading userpics is not writable. In order to enable users to upload userpics, please make the following directory writable by your web server: [_1]'
      => 'Das angegebene Benutzerbilder-Verzeichnis kann nicht beschrieben werden. Damit Mitglieder Benutzerbilder hochladen können, machen Sie folgendes Verzeichnis durch Ihren Webserver beschreibbar: [_1]',
    'Image::Magick is either not present on your server or incorrectly configured. Due to that, you will not be able to use Melody\'s userpics feature. If you wish to use that feature, please install Image::Magick or use an alternative image driver.'
      => 'Die Benutzerbild-Funktion steht Ihnen derzeit nicht zur Verfügung, da Image::Magick nicht installiert oder nicht richtig konfiguriert ist. Um die Funktion zu nutzen, installieren Sie Image::Magick oder verwenden Sie einen anderen entsprechenden Treiber',
...
## tmpl/cms/cfg_trackbacks.tmpl
    ...
    'Your TrackBack preferences have been saved.' =>
      'TrackBack-Einstellungen gespeichert.',
    ...
    'If you turn on auto-discovery, when you write a new entry, any external links will be extracted and the appropriate sites automatically sent TrackBacks.'
      => 'Falls aktiviert, werden an alle verlinkten externen Seiten, die TrackBack unterstützen, bei Veröffentlichung eines neuen Eintrags automatisch TrackBack-Pings verschickt.',
    ...
    'Note: The above option may be affected since outbound pings are constrained system-wide.'
      => 'Hinweis: Die Funktion ist möglicherweise nur eingeschränkt wirksam, da ausgehende Pings systemweit eingeschränkt sind.',
    ...
    'Note: The above option is currently ignored since outbound pings are disabled system-wide.'
      => 'Hinweis: Die Funktion ist derzeit nicht wirksam, da ausgehende Pings systemweit deaktiviert sind.',
...
## tmpl/cms/edit_widget.tmpl
    ...
    'Please use a unique name for this widget set.' =>
      'Bitte verwenden Sie für die Widgetgruppe einen eindeutigen Namen.',
    'Set Name' => 'Gruppenname',
    'Drag and drop the widgets you want into the Installed column.' =>
      'Ziehen Sie die Widgets, die angezeigt werden sollen, in die Spalte \'Installierte Widgets\'. Soll ein Widget nicht mehr angezeigt werden, schieben Sie es zurück in die Spalte \'Verfügbare Widgets\'.',
...
## tmpl/cms/edit_commenter.tmpl
    ...
    'View all comments with this URL address' =>
      'Alle Kommentare mit dieser Web-Adresse (URL) anzeigen',
    'Status' => 'Status',
...
## tmpl/cms/cfg_system_general.tmpl
    ...
    'Test email was sent.' =>
      'Die Test-Mail wurde erfolgreich verschickt.',    # Translate - New # OK
    ...
    'The email address used in the From: header of each email sent from the system.  The address is used in password recovery, commenter registration, comment, trackback notification and a few other minor events.'
      => 'Geben Sie die E-Mail-Adresse an, die als Absenderadresse der vom System verschickten E-Mails verwendet werden soll. E-Mails werden vom System verschickt bei Passwortanforderungen, Registrierungen von Kommentarautoren, für Benachrichtigungen über neue Kommentare, TrackBacks und einigen weiteren Fällen.',
    'Debug Mode' => 'Debug-Modus',                      # Translate - New # OK
    'You can find an explanation of the various debug modes in the' =>
      'Eine Beschreibung der verschiedenen Debug-Modi finden Sie in der'
    ,                                                   # Translate - New # OK
...
## tmpl/cms/view_rpt_log.tmpl
    ...
    'Showing all Schwartz errors' =>
      'Alle Schwartz-Fehler zeigen',                    # Translate - New # OK
...
## tmpl/cms/cfg_comments.tmpl
    ...
    'Comment authentication is not available because one of the needed modules, MIME::Base64 or LWP::UserAgent is not installed. Talk to your host about getting this module installed.'
      => 'Kommentarauthentifizierung ist derzeit nicht möglich, da ein erforderliches Modul nicht installiert ist (MIME::Base64 oder LWP::UserAgent). Bitte wenden Sie sich an Ihren Administrator.',
    'Accept Comments' => 'Kommentare zulassen',
    'If enabled, comments will be accepted.' =>
      'Falls aktiviert, werden Kommentare zugelassen',
    ...
    'If enabled, users will be able to enter a limited set of HTML in their comments. If not, all HTML will be stripped out.'
      => 'Wenn die Option aktiv ist, darf HTML in Kommentaren verwendet werden. Andernfalls wird HTML aus Kommentaren automatisch herausgefiltert.',
    ...
    'Specifies the list of HTML tags allowed by default when cleaning an HTML string (a comment, for example).'
      => 'Liste der HTML-Tags, die aus HTML-Kommentaren nicht ausgefiltert werden sollen.',
    'Use defaults'    => 'Standardwerte verwenden',
    '([_1])'          => '([_1])',
    'Use my settings' => 'Eigene Einstellungen',
    'Disable \'nofollow\' for trusted commenters' =>
      '\'nofollow\' für Kommentare von vertrauten Kommentarautoren nicht verwenden',
    'If enabled, the \'nofollow\' link relation will not be applied to any comments left by trusted commenters.'
      => 'Falls aktiviert, wird für Links in Kommentaren von vertrauten Kommentarautoren das \'nofollow\'-Attribut nicht gesetzt.',
    'Specify when Melody should notify you of new comments if at all.' =>
      'Legt fest, ob und wann Melody Email-Benachrichtigungen über neue Kommentare versendet.',
    ...
    'Select whether you want visitor comments displayed in ascending (oldest at top) or descending (newest at top) order.'
      => 'Wählen Sie aus, ob Kommentare von Besuchern in aufsteigender (ältester zuerst) oder absteigender (neuester zuerst) Reihenfolge angezeigt werden sollen.',
    ...
    'If enabled, all non-linked URLs will be transformed into links to that URL.'
      => 'Wenn die Option aktiv ist, werden alle URLs automatisch in HTML-Links umgewandelt.',
    ...
    'No CAPTCHA provider is available in this system.  Please check to see if Image::Magick is installed, and CaptchaSourceImageBase directive points to captcha-source directory under mt-static/images.'
      => 'Keine CAPTCHA-Quelle verfügbar. Bitte überprüfen Sie, ob Image::Magick installiert ist und die CaptchaSourceImageBase-Direktive auf das Captcha-Quellverzeichnis im Ordner mt-static/images verweist.',
...
## tmpl/cms/backup.tmpl
    ...
    'Approximate file size per backup file.' =>
      'Ungefähre Größe pro Backupdatei (MB)',
...
## tmpl/cms/cfg_system_users.tmpl
    ...
    'You must set a valid Default Site URL.' =>
      'Standard-Site URL erforderlich.',
    'You must set a valid Default Site Root.' =>
      'Standard-Site Root erforderlich.',
    ...
    'Allow commenters to register to Melody' =>
      'Falls aktiv, können sich Benutzer bei dieser Melody-Installation als Kommentarautor selbst registrieren',
    'Notify the following administrators upon registration:' =>
      'Bei Registrierungen folgende Administratoren benachrichtigen:',
    'Select Administrators' => 'Administratoren wählen',
    'Clear'                 => 'zurücksetzen',
    'Note: System Email Address is not set. Emails will not be sent.' =>
      'Hinweis: System-E-Mail-Adresse nicht konfiguriert. E-Mails können daher nicht verschickt werden.',
    ...
    'Check to have the system automatically create a new personal blog when a user is created in the system. The user will be granted a blog administrator role on the blog.'
      => 'Wenn diese Option aktiv ist, wird für jeden neu angelegten Benutzer automatisch ein persönliches Weblog angelegt. Der Benutzer wird für dieses Blog als Blog-Administrator eingetragen.',
    ...
    'Select a blog you wish to use as the source for new personal blogs. The new blog will be identical to the source except for the name, publishing paths and permissions.'
      => 'Wählen Sie, welches Blog Vorlage für persönliche Blogs sein soll. Neue Blogs sind mit den Ausnahmen Name, Pfade und Berechtigungen mit der Vorlage identisch.',
    ...
    'Define the default site URL for new blogs. This URL will be appended with a unique identifier for the blog.'
      => 'Wählen Sie die Standard-URL für neue Weblogs. Dieser URL wird ein individueller Bezeichner für jedes Weblog angehängt.',
    ...
    'Define the default site root for new blogs. This path will be appended with a unique identifier for the blog.'
      => 'Wählen Sie das Standard-Wurzelverzeichnis für neue Weblogs. Dem Pfad wird ein individueller Bezeichner für jedes Weblog angehängt.',
    'Default User Language' => 'Standard-Sprache',
    'Define the default language to apply to all new users.' =>
      'Wählen Sie die Standard-Sprache aller neuer Benutzerkonten ',
...
## tmpl/cms/edit_entry.tmpl
    ...
    '<a href="[_2]">[quant,_1,comment,comments]</a>' =>
      '<a href="[_2]">[quant,_1,Kommentar,Kommentare]</a>',
    ...
    'Warning: Changing this entry\'s basename may break inbound links.' =>
      'Warnung: Wenn Sie den Basisnamen nachträglich ändern, können externe Links zu diesem Eintrag ungültig werden.',
    'close'                           => 'schließen',
    'Accept'                          => 'Annehmen',
    ...
    'The published order of these assets can be changed using template tag modifiers.'
      => 'Die Reihenfolge, in der diese Assets veröffentlicht werden, kann mittels Template Tag Modifiers beeinflusst werden.'
    ,    # Translate - New # OK
    ...
    'Are you sure you want to use the Rich Text editor?' =>
      'Grafischen Editor wirklich verwenden?',
    'Remove'                => 'Entfernen',
    ...
    'Use <a href="http://blogit.typepad.com/">Blog It</a> to post to Melody from social networks like Facebook.'
      => 'Mit <a href="http://blogit.typepad.com/">Blog It</a> aus Facebook heraus in Melody-Blogs bloggen',
...
## tmpl/cms/include/comment_table.tmpl
    ...
    'Report selected comments as Spam (j)' =>
      'Gewählte Kommentare als Spam melden (j)',
    'Report selected comments as Not Spam and Publish (j)' =>
      'Gewählte Kommentare als gültig melden und veröffentlichen (j)',
    'Not Spam' => 'Nicht Spam',
    'Are you sure you want to remove all comments reported as spam?' =>
      'Wirklich alle als Spam gemeldeten Kommentare löschen?',
    'Delete all comments reported as Spam' =>
      'Alle als Spam gemeldeten Kommentare löschen',
    'Empty'       => 'Leer',
    ...
    'Only show published comments' =>
      'Nur veröffentlichte Kommentare anzeigen',
    'Only show pending comments' =>
      'Nur nicht veröffentlichte Kommentare anzeigen',
    'Pending'                    => 'Auf Moderation wartend',
...
## tmpl/cms/include/member_table.tmpl
    ...
    'Are you sure you want to remove the selected user from this blog?' =>
      'Gewählte Benutzer wirklich aus diesem Blog entfernen?',
    'Are you sure you want to remove the [_1] selected users from this blog?'
      => 'Gewählte [_1] Benutzer wirklich aus diesem Blog entfernen?',
...
## tmpl/cms/include/import_end.tmpl
    ...
    'Make sure that you remove the files that you imported from the \'import\' folder, so that if/when you run the import process again, those files will not be re-imported.'
      => 'Vergessen Sie nicht, die verwendeten Dateien aus dem \'import\'-Ordner zu entfernen, damit sie bei künftigen Importvorgängen nicht erneut importiert werden.',
...
## tmpl/cms/include/import_start.tmpl
    ...
    'Importing entries as user \'[_1]\'' =>
      'Importiere als Benutzer \'[_1]\'...',
    'Creating new users for each user found in the blog' =>
      'Lege Benutzerkonten für neu entdeckte Benutzer an...',
...
## tmpl/cms/include/footer.tmpl
    'This is a beta version of Melody and is not recommended for production use.'
      => 'Das ist eine Beta-Version von Melody. Der Einsatz als Produktivsystem wird nicht empfohlen.',
...
## tmpl/cms/include/commenter_table.tmpl
    ...
    'Only show trusted commenters' =>
      'Nur vertrauenswürdige Kommentarautoren anzeigen',
    'Only show banned commenters' =>
      'Nur gesperrte Kommentarautoren anzeigen',
    'Only show neutral commenters' =>
      'Nur neutrale Kommentarautoren anzeigen',
...
## tmpl/cms/include/ping_table.tmpl
    ...
    'Report selected [_1] as Not Spam and Publish (j)' =>
      'Markierte [_1] als gültig melden und veröffentlichen (j)',
    'Are you sure you want to remove all TrackBacks reported as spam?' =>
      'Wirklich alle als Spam gemeldeten TrackBacks löschen?',
    'Deletes all [_1] reported as Spam' =>
      'Alle als Spam gemeldeten [_1] löschen',
    'From'   => 'Von',
    'Target' => 'Nach',
    'Only show published TrackBacks' =>
      'Nur veröffentlichte TrackBacks anzeigen',
    'Only show pending TrackBacks' =>
      'Nur nicht veröffentlichte TrackBacks anzeigen',
    'Edit this TrackBack' => 'TrackBack bearbeiten',
    'Go to the source entry of this TrackBack' =>
      'Zum Eintrag wechseln, auf den sich das TrackBack bezieht',
...
## tmpl/cms/include/entry_table.tmpl
    ...
    'Republish selected entries (r)' =>
      'Markierte Einträge neu veröffentlichen (r)',
    ...
    'Republish selected pages (r)' =>
      'Markierte Seiten neu veröffentlicchen (r)',
    ...
    'No entries could be found. <a href="[_1]">Create an entry</a> now.' =>
      'Keine Einträge gefunden. Jetzt <a href="[_1]>einen Eintrag anlegen</a>.',
...
## tmpl/cms/include/backup_start.tmpl
    'Backing up Melody' => 'Erstelle Sicherung',
...
## tmpl/cms/include/asset_upload.tmpl
    'Before you can upload a file, you need to publish your blog. [_1]Configure your blog\'s publishing paths[_2] and rebuild your blog.'
      => 'Bevor Sie eine Datei hochladen können, müssen Sie das Blog veröffentlicht haben. Konfigurieren Sie dazu zuerst die [_1]Veröffentlichungspfade[_2] und veröffentlichen Sie dann das Blog.',
    'Your system or blog administrator needs to publish the blog before you can upload files. Please contact your system or blog administrator.'
      => 'Bevor Sie eine Datei hochladen können, muss Ihr Systemadministrator das Blog veröffentlicht haben. Bitte wenden Sie daher an Ihren Administrator.',
    'Close (x)'             => 'Schließen (x)',
...
## tmpl/cms/setup_initial_blog.tmpl
    ...
    'Select the templates you wish to use for this new blog.' =>
      'Wählen Sie, welche Vorlage für das neue Blog verwendet werden sollen.',
...
## tmpl/cms/import.tmpl
    ...
    'Transfer weblog entries into Melody from other Melody installations or even other blogging tools or export your entries to create a backup or copy.'
      => 'Mit der Import/Export-Funktion können Sie Einträge aus anderen Melody-Installationen oder aus anderen Weblog-Systemen übernehmen. Bestehende Einträge können in einem Austauschformat gesichert werden.',
    ...
    'If you choose to preserve the ownership of the imported entries and any of those users must be created in this installation, you must define a default password for those new accounts.'
      => 'Wenn Sie mit ursprünglichen Benutzernamen importieren und einer oder mehrere der Benutzer in dieser Melody-Installation noch kein Konto haben, werden entsprechende Benutzerkonten automatisch angelegt. Für diese Konten müssen Sie ein Standardpasswort vergeben.',
    ...
    'If your import file is located on your computer, you can upload it here.  Otherwise, Melody will automatically look in the \'import\' folder of your Melody directory.'
      => 'Wenn Sie eine auf Ihrem Computer gespeicherte Importdatei verwenden wollen, laden Sie diese hier hoch. Alternativ verwendet Melody automatisch die Importdatei, die es im \'import\'-Unterordner Ihres Melody-Verzeichnis findet.',
    ...
    'By default, Melody will attempt to automatically detect the character encoding of your import file.  However, if you experience difficulties, you can set it explicitly.'
      => 'Melody versucht automatisch die korrekte Zeichenkodierung auszuwählen. Sollte das fehlschlagen, können Sie sie auch explizit angeben.',
...
## tmpl/cms/cfg_spam.tmpl
    ...
    'Your spam preferences have been saved.' =>
      'Spam-Einstellungen gespeichert.',
    ...
    'If enabled, feedback reported as spam will be automatically erased after a number of days.'
      => 'Falls aktiviert, wird als Spam markiertes Feedback nach einer wählbaren Anzahl von Tagen automatisch gelöscht.',
    'Delete Spam After' => 'Spam löschen nach',
    'When an item has been reported as spam for this many days, it is automatically deleted.'
      => 'Wenn ein Feedback für länger als angegeben als Spam markiert war, wird es automatisch gelöscht.',
...
## tmpl/cms/upgrade.tmpl
    ...
    'While Melody may run, it is an <strong>untested and unsupported environment</strong>.  We strongly recommend upgrading to at least Perl [_1].'
      => 'Wir empfehlen dringend, die Perl-Installation mindestens auf Version [_1] zu aktualisieren. Melody läuft zwar möglicherweise auch mit der vorhandenen Perl-Version, es handelt sich aber um eine <strong>nicht getestete und nicht unterstützte Umgebung</strong>.',
    'Do you want to proceed with the upgrade anyway?' =>
      'Upgrade dennoch fortsetzen?',
    'Yes (s)'           => 'Ja (s)',
    ...
    'A new version of Melody has been installed.  We\'ll need to complete a few tasks to update your database.'
      => 'Es wurde eine neue Version von Melody installiert. Ihre Datenbank wird nun auf den aktuellen Stand gebracht.',
    'Information about this upgrade can be found <a href=\'[_1]\' target=\'_blank\'>here</a>.'
      => 'Informationen über dieses Upgrade finden Sie <a href=\'[_1]\' target=\'_blank\'>hier</a>.',
    'In addition, the following Melody components require upgrading or installation:'
      => 'Zusätzlich müssen folgende Melody-Komponenten installiert oder aktualisiert werden:',
    'The following Melody components require upgrading or installation:' =>
      'Die folgenden Melody-Komponenten müssen installiert oder aktualisiert werden:',
    'Begin Upgrade' => 'Upgrade durchführen',
    'Congratulations, you have successfully upgraded to Melody [_1].' =>
      'Herzlichen Glückwunsch, Sie haben Ihre Installation erfolgreich auf Melody [_1] aktualisiert!',
    'Return to Melody' => 'Zurück zu Melody',
    'Your Melody installation is already up to date.' =>
      'Ihre Melody-Installation ist bereits auf dem neuesten Stand.',
...
## tmpl/cms/edit_category.tmpl
    ...
    'Warning: Changing this category\'s basename may break inbound links.' =>
      'Achtung: Änderungen des Basisnamens können bestehende externe Links auf diese Kategorieseite ungültig machen',
...
## tmpl/cms/dialog/recover.tmpl
    'The email address provided is not unique.  Please enter your username.'
      => 'Die angegebene E-Mail-Adresse wird bereits genutzt. Bitte geben Sie Ihren Benutzernamen ein.',
    'An email with a link to reset your password has been sent to your email address ([_1]).'
      => 'Es wurde eine E-Mail mit einem Link zur Zurücksetzung Ihres Passwortes an Ihre Adresse gesendet([_1]).',
    'Go Back (x)'           => 'Zurück (x)',
    'Sign in to Melody (s)' => 'Bei Melody anmelden (s)',
    'Sign in to Melody'     => 'Bei Melody anmelden',
...
## tmpl/cms/dialog/asset_replace.tmpl
    'A file named \'[_1]\' already exists. Do you want to overwrite this file?'
      => 'Eine Datei namens \'[_1]\' ist bereits vorhanden. Möchten Sie sie überschreiben?',
...
## tmpl/cms/dialog/refresh_templates.tmpl
    ...
    'Deletes all existing templates and install the selected template set.' =>
      'Löscht alle vorhandenen Vorlagen und installiert die gewählten Vorlagengruppe.',
    ...
    'Deletes all existing templates and installs factory default template set.'
      => 'Löscht alle vorhandenen Vorlagen und installiert die Melody-Standardvorlagen',
...
## tmpl/cms/dialog/publishing_profile.tmpl
    ...
    'Immediately publish Main Index template, Entry archives, and Page archives statically. Use Publish Queue to publish all other templates statically.'
      => 'Hauptindex, Eintragsarchive und Seitenarchive sofort statisch, alle anderen Vorlagen im Hintergrund statisch veröffentlichen.',
    ...
    'Publish all Archive templates dynamically. Immediately publish all other templates statically.'
      => 'Alle Archivvorlagen dynamisch, alle anderen Vorlagen sofort statisch veröffentlichen.',
    'This new publishing profile will update all of your templates.' =>
      'Mit dem neuen Veröffentlichungsprofil werden alle Vorlagen aktualisiert.',
...
## tmpl/cms/dialog/entry_notify.tmpl
    ...
    'Your blog\'s name, this entry\'s title and a link to view it will be sent in the notification.  Additionally, you can add a  message, include an excerpt of the entry and/or send the entire entry.'
      => 'Benachrichtigungen enthalten den Names Ihres Blogs, den Namen des Eintrags und einen Link zum Eintrag. Zusätzlich können Sie eine persönliche Nachricht eingeben und  den Text des Eintrags oder einen Auszug daraus anhängen.',
    'Recipients' => 'Empfänger',
    'Enter email addresses on separate lines, or comma separated.' =>
      'Geben Sie pro Zeile nur eine E-Mail-Adresse ein oder trennen Sie mehrere Adressen mit Kommata.',
    ...
    '(Entry Body will be sent without any text formatting applied)' =>
      '(Der Text des Eintrags wird ohne Formatierung verschickt)',
...
## tmpl/cms/dialog/clone_blog.tmpl
    'Verify Blog Settings' =>
      'Blog-Einstellungen bestätigen',    # Translate - New # OK
    'Overwrite' => 'Überschreiben',       # Translate - New # OK
    'Overwrite Original Paths' =>
      'Ursprüngliche Pfade überschreiben',    # Translate - New # OK
    'Preserve Original Paths' =>
      'Ursprüngliche Pfade beibehalten',       # Translate - New # OK
    'Exclusions' => 'Ausnahmen',                # Translate - New # OK
    'Exclude Entries/Pages' =>
      'Seiten/Einträge auslassen',             # Translate - New # OK
    ...
    'Enter the new URL of your public website. Example: http://www.example.com/weblog/'
      => 'Geben Sie die neue URL Ihrer öffentlichen Website ein. Beispiel: http://beispiel.de/weblog/'
    ,                                                  # Translate - New # OK
    'Enter a new path where your main index file will be located. Example: /home/melody/public_html/weblog'
      => 'Geben Sie den neuen lokalen Pfad zur Indexdatei an.  Beispiel: /home/melody/public_html/weblog'
    ,                                                  # Translate - New # OK
    'If this is set to the same path as the original blog, it will overwrite it.'
      => 'Wird der Pfad des Ursprungsblogs angegeben, wird dieses überschrieben'
    ,                                                  # Translate - New # OK
    ...
    'If this option is set, any matching path settings will overwrite the original blog.'
      => 'Ist diese Option aktiviert, wird bei übereinstimmenden Pfad-Angaben das Ursprungsblog überschrieben.'
    ,                                                  # Translate - New # OK
    'Mark the settings that you want cloning to skip' =>
      'Markieren Sie Einträge, die nicht geklont werden sollen'
    ,                                                  # Translate - New # OK
...
## tmpl/cms/list_author.tmpl
    ...
    'You have successfully deleted the user(s) from the Melody system.' =>
      'Gewählte Benutzerkonten erfolgreich aus Melody gelöscht',
    'The deleted user(s) still exist in the external directory. As such, they will still be able to login to Melody Enterprise.'
      => 'Die gelöschten Benutzerkonten sind im externen Verzeichnis weiterhin vorhanden. Die Benutzer können sich daher weiterhin an Melody Enterprise anmelden.',
    'You have successfully synchronized users\' information with the external directory.'
      => 'Benutzerinformationen erfolgreich mit externem Verzeichnis synchronisiert.',
    ...
    'An error occured during synchronization.  See the <a href=\'[_1]\'>activity log</a> for detailed information.'
      => 'Bei der Synchronisation ist ein Fehler aufgetreten. Das  <a href=\'[_1]\'>Aktivitätsprotokoll</a> enthält nähere Informationen.',
    'Enable selected users (e)' => 'Gewählte Benutzerkonten aktivieren (e)',
    '_USER_ENABLE'              => 'Aktivieren',
    '_NO_SUPERUSER_DISABLE' =>
      'Sie können Ihr eigenes Benutzerkonto nicht deaktivieren, da Sie Verwalter dieser Melody-Installation sind.',
...
## tmpl/cms/upgrade_runner.tmpl
    ...
    'Return to Melody (s)'       => 'Zurück zu Melody (s)',
...
## tmpl/cms/cfg_entry.tmpl
    ...
    'Select the number of days of entries or the exact number of entries you would like displayed on your blog.'
      => 'Geben Sie entweder die größte Zahl Einträge an, die auf der Startseite höchstens angezeigt werden sollen, oder die größte Zahl Tage, aus denen dort Einträge erscheinen sollen.',
    'Days'        => 'Tage',
    ...
    'Specifies the default Entry Status when creating a new entry.' =>
      'Gibt an, welcher Eintragsstatus neue Einträge standardmäßig zugewiesen werden soll.',
...
## tmpl/cms/cfg_registration.tmpl
    ...
    'Allow registration for Melody.' => 'Registrierungen bei Melody erlauben',
    ...
    'Note: You have selected to accept comments from authenticated commenters only but authentication is not enabled. In order to receive authenticated comments, you must enable authentication.'
      => 'Hinweis: Sie möchten Kommentare nur von authentifizierten Kommentarautoren zulassen. Allerdings haben Sie die Authentifizierung nicht aktiviert.',
    'Native' => 'nativ',
    'Require E-mail Address for Comments via TypePad' =>
      'E-Mail-Adresse erfordern für über TypePad eingehende Kommentare',
    'If enabled, visitors must allow their TypePad account to share e-mail address when commenting.'
      => 'Falls aktiviert, müssen Kommentar-Autoren über ihr TypePad-Konto ihre E-Mail-Adresse mitteilen',
    'One or more Perl modules may be missing to use this authentication method.'
      => 'Zur Verwendung dieser Authentifizierungs-Methode fehlt mindestens ein Perl-Modul'
    ,    # Translate - New # OK
    ...
    'Required module (Digest::SHA1) for OpenID commenter authentication is missing.'
      => 'Für OpenID-Authentifizierung von Kommentarautoren erforderliches Modul (Digest::SHA1) nicht vorhanden.',
...
## tmpl/cms/edit_author.tmpl
    ...
    'Status of user in the system. Disabling a user removes their access to the system but preserves their content and history.'
      => 'Globaler Benutzerstatus. Deaktivierung eines Benutzerkontos führt zum Ausschluß des Benutzers. Seine Inhalte und Protokolleinträge bleiben erhalten.',
    ...
    'The URL of the site associated with this user. eg. http://www.movabletype.com/'
      => 'Mit diesem Benutzer verknüpfte Web-Adresse (z.B. http://movabletype.de/)',
...
## tmpl/cms/preview_strip.tmpl
    ...
    'You are previewing the entry titled &ldquo;[_1]&rdquo;' =>
      'Sie sehen eine Vorschau auf den Eintrag &#8222;[_1]&#8221;',
    'You are previewing the page titled &ldquo;[_1]&rdquo;' =>
      'Sie sehen eine Vorschau auf die Seite &#8222;[_1]&#8221;',
...
## tmpl/cms/list_comment.tmpl
    ...
    'No comments appeared to be spam.' =>
      'Kein Kommentar scheint Spam zu sein.',
    '[_1] on entries created within the last [_2] days' =>
      '[_1] zu Einträgen, die in den letzten [_2] Tagen angelegt wurden',
    '[_1] on entries created more than [_2] days ago' =>
      '[_1] zu Einträgen, die vor mehr als [_2] Tagen angelegt wurden',
...
## tmpl/cms/cfg_web_services.tmpl
    ...
    'Your TypePad token is used to access Six Apart services like its free Authentication service.'
      => 'Mit Ihrem TypePad-Schlüssel erhalten Sie Zugriff von Six Apart angebotene Dienste wie den kostenlosen Authentifizierungs-Dienst',
    ...
    'Please click the Save Changes button below to enable TypePad.' =>
      'Bitte klicken Sie auf "Änderungen speichern", um TypePad zu aktivieren.',
    ...
    'When this blog is updated, Melody will automatically notify the selected sites.'
      => 'Melody benachrichtigt die gewählten Sites automatisch, wenn dieses Blog aktualisiert wurde.',
    'Note: This option is currently ignored since outbound notification pings are disabled system-wide.'
      => 'Hinweis: Diese Einstellung zeigt momentan keine Wirkung, da ausgehende Pings systemweit deaktiviert sind.',
    'Others:'                                 => 'Andere:',
    ...
    'If you have received a recently updated key (by virtue of your purchase), enter it here.'
      => 'Wenn Sie einen "Kürzlich aktualisiert"-Schlüssel erhalten haben, tragen Sie ihn hier ein.',
...
## tmpl/cms/edit_blog.tmpl
    ...
    'You must set your Site URL.' =>
      'Bitte wählen Sie einen Webadresse (URL)',
    'Your Site URL is not valid.' =>
      'Die gewählte Webadresse (URL) ist ungültig.',
    'You can not have spaces in your Site URL.' =>
      'Die Adresse (URL) darf keine Leerzeichen enthalten.',
    'You can not have spaces in your Local Site Path.' =>
      'Der lokale Pfad darf keine Leerzeichen enthalten.',
    'Your Local Site Path is not valid.' =>
      'Das gewählte lokale Verzeichnis ist ungültig.',
    'Enter the URL of your public website. Do not include a filename (i.e. exclude index.html). Example: http://www.example.com/weblog/'
      => 'Geben Sie die Webadresse Ihrer Site ein. Geben Sie die Adresse ohne Dateinamen ein beispielsweise so: http://www.beispiel.de/weblog/',
    'Enter the path where your main index file will be located. An absolute path (starting with \'/\') is preferred, but you can also use a path relative to the Melody directory. Example: /home/melody/public_html/weblog'
      => 'Der Pfad, in dem Startseite Ihres Blog abgelegt werden soll. Eine absolute (mit \'/\' beginnende) Pfadangabe wird bevorzugt, Sie können den Pfad aber auch relativ Sie zu Ihrem Melody-Verzeichnis angeben. Beispiel: /home/melanie/public_html/blog',
...
## tmpl/cms/list_tag.tmpl
    ...
    'An error occurred while testing for the new tag name.' =>
      'Bei der Überprüfung des neuen Tag-Namens ist ein Fehler aufgetreten.',
...
## tmpl/cms/install.tmpl
    ...
    'Password recovery word/phrase is required.' =>
      'Passwort-Erinnerungsfrage erforderlich',
    ...
    'Before you can begin blogging, you must create an administrator account for your system. When you are done, Melody will then initialize your database.'
      => 'Bevor Sie bloggen können, müssen Sie einen Systemadministrator bestimmen. Melody wird daraufhin Ihre Datenbank einrichten.',
    ...
    'The email address used in the From: header of each email sent from the system.'
      => 'Die E-Mail-Adresse, die als Absenderadresse vom System versandter E-Mails verwendet wird',
...
## tmpl/cms/cfg_system_feedback.tmpl
    ...
    'Your feedback preferences have been saved.' =>
      'Ihre Feedback-Einstellungen wurden gespeichert.',
    'Feedback: Master Switch' => 'Feedback-Hauptschalter',
    'This will override all individual blog settings.' =>
      'Dieser Schalter überragt alle auf Blog-Ebene getätigten Einstellungen.',
    'Disable comments for all blogs' =>
      'Kommentare für alle Blogs deaktivieren',
    'Disable TrackBacks for all blogs' =>
      'TrackBacks für alle Blogs deaktivieren',
    ...
    'This feature allows you to disable sending notification pings when a new entry is created.'
      => 'Mit dieser Funktion können Sie die automatische Versendung von Benachrichtigungs-Pings bei Veröffentlichung eines neuen Eintrags unterbinden.',
    'Disable notification pings for all blogs' =>
      'Versendung von Benachrichtigungs-Pings für alle Blogs deaktivieren',
    'Limit outbound TrackBacks and TrackBack auto-discovery for the purposes of keeping your installation private.'
      => 'Schränken Sie den Versand von TrackBacks und TrackBack Auto-Discovery auf bestimmte Sites ein, um diese Melody-Installation nichtöffentlich zu halten.',
    'Allow to any site'        => 'Zu allen Sites',
    '(No outbound TrackBacks)' => '(Kein TrackBack-Versand)',
    'Only allow to blogs on this installation' =>
      'Nur zu Blogs dieser Installation',
    'Only allow the sites on the following domains:' =>
      'Nur zu Sites auf folgenden Domains:',
...
## tmpl/cms/widget/new_user.tmpl
    'Welcome to Melody, the world\'s most powerful blogging, publishing and social media platform. To help you get started we have provided you with links to some of the more common tasks new users like to perform:'
      => 'Willkommen zu Melody, der leistungsfähigsten Blogging-, Publishing- und Social Media-Plattfom! Um Ihnen den Einstieg zu erleichtern, haben wir Ihnen einige Links zu den Funktionen zusammengestellt, die für neue Benutzer besonders interessant sind:',
    ...
    'What would a blog be without content? Start your Melody experience by creating your very first post.'
      => 'Was ist ein Blog ohne Inhalt? Schreiben Sie jetzt Ihren ersten Eintrag!',
    ...
    'Customize the look and feel of your blog quickly by selecting a design from one of our professionally designed themes.'
      => 'Mit unseren professionellen Designvorlagen gestalten Sie Ihr Blog unkompliziert nach Ihren Vorstellungen.',
    ...
    'Whether you\'re new to Melody or using it for the first time, learn more about what this tool can do for you.'
      => 'Für Neueinsteiger wie für erfahrende Melody-Anwender: Erfahren Sie, was Melody für Sie leisten kann!',
...
## tmpl/cms/widget/blog_stats_recent_entries.tmpl
    ...
    'View all entries tagged &ldquo;[_1]&rdquo;' =>
      'Zeige alle mit &#8222;[_1]&#8221; getaggten Einträge',
...
## tmpl/cms/widget/mt_news.tmpl
    ...
    'Pronet'                    => 'Pronet',
    'No Melody news available.' => 'Es liegen keine Melody-Nachrichten vor.',
    'No Learning Melody news available.' =>
      'Es liegen keine Melody lernen-Nachrichten vor',
...
## tmpl/cms/widget/custom_message.tmpl
    ...
    'You can manage your blog by selecting an option from the menu located to the left of this message.'
      => 'Sie können Ihr Blog von dem links befindlichen Menü aus verwalten.',
    'If you need assistance, try:' =>
      'Falls Sie Hilfe benötigen, stehen folgende Möglichkeiten zur Verfügung:',
    'Melody User Manual' => 'Melody Benutzerhandbuch',
    'http://www.sixapart.com/movabletype/support' =>
      'http://www.sixapart.com/movabletype/support',
    'Melody Technical Support' => 'Melody Technischer Support',
    'Melody Community Forums'  => 'Melody Community-Foren',
...
## tmpl/cms/widget/new_version.tmpl
    'What\'s new in Melody [_1]' => 'Neu in Melody [_1]',
    'Congratulations, you have successfully installed Melody [_1]. Listed below is an overview of the new features found in this release.'
      => 'Herzlichen Glückwunsch, Sie haben Melody [_1] erfolgreich installiert! Die wichtigsten Neuerungen dieser Version:',
...
## tmpl/cms/widget/this_is_you.tmpl
    ...
    'You\'ve written <a href="[_1]">[quant,_2,entry,entries]</a> with <a href="[_3]">[quant,_4,comment,comments]</a>.'
      => 'Sie haben <a href="[_1]">[quant,_2,Eintrag,Einträge]</a> mit <a href="[_3]">[quant,_4,Kommentar,Kommentaren]</a> geschrieben.',
    'You\'ve written [quant,_1,entry,entries] with <a href="[_2]">[quant,_3,comment,comments]</a>.'
      => 'Sie haben [quant,_1,Eintrag,Einträge] mit <a href="[_2]">[quant,_3,Kommentar,Kommentaren]</a> geschrieben.',
    'You\'ve written [quant,_1,entry,entries] with [quant,_2,comment,comments].'
      => 'Sie haben [quant,_1,Eintrag,Einträge] mit [quant,_2,Kommentar,Kommentaren] geschrieben.',
    'You\'ve written <a href="[_1]">[quant,_2,entry,entries]</a>.' =>
      'Sie haben <a href="[_1]">[quant,_2,Eintrag,Einträge]</a> geschrieben.',
    'You\'ve written [quant,_1,entry,entries].' =>
      'Sie haben [quant,_1,Eintrag,Einträge] geschrieben.',
    'Edit your profile' => 'Profil bearbeiten',

## tmpl/cms/widget/new_install.tmpl
    'Thank you for installing Melody' =>
      'Vielen Dank, daß Sie sich für Melody entschieden haben',
    'Congratulations on installing Melody, the world\'s most powerful blogging, publishing and social media platform. To help you get started we have provided you with links to some of the more common tasks new users like to perform:'
      => 'Herzlichen Glückwunsch zur Installation von Melody, der leistungsfähigsten Blogging-, Publizierungs- und Social Media-Plattfom. Um Ihnen den Einstieg zu erleichtern, haben wir Ihnen einige Links zu den Funktionen, die für neue Benutzer besonders interessant sind, zusammengestellt:',
    ...
    'Start building your network of blogs and your community now. Invite users to join your blog and promote them to authors.'
      => 'Bauen Sie ein Netzwerk auf und laden Sie weitere Personen ein, Mitautoren Ihres Blogs zu werden!',
...
## tmpl/cms/widget/blog_stats.tmpl
    ...
    'Melody was unable to locate your \'mt-static\' directory. Please configure the \'StaticFilePath\' configuration setting in your config.cgi file, and create a writable \'support\' directory underneath your \'mt-static\' directory.'
      => 'Melody konnte Ihr \'mt-static\'-Verzeichnis nicht finden. Bitte überprüfen Sie die \'StaticFilePath\'-Direktive in der Konfigurationsdatei config.cgi und legen Sie ein vom Webserver beschreibbares Verzeichnis \'support\' im \'mt-static\'-Verzeichnis an.',
    'Melody was unable to write to its \'support\' directory. Please create a directory at this location: [_1], and assign permissions that will allow the web server write access to it.'
      => 'Melody kann auf den Ordner \'support\' nicht schreibend zugreifen. Legen Sie hier: [_1] ein solches Verzeichnis an und stellen Sie sicher, daß der Webserver Schreibrechte für diesen Ordner besitzt.',
...
## tmpl/cms/restore_end.tmpl
    'Make sure that you remove the files that you restored from the \'import\' folder, so that if/when you run the restore process again, those files will not be re-restored.'
      => 'Vergessen Sie nicht, die verwendeten Dateien aus dem \'import\'-Ordner zu entfernen, damit sie bei künftigen Wiederherstellungen nicht erneut wiederhergestellt werden.',
...
## tmpl/cms/system_check.tmpl
    ...
    'Users who have logged in within 90 days are considered <strong>active</strong> in Melody license agreement.'
      => 'Benutzer, die sich innerhalb der letzten 90 Tage eingeloggt haben, gelten nach den Melody-Lizenzbedingungen als <strong>aktiv</strong>.',
    ...
    'Melody could not find the script named \'check.cgi\'. To resolve this issue, please ensure that the check.cgi script exists and/or the CheckScript configuration parameter references it properly.'
      => 'Melody konnte die Datei \'check.cgi\' nicht finden. Stellen Sie sicher, daß die Datei vorhanden ist und MTCheckScript die richtigen Pfadangaben enthält.',
...
## tmpl/cms/restore.tmpl
    ...
    'Perl module XML::SAX and/or its dependencies are missing - Melody can not restore the system without it.'
      => 'Das Per-Modul XML::SAX und/oder seine Abhängigkeiten fehlen. Ohne kann Melody das System nicht wiederherstellen.',
    ...
    'If your backup file is located on your computer, you can upload it here.  Otherwise, Melody will automatically look in the \'import\' folder of your Melody directory.'
      => 'Wenn Sie eine auf Ihrem Computer gespeicherte Sicherungsdatei verwenden wollen, laden Sie diese hier hoch. Alternativ verwendet Melody automatisch die Sicherungsdatei, die es im \'import\'-Unterordner Ihres Melody-Verzeichnis findet.',
    'Check this and files backed up from newer versions can be restored to this system.  NOTE: Ignoring Schema Version can damage Melody permanently.'
      => 'Anwählen, um auch Dateien mit einer neueren Schemaversionen wiederherstellen zu können. HINWEIS: Nichtbeachtung der Schemaverion kann Ihre Melody-Installation dauerhaft beschädigen.',
    ...
    'Check this and existing global templates will be overwritten from the backup file.'
      => 'Wenn diese Option aktiv ist, werden globale Vorlagen mit der gesicherten Fassung überschrieben',
...
## tmpl/cms/list_folder.tmpl
    'Your folder changes and additions have been made.' =>
      'Ordneränderungen gespeichert.',
    'You have successfully deleted the selected folder.' =>
      'Gewählte Ordner erfolgreich gelöscht.',
...
## tmpl/cms/cfg_archives.tmpl
    'Error: Melody was not able to create a directory for publishing your blog. If you create this directory yourself, assign sufficient permissions that allow Melody to create files within it.'
      => 'Fehler: Melody konnte kein Verzeichnis zur Veröffentlichung Ihres Blogs anlegen. Wenn Sie das Verzeichnis manuell angelegt haben, stellen Sie bitte sicher, daß der Webserver Schreibrechte für das Verzeichnis hat.',
    'Your blog\'s archive configuration has been saved.' =>
      'Einstellungen übernommen',
    'You have successfully added a new archive-template association.' =>
      'Sie haben erfolgreich eine neue Verknüpfung zwischen Archiven und Vorlagen hinzugefügt.',
    'You may need to update your \'Master Archive Index\' template to account for your new archive configuration.'
      => 'Eventuell müssen Sie Ihre Vorlage für das Archiv-Index aktualisieren, um die neue Archiv-Konfiguration zu übernehmen.',
    'The selected archive-template associations have been deleted.' =>
      'Die gewählten Verknüpfungen zwischen Archiven und Vorlagen wurden gelöscht.',
    'Warning: one or more of your templates is set to publish dynamically using PHP, however your server side include method may not be compatible with dynamic publishing.'
      => 'Achtung: Mindestens eine ihrer Vorlagen wird dynamisch per PHP veröffentlicht. Die gewählte Server Side Include-Methode ist möglicherweise aber nicht für dynamisches Veröffentlichen geeignet.',
    ...
    'You must set Local Archive Path.' =>
      'Bitte definieren Sie Ihren Local Archive Path.',
    'You must set a valid Archive URL.' =>
      'Bitte definieren Sie eine gültige Archive URL.',
    'You must set a valid Local Archive Path.' =>
      'Bitte definieren Sie einen gültigen Local Archive Path.',
    ...
    'The URL of your website. Do not include a filename (i.e. exclude index.html). Example: http://www.example.com/blog/'
      => 'Die URL Ihrer Website. Bitte geben Sie die Adresse ohne Dateinamen ein, beispielsweise so: http://www.beispiel.de/blog/',
    'Unlock this blog&rsquo;s site URL for editing' =>
      'Blog-URL manuell bearbeiten',
    'Warning: Changing the site URL can result in breaking all the links in your blog.'
      => 'Hinweis: Eine Änderung der Webadresse kann alle Link zu Ihrem Blog ungültig machen.',
    'The path where your index files will be published. An absolute path (starting with \'/\') is preferred, but you can also use a path relative to the Melody directory. Example: /home/melody/public_html/blog'
      => 'Der Pfad, in dem die Indexdateien abgelegt werden. Eine absolute (mit \'/\' beginnende) Pfadangabe wird bevorzugt, Sie können den Pfad aber auch relativ Sie zu Ihrem Melody-Verzeichnis angeben. Beispiel: /home/melanie/public_html/blog',
    ...
    'Note: Changing your site root requires a complete publish of your site.'
      => 'Hinweis: Im Anschluss an eine Änderung des Wurzelverzeichnisses muss die gesamte Site neu veröffentlicht werden.',
    ...
    'Select this option only if you need to publish your archives outside of your Site Root.'
      => 'Wählen Sie diese Option nur, wenn Sie Ihre Archive außerhalb des Wurzelverzeichnisses Ihres Blog veröffentlichen müssen.',
    'Publish archives outside of Site Root' =>
      'Archive außerhalb Wurzelverzeichnis ablegen',
    'Enter the URL of the archives section of your website. Example: http://archives.example.com/'
      => 'Geben Sie die Adresse der Archivsektion Ihrer Website ein, beispielsweise http://archiv.beispiel.de/',
    'Unlock this blog&rsquo;s archive url for editing' =>
      'Archivadresse manuell bearbeiten',
    'Warning: Changing the archive URL can result in breaking all the links in your blog.'
      => 'Hinweis: Eine Änderung der Archivadresse kann alle Links zu Ihrem Blog ungültig machen.',
    'Enter the path where your archive files will be published. Example: /home/melody/public_html/archives'
      => 'Geben Sie den lokalen Pfad zu Ihrem Archiv ein, beispielsweise /home/melanie/public_html/archiv',
    'Warning: Changing the archive path can result in breaking all the links in your blog.'
      => 'Warnung: Eine Änderung des Archivpfads kann sämtliche Links zu Ihrem Blog ungültig machen.',
    ...
    'Requires the use of a cron job to publish pages in the background.' =>
      'Zur Veröffentlichung im Hintergrund muss der Server Cronjobs ausführen können.',
    'Use background publishing queue for publishing static pages for this blog'
      => 'Für die Veröffentlichung der statischen Seiten dieses Blogs Hintergrund-Warteschleife verwenden',
    ...
    'Enter the archive file extension. This can take the form of \'html\', \'shtml\', \'php\', etc. Note: Do not enter the leading period (\'.\').'
      => 'Geben Sie die gewünschte Erweiterung der Archivdateien an. Möglich sind \'html\', \'shtml\', \'php\' usw. Hinweis: Geben Sie nicht den führenden Punkt (\'.\') ein.',
    ...
    'Used for creating links to an archived entry (permalink). Select from the archive types used in this blogs archive templates.'
      => 'Bestimmt, mit welcher Art Archivseite Permalinks verlinkt werden. Welche Archivarten zur Verfügung stehen, hängt von den verwendeten Vorlagen ab.',
...
## tmpl/cms/restore_start.tmpl
    'Restoring Melody' => 'Melody wiederherstellen',
...
## tmpl/comment/signup_thanks.tmpl
    ...
    'Before you can leave a comment you must first complete the registration process by confirming your account. An email has been sent to [_1].'
      => 'Bevor Sie kommentieren können, müssen Sie noch Ihre Registrierung bestätigen. Dazu haben wir Ihnen eine E-Mail an [_1] geschickt.',
...
## tmpl/error.tmpl
    ...
    '_ERROR_CONFIG_FILE' =>
      'Ihre Melody-Konfigurationsdatei fehlt, ist fehlerhaft oder kann nicht gelesen werden. Anweisungen zur Konfigurierung finden Sie im Abschnitt <a href="javascript:void(0)">Installation and Configuration</a> der Melody-Dokumentation.',
    'Database Connection Error' => 'Verbindung mit Datenbank fehlgeschlagen',
    '_ERROR_DATABASE_CONNECTION' =>
      'Die Datenbankeinstellungen in Ihrer Konfigurationsdatei fehlen oder sind fehlerhaft. Anweisungen zur Konfigurierung finden Sie im Abschnitt <a href="javascript:void(0)">Installation and Configuration</a> der Melody-Dokumentation.',
    'CGI Path Configuration Required' => 'CGI-Pfad muß eingestellt sein',
    '_ERROR_CGI_PATH' =>
      'Die CGIPath-Angabe in Ihrer Konfigurationsdatei fehlt oder ist fehlerhaft. Anweisungen zur Konfigurierung finden Sie im Abschnitt <a href="javascript:void(0)">Installation and Configuration</a> der Melody-Dokumentation.',
...
## tmpl/feeds/login.tmpl
    'Melody Activity Log' => 'Melody-Aktivitätsprotokoll',
...
## addons/Community.pack/lib/MT/App/Community.pm
    ...
    '[_1] registered to Melody.'    => '[_1] hat sich bei Melody registriert',
...
## addons/Community.pack/lib/MT/Community/CMS.pm
    ...
    'Welcome to the Melody Community Solution' =>
      'Willkommen zur Melody Community Solution',
    'The Community Solution gives you to the tools to build a successful community with active, engaged conversations. Some key features to explore:'
      => 'Mit der Community Solution erhalten Sie alle Werkzeuge, die zum Aufbau erfolgreicher Communities mit aktiven, engagierten Mitgliedern erforderlich sind. Zu den Schlüsselfunktionen gehören:',
    'Friends and Followers' => 'Freundesliste',
    'Allow registered members to maintain a list of friends across your community'
      => 'Registrierten Mitgliedern ermöglichen, den Aktivitäten ihrer Freunde in Ihrer Community zu folgen.',
...
## addons/Community.pack/templates/global/new_entry_email.mtml
    'A new entry \'[_1]([_2])\' has been posted on your blog [_3].' =>
      'In Ihrem Blog [_3] wurde ein neuer Eintrag \'[_1]([_2])\' veröffentlicht.',
...
## addons/Community.pack/templates/global/password_reset_form.mtml
    ...
    'Your password has been changed, and the new password has been sent to your email address ([_1]).'
      => 'Ein neues Passwort wurde erzeugt und an Ihre E-Mail-Adresse gesendet ([_1]).',
...
## addons/Community.pack/templates/blog/entry_response.mtml
    ...
    'Return to the <a href="[_1]">blog\'s main index</a>.' =>
      'Zurück zur <a href="[_1]">Startseite</a>.',
...
## addons/Community.pack/templates/blog/entry_form.mtml
    ...
    'You don\'t have permission to post.' =>
      'Sie haben nicht genügend Benutzerrechte um zu veröffentlichen.',
...
## addons/Community.pack/templates/forum/entry_response.mtml
    ...
    'Return to the <a href="[_1]">forum\'s homepage</a>.' =>
      'Zurück zur <a href="[_1]">Startseite</a> des Forums.',
...
## addons/Commercial.pack/config.yaml
    ...
    'Themes that are compatible with the Professional Website template set.'
      => 'Mit der Vorlagengruppe &#8222;Professionelle Website&#8220; kompatible Designs.',
...
## addons/Commercial.pack/lib/MT/Commercial/Util.pm
    'Could not install custom field [_1]: field attribute [_2] is required' =>
      'Konnte eigenes Feld [_1] nicht installieren: Feld-Attribut [_2] erforderlich',
    'Could not install custom field [_1] on blog [_2]: the blog already has a field [_1] with a conflicting type'
      => 'Konnte eigenes Feld [_1] nicht in Blog [_2] installieren: es liegt ein Typ-Konflikt mit dem bereits im Blog vorhandenen Feld [_1] vor',
    'Blog [_1] using template set [_2]' =>
      'Blog [_2] mit Vorlagengruppe [_2]',
    'About' => 'Über',
    '_PTS_REPLACE_THIS' =>
      '<p><strong>Ersetzen Sie diesen Text durch Ihre eigenen Informationen.</strong></p>',
    '_PTS_SAMPLE_ABOUT' => '
...
',
    'New design launched using Melody' => 'Neue Website auf Basis von Melody',
    '_PTS_SAMPLE_NEWDESIGN'            => ' 
<p>Unsere Website hat ein neues Aussehen - dank <a href="http://www.movabletype.com/">Melody</a> und der Universellen Vorlagengruppe. Mit der Universellen Vorlagengruppe kann so gut wie jeder eine neue Website mit Melody anlegen. Neue Vorlagengruppe anlegen, "Universelle Vorlagengruppe" auswählen, "Veröffentlichen" klicken - fertig! So einfach war es noch nie. Danke, Melody!</p>
',
    'Could not create entry: [_1]' => 'Konnte Eintrag nicht speichern: [_1]',
    'John Doe'                     => 'Max Muster',
    'Great new site. I can\'t wait to try Melody. Congrats!' =>
      'Tolle neue Website, herzlichen Glückwunsch! Kann es kaum noch abwarten, Melody selbst auszuprobieren.',
    'Created entry and comment \'[_1]\'' =>
      'Eintrag und Kommentar \'[_1]\' angelegt',
...
## addons/Commercial.pack/lib/CustomFields/Template/ContextHandlers.pm
    'Are you sure you have used a \'[_1]\' tag in the correct context? We could not find the [_2]'
      => 'Wird der \'[_1]\'-Befehl im richtigen Kontext verwendet? Kann [_2] nicht finden',
    'You used an \'[_1]\' tag outside of the context of the correct content; '
      => '\'[_1]\'-Befehl außerhalb des passenden Kontexts verwendet.',
...
## addons/Commercial.pack/tmpl/edit_field.tmpl
    ...
    'Please ensure all required fields (highlighted) have been filled in.' =>
      'Bitte füllen Sie alle erforderlichen (hervorgehobenen) Felder aus.',
    'System Object' => 'Systemobjekt',
    'Select the system object this field is for' =>
      'Wählen Sie aus, auf welches Systemobjekt sich dieses Feld bezieht',
    'Select...' => 'Wählen...',
    'Required?' => 'Erforderlich?',
    'Should a value be chosen or entered into this field?' =>
      'Ist diese Option aktiv, muss das Formularfeld ausgefüllt werden.',
    'Default' => 'Standardwert',
    'You will need to first save this field in order to set a default value'
      => 'Um den Standardwert festlegen zu können, speichern Sie das Feld bitte vorher.',
    '_CF_BASENAME' => 'Basisname',
    'The basename is used for entering custom field data through a 3rd party client. It must be unique.'
      => 'Der Basisname wird für das Befüllen eigener Felder durch externe Software verwendet. Basisnamen müssen eindeutig sein.',
    ...
    'Warning: Changing this field\'s basename may require changes to existing templates.'
      => 'Hinweis: Eine Änderung des Basisnamens eines Feldes kann die Bearbeitung vorhandener Vorlagen notwendig machen.',
    'Template Tag' => 'Vorlagenbefehl',
    'Create a custom template tag for this field.' =>
      'Einen eigenen Vorlagenbefehl für dieses Feld anlegen.',
...
## addons/Enterprise.pack/config.yaml
    ...
    'Microsoft SQL Server Database (UTF-8 support)' =>
      'Microsoft SQL Server-Datenbank (mit UTF-8-Unterstüzung)',
...
## addons/Enterprise.pack/lib/MT/Enterprise/BulkCreation.pm
    'Format error at line [_1]: [_2]' =>
      'Fehlerhaftes Format in Zeile [_1]: [_2]',
    ...
    'A user with the same name was found.  Register was not processed: [_1]'
      => 'Benutzer mit gleichem Namen gefunden, Registrierung daher nicht durchgeführt: [_1]',
    ...
    'User \'[_1]\' already exists. Update was not processed: [_2]' =>
      'Benutzerkonto \'[_1]\' bereits vorhanden, Aktualisierung daher nicht durchgeführt: [_2] ',
    'User cannot be updated: [_1].' =>
      'Benutzerkonto kann nicht aktualisiert werden: [_1].',
    'User \'[_1]\' not found.  Update was not processed.' =>
      'Benutzerkonto \'[_1]\' nicht gefunden, Aktualisierung daher nicht durchgeführt. ',
    'User \'[_1]\' has been updated.' =>
      'Benutzerkonto \'[_1]\' aktualisiert.',
    'User \'[_1]\' was found, but delete was not processed' =>
      'Benutzerkonto \'[_1]\' gefunden, aber Löschung nicht durchgeführt.',
    'User \'[_1]\' not found.  Delete was not processed.' =>
      'Benutzerkonto \'[_1]\' nicht gefunden, Löschung daher nicht durchgeführt.',
...
## addons/Enterprise.pack/lib/MT/Enterprise/CMS.pm
    ...
    'You can not create associations for disabled groups.' =>
      'Deaktivierte Gruppen können nicht zugewiesen werden.',
    ...
    'Melody Enterprise has just attempted to disable your account during synchronization with the external directory. Some of the external user management settings must be wrong. Please correct your configuration before proceeding.'
      => 'Melody Enterprise hat während der Synchronisation versucht, Ihr Benutzerkonto zu deaktivieren. Das deutet auf einen Fehler in der externen Benutzerverwaltung hin. Überprüfen Sie daher die dortigen Einstellungen, bevor Sie Ihre Arbeit in Melody forsetzen.',
    ...
    'No record found in the file.  Make sure the file uses CRLF as the line ending character.'
      => 'Keine Eintr�ge in der Datei gefunden. Stellen Sie sicher, da� CRLF f�r den Zeilenwechsel verwendet wird.',
    'Registered [quant,_1,user,users], updated [quant,_2,user,users], deleted [quant,_3,user,users].'
      => '[quant,_1,Benutzer] registiert, [quant,_2,Benutzerkonto,Benutzerkonten] aktualisiert, [quant,_3,Benutzerkonto,Benutzerkonten] gel�scht.',
...
## addons/Enterprise.pack/lib/MT/Auth/LDAP.pm
    ...
    'Failed login attempt by user \'[_1]\' deleted from LDAP.' =>
      'Fehlgeschlagener Anmeldeversuch von Benutzer \'[_1]\' aus LDAP gelöscht.',
    ...
    "Failed login attempt by user \'[_1]\'. A user with that\nusername already exists in the system with a different UUID."
      => "Fehlgeschlagener Anmeldeversuch durch Benutzer \'[_1]\'. Im System ist bereits ein Benutzer
mit diesem Benutzernamen, aber anderer UUID vorhanden.",
    ...
    'The following users\' information were modified:' =>
      'Die Daten folgender Benutzer wurden geändert:',
    'The following users were disabled:' =>
      'Die folgenden Benutzer wurden deaktiviert:',
    ...
    'Synchronization of groups can not be performed without LDAPGroupIdAttribute and/or LDAPGroupNameAttribute is set.'
      => 'Gruppen können nur synchronisiert werden, wenn LDAPGroupIdAttribute und/oder LDAPGroupNameAttribute gesetzt ist.',
    ...
    'The following groups\' information were modified:' =>
      'Die Daten folgender Gruppen wurden geändert:',
    'No LDAP group was found using given filter.' =>
      'Keine entsprechenden LDAP-Gruppen gefunden.',
    "Filter used to search for groups: [_1]\nSearch base: [_2]" =>
      "Verwendeter Suchfilter: [_1]
Suchbasis: [_2]",
    '(none)' => '(Keine)',
    ...
    '[_1] directive must be set to synchronize members of LDAP groups to Melody Enterprise.'
      => '[_1]-Direktive muss gesetzt sein, um LDAP-Gruppenmitgliedschaften mit Melody Enterprise zu synchronisieren.',
    ...
    'Memberships of the group \'[_2]\' (#[_3]) has been changed in synchronizing with external directory.'
      => 'Die Mitgliedschaften der Gruppe \'[_2]\' (#[_3]) wurden bei der Sychronisierung mit dem externen Verzeichnis verändert.',
...
## addons/Enterprise.pack/lib/MT/ObjectDriver/Driver/DBD/MSSQLServer.pm
    'PublishCharset [_1] is not supported in this version of MS SQL Server Driver.'
      => 'PublishCharset [_1] wird von dieser Version des Microsoft SQL Server-Treibers nicht unterstützt.',
...
## addons/Enterprise.pack/lib/MT/LDAP.pm
    ...
    'User not found on LDAP: [_1]' =>
      'Benutzer nicht im LDAP-Verzeichnis gefunden:',
    ...
    'More than one user with the same name found on LDAP: [_1]' =>
      'Mehrere Benutzer mit identischem Namen im LDAP-Verzeichnis gefunden: [_1]',
...
## addons/Enterprise.pack/tmpl/dialog/select_groups.tmpl
    ...
    'Before you can do this, you need to create some groups. <a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">Click here</a> to create a group.'
      => 'Bitte legen Sie zuerst einige Gruppen an. <a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">Klicken Sie hier </a> um Gruppen anzulegen.',
...
## addons/Enterprise.pack/tmpl/create_author_bulk_end.tmpl
    ...
    'An error occurred during the updating process. Please check your CSV file.'
      => 'Während der Aktualisierung ist ein Fehler aufgetreten. Bitte überprüfen Sie Ihre CSV-Datei.',
...
## addons/Enterprise.pack/tmpl/list_group_member.tmpl
    ...
    'Some ([_1]) of the selected users could not be re-enabled because they were no longer found in LDAP.'
      => 'Einige ([_1]) der gewählten Benutzerkonten konnten nicht reaktiviert werden, da sie nicht mehr im LDAP-Verzeichnis vorhanden sind.',
    ...
    'You can not add users to a disabled group.' =>
      'Zu deaktivierten Gruppen können keine Benutzer hinzugefügt werden.',
    ...
    'Are you sure you want to remove this [_1] from this group?' =>
      '[_1] wirklich aus dieser Gruppe entfernen?',
    'Are you sure you want to remove the [_1] selected [_2] from this group?'
      => '[_1] gewählten [_2] wirklich aus dieser Gruppe entfernen?',
...
## addons/Enterprise.pack/tmpl/cfg_ldap.tmpl
    ...
    'Click \'Continue\' below to configure the External User Management settings.'
      => 'Klicken Sie auf \'Weiter\', um die externe Benutzerverwaltung zu konfigurieren.',
    'Click \'Continue\' below to configure your LDAP attribute mappings.' =>
      'Klicken Sie auf \'Weiter\', um die LDAP-Attribute zuzuweisen.',
    ...
    'To finish with the configuration wizard, press \'Continue\' below.' =>
      'Mit einem Klick auf \'Weiter\' schließen Sie die Konfigurierung ab.',
    ...
    'The name of SASL Mechanism to use for both binding and authentication.'
      => 'Name des für Bindung und Authentifizierung verwendeten SASL-Mechanismus',
    ...
    'Frequency of synchronization in minutes. (Default is 60 minutes)' =>
      'Aktualisierungsintervall in Minuten (Standard: 60 Minuten)',
...
## addons/Enterprise.pack/tmpl/edit_group.tmpl
    ...
    'Status of group in the system. Disabling a group removes its members&rsquo; access to the system but preserves their content and history.'
      => 'Globaler Gruppenstatus. Deaktivierung einer Gruppe entzieht ihren Mitgliedern den Zugang zum System. Inhalte und Nutzungsverläufe der Mitglieder bleiben jedoch erhalten.',
...
## plugins/Markdown/SmartyPants.pl
    'Easily translates plain punctuation characters into \'smart\' typographic punctuation.'
      => 'Wandelt einfache Interpunktionszeichen in typographisch korrekte Zecichen um.',
...
## plugins/WXRImporter/WXRImporter.pl
    'Import WordPress exported RSS into MT.' =>
      'Aus WordPress exportiertes RSS in Melody importieren',
    'WordPress eXtended RSS (WXR)' => 'WordPress eXtended RSS (WXR)',
    'Download WP attachments via HTTP.' =>
      'WP-Anhänge per HTTP herunterladen',
...
## plugins/WXRImporter/tmpl/options.tmpl
    'Before you import WordPress posts to Melody, we recommend that you <a href=\'[_1]\'>configure your blog\'s publishing paths</a> first.'
      => 'Bevor Sie WordPress-Einträge in Melody importieren, sollten Sie zuerst die <a href=\'[_1]\'>Veröffentlichungspfade Ihres Weblogs einstellen</a>.',
...
## plugins/TypePadAntiSpam/tmpl/system.tmpl
    ...
    'To enable this plugin, you\'ll need a free TypePad AntiSpam API key. You can <strong>get your free API key at [_1]antispam.typepad.com[_2]</strong>. Once you have your key, return to this page and enter it in the field below.'
      => 'Um dieses Plugin zu aktivieren, benötigen Sie einen kostenlosen TypePad AntiSpam API-Schlüssel. <strong>Sie erhalten Ihren kostenlosen API-Schlüssel auf [_1]antispam.typepad.com[_2]</strong>. Geben Sie Ihren Schlüssel in das folgende Feld ein.',
...
## plugins/StyleCatcher/config.yaml
    'StyleCatcher lets you easily browse through styles and then apply them to your blog in just a few clicks. To find out more about Melody styles, or for new sources for styles, visit the <a href=\'http://www.sixapart.com/movabletype/styles\'>Melody styles</a> page.'
      => 'Mit StyleCatchter können Sie spielend leicht neue Designvorlagen für Ihre Blogs finden und mit wenigen Klicks direkt aus dem Internet installieren. Mehr dazu auf der <a href=\'http://www.sixapart.com/movabletype/styles\'>Melody Styles</a>-Seite.',
...
## plugins/MultiBlog/lib/MultiBlog.pm
    'The include_blogs, exclude_blogs, blog_ids and blog_id attributes cannot be used together.'
      => 'Die Attribute include_blogs, exclude_blog, blog_ids und blog_id können nicht gemeinsam verwendet werden.',
    'The attribute exclude_blogs cannot take "all" for a value.' =>
      '"All" ist kein gültiger Wert für exclude_blogs.',
    'The value of the blog_id attribute must be a single blog ID.' =>
      'blog_id erfordert genau eine Blog-ID als Wert.',
    'The value for the include_blogs/exclude_blogs attributes must be one or more blog IDs, separated by commas.'
      => 'include_blogs und exclude_blogs erfordern mindestens eine Blog-ID als Wert. Mehrere IDs sind per Kommata zu trennen.',
...
## plugins/MultiBlog/multiblog.pl
    ...
    'Select to apply this trigger to all weblogs' =>
      'Auslöser auf alle Weblogs anwenden',
...
## plugins/MultiBlog/tmpl/blog_config.tmpl
    ...
    'Specify whether other blogs in the installation may publish content from this blog. This setting takes precedence over the default system aggregation policy found in the system-level MultiBlog configuration.'
      => 'Hier können Sie festlegen, ob andere Blogs dieser Melody-Installation die Inhalte dieses Blogs verwenden dürfen oder nicht. Diese Einstellung hat Vorrang vor der globalen MultiBlog-Konfiguration.',
    ...
    'Enables use of the MTMultiBlog tag without include_blogs/exclude_blogs attributes. Comma-separated BlogIDs or \'all\' (include_blogs only) are acceptable values.'
      => 'Ermöglicht die Verwendung von MTMultiBlog ohne include_blogs- und exclude_blogs-Attribute. Erlaubte Werte sind \'all\' oder per Kommata getrennte BlogIDs.',
...
## plugins/WidgetManager/WidgetManager.pl
    'Widget Manager version 1.1; This version of the plugin is to upgrade data from older version of Widget Manager that has been shipped with Melody to the Melody core schema.  No other features are included.  You can safely remove this plugin after installing/upgrading Melody.'
      => 'Widget Manager 1.1 - Diese Version des Plugins dient ausschließlich dazu, Daten älterer Versionen auf das Melody Core-Schema zu aktualisieren. Sie können diese Plugin daher nach Installation bzw. Aktualisierung von Melody gefahrlos löschen.',
    'Moving storage of Widget Manager [_1]...' =>
      'Verschiebe den Speicherort von Widget Manager [_1]...',
...
## plugins/feeds-app-lite/tmpl/msg.tmpl
    ...
    'An error occurred processing [_1]. Check <a href="javascript:void(0)" onclick="closeDialog(\'http://www.feedvalidator.org/check.cgi?url=[_2]\')">here</a> for more detail and please try again.'
      => 'Fehler beim Einlesen von [_1]. Beachten Sie die  <a href="javascript:void(0)" onclick="closeDialog(\'http://www.feedvalidator.org/check.cgi?url=[_2]\')">Hinweise des Feed Validators</a> und versuchen Sie es ggf. erneut.',
    ...
    'You may now <a href="javascript:void(0)" onclick="closeDialog(\'[_2]\')">edit &ldquo;[_1]&rdquo;</a> or include the widget in your blog using <a href="javascript:void(0)" onclick="closeDialog(\'[_3]\')">WidgetManager</a> or the following MTInclude tag:'
      => 'Sie können &ldquo;[_1]&rdquo; jetzt <a href="javascript:void(0)" onclick="closeDialog(\'[_2]\')">bearbeiten</a> oder in Ihr Blog <a href="javascript:void(0)" onclick="closeDialog(\'[_3]\')">einbinden</a>. Alternativ können Sie dazu auch diesen MTInclude-Befehl verwenden:',
    'You may now <a href="javascript:void(0)" onclick="closeDialog(\'[_2]\')">edit &ldquo;[_1]&rdquo;</a> or include the widget in your blog using the following MTInclude tag:'
      => 'Sie können &ldquo;[_1]&rdquo; jetzt <a href="javascript:void(0)" onclick="closeDialog(\'[_2]\')">bearbeiten</a> oder mit diesem MTInclude-Befehl in Ihr Blog einbinden:',
...
## plugins/CommunityActionStreams/config.yaml
    'Action streams for community events: add entry, add comment, add favorite, follow user.'
      => 'Action Streams für Community-Ereignisse: Eintrag hinzufügen, Kommentar hinzufügen, Favoriten hinzufügen, Benutzer folgen',

## plugins/Motion/config.yaml
    'A Melody theme with structured entries and action streams.' =>
      'Ein Melody-Thema mit strukturierten Einträgen und Action Streams.',
    'Adjusting field types for embed custom fields...' =>
      'Passe Feldtypen für eingebettete individuelle Felder an...',
    'Updating favoriting namespace for Motion...' =>
      'Aktualisieren Favoriten-Namespace für Motion...',
    'Motion Themes' => 'Motion-Designs',
    'Themes for Motion template set' =>
      'Designs für die Motion-Vorlagengruppe',
    'Motion'                  => 'Motion',
    'Post Type'               => 'Eintragsart',
    'Photo'                   => 'Foto',
    'Embed Object'            => 'Objekt einbetten',
    ...
    'Main Column Posting Form (All Media)' =>
      'Hauptspalte: Eingabeformular (alle Medien)',
    'Main Column Posting Form (Text Only, Like Twitter)' =>
      'Hauptspalte: Eingabeformular (nur Text, z.B. Twitter)',
...
## plugins/Motion/lib/Motion/Search.pm
    'This module works with MT::App::Search.' =>
      'Dieses Modul verwendet MT::App:Search.',
    'Specify the blog_id of a blog that has Motion template set.' =>
      'Geben Sie die blog_id eines Blogs mit der Motion-Vorlagengruppe an.',
...
## plugins/Motion/templates/Motion/widget_about_ssite.mtml
    ...
    'The Motion Template Set is a great example of the type of site you can build with Melody.'
      => 'Die Motion-Vorlagengruppe ist ein tolles Beispiel für die große Bandbreite von Websites, die Sie mit Melody erstellen können.',
...
## plugins/Motion/templates/Motion/single_entry.mtml
    'By [_1] <span class="date">on [_2]</span>' =>
      'Von [_1] <span class="date">am [_2]</span>',
    ...
    'Note: This post is being held for approval by the site owner.' =>
      'Hinweis: Dieser Eintrag ist vom Betreiber der Site noch nicht freigeschaltet worden.',
    '<a href="[_1]">Most recent comment by <strong>[_2]</strong> on [_3]</a>'
      => '<a href="[_1]">Aktuelle Kommentare von <strong>[_2]</strong> zu [_3]</a>',
...
## plugins/Motion/templates/Motion/javascript.mtml
    'Please select a file to post.' =>
      'Bitte wählen die Datei, die Sie hochladen möchten',
...
## plugins/Motion/templates/Motion/widget_elsewhere.mtml
    'Are you sure you want to remove the [_1] from your profile?' =>
      '[_1] wirklich aus Ihrem Profil entfernen?',
    'Your user name or ID is required.' =>
      'Ihr Benutzername oder Ihre ID ist erforderlich.',
...
## plugins/Motion/templates/Motion/widget_main_column_registration.mtml
    '<a href="javascript:void(0)" onclick="[_1]">Sign In</a>' =>
      '<a href="javascript:void(0)" onclick="[_1]">Anmelden</a>',
    'Not a member? <a href="[_1]">Register</a>' =>
      'Noch kein Mitglied? <a href="[_1]>Registieren</a>',
    '(or <a href="javascript:void(0)" onclick="[_1]">Sign In</a>)' =>
      '(oder <a href="javascript:void(0)" onclick="[_1]">anmelden</a>)',
...
## plugins/Motion/templates/Motion/widget_main_column_posting_form.mtml
    ...
    'Only GIF, JPEG and PNG image files are supported.' =>
      'Unterstützt werden die Formate GIF, JPG und PNG.',
    'Select audio file' => 'Audiodatei wählen',
    'Only MP3 audio files are supported.' =>
      'Unterstützt wird das Format MP3.',
...
## plugins/Motion/templates/Motion/comments.mtml
    ...
    '[_1] [_2]in reply to comment from [_3][_4]' =>
      '[_1] [_2] alt Antwort auf den Kommentar von [_3][_4]',
...
## plugins/Motion/templates/Motion/actions.mtml
    ...
    '[_1] favorited [_2] on [_3]' =>
      '[_1] hat [_2] auf [_3] zum Favoriten gemacht',
...
## plugins/FacebookCommenters/plugin.pl
    ...
    '{*actor*} commented on the blog post <a href="{*post_url*}">{*post_title*}</a>.'
      => '{*actor*} hat den Blog-Eintrag <a href="{*post_url*}">{*post_title*}</a> kommentiert.',
    'Could not register story template with Facebook: [_1]. Did you enter the correct application secret?'
      => 'Das Story Template konnte nicht bei Facebook registriert werden: [_1]. Haben Sie das Application Secret richtig eingegeben?',
    'Could not register story template with Facebook: [_1]' =>
      'Das Story Template konnte nicht bei Facebook registriert werden: [_1]. ',
    'Facebook' => 'Facebook',
...
## plugins/mixiComment/mixiComment.pl
    'Allows commenters to sign in to Melody 4 using their own mixi username and password via OpenID.'
      => 'Ermöglicht es Kommentarautoren, sich per OpenID mit ihrem mixi-Benutzernamen und -Passwort bei Melody 4 anzumelden',
    'Sign in using your mixi ID' => 'Mit Ihrer mixi-ID anmelden',
    'Click the button to sign in using your mixi ID' =>
      'Klicken Sie den Knopf an, um sich mit Ihrer mixi-ID anzumelden',
    'mixi' => 'mixi',
...
## plugins/ActionStreams/streams.yaml
    ...
    'The games in your collection you\'re currently playing' =>
      'Die Spiele aus Ihrer Sammlung, die Sie derzeit spielen',
    'Comments you have made on the web' =>
      'Kommentare, die Sie im Web geschrieben haben',
    'Colors'             => 'Farben',
    ...
    'Palettes you saved as favorites' =>
      'Paletten, die Sie als Favoriten gespeichert haben',
    'Reviews'               => 'Kritiken',
    ...
    'The events you said you\'ll be attending' =>
      'Veranstaltungen, an denen Sie vorhaben teilzunehmen',
    'Your public posts to your journal' =>
      'Ihre öffentlichen Tagebuch-Einträge',
    'Queue'                                 => 'Ausleihliste',
    ...
    'Stations'                        => 'Sender',
    'Radio stations you added' =>
      'Radiostationen, die Sie in Ihre Liste aufgenommen haben',
    'List'                        => 'Liste',
    ...
    'Articles you liked (your votes must be public)' =>
      'Artikel, die Ihnen gefallen haben (bei öffentlicher Abstimmung)',
    'Dislikes' => 'Nicht gefallen',
    'Articles you disliked (your votes must be public)' =>
      'Artikel, die Ihnen nicht gefallen haben (bei öffentlicher Abstimmung)',
    'Slideshows you saved as favorites' =>
      'Slideshows, die Sie als Favoriten gespeichert haben',
    'Slideshows'            => 'Slideshows',
    'Slideshows you posted' => 'Slideshows, die Sie veröffentlicht haben',
    'Your achievements for achievement-enabled games' =>
      'Ihre Achievements bei Spielen, die das Achievements-System unterstützen',
    'Stuff'              => 'Sachen',
    ...
    'Public tweets you saved as favorites' =>
      'Öffentliche Tweets, die Sie als Ihre Favoriten gespeichert haben',
    'Tweets about your search term' => 'Tweets zu Ihren Suchbegriffen',
    'Saved'                         => 'Gespeichert',
    'Things you saved as favorites' =>
      'Dinge, die Sie als Favoriten gespeichert haben',
...
## plugins/ActionStreams/services.yaml
    ...
    'You can find your Facebook userid within your profile URL.  For example, http://www.facebook.com/profile.php?id=24400320.'
      => 'Ihre Facebook-Benutzerkennung ist die Zahl in der Webadresse Ihres Profils; z.B. http://www.facebook.com/profile.php?id=24400320',
    'FFFFOUND!' => 'FFFFOUND!',
    'Flickr'    => 'Flickr',
    'Enter your Flickr userid which contains "@" in it, e.g. 36381329@N00.  Flickr userid is NOT the username in the URL of your photostream.'
      => 'Ihre Flickr-Benutzerkennung ist NICHT Ihr Benutzername, sondern der Teil der Webadresse Ihres Profils mit dem "@"-Zeichen; z.B. 36381329@N00',
    ...
    'You can find your Goodreads userid within your profile URL. For example, http://www.goodreads.com/user/show/123456.'
      => 'Ihre Goodreads-Benutzerkennung ist die Zahl in der Webadresse Ihres Profils; z.B. http://www.goodreads.com/user/show/123456',
    ...
    'You can find your istockphoto userid within your profile URL.  For example, http://www.istockphoto.com/user_view.php?id=1234567.'
      => 'Ihre istockphoto-Benutzerkennung ist die Zahl in der Webadresse Ihres Profils; z.B. http://www.istockphoto.com/user_view.php?id=1234567',
    'IUseThis'        => 'IUseThis',
    ...
    'To find your Netflix RSS ID, click "RSS" at the bottom of any page on the Netflix site, then copy and paste in your "Queue" link.'
      => 'Ihre Netflix RSS-ID finden Sie, indem Sie auf einer beliebigen Netflix-Seite unten auf "RSS" klicken und dann den "Queue"-Link koppieren',
    'Netvibes'           => 'Netvibes',
    'Newsvine'           => 'Newsvine',
    'Ning'               => 'Ning',
    ...
    'You can find your orkut uid within your profile URL. For example, http://www.orkut.com/Main#Profile.aspx?rl=ls&uid=1234567890123456789'
      => 'Ihre Orkut-Benutzerkennung ist die Zahl in der Webadresse Ihres Profils nach "uid="; z.B. http://www.orkut.com/Main#Profile.aspx?rl=ls&uid=1234567890123456789',
    'Pandora'           => 'Pandora',
    ...
    'You can find your p0pulist user id within your Hot List URL. for example, http://p0pulist.com/list/hot_list/10000'
      => 'Ihre p0pulist-Benutzerkennung ist die Zahl in der Webadresse Ihres Profil; z.B. http://p0pulist.com/list/hot_list/10000',
    'Pownce'      => 'Pownce',
    'Reddit'      => 'Reddit',
    'Skype'       => 'Skype',
    ...
    'You can find your SonicLiving userid within your share&subscribe URL. For example, http://sonicliving.com/user/12345/feeds'
      => 'Ihre SonicLiving-Benutzerkennung ist die Zahl in der Webadresse Ihrer Share&Subscribe-Seite; z.B. http://sonicliving.com/user/12345/feeds',
    'Steam'       => 'Steam',
    'StumbleUpon' => 'StumbleUpon',
    'Tabblo'      => 'Tabblo',
    'Blank should be replaced by positive sign (+).' =>
      'Verwenden Sie statt Leerzeichen Pluszeichen (+)',
    'Tribe' => 'Tribe',
    'You can find your tribe userid within your profile URL.  For example, http://people.tribe.net/dcdc61ed-696a-40b5-80c1-e9a9809a726a.'
      => 'Ihre Tribe-Benutzerkennung ist die Zahl in der Webadresse Ihres Profils; z.B. http://people.tribe.net/dcdc61ed-696a-40b5-80c1-e9a9809a726a',
    'Tumblr'        => 'Tumblr',
    'Twitter'       => 'Twitter',
    ...
    'You can find your VIRB userid within your home URL.  For example, http://www.virb.com/backend/2756504321310091/your_home.'
      => 'Ihre Virb-Benutzerkennung ist die Zahl in der Webadresse Ihrer Startseite; z.B. http://www.virb.com/backend/2756504321310091/your_home',
    'Vox name'           => 'Vox-Name',
    'Website'            => 'Website',
    'Xbox Live\''        => 'Xbox Live',
    'Gamertag'           => 'Gamertag',
...
## plugins/ActionStreams/config.yaml
    'Manages authors\' accounts and actions on sites elsewhere around the web'
      => 'Verwaltet die Benutzerkonten und Ereignisse des Autors auf anderen Websites',
    'Are you sure you want to hide EVERY event in EVERY action stream?' =>
      'Wirklich ALLE Ereignisse in ALLEN Action Streams verstecken?',
    'Are you sure you want to show EVERY event in EVERY action stream?' =>
      'Wirklich ALLE Ereignisse in ALLEN Action Streams anzeigen?',
    'Deleted events that are still available from the remote service will be added back in the next scan. Only events that are no longer available from your profile will remain deleted. Are you sure you want to delete the selected event(s)?'
      => 'Gelöschte Ereignisse, die bei dem jeweiligen Web-Dienst noch aufgeführt sind, werden bei der nächsten Aktualisierung wieder hinzugefügt. Gelöscht werden nur Ereignisse, die nicht mehr in Ihrem Profil verfügbar sind. Gewählte Ereignisse wirklich löschen?',
    ...
    'Enabling default action streams for selected profiles...' =>
      'Aktiviere Standard-Action Streams für die gewählten Profile...',

## plugins/ActionStreams/lib/ActionStreams/Upgrade.pm
    'Updating classification of [_1] [_2] actions...' =>
      'Aktualisiere Klassifizierungen von [_1] [_2]-Aktionen',
    'Renaming "[_1]" data of [_2] [_3] actions...' =>
      'Benenne "[_1]"-Daten von [_2] [_3]-Aktionen um...',
...
## plugins/ActionStreams/lib/ActionStreams/Event.pm
    '[_1] updating [_2] events for [_3]' =>
      '[_1] aktualisiert [_2]-Ereignisse für [_3]',
    'Error updating events for [_1]\'s [_2] stream (type [_3] ident [_4]): [_5]'
      => 'Fehler bei der Aktualisierung der Ereignisse für [_1]s [_2]-Stream (Typ [_3], Ident [_4]): [_5]',
    'Could not load class [_1] for stream [_2] [_3]: [_4]' =>
      'Konnte Klasse [_1] für Stream [_2] [_3] nicht laden: [_4]',
    'No URL to fetch for [_1] results' =>
      'Keine URL zum Einlesen von [_1]-Ergebnissen',
    'Could not fetch [_1]: [_2]' =>
      '[_1] konnte nicht einlesen gewerden: [_2]',
...
## plugins/ActionStreams/tmpl/dialog_edit_profile.tmpl
    ...
    'Edit a profile on a social networking or instant messaging service.' =>
      'Bearbeiten Sie Ihr Profil bei einem Social Network oder Instant Messaging-Dienst.',
    'Service' => 'Dienst',
    'Enter your account on the selected service.' =>
      'Geben Sie Ihren Benutzernamen beim gewählten Dienst ein.',
    'For example:'   => 'Beispiel:',
    'Action Streams' => 'Action Streams:',
    'Select the action streams to collect from the selected service.' =>
      'Wählen Sie, welche Action Streams beim gewählten Dienst abgefragt werden sollen.',
    'No streams are available for this service.' =>
      'Für diesen Dienst sind keine Action Streams verfügbar.',
...
## plugins/ActionStreams/tmpl/other_profiles.tmpl
    ...
    'The selected profiles were scanned for updates.' =>
      'Gewählte Profile auf Aktualisierungen überprüft.',
...
## plugins/ActionStreams/tmpl/dialog_add_profile.tmpl
    'Add a profile on a social networking or instant messaging service.' =>
      'Profil bei einem Social Network oder Instant Messaging-Dienst hinzufügen',
    'Select a service where you already have an account.' =>
      'Wählen Sie einen Dienst, bei dem Sie bereits ein Benutzerkonto haben.',
    'Add Profile (s)' => 'Profil hinzufügen (s)',

## plugins/ActionStreams/tmpl/list_profileevent.tmpl
    'The selected events were deleted.' =>
      'Die gewählten Ereignisse wurden gelöscht.',
    'The selected events were hidden.' =>
      'Die gewählten Ereignisse werden verborgen.',
    'The selected events were shown.' =>
      'Die gewählten Ereignisse werden angezeigt.',
    'All action stream events were hidden.' =>
      'Die Action Stream-Ereignisse werden verborgen.',
    'All action stream events were shown.' =>
      'Alle Action Stream-Ereignisse werden angezeigt.',
    'event'                     => 'Ereignis',
    'events'                    => 'Ereignisse',
...
## plugins/ActionStreams/tmpl/blog_config_template.tmpl
    ...
    'If selected, this blog\'s indexes will be rebuilt when new action stream events are discovered.'
      => 'Falls aktiviert, werden die Indizes dieses Blogs neu aufgebaut, wenn neue Action Stream-Ereignisse eintreffen',
    'Enable rebuilding' => 'Neuaufbau aktivieren',
    'Extension changed from [_1] to [_2]' =>
      'Erweiterung von [_1] in [_2] geändert',    # Translate - New # OK
    '[_1] changed from [_2] to [_3]' =>
      '[_1] von [_2] in [_3] geändert',           # Translate - New # OK
    '\'[_1]\' edited the template \'[_2]\' in the blog \'[_3]\'' =>
      '\'[_1]\' hat die Vorlage \'[_2]\' im Blog \'[_3]\' bearbeitet'
    ,                                              # Translate - New # OK
    ...
    'Entries must be cloned if comments and trackbacks are cloned' =>
      'Zum Klonen der TrackBacks und Kommentare müssen auch die Einträge geklont werden.'
    ,                                              # Translate - New # OK
    'Test e-mail was successfully sent to [_1]' =>
      'Testmail erfolgreich an [_1] verschickt',    # Translate - New # OK
    'These setting(s) are overridden by a value in the MT configuration file: [_1]. Remove the value from the configuration file in order to control the value on this page.'
      => 'Diese Einstellungen werden von einer Angabe in der MT-Konfigurationsdatei außer Kraft gesetzt: [_1]. Um diese Einstellungen an dieser Stelle vornehmen zu können, entfernen Sie die Angabe aus der Konfigurationsdatei.'
    ,                                               # Translate - New # OK
    'Email address is [_1]' =>
      'Die E-Mail-Adresse lautet [_1]',             # Translate - New # OK
    'Debug mode is [_1]' => 'Der Debug-Modus ist [_1]', # Translate - New # OK
    'Performance logging is on' =>
      'Performance-Logging ist aktiviert',              # Translate - New # OK
    'Performance logging is off' =>
      'Performance-Logging ist deaktiviert',            # Translate - New # OK
    'Performance log path is [_1]' =>
      'Die Performance-Logs liegen im Pfad [_1]',       # Translate - New # OK
    'Performance log threshold is [_1]' =>
      'Der Schwellenwert für Performance-Logging ist [_1]'
    ,                                                   # Translate - New # OK
    ...
    'This is set to the same URL as the original blog.' =>
      'Die URL entspricht der des Ursprungsblogs.',     # Translate - New # OK
    'This will overwrite the original blog.' =>
      'Das Ursprungsblog wird überschrieben.',         # Translate - New # OK
    'No such template' => 'Keine solche Vorlage',       # Translate - New
    'template_id cannot be a global template' =>
      'template_id kann keine globale Vorlage sein.',    # Translate - New
    'Output file cannot be asp or php' =>
      'Die Ausgabedatei darf weder ASP noch PHP sein.',    # Translate - New
    'You must pass a valid archive_type with the template_id' =>
      'template_id erfordert ein gültiges archive_type-Parameter.'
    ,                                                      # Translate - New
    'Template must have identifier entry_listing for non-Index archive types'
      => 'Für Nicht-Index-Archive sind in der Vorlage eine entry_listing-Angabe erforderlich.'
    ,                                                      # Translate - New
    'Blog file extension cannot be asp or php for these archives' =>
      'Dateien dieses Archivs dürfen weder auf .asp noch auf .php enden.'
    ,                                                      # Translate - New
    'Template must have identifier main_index for Index archive type' =>
      'Für Index-Archive sind in der Vorlage eine main_index-Angabe erforderlich. '
    ,                                                      # Translate - New
    'Add New' => 'Neues Asset',                            # Translate - Case
    'No asset(s) associated with this [_1]' =>
      'Keine Assets verknüpft ',                          # Translate - New
);
