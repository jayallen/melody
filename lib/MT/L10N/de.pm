...
## default_templates/recover-password.mtml
	'A request has been made to change your password in Melody. To complete this process click on the link below to select a new password.' => 'Es wurde eine Anfrage zur Änderung Ihres Passwortes in Melody gestellt. Bitte klicken Sie auf untenstehenden Link und wählen Sie ein neues Passwort aus um diesen Prozess abzuschließen.',
...
## lib/MT/Upgrade.pm
	...
	'This role was generated by Melody upon upgrade.' => 'Diese Rolle wurde von Melody während eines Upgrades angelegt.',
	...
	'I just finished installing Melody [_1]!' => 'Ich habe soeben Melody [_1] installiert!',
	'Welcome to my new blog powered by Melody. This is the first post on my blog and was created for me automatically when I finished the installation process. But that is ok, because I will soon be creating posts of my own!' => 'Willkommen zu meinem neuen Melody-Blog. Dieser Eintrag hier ist nur ein automatisch erzeugter Platzhalter, damit hier etwas steht, bis ich meine ersten eigenen Einträge geschrieben habe.',
	'Melody also created a comment for me as well so that I could see what a comment will look like on my blog once people start submitting comments on all the posts I will write.' => 'Ein Beispielkommentar wurde auch gleich angelegt, so daß man sehen kann, wie die Kommentare von Lesern dargestellt werden werden.',
	...
	'Database has been upgraded to version [_1].' => 'Datenbank auf Melody-Version [_1] aktualisiert',
...
## lib/MT/App/Comments.pm
	...
	'Invalid commenter login attempt from [_1] to blog [_2](ID: [_3]) which does not allow Melody native authentication.' => 'Ungültiger Anmeldeversuch von Kommentarautor [_1] an Weblog [_2](ID: [_3]) - native Melody-Authentifizierung bei diesem Weblog nicht zulässig.',
...
## lib/MT/App/Upgrader.pm
	...
	'No permissions. Please contact your administrator for upgrading Melody.' => 'Bitte kontaktieren Sie Ihren Administrator, um das Upgrade von Melody durchzuführen. Sie haben nicht die erforderlichen Rechte.',
	'Melody has been upgraded to version [_1].' => 'Melody erfolgreich auf Version [_1] aktualisiert.',
...
## lib/MT/App/Wizard.pm
	...
	'Sendmail' => 'Sendmail',
	'Test email from Melody Configuration Wizard' => 'Testmail vom Melody-Konfigurationshelfer',
	'This is the test email sent by your new installation of Melody.' => 'Diese Testmail wurde von Ihrer neuen Melody-Installation verschickt.',
	'This module is needed to encode special characters, but this feature can be turned off using the NoHTMLEntities option in config.cgi.' => 'Dieses Modul ist zur Sonderzeichenkodierung erforderlich. Sonderzeichenkodierung kann über den Schalter NoHTMLEntities in config.cgi abgeschaltet werden.',
	...
	'This module is required in search.cgi if you are running Melody on Perl older than Perl 5.8.' => 'Dieses Modul ist für search.cgi erforderlich, wenn Sie Melody unter Perl älter als Version 5.8 ausführen.',
	...
	'CGI is required for all Melody application functionality.' => 'CGI ist für sämtliche Melody-Funktionen erforderlich.',
...
## lib/MT/Util/Captcha.pm
	'Melody default CAPTCHA provider requires Image::Magick.' => 'Zur Nutzung der in Melody integrierten CAPTCHA-Quelle ist Image::Magick erforderlich.',
...
## lib/MT/BackupRestore.pm
	...
	'Manifest file [_1] was not a valid Melody backup manifest file.' => 'Manifest-Datei [_1] ist keine gültige Melody Backup-Manifest-Datei.',
...
## lib/MT/XMLRPCServer.pm
	...
	'Template methods are not implemented, due to differences between the Blogger API and the Melody API.' => 'Funktionen zum Zugriff auf Vorlagen sind auf Grund von Unterschieden zwischen der Blogger-API und der MovableType-API nicht implementiert.',
...
## lib/MT/CMS/Tools.pm
	...
	'This is the test email sent by your installation of Melody.' => 'Diese Testmail wurde von Ihrer Melody-Installation verschickt.', # Translate - New # OK
	...
	'Successfully restored objects to Melody system by user \'[_1]\'' => 'Objekte erfolgreich wiederhergestellt von Benutzer \'[_1]\'',
	...
	'Uploaded file was not a valid Melody backup manifest file.' => 'Die hochgeladene Datei ist keine gültige Melody Backup-Manifest-Datei.',
	'Blog(s) (ID:[_1]) was/were successfully backed up by user \'[_2]\'' => 'Weblog(s) (ID:[_1]) erfolgreich gesichert von Benutzer \'[_2]\'',
	'Melody system was successfully backed up by user \'[_1]\'' => 'Melody-System erfolgreich gesichert von Benutzer \'[_1]\'',
...
## lib/MT/App.pm
	...
	'Our apologies, but you do not have permission to access any blogs within this installation. If you feel you have reached this message in error, please contact your Melody system administrator.' => 'Sie haben leider keine Berechtigung, auf Blogs dieser Melody-Installation zuzugreifen. Sollte diese Meldung irrtümlich angezeigt werden, wenden Sie sich bitte an Ihren Administrator.',
...
## lib/MT/BackupRestore/BackupFileHandler.pm
	'Uploaded file was backed up from Melody but the different schema version ([_1]) from the one in this system ([_2]).  It is not safe to restore the file to this version of Melody.' => 'Die hochgeladene Sicherungsdatei stammt aus einer Melody-Installation mit anderer Schema-Version ([_1]) wie diese Installation ([_2]). Wir raten daher ausdrücklich davor ab, die Datei in diese Melody-Version einzuspielen.',
	'[_1] is not a subject to be restored by Melody.' => '[_1] wird von Melody nicht wiederhergestellt.',
...
## lib/MT.pm.pre
	...
	'Sign in to Melody with your[_1] Account[_2]' => 'Bei Melody mit Ihrem[_1]-Konto[_2] anmelden',
	...
	'Missing configuration file. Maybe you forgot to move config.cgi-original to config.cgi?' => 'Keine Konfigurationsdatei gefunden. Haben Sie möglicheweise vergessen, config.cgi-original in config.cgi umzubennen?',
...
## tmpl/wizard/optional.tmpl
	...
	'Check your email to confirm receipt of a test email from Melody and then proceed to the next step.' => 'Überprüfen Sie den Eingang der Testmail in Ihrem Postfach und fahren Sie dann mit dem nächsten Schritt fort.',
	'Back' => 'Zurück',
	'Continue' => 'Weiter',
	'Show current mail settings' => 'Mail-Einstellungen anzeigen',
	'Periodically Melody will send email to inform users of new comments as well as other other events. For these emails to be sent properly, you must instruct Melody how to send email.' => 'Geben Sie an, auf welchem Wege Melody E-Mails verschicken soll. E-Mails werden beispielsweise zur Benachrichtigung über neue Kommentare verschickt.',
...
## tmpl/wizard/complete.tmpl
	...
	'Please use the configuration text below to create a file named \'config.cgi\' in the root directory of [_1] (the same directory in which index.cgi is found).' => 'Kopieren Sie folgenden Text in eine Datei namens \'config.cgi\' und legen diese im Melody-Hauptverzeichnis ab (das Verzeichnis, in dem sich auch die Datei index.cgi befindet)',
	'The wizard was unable to save the [_1] configuration file.' => 'Die [_1]-Konfigurationsdatei konnte nicht gespeichert werden.',
	'Confirm your [_1] home directory (the directory that contains index.cgi) is writable by your web server and then click \'Retry\'.' => 'Bitte überprüfen Sie, ob der Webserver Schreibrechte für Ihr [_1]-Hauptverzeichnis hat und klicken Sie dann auf "Erneut versuchen".',
	...
	'Show the config.cgi file generated by the wizard' => 'Vom Konfigurationshelfer erzeugte config.cgi-Datei anzeigen',
	'The config.cgi file has been created manually.' => 'Die config.cgi-Konfigurationsdatei wurde manuell erstellt.',
...
## tmpl/wizard/start.tmpl
	...
	'A configuration (config.cgi) file already exists, <a href="[_1]">sign in</a> to Melody.' => 'Es ist bereits eine Konfigurationsdatei (config.cgi) vorhanden. Sie können sich daher sofort <a href="[_1]">bei Melody anmelden</a>.',
	...
	'Melody requires that you enable JavaScript in your browser. Please enable it and refresh this page to proceed.' => 'Melody erfordert JavaScript. Bitte aktivieren Sie es in Ihren Browsereinstellungen und laden diese Seite dann neu.',
	'This wizard will help you configure the basic settings needed to run Melody.' => 'Dieser Konfigurationshelfer hilft Ihnen, die zum Betrieb von Melody erforderlichen Grundeinstellungen vorzunehmen.',
	...
	'Melody ships with directory named [_1] which contains a number of important files such as images, javascript files and stylesheets.' => 'Melody wird mit einem Verzeichnis namens [_1] ausgeliefert, das einige wichtige Bild-, JavaScript- und Stylesheet-Dateien enthält.',
	'The [_1] directory is in the main Melody directory which this wizard script resides, but due to your web server\'s configuration, the [_1] directory is not accessible in this location and must be moved to a web-accessible location (e.g., your web document root directory).' => 'Der [_1]-Ordner befindet sich im Hauptverzeichnis von Melody, ist aufgrund der Serverkonfiguration vom Webserver aber nicht erreichbar. Verschieben Sie den Ordner [_1] daher an einen Ort, auf dem der Webserver zugreifen kann (z.B. Document Root).',
	'This directory has either been renamed or moved to a location outside of the Melody directory.' => 'Das Verzeichnis wurde entweder umbenannt oder an einen Ort außerhalb des Melody-Verzeichnisses verschoben.',
...
## tmpl/wizard/packages.tmpl
	...
	'The following Perl modules are required in order to make a database connection.  Melody requires a database in order to store your blog\'s data.  Please install one of the packages listed here in order to proceed.  When you are ready, click the \'Retry\' button.' => 'Die folgenden Perl-Module sind zur Herstellung einer Datenbankverbindung erforderlich (Melody speichert Ihre Daten in einer Datenbank). Bitte installieren Sie die hier genannten Pakete und klicken Sie danach auf \'Erneut versuchen\'.',
	'All required Perl modules were found.' => 'Alle erforderlichen Perl-Module sind vorhanden.',
	'You are ready to proceed with the installation of Melody.' => 'Sie können die Installation von Melody fortsetzen.',
	...
	'One or more Perl modules required by Melody could not be found.' => 'Mindestens ein von Melody erforderliche Perl-Modul wurde nicht gefunden.',
	'The following Perl modules are required for Melody to run properly. Once you have met these requirements, click the \'Retry\' button to re-test for these packages.' => 'Die folgenden Pakete sind nicht vorhanden, zur Ausführung von Melody aber erforderlich. Bitte installieren Sie sie und klicken dann auf \'Erneut versuchen\'.',
...
## tmpl/wizard/configure.tmpl
	...
	'Is your preferred database not listed? View the <a href="[_1]" target="_blank">Melody System Check</a> see if additional modules are necessary.' => 'Wird Ihr Datenbanksystem nicht aufgeführt? Führen Sie die <a href="[_1]" target="_blank">Melody Systemüberprüfung</a> durch, um zu erfahren, ob zusätzliche Module erforderlich sind.',
	...
	'A default location of \'./db/mt.db\' will store the database file underneath your Melody directory.' => 'Mit der  Voreinstellung \'./db/mt.db\' wird die Datenbankdatei unterhalb Ihres Melody-Verzeichnisses angelegt.',
...
## tmpl/cms/cfg_plugin.tmpl
	...
	'This plugin has not been upgraded to support Melody [_1]. As such, it may not be 100% functional. Furthermore, it will require an upgrade once you have upgraded to the next Melody major release (when available).' => 'Dieses Plugin wurde noch nicht für Melody [_1] portiert. Daher funktioniert es möglicherweise nicht fehlerfrei. Außerdem erfordert es nach Installation der nächsten Melody-Version eine zusätzliche Aktualisierung.',
...
## tmpl/cms/login.tmpl
	'Your Melody session has ended.' => 'Ihre Melody-Sitzung ist abgelaufen oder Sie haben sich abgemeldet.',
	'Your Melody session has ended. If you wish to sign in again, you can do so below.' => 'Ihre Melody-Sitzung ist abgelaufen. Unten können Sie sich erneut anmelden.',
	'Your Melody session has ended. Please sign in again to continue this action.' => 'Ihre Melody-Sitzung ist abgelaufen. Bitte melden Sie sich erneut an, um den Vorgang fortzusetzen.',
	'Forgot your password?' => 'Passwort vergessen?',
	'Sign In (s)' => 'Anmelden (s)',

## tmpl/cms/list_blog.tmpl
	'You have successfully deleted the blogs from the Melody system.' => 'Blog(s) erfolgreich gelöscht',
...
## tmpl/cms/dashboard.tmpl
	...
	'Image::Magick is either not present on your server or incorrectly configured. Due to that, you will not be able to use Melody\'s userpics feature. If you wish to use that feature, please install Image::Magick or use an alternative image driver.' => 'Die Benutzerbild-Funktion steht Ihnen derzeit nicht zur Verfügung, da Image::Magick nicht installiert oder nicht richtig konfiguriert ist. Um die Funktion zu nutzen, installieren Sie Image::Magick oder verwenden Sie einen anderen entsprechenden Treiber',
...
## tmpl/cms/cfg_trackbacks.tmpl
	...
	'Specify when Melody should notify you of new TrackBacks if at all.' => 'Legt fest, ob und wann Sie bei neuen TrackBacks benachrichtigt werden',
	'On' => 'Immer',
...
## tmpl/cms/cfg_comments.tmpl
	...
	'Specify when Melody should notify you of new comments if at all.' => 'Legt fest, ob und wann Melody Email-Benachrichtigungen über neue Kommentare versendet.',
...
## tmpl/cms/cfg_system_users.tmpl
	...
	'Allow commenters to register to Melody' => 'Falls aktiv, können sich Benutzer bei dieser Melody-Installation als Kommentarautor selbst registrieren',
...
## tmpl/cms/edit_entry.tmpl
	...
	'Use <a href="http://blogit.typepad.com/">Blog It</a> to post to Melody from social networks like Facebook.' => 'Mit <a href="http://blogit.typepad.com/">Blog It</a> aus Facebook heraus in Melody-Blogs bloggen',
...
## tmpl/cms/include/footer.tmpl
	'This is a beta version of Melody and is not recommended for production use.' => 'Das ist eine Beta-Version von Melody. Der Einsatz als Produktivsystem wird nicht empfohlen.',
...
## tmpl/cms/import.tmpl
	...
	'Transfer weblog entries into Melody from other Melody installations or even other blogging tools or export your entries to create a backup or copy.' => 'Mit der Import/Export-Funktion können Sie Einträge aus anderen Melody-Installationen oder aus anderen Weblog-Systemen übernehmen. Bestehende Einträge können in einem Austauschformat gesichert werden.',
	...
	'If your import file is located on your computer, you can upload it here.  Otherwise, Melody will automatically look in the \'import\' folder of your Melody directory.' => 'Wenn Sie eine auf Ihrem Computer gespeicherte Importdatei verwenden wollen, laden Sie diese hier hoch. Alternativ verwendet Melody automatisch die Importdatei, die es im \'import\'-Unterordner Ihres Melody-Verzeichnis findet.',
	'More options' => 'Weitere Optionen',
	'Import File Encoding' => 'Zeichenkodierung der Importdatei',
	'By default, Melody will attempt to automatically detect the character encoding of your import file.  However, if you experience difficulties, you can set it explicitly.' => 'Melody versucht automatisch die korrekte Zeichenkodierung auszuwählen. Sollte das fehlschlagen, können Sie sie auch explizit angeben.',
...
## tmpl/cms/upgrade.tmpl
	...
	'While Melody may run, it is an <strong>untested and unsupported environment</strong>.  We strongly recommend upgrading to at least Perl [_1].' => 'Wir empfehlen dringend, die Perl-Installation mindestens auf Version [_1] zu aktualisieren. Melody läuft zwar möglicherweise auch mit der vorhandenen Perl-Version, es handelt sich aber um eine <strong>nicht getestete und nicht unterstützte Umgebung</strong>.',
	'Do you want to proceed with the upgrade anyway?' => 'Upgrade dennoch fortsetzen?',
	'Yes (s)' => 'Ja (s)',
	'View MT-Check (x)' => 'MT-Check anzeigen (x)',
	'A new version of Melody has been installed.  We\'ll need to complete a few tasks to update your database.' => 'Es wurde eine neue Version von Melody installiert. Ihre Datenbank wird nun auf den aktuellen Stand gebracht.',
	...
	'In addition, the following Melody components require upgrading or installation:' => 'Zusätzlich müssen folgende Melody-Komponenten installiert oder aktualisiert werden:',
	'The following Melody components require upgrading or installation:' => 'Die folgenden Melody-Komponenten müssen installiert oder aktualisiert werden:',
	'Begin Upgrade' => 'Upgrade durchführen',
	'Congratulations, you have successfully upgraded to Melody [_1].' => 'Herzlichen Glückwunsch, Sie haben Ihre Installation erfolgreich auf Melody [_1] aktualisiert!',
	'Return to Melody' => 'Zurück zu Melody',
	'Your Melody installation is already up to date.' => 'Ihre Melody-Installation ist bereits auf dem neuesten Stand.',
...
## tmpl/cms/dialog/refresh_templates.tmpl
	...
	'Deletes all existing templates and installs factory default template set.' => 'Löscht alle vorhandenen Vorlagen und installiert die Melody-Standardvorlagen',
...
## tmpl/cms/list_author.tmpl
	...
	'You have successfully deleted the user(s) from the Melody system.' => 'Gewählte Benutzerkonten erfolgreich aus Melody gelöscht',
	'The deleted user(s) still exist in the external directory. As such, they will still be able to login to Melody Enterprise.' => 'Die gelöschten Benutzerkonten sind im externen Verzeichnis weiterhin vorhanden. Die Benutzer können sich daher weiterhin an Melody Enterprise anmelden.',
	...
	'_NO_SUPERUSER_DISABLE' => 'Sie können Ihr eigenes Benutzerkonto nicht deaktivieren, da Sie Verwalter dieser Melody-Installation sind.',
...
## tmpl/cms/cfg_web_services.tmpl
	...
	'When this blog is updated, Melody will automatically notify the selected sites.' => 'Melody benachrichtigt die gewählten Sites automatisch, wenn dieses Blog aktualisiert wurde.',
...
## tmpl/cms/install.tmpl
	...
	'Before you can begin blogging, you must create an administrator account for your system. When you are done, Melody will then initialize your database.' => 'Bevor Sie bloggen können, müssen Sie einen Systemadministrator bestimmen. Melody wird daraufhin Ihre Datenbank einrichten.',
...
## tmpl/cms/cfg_system_feedback.tmpl
	...
	'Limit outbound TrackBacks and TrackBack auto-discovery for the purposes of keeping your installation private.' => 'Schränken Sie den Versand von TrackBacks und TrackBack Auto-Discovery auf bestimmte Sites ein, um diese Melody-Installation nichtöffentlich zu halten.',
...
## tmpl/cms/widget/new_user.tmpl
	'Welcome to Melody, the world\'s most powerful blogging, publishing and social media platform. To help you get started we have provided you with links to some of the more common tasks new users like to perform:' => 'Willkommen zu Melody, der leistungsfähigsten Blogging-, Publishing- und Social Media-Plattfom! Um Ihnen den Einstieg zu erleichtern, haben wir Ihnen einige Links zu den Funktionen zusammengestellt, die für neue Benutzer besonders interessant sind:',
...
## tmpl/cms/widget/mt_news.tmpl
	...
	'No Learning Melody news available.' => 'Es liegen keine Melody lernen-Nachrichten vor',
...
## tmpl/cms/widget/new_version.tmpl
	...
	'Congratulations, you have successfully installed Melody [_1]. Listed below is an overview of the new features found in this release.' => 'Herzlichen Glückwunsch, Sie haben Melody [_1] erfolgreich installiert! Die wichtigsten Neuerungen dieser Version:',
...
## tmpl/cms/widget/new_install.tmpl
	'Thank you for installing Melody' => 'Vielen Dank, daß Sie sich für Melody entschieden haben',
	'Congratulations on installing Melody, the world\'s most powerful blogging, publishing and social media platform. To help you get started we have provided you with links to some of the more common tasks new users like to perform:' => 'Herzlichen Glückwunsch zur Installation von Melody, der leistungsfähigsten Blogging-, Publizierungs- und Social Media-Plattfom. Um Ihnen den Einstieg zu erleichtern, haben wir Ihnen einige Links zu den Funktionen, die für neue Benutzer besonders interessant sind, zusammengestellt:',
...
## tmpl/cms/widget/blog_stats.tmpl
	...
	'Nov.' => 'November',
	'Dec.' => 'Dezember',
	'Melody was unable to locate your \'mt-static\' directory. Please configure the \'StaticFilePath\' configuration setting in your config.cgi file, and create a writable \'support\' directory underneath your \'mt-static\' directory.' => 'Melody konnte Ihr \'mt-static\'-Verzeichnis nicht finden. Bitte überprüfen Sie die \'StaticFilePath\'-Direktive in der Konfigurationsdatei config.cgi und legen Sie ein vom Webserver beschreibbares Verzeichnis \'support\' im \'mt-static\'-Verzeichnis an.',
	'Melody was unable to write to its \'support\' directory. Please create a directory at this location: [_1], and assign permissions that will allow the web server write access to it.' => 'Melody kann auf den Ordner \'support\' nicht schreibend zugreifen. Legen Sie hier: [_1] ein solches Verzeichnis an und stellen Sie sicher, daß der Webserver Schreibrechte für diesen Ordner besitzt.',
...
## tmpl/cms/system_check.tmpl
	...
	'Users who have logged in within 90 days are considered <strong>active</strong> in Melody license agreement.' => 'Benutzer, die sich innerhalb der letzten 90 Tage eingeloggt haben, gelten nach den Melody-Lizenzbedingungen als <strong>aktiv</strong>.',
	'Memcache Status' => 'Memcache-Status',
	'Server Model' => 'Server-Modell',
	'Melody could not find the script named \'check.cgi\'. To resolve this issue, please ensure that the check.cgi script exists and/or the CheckScript configuration parameter references it properly.' => 'Melody konnte die Datei \'check.cgi\' nicht finden. Stellen Sie sicher, daß die Datei vorhanden ist und MTCheckScript die richtigen Pfadangaben enthält.',

## tmpl/cms/restore.tmpl
	'Restore from a Backup' => 'System aus Sicherheitskopie wiederherstellen',
	'Perl module XML::SAX and/or its dependencies are missing - Melody can not restore the system without it.' => 'Das Per-Modul XML::SAX und/oder seine Abhängigkeiten fehlen. Ohne kann Melody das System nicht wiederherstellen.',
	'Backup file' => 'Sicherungsdatei',
	'If your backup file is located on your computer, you can upload it here.  Otherwise, Melody will automatically look in the \'import\' folder of your Melody directory.' => 'Wenn Sie eine auf Ihrem Computer gespeicherte Sicherungsdatei verwenden wollen, laden Sie diese hier hoch. Alternativ verwendet Melody automatisch die Sicherungsdatei, die es im \'import\'-Unterordner Ihres Melody-Verzeichnis findet.',
	'Check this and files backed up from newer versions can be restored to this system.  NOTE: Ignoring Schema Version can damage Melody permanently.' => 'Anwählen, um auch Dateien mit einer neueren Schemaversionen wiederherstellen zu können. HINWEIS: Nichtbeachtung der Schemaverion kann Ihre Melody-Installation dauerhaft beschädigen.',
...
## tmpl/cms/cfg_archives.tmpl
	...
	'The path where your index files will be published. An absolute path (starting with \'/\') is preferred, but you can also use a path relative to the Melody directory. Example: /home/melody/public_html/blog' => 'Der Pfad, in dem die Indexdateien abgelegt werden. Eine absolute (mit \'/\' beginnende) Pfadangabe wird bevorzugt, Sie können den Pfad aber auch relativ Sie zu Ihrem Melody-Verzeichnis angeben. Beispiel: /home/melanie/public_html/blog',
...
## tmpl/error.tmpl
	...
	'_ERROR_CONFIG_FILE' => 'Ihre Melody-Konfigurationsdatei fehlt, ist fehlerhaft oder kann nicht gelesen werden. Anweisungen zur Konfigurierung finden Sie im Abschnitt <a href="javascript:void(0)">Installation and Configuration</a> der Melody-Dokumentation.',
	'Database Connection Error' => 'Verbindung mit Datenbank fehlgeschlagen',
	'_ERROR_DATABASE_CONNECTION' => 'Die Datenbankeinstellungen in Ihrer Konfigurationsdatei fehlen oder sind fehlerhaft. Anweisungen zur Konfigurierung finden Sie im Abschnitt <a href="javascript:void(0)">Installation and Configuration</a> der Melody-Dokumentation.',
	'CGI Path Configuration Required' => 'CGI-Pfad muß eingestellt sein',
	'_ERROR_CGI_PATH' => 'Die CGIPath-Angabe in Ihrer Konfigurationsdatei fehlt oder ist fehlerhaft. Anweisungen zur Konfigurierung finden Sie im Abschnitt <a href="javascript:void(0)">Installation and Configuration</a> der Melody-Dokumentation.',
...
## addons/Community.pack/lib/MT/Community/CMS.pm
	...
	'Welcome to the Melody Community Solution' => 'Willkommen zur Melody Community Solution',
...
',
	...
	'John Doe' => 'Max Muster',
	'Great new site. I can\'t wait to try Melody. Congrats!' => 'Tolle neue Website, herzlichen Glückwunsch! Kann es kaum noch abwarten, Melody selbst auszuprobieren.',
...
Suchbasis: [_2]",
	...
	'[_1] directive must be set to synchronize members of LDAP groups to Melody Enterprise.' => '[_1]-Direktive muss gesetzt sein, um LDAP-Gruppenmitgliedschaften mit Melody Enterprise zu synchronisieren.',
...
## addons/Enterprise.pack/tmpl/list_group.tmpl
	...
	'You have successfully deleted the groups from the Melody system.' => 'Gruppen erfolgreich aus dem System gelöscht.',
...
## plugins/WXRImporter/WXRImporter.pl
	'Import WordPress exported RSS into MT.' => 'Aus WordPress exportiertes RSS in Melody importieren',
	'WordPress eXtended RSS (WXR)' => 'WordPress eXtended RSS (WXR)',
	'Download WP attachments via HTTP.' => 'WP-Anhänge per HTTP herunterladen',

## plugins/WXRImporter/tmpl/options.tmpl
	'Before you import WordPress posts to Melody, we recommend that you <a href=\'[_1]\'>configure your blog\'s publishing paths</a> first.' => 'Bevor Sie WordPress-Einträge in Melody importieren, sollten Sie zuerst die <a href=\'[_1]\'>Veröffentlichungspfade Ihres Weblogs einstellen</a>.',
...
## plugins/WidgetManager/WidgetManager.pl
	'Widget Manager version 1.1; This version of the plugin is to upgrade data from older version of Widget Manager that has been shipped with Melody to the Melody core schema.  No other features are included.  You can safely remove this plugin after installing/upgrading Melody.' => 'Widget Manager 1.1 - Diese Version des Plugins dient ausschließlich dazu, Daten älterer Versionen auf das Melody Core-Schema zu aktualisieren. Sie können diese Plugin daher nach Installation bzw. Aktualisierung von Melody gefahrlos löschen.',
...
## plugins/Motion/config.yaml
	'A Melody theme with structured entries and action streams.' => 'Ein Melody-Thema mit strukturierten Einträgen und Action Streams.',
...
## plugins/Motion/templates/Motion/widget_about_ssite.mtml
	'About' => 'Über',
	'The Motion Template Set is a great example of the type of site you can build with Melody.' => 'Die Motion-Vorlagengruppe ist ein tolles Beispiel für die große Bandbreite von Websites, die Sie mit Melody erstellen können.',
...
## plugins/mixiComment/mixiComment.pl
	'Allows commenters to sign in to Melody 4 using their own mixi username and password via OpenID.' => 'Ermöglicht es Kommentarautoren, sich per OpenID mit ihrem mixi-Benutzernamen und -Passwort bei Melody 4 anzumelden',
