...
## php/lib/function.mtwidgetmanager.php
	'Error: widgetset [_1] is empty.' => 'Ошибка: связка виджетов [_1] пустая.',
...
## php/lib/function.mtremotesigninlink.php
	'TypePad authentication is not enabled in this blog.  MTRemoteSignInLink can\'t be used.' => 'Авторизация через TypePad не включена в этом блоге. MTRemoteSignInLink не может быть использована',
...
## php/lib/thumbnail_lib.php
	'GD support has not been available. Please install GD support.' => 'Поддержка GD недоступна. Пожалуйста, установите её.',
...
## default_templates/commenter_notify.mtml
	'This email is to notify you that a new user has successfully registered on the blog \'[_1]\'. Listed below you will find some useful information about this new user.' => 'На вашем сайте «[_1]» зарегистрировался новый пользователь. Ниже представлена некоторая информация о нём:',
...
## default_templates/notify-entry.mtml
	'A new [lc,_3] entitled \'[_1]\' has been published to [_2].' => 'В блоге «[_2]» опубликована новая [lc,_3] «[_1]».',
...
## default_templates/new-ping.mtml
	'An unapproved TrackBack has been posted on your blog [_1], for entry #[_2] ([_3]). You need to approve this TrackBack before it will appear on your site.' => 'На блог «[_1]» прислан трекбэк, к записи #[_2] ([_3]). Чтобы он появился в вашем блоге, необходимо его одобрить.',
	'An unapproved TrackBack has been posted on your blog [_1], for category #[_2], ([_3]). You need to approve this TrackBack before it will appear on your site.' => 'На блог «[_1]» прислан трекбэк, к категории #[_2], ([_3]). Чтобы он появился в вашем блоге, его необходимо одобрить.',
	'A new TrackBack has been posted on your blog [_1], on entry #[_2] ([_3]).' => 'На блог «[_1]» прислан новый трекбэк, к записи #[_2] ([_3]).',
	'A new TrackBack has been posted on your blog [_1], on category #[_2] ([_3]).' => 'На блог «[_1]» прислан новый трекбэк, к категории #[_2] ([_3]).',
	'Excerpt' => 'Выдержка',
	'Title' => 'Заголовок',
	'Blog' => 'Блог',
	'IP address' => 'IP адрес',
...
## default_templates/new-comment.mtml
	'An unapproved comment has been posted on your blog [_1], for entry #[_2] ([_3]). You need to approve this comment before it will appear on your site.' => 'В блоге [_1] появился новый комментарий, оставленный к записи #[_2] ([_3]). Вам необходимо одобрить комментарий, прежде чем он появится в блоге.',
	'A new comment has been posted on your blog [_1], on entry #[_2] ([_3]).' => 'В блоге [_1] появился новый комментарий, оставленный к записи [_2] ([_3]). ',
...
## default_templates/syndication.mtml
	...
	'Subscribe to this blog\'s feed' => 'Подписаться на обновления этого блога',
...
## lib/MT/Template.pm
	...
	'Template with the same name already exists in this blog.' => 'Шаблон с таким именем уже существует в этом блоге.',
...
## lib/MT/App/Wizard.pm
	...
	'This module is needed to encode special characters, but this feature can be turned off using the NoHTMLEntities option in config.cgi.' => 'Модуль необходим для кодирования специальных символов. Но вы можете отключить эту возможность, используя опцию NoHTMLEntities в config.cgi.',
	...
	'This module is needed if you wish to use the MT XML-RPC server implementation.' => 'Модуль необходим, если вы хотите использовать MT XML-RPC (для работы с блогами через сторонние интерфейсы, например, через блогинг-редакторы).',
	...
	'This module and its dependencies are required in order to allow commenters to be authenticated by OpenID providers such as AOL and Yahoo! which require SSL support.' => 'Модуль необходим для авторизации комментаторов через OpenID с использованием протокола HTTPS (AOL, Yahoo).',
	...
	'This module and its dependencies are required in order to allow commenters to be authenticated by OpenID providers including Vox and LiveJournal.' => 'Это модуль и зависимости от него необходимы для авторизации комментаторов через OpenID, включая LiveJournal и Vox.',
	...
	'This module is required in search.cgi if you are running Melody on Perl older than Perl 5.8.' => 'Модуль необходим для search.cgi, если ваш Melody работает на Perl версии старше 5.8.',
...
## lib/MT/App/Upgrader.pm
	...
	'Failed to authenticate using given credentials: [_1].' => 'Ошибка авторизации с представленными данными: [_1].',
	'You failed to validate your password.' => 'Вы неправильно ввели проверочный пароль.',
	'You failed to supply a password.' => 'Вы не указали пароль.',
...
## lib/MT/App/CMS.pm
	...
	'[_1] posted on or before [_2]' => '[_1], добавленные не позднее [_2]',
	'All comments by [_1] \'[_2]\'' => 'Все комментарии от [_1] «[_2]»',
	'Commenter' => 'Комментатор',
	'All comments for [_1] \'[_2]\'' => 'Все комментарии к [_1] «[_2]»',
	'Comments posted between [_1] and [_2]' => 'Комментарии, добавленные между [_1] и [_2]',
	'Comments posted since [_1]' => 'Комментарии, добавленные с [_1]',
	'Comments posted on or before [_1]' => 'Комментарии, добавленные не позднее [_1]',
	...
	'TrackBacks on my entries' => 'Трекбэки к моим записям',
	'Published TrackBacks' => 'Опубликованные трекбэки',
	'Unpublished TrackBacks' => 'Неопубликованные трекбэки',
	'TrackBacks marked as Spam' => 'Трекбэки, помеченные как спам',
	'All TrackBacks in the last 7 days' => 'Все трекбэки за последние 7 дней',
	'Non-spam Comments' => 'Комментарии без спама',
	'Comments on my entries' => 'Комментарии к моим записям',
...
## lib/MT/App/Comments.pm
	...
	'Name and email address are required.' => 'Поля «Имя» и «Email» обязательны для заполнения.',
...
## lib/MT/App/Trackback.pm
	...
	'New TrackBack Ping to Entry [_1] ([_2])' => 'Новый трекбэк к записи «[_1]» ([_2])',
	'New TrackBack Ping to Category [_1] ([_2])' => 'Новый трекбэк к категории «[_1]» ([_2])',
...
## lib/MT/Template/Context.pm
	'The attribute exclude_blogs cannot take \'all\' for a value.' => 'Атрибут exclude_blogs не может иметь значение «all».',
	'You used an \'[_1]\' tag outside of the context of a author; perhaps you mistakenly placed it outside of an \'MTAuthors\' container?' => 'Вы использовали тег «[_1]» вне контекста (автор); возможно, вы поместили его вне контейнера «MTAuthors» ?',
	...
	'You used an \'[_1]\' tag outside of the context of a comment; perhaps you mistakenly placed it outside of an \'MTComments\' container?' => 'Вы использовали тег «[_1]» вне контекста (комментарий); возможно, вы поместили его вне контейнера «MTComments» ?',
	'You used an \'[_1]\' tag outside of the context of a ping; perhaps you mistakenly placed it outside of an \'MTPings\' container?' => 'Вы использовали тег «[_1]» вне контекста (пинг); возможно, вы поместили его вне контейнера «MTPings»?',
	'You used an \'[_1]\' tag outside of the context of an asset; perhaps you mistakenly placed it outside of an \'MTAssets\' container?' => 'Вы использовали тег «[_1]» вне контекста (медиа объекты); возможно, вы поместили его вне контейнера «MTAssets»?',
...
## lib/MT/Template/ContextHandlers.pm
	...
	'records' => 'записи',
	'Invalid tag [_1] specified.' => 'Тег [_1] указан неверно.',
	'No template to include specified' => 'Нет шаблонов для включения указанного',
	...
	'Can\'t find included template widget \'[_1]\'' => 'Не удалось найти включённый шаблон виджета «[_1]»',
...
## lib/MT/ArchiveType/AuthorMonthly.pm
	...
	'author/author-display-name/yyyy/mm/index.html' => 'автор/отображаемое-имя/гггг/мм/index.html',
	'author/author_display_name/yyyy/mm/index.html' => 'автор/отображаемое_имя/гггг/мм/index.html',
...
## lib/MT/ArchiveType/Author.pm
	'AUTHOR_ADV' => 'авторов',
	'author/author-display-name/index.html' => 'автор/отображаемое-имя/index.html',
	'author/author_display_name/index.html' => 'автор/отображаемое_имя/index.html',

## lib/MT/ArchiveType/AuthorYearly.pm
	'AUTHOR-YEARLY_ADV' => 'авторов по годам',
	'author/author-display-name/yyyy/index.html' => 'автор/отображаемое-имя/гггг/index.html',
	'author/author_display_name/yyyy/index.html' => 'автор/отображаемое_имя/гггг/index.html',
...
## lib/MT/ArchiveType/AuthorWeekly.pm
	...
	'author/author-display-name/yyyy/mm/day-week/index.html' => 'автор/отображаемое-имя/гггг/мм/день-недели/index.html',
	'author/author_display_name/yyyy/mm/day-week/index.html' => 'автор/отображаемое_имя/гггг/мм/день-недели/index.html',
...
## lib/MT/ArchiveType/AuthorDaily.pm
	...
	'author/author-display-name/yyyy/mm/dd/index.html' => 'автор/отображаемое-имя/гггг/мм/дд/index.html',
	'author/author_display_name/yyyy/mm/dd/index.html' => 'автор/отображаемое_имя/гггг/мм/дд/index.html',
...
## lib/MT/CMS/Entry.pm
	...
	'Invalid date \'[_1]\'; authored on dates must be in the format YYYY-MM-DD HH:MM:SS.' => 'Неправильная дата «[_1]»; формат даты должен быть следующим: ГГГГ-ММ-ДД ЧЧ:ММ:СС.',
	'Invalid date \'[_1]\'; authored on dates should be real dates.' => 'Неправильная дата «[_1]»; должны быть указаны реальные сроки.',
	...
	'<a href="[_1]">QuickPost to [_2]</a> - Drag this link to your browser\'s toolbar then click it when you are on a site you want to blog about.' => '<a href="[_1]">Опубликовать в блоге [_2]</a> — Перетащите эту ссылку на панель закладок браузера. Находясь на странице, о которой вы хотите написать, выделите текст и нажмите на эту ссылку — некоторые поля редактора заполнятся автоматически.',
...
## lib/MT/CMS/Asset.pm
	...
	'Before you can upload a file, you need to publish your blog.' => 'Прежде чем вы сможете загрузить файл, необходимо опубликовать блог.',
...
## lib/MT/CMS/Common.pm
	'Cloning blog \'[_1]\'...' => 'Клонирование блога «[_1]»…',
	'Error' => 'Ошибка',
	'Finished! You can <a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">return to the blog listing</a> or <a href="javascript:void(0);" onclick="closeDialog(\'[_2]\');">configure the Site root and URL of the new blog</a>.' => 'Готово! Вы можете <a href=\"javascript:void(0);\" onclick=\"closeDialog(\'[_1]\');\">вернуться к списку блогов</a> или <a href=\"javascript:void(0);\" onclick=\"closeDialog(\'[_2]\');\">настроить URL и путь публикации</a> нового блога.',
	'Close' => 'Закрыть',
	...
	'You need to specify a Site URL' => 'Необходимо указать URL сайта',
	'You need to specify a Site Path' => 'Необходимо указать путь сайта',
...
## lib/MT/CMS/Comment.pm
	...
	'Comments Activity Feed' => 'Фид с последними комментариями',
	'*User deleted*' => '*Пользователь удалён*',
...
## lib/MT/CMS/TrackBack.pm
	...
	'TrackBacks where <strong>[_1]</strong> is &quot;[_2]&quot;.' => 'Трекбэки, у которых <strong>[_1]</strong> — «[_2]».',
	'TrackBack Activity Feed' => 'Фид с последними трекбэками',
...
## lib/MT/CMS/Tools.pm
	...
	'Email Address is required for password recovery.' => 'Необходимо указать email, иначе вы не сможете восстановить пароль в случае его утери.',
	...
	'User does not have email address' => 'У пользователя нет email адреса',
...
## lib/MT/CMS/Dashboard.pm
	...
	'The template editing interface has been enhanced to make designers more efficient at updating their site\'s design. The default templates have also been dramatically simplified to make it easier for you to edit and create the site you want.' => 'Интерфейс редактора шаблонов был перепроектирован, чтобы работа дизайнеров была более эффективной. Кроме того, были упрощены стандартные шаблоны, чтобы вы с лёгкостью смогли отредактировать их и создать такой сайт, какой хотите.',
	'Threaded Comments' => 'Ветвистые комментарии',
	'Allow commenters on your blog to reply to each other increasing user engagement and creating more dynamic conversations.' => 'Теперь вы можете позволить вашим комментаторам отвечать на комментарии друг друга. Это не только создаёт более динамическую беседу, но и красиво выглядит.',
...
## lib/MT/CMS/User.pm
	...
	'User Associations' => 'Пользовательские ассоциации',
	'Role Users & Groups' => 'Роли пользователей и группы',
	'(Custom)' => '(Собственное)',
	...
	'Invalid ID given for personal blog clone source ID.' => 'Указан неправильный ID блога, с которого необходимо сделать клон.',
	'If personal blog is set, the default site URL and root are required.' => 'Если создание персональных блогов включено, то необходимо указать URL и путь публикации по умолчанию.',
	...
	'Email Address is required for password recovery' => 'Для восстановления пароля необходим email адрес',
...
## lib/MT/CMS/Import.pm
	...
	'You do not have import permissions' => 'У вас недостаточно прав для импорта',
...
## lib/MT/Upgrade.pm
	...
	'Editor' => 'Редактор',
	'Can upload files, edit all entries/categories/tags on a blog and publish the blog.' => 'Может загружать файлы, редактировать все записи, категории, теги блога, а также осуществлять публикацию блога.',
	'Can create entries, edit their own, upload files and publish.' => 'Может создавать записи, редактировать свои записи, загружать файлы, также осуществлять публикацию блога.',
	'Designer' => 'Дизайнер',
	'Can edit, manage and publish blog templates.' => 'Может управлять шаблонами блога: редактировать и публиковать их.',
	'Webmaster' => 'Вебмастер',
	'Can manage pages and publish blog templates.' => 'Может управлять страницами и публиковать шаблоны блога.',
	'Contributor' => 'Участник',
	'Can create entries, edit their own and comment.' => 'Может создавать записи, редактировать их и оставлять комментарии.',
	'Moderator' => 'Модератор',
	...
	'Comment Response' => 'Уведомление о добавленном комментарие',
...
## lib/MT/Core.pm
	...
	'Remove Expired Search Caches' => 'Удалить истёкший поисковый кэш',
...
## lib/MT/App.pm
	...
	'Error creating directory [_1] for blog #[_2].' => 'Не удалось создать директорию [_1] для блога #[_2].',
...
## lib/MT/Image.pm
	...
	'Converting to [_1] failed: [_2]' => 'Конвертация в [_1] не удалась: [_2]',
...
## lib/MT.pm.pre
	...
	'Sign in using your OpenID identity.' => 'Авторизации при помощи идентификатора OpenID.',
	'OpenID is an open and decentralized single sign-on identity system.' => 'OpenID — это открытая и децентрализованная система идентификации.',
	...
	'Missing configuration file. Maybe you forgot to move config.cgi-original to config.cgi?' => 'Файл конфигурации не найден. Возможно вы забыли переименовать config.cgi-original в  config.cgi?',
...
## mt-static/js/assetdetail.js
	...
	'View uploaded file' => 'Посмотреть загруженный файл',
...
## search_templates/default.tmpl
	...
	'Entries from [_1] tagged with \'[_2]\'' => 'Записи блога «[_1]», связанные с тегом «[_2]»',
	...
	'Entries matching \'[_1]\'' => 'Записи, в которых присутствует «[_1]»',
	'Entries tagged with \'[_1]\'' => 'Записи, связанные с тегом «[_1]»',
	'No pages were found containing \'[_1]\'.' => 'По запросу «[_1]» ничего не найдено.',
	...
	'If you use an RSS reader, you can subscribe to a feed of all future entries tagged \'[_1]\'.' => 'Вы можете подписаться на фид, в котором будут присутствовать новые сообщения этого блога, связанные с тегом «[_1]».',
	'If you use an RSS reader, you can subscribe to a feed of all future entries matching \'[_1]\'.' => 'Вы можете подписаться на фид, в котором будут присутствовать новые сообщения этого блога, соответствующие запросу «[_1]».',
	'SEARCH/TAG FEED SUBSCRIPTION INFORMATION' => 'ПОИСК/ТЕГ — ИНФОРМАЦИЯ О ПОДПИСКЕ',
	'Feed Subscription' => 'Подписка на обновления',
	'http://www.sixapart.com/about/feeds' => 'http://ru.wikipedia.org/wiki/RSS',
...
## tmpl/cms/edit_category.tmpl
	...
	'Your category changes have been made.' => 'Изменения в категории сохранены.',
	...
	'Unlock this category&rsquo;s output filename for editing' => 'Разблокировать эту категорию, чтобы можно было изменить имя генерируемого файла',
	'Warning: Changing this category\'s basename may break inbound links.' => 'Внимание: если вы измените базовое имя категории, то потеряете входящие ссылки на неё.',
...
## tmpl/cms/cfg_archives.tmpl
	...
	'The selected archive-template associations have been deleted.' => 'Выбранная ассоциация архив-шаблон удалена.',
	'Warning: one or more of your templates is set to publish dynamically using PHP, however your server side include method may not be compatible with dynamic publishing.' => 'Предупреждение: один или несколько ваших шаблонов настроены на динамическую публикацию с использованием PHP, но следует учесть, что включение на стороне сервера (SSI) не совместимы с динамической публикацией.',
	...
	'You must set Local Archive Path.' => 'Необходимо указать локальный путь архива.',
	...
	'Select this option only if you need to publish your archives outside of your Site Root.' => 'Выберите эту опцию только в том случае, если вы желаете публиковать архивы вне корневого каталога сайта.',
	'Publish archives outside of Site Root' => 'Публиковать архивы вне корневого каталога сайта',
	'Archive URL' => 'URL архива',
	'Enter the URL of the archives section of your website. Example: http://archives.example.com/' => 'Введите URL для архива вашего сайта. Например: http://archives.example.com/',
	'Unlock this blog&rsquo;s archive url for editing' => 'Разблокировать URL архива сайта для редактирования',
	...
	'Enter the path where your archive files will be published. Example: /home/melody/public_html/archives' => 'Введите путь для публикации архивов. Пример: /home/melody/public_html/archives',
	...
	'Asynchronous Job Queue' => 'Асинхронная задача очереди',
	'Use Publishing Queue' => 'Использовать очередь публикации (нужен CRON)',
	'Requires the use of a cron job to publish pages in the background.' => 'Публикация страниц в фоновом режиме требует использования cron (запланированных заданий).',
	'Use background publishing queue for publishing static pages for this blog' => 'Использовать очередь для фоновой публикации статических страниц блога',
	...
	'Enter the archive file extension. This can take the form of \'html\', \'shtml\', \'php\', etc. Note: Do not enter the leading period (\'.\').' => 'Введите расширение файлов архива. Например: html, shtml, php, и.т.д. Внимание: не вводите стартовую точку («.»).',
	'Preferred Archive' => 'Предпочтительный архив',
	'Used for creating links to an archived entry (permalink). Select from the archive types used in this blogs archive templates.' => 'Используется для создания ссылок на архивную запись (постоянная ссылка записи). Выберите один из типов архивов, используемых в шаблонах блога.',
	'No archives are active' => 'Нет активных архивов',
	'Module Options' => 'Опции модуля',
	'Enable template module caching' => 'Включить модуль кэширования шаблонов',
	'Server Side Includes' => 'Включении на стороне сервера (SSI)',
...
## tmpl/cms/cfg_comments.tmpl
	...
	'Comment authentication is not available because one of the needed modules, MIME::Base64 or LWP::UserAgent is not installed. Talk to your host about getting this module installed.' => 'Авторизация в комментариях не активна, так как отсутствует модуль MIME::Base64 или LWP::UserAgent. Свяжитесь с администратором сервера для установки модуля.',
	'Accept Comments' => 'Принимать комментарии',
	'If enabled, comments will be accepted.' => 'Если активно, комментарии будут приниматься.',
	...
	'If enabled, users will be able to enter a limited set of HTML in their comments. If not, all HTML will be stripped out.' => 'Если активно, автор комментария сможет использовать HTML-теги, разрешённые вами. В противном случае HTML не будет публиковаться.',
	'Limit HTML Tags' => 'Лимит HTML тегов',
	'Specifies the list of HTML tags allowed by default when cleaning an HTML string (a comment, for example).' => 'Укажите список разрешённых HTML тегов.',
	'Use defaults' => 'Использовать значения по умолчанию',
	'([_1])' => '([_1])',
	'Use my settings' => 'Использовать собственные параметры',
	'Apply \'nofollow\' to URLs' => 'Добавить «nofollow» и «noindex» к URL',
	'This preference affects both comments and TrackBacks.' => 'Эта опция затрагивает комментарии и трекбэки.',
	'If enabled, all URLs in comments and TrackBacks will be assigned a \'nofollow\' link relation.' => 'Если активно, то ко всем URL в комментариях и трекбэках будет добавлен атрибут «nofollow», а также они будут заключены в тег noindex.',
	...
	'Off' => 'Отключено',
	'Comment Display Options' => 'Опции отображения комментариев',
	'Comment Order' => 'Порядок комментариев',
	'Select whether you want visitor comments displayed in ascending (oldest at top) or descending (newest at top) order.' => 'Выберите, каким образом должны отображаться комментарии на сайте: по возрастания (наиболее ранние вверху) или по убыванию (последние вверху).',
	'Ascending' => 'По возрастанию',
	'Descending' => 'По убыванию',
	'Auto-Link URLs' => 'Автоматически создавать ссылку из URL',
	'If enabled, all non-linked URLs will be transformed into links to that URL.' => 'Если активно, то любой URL из текста комментария будет автоматически трансформирован в ссылку.',
	...
	'No CAPTCHA provider is available in this system.  Please check to see if Image::Magick is installed, and CaptchaSourceImageBase directive points to captcha-source directory under mt-static/images.' => 'В этой системе не доступен ни один CAPTCHA провайдер. Пожалуйста, удостоверьтесь, что установлен Image::Magick, и директива CaptchaSourceImageBase расположена в mt-static/images.',
...
## tmpl/cms/system_check.tmpl
	...
	'Melody could not find the script named \'check.cgi\'. To resolve this issue, please ensure that the check.cgi script exists and/or the CheckScript configuration parameter references it properly.' => 'Melody не может найти скрипт «check.cgi». Убедитесь, что скрипт check.cgi существует, а также, что параметр CheckScript настроен правильно.',

## tmpl/cms/cfg_system_feedback.tmpl
	'System: Feedback Settings' => 'Настройка обратной связи: системный уровень',
	'Your feedback preferences have been saved.' => 'Параметры обратной связи сохранены',
	'Feedback: Master Switch' => 'Обратная связь: глобальная настройка',
	'This will override all individual blog settings.' => 'Эта опция переопределит все индивидуальные параметры блогов.',
	'Disable comments for all blogs' => 'Запретить комментарии во всех блогах',
	'Disable TrackBacks for all blogs' => 'Запретить трекбэки во всех блогах',
	'Outbound Notifications' => 'Исходящие уведомления',
	'Notification pings' => 'Пинги',
	'This feature allows you to disable sending notification pings when a new entry is created.' => 'Эта опция позволяет отключить пингование при создании новой записи.',
	'Disable notification pings for all blogs' => 'Отключение пинги для всех блогов',
	'Limit outbound TrackBacks and TrackBack auto-discovery for the purposes of keeping your installation private.' => 'Ограничение исходящих трекбэков и автоматического поиска трекбэков на других сайтах.',
...
## tmpl/cms/edit_widget.tmpl
	...
	'Please use a unique name for this widget set.' => 'Пожалуйста, используйте уникальное имя для связки виджетов.',
	'Your template changes have been saved.' => 'Шаблон сохранён.',
	'Set Name' => 'Имя связки',
	'Drag and drop the widgets you want into the Installed column.' => 'Перетащите необходимые вам виджеты в колонку используемых виджетов.',
...
## tmpl/cms/preview_template_strip.tmpl
	...
	'Re-Edit this template (e)' => 'Повторное редактирование шаблона (e)',
...
## tmpl/cms/cfg_registration.tmpl
	...
	'Note: You have selected to accept comments from authenticated commenters only but authentication is not enabled. In order to receive authenticated comments, you must enable authentication.' => 'Внимание: вы разрешили комментарии только от авторизованных пользователей, но при этом авторизация отключена. Для получения авторизованных комментариев необходимо разрешить авторизацию.',
	'Native' => 'Встроенная',
	'Require E-mail Address for Comments via TypePad' => 'Требовать email для авторизовавшихся через TypePad',
	'If enabled, visitors must allow their TypePad account to share e-mail address when commenting.' => 'Если активно, то комментаторы должны разрешить в своём аккаунте TypePad передачу email адреса.',
	...
	'OpenID providers disabled' => 'Провайдеры OpenID отключены',
	'Required module (Digest::SHA1) for OpenID commenter authentication is missing.' => 'Модуль (Digest::SHA1), необходимый для авторизации через OpenID, не найден.',
...
## tmpl/cms/list_comment.tmpl
	...
	'No comments appeared to be spam.' => 'Нет спам-комментариев.',
	...
	'[_1] on entries created within the last [_2] days' => '[_1] к записям, созданных за последние [_2] дн.',
	'[_1] on entries created more than [_2] days ago' => '[_1] к записям, созданные более [_2] дн. назад',
...
## tmpl/cms/edit_asset.tmpl
	...
	'Your asset changes have been made.' => 'Изменения в медиа сделаны',
	'Stats' => 'Статистика',
	...
	'This asset has not been used.' => 'Этот объект ещё не был использован.',
	'Related Assets' => 'Похожее медиа',
	'No thumbnail image' => 'Нет миниатюры изображения',
	'You must specify a label for the asset.' => 'Необходимо указать имя для медиа',
...
## tmpl/cms/edit_author.tmpl
	...
	'Status of user in the system. Disabling a user removes their access to the system but preserves their content and history.' => 'Статус пользователя в системе. Если отключить пользователя, он потеряет доступ ко всем функциям системы, но вся его история и созданный им контент сохраняются.',
	...
	'The URL of the site associated with this user. eg. http://www.movabletype.com/' => 'Адрес сайта, связанный с этим пользователем. Например, http://movable-type.ru/',
	'Userpic' => 'Аватар',
	...
	'Language' => 'Язык',
	'Preferred language of this user.' => 'Язык пользователя.',
	'Text Format' => 'Форматирование текста',
	'Preferred text format option.' => 'Предпочтительное форматирование текста.',
	'(Use Blog Default)' => '(Использовать параметры блога)',
...
## tmpl/cms/edit_blog.tmpl
	...
	'You must set your Site URL.' => 'Необходимо указать URL сайта.',
	'Your Site URL is not valid.' => 'Указанный URL сайта неправильный.',
	'You can not have spaces in your Site URL.' => 'URL сайта не может содержать пробелов.',
	'You can not have spaces in your Local Site Path.' => 'Локальный путь сайта не может содержать пробелов.',
	'Your Local Site Path is not valid.' => 'Локальный путь сайта неправильный.',
...
## tmpl/cms/list_member.tmpl
	...
	'Add a user to this blog' => 'Добавить пользователя в блог',
	'Show only users where' => 'Показать пользователей, у которых',
	'role' => 'роль',
	'enabled' => 'активный',
...
## tmpl/cms/cfg_plugin.tmpl
	'System Plugin Settings' => 'Настройка плагинов: системный уровень',
	'http://plugins.movabletype.org/' => 'http://plugins.movabletype.org/',
	'Find Plugins' => 'Поиск плагинов',
	'Plugin System' => 'Системные плагины',
	'Manually enable or disable plugin-system functionality. Re-enabling plugin-system functionality, will return all plugins to their original state.' => 'Вы можете вручную включить или отключить плагины. Повторное включение плагинов вернёт их в то состояние, из которого они были отключены.',
	...
	'Your plugins have been reconfigured. Since you\'re running mod_perl, you will need to restart your web server for these changes to take effect.' => 'Конфигурация плагинов изменена. Так как вы используете mod_perl, необходимо перезапустить веб-сервер, чтобы изменения вступили в силу.',
	...
	'Are you sure you want to disable plugin functionality?' => 'Вы действительно хотите отключить функциональность плагина?',
	'Disable this plugin?' => 'Отключить этот плагин?',
	'Are you sure you want to enable plugin functionality? (This will re-enable any plugins that were not individually disabled.)' => 'Вы действительно хотите активировать плагины? (Это действие активирует все плагины, которые не были отключены индивидуально.)',
	'Enable this plugin?' => 'Активировать этот плагин?',
...
## tmpl/cms/list_template.tmpl
	...
	'Blog Publishing Settings' => 'Настройка публикации блога',
...
## tmpl/cms/restore_end.tmpl
	...
	'Make sure that you remove the files that you restored from the \'import\' folder, so that if/when you run the restore process again, those files will not be re-restored.' => 'Не забудьте удалить файлы, которые находятся в папке «import», иначе, если вы повторно запустите процесс восстановления, эти файлы буду повторно импортированы.',
...
## tmpl/cms/list_tag.tmpl
	...
	'Show all [_1] with this tag' => 'Показать все [_1] с этим тегом',
	...
	'An error occurred while testing for the new tag name.' => 'Произошла ошибка при тестировании с новым именем тега.',
...
## tmpl/cms/include/anonymous_comment.tmpl
	...
	'Require E-mail Address for Anonymous Comments' => 'Обязать анонимных комментаторов указывать e-mail',
...
## tmpl/cms/include/member_table.tmpl
	'Are you sure you want to remove the selected user from this blog?' => 'Вы уверены, что хотите удалить выбранного пользователя из этого блога?',
	'Are you sure you want to remove the [_1] selected users from this blog?' => 'Вы уверены, что хотите удалить [_1] выбранных пользователей из этого блога?',
...
## tmpl/cms/include/comment_table.tmpl
	...
	'Report selected comments as Not Spam and Publish (j)' => 'Пометить выбранные комментарии как не спам и опубликовать их (j)',
	'Not Spam' => 'Не спам',
	...
	'Delete all comments reported as Spam' => 'Удалить все комментарии, помеченные как спам',
	'Empty' => 'Очистить',
	'Entry/Page' => 'Запись/Страница',
	'Only show published comments' => 'Показать только опубликованные комментарии',
	'Published' => 'Опубликовано',
	'Only show pending comments' => 'Показать только ожидающие комментарии',
...
## tmpl/cms/include/ping_table.tmpl
	...
	'Report selected [_1] as Spam (j)' => 'Отметить выбранные [_1] как спам (j)',
	'Report selected [_1] as Not Spam and Publish (j)' => 'Отметить выбранные [_1] как не спам и опубликовать (j)',
	...
	'Deletes all [_1] reported as Spam' => 'Удаление всех [_1], отмеченных как спам',
	'From' => 'От',
	'Target' => 'К записи',
	'Only show published TrackBacks' => 'Показать только опубликованные трекбэки',
	'Only show pending TrackBacks' => 'Показать только неопубликованные трекбэки',
...
## tmpl/cms/include/import_start.tmpl
	...
	'Importing entries as user \'[_1]\'' => 'Импортирование записей как пользователем «[_1]»',
...
## tmpl/cms/include/commenter_table.tmpl
	...
	'Only show trusted commenters' => 'Показать только доверенных комментаторов',
	'Only show banned commenters' => 'Показать только заблокированных комментаторов',
	'Only show neutral commenters' => 'Показать только нейтральных комментаторов',
...
## tmpl/cms/include/asset_upload.tmpl
	'Before you can upload a file, you need to publish your blog. [_1]Configure your blog\'s publishing paths[_2] and rebuild your blog.' => 'Перед загрузкой файла необходимо опубликовать блог. [_1]Настройте пути для публикации[_2], а затем полностью опубликуйте блог.',
	'Your system or blog administrator needs to publish the blog before you can upload files. Please contact your system or blog administrator.' => 'Администратор системы или администратор блога должен выполнить публикацию блога перед загрузкой файла. Обратитесь к администратору.',
...
## tmpl/cms/include/overview-left-nav.tmpl
	...
	'Weblogs' => 'Блоги',
	'List Users and Groups' => 'Список пользователей и групп',
	'Users &amp; Groups' => 'Пользователи и группы',
	'List Associations and Roles' => 'Список ассоциаций и ролей',
	'Privileges' => 'Права',
	'List Plugins' => 'Список плагинов',
	'Aggregate' => 'Совокупно',
	'List Entries' => 'Список записей',
	'List uploaded files' => 'Список загруженных файлов',
	'List Tags' => 'Список тегов',
	'List Comments' => 'Список комментариев',
	'List TrackBacks' => 'Список трекбэков',
	'Configure' => 'Конфигурация',
	'Edit System Settings' => 'Изменить параметры системы',
	'Utilities' => 'Утилиты',
	'Search &amp; Replace' => 'Поиск и замена',
	'_SEARCH_SIDEBAR' => 'Поиск',
	'Show Activity Log' => 'Показать журнал активности',
...
## tmpl/cms/include/list_associations/page_title.tmpl
	...
	'Permissions: System-wide' => 'Права доступа: системный уровень',
...
## tmpl/cms/include/blog-left-nav.tmpl
	...
	'Edit Address Book' => 'Редактировать адресную книгу',
	'List Users &amp; Groups' => 'Список пользователей и групп',
	'List &amp; Edit Templates' => 'Список шаблонов и их редактирование',
	'Edit Categories' => 'Редактирование категорий',
	'Edit Tags' => 'Редактирование тегов',
	'Edit Weblog Configuration' => 'Изменить параметры блога',
	'Backup this weblog' => 'Бэкап этого блога',
	'Import &amp; Export Entries' => 'Импорт и экспорт записей',
	'Import / Export' => 'Импорт / Эскпорт',
	'Rebuild Site' => 'Опубликовать сайт',

## tmpl/cms/include/entry_table.tmpl
	'Save these entries (s)' => 'Сохранить записи (s)',
	'Republish selected entries (r)' => 'Опубликовать повторно (r)',
	'Delete selected entries (x)' => 'Удалить выбранные записи (x)',
	'Save these pages (s)' => 'Сохранить страницы (s)',
	'Republish selected pages (r)' => 'Опубликовать повторно (r)',
	...
	'Only show unpublished entries' => 'Показать только неопубликованные записи',
	'Only show unpublished pages' => 'Показать только неопубликованные страницы',
	'Only show published entries' => 'Показать только опубликованные записи',
	'Only show published pages' => 'Показать только опубликованные страницы',
	'Only show entries for review' => 'Показать только записи для проверки',
	'Only show pages for review' => 'Показать только страницы для проверки',
	'Only show scheduled entries' => 'Показать только запланированные записи',
	'Only show scheduled pages' => 'Показать только запланированные страницы',
	'Only show spam entries' => 'Показать только спам-записи',
	'Only show spam pages' => 'Показать только спам-страницы',
	'Edit Entry' => 'Редактирование записи',
	'Edit Page' => 'Редактирование страницы',
	'View entry' => 'Посмотреть запись →',
	'View page' => 'Посмотреть страницу',
	'No entries could be found. <a href="[_1]">Create an entry</a> now.' => 'Записей не найдено. <a href="[_1]">Создать новую</a>?',
	'No page could be found. <a href="[_1]">Create a page</a> now.' => 'Страницы не найдены. <a href="[_1]">Создать новую</a>?',
...
## tmpl/cms/dialog/asset_options_image.tmpl
	'Display image in entry' => 'Показать изображение в записи',
...
## tmpl/cms/dialog/refresh_templates.tmpl
	'Refresh Template Set' => 'Обновить связку шаблонов',
	'Refresh [_1] template set' => 'Обновить связку шаблонов «[_1]»',
	'Refresh global templates' => 'Восстановить глобальные шаблоны',
	...
	'Apply a new template set' => 'Применить новую связку шаблонов',
	'Deletes all existing templates and install the selected template set.' => 'Удаление всех существующих шаблонов и установка выбранной связки шаблонов.',
...
## tmpl/cms/dialog/adjust_sitepath.tmpl
	...
	'You can not have spaces in the URL.' => 'Пробелы в URL недопустимы.',
	'You can not have spaces in the path.' => 'Путь не должен содержать пробелов.',
...
## tmpl/cms/dialog/publishing_profile.tmpl
	...
	'This new publishing profile will update all of your templates.' => 'Этот новый профиль публикации обновит все ваши шаблоны.',
...
## tmpl/cms/dialog/entry_notify.tmpl
	...
	'Your blog\'s name, this entry\'s title and a link to view it will be sent in the notification.  Additionally, you can add a  message, include an excerpt of the entry and/or send the entire entry.' => 'В письмо будут включены: имя блога, заголовок и ссылка на полный текст записи. Вы также можете добавить дополнительное сообщение, включить текст выдержки или полный текст записи.',
	'Recipients' => 'Адресаты',
	'Enter email addresses on separate lines, or comma separated.' => 'Введите email адреса (по одному на строке или через запятую).',
	...
	'(Entry Body will be sent without any text formatting applied)' => '(Основной текст записи будет отправлен без форматирования)',
	'Send notification (s)' => 'Отправить уведомление (s)',
	'Send' => 'Отправить',

## tmpl/cms/dialog/asset_replace.tmpl
	'A file named \'[_1]\' already exists. Do you want to overwrite this file?' => 'Файл с именем «[_1]» уже существует. Хотите перезаписать файл?',
...
## tmpl/cms/cfg_entry.tmpl
	...
	'New Entry Defaults' => 'Предпочтения для новых записей',
	'Specifies the default Entry Status when creating a new entry.' => 'Определите статус новой записи по умолчанию.',
	...
	'ASCII equivalents (&quot;, \', ..., -, --)' => 'Эквиваленты ASCII (&quot;, \', ..., -, --)',
	...
	'Select the location of the entry editor&rsquo;s action bar.' => 'Выберите расположение панели задач в редакторе записей.',
...
## tmpl/cms/widget/blog_stats.tmpl
	...
	'Nov.' => '&#1053;&#1086;&#1103;.',
	'Dec.' => '&#1044;&#1077;&#1082;.',
	'Melody was unable to locate your \'mt-static\' directory. Please configure the \'StaticFilePath\' configuration setting in your config.cgi file, and create a writable \'support\' directory underneath your \'mt-static\' directory.' => 'Melody не удалось определить местонахождение вашего каталога «mt-static». Пожалуйста, проверьте параметр «StaticFilePath» в файле config.cgi. Также необходимо убедиться, чтобы каталог находящаяся в mt-static папка «support» была перезаписываема.',
...
## tmpl/cms/widget/blog_stats_recent_entries.tmpl
	...
	'View all entries tagged &ldquo;[_1]&rdquo;' => 'Посмотреть все записи, связанные с тегом «[_1]»',
...
## tmpl/cms/widget/this_is_you.tmpl
	...
	'You\'ve written <a href="[_1]">[quant,_2,entry,entries]</a> with <a href="[_3]">[quant,_4,comment,comments]</a>.' => 'Всего вами создано <a href="[_1]">[quant,_2,запись,записи,записей]</a>, которые <a href="[_3]">прокомментировали</a> <nobr>[quant,_4,раз,раза,раз]</nobr>.',
	'You\'ve written [quant,_1,entry,entries] with <a href="[_2]">[quant,_3,comment,comments]</a>.' => 'Всего вами создано [quant,_1,запись,записи,записей], которые <a href="[_2]">прокомментировали</a> <nobr>[quant,_3,раз,раза,раз]</nobr>.',
	'You\'ve written [quant,_1,entry,entries] with [quant,_2,comment,comments].' => 'Всего вами создано [quant,_2,запись,записи,записей], которые прокомментировали <nobr>[quant,_3,раз,раза,раз]</nobr>.',
	'You\'ve written <a href="[_1]">[quant,_2,entry,entries]</a>.' => 'Всего вами создано <a href="[_1]">[quant,_2,запись,записи,записей]</a>.',
	'You\'ve written [quant,_1,entry,entries].' => 'Всего вами создано [quant,_2,запись,записи,записей].',
...
## tmpl/cms/edit_template.tmpl
	...
	'Syntax Highlight On' => 'Включить подсветку синтаксиса',
	'Syntax Highlight Off' => 'Выключить подсветку синтаксиса',
	'Insert...' => 'Вставить…',
...
## tmpl/cms/cfg_system_users.tmpl
	'System: User Settings' => 'Параметры пользователей',
	'(No blog selected)' => '(Блог не выбран)',
	'Select blog' => 'Выбрать блог',
	'You must set a valid Default Site URL.' => 'Необходимо указать правильный URL для сайта по умолчанию.',
	...
	'Clear' => 'Очистить',
	'Note: System Email Address is not set. Emails will not be sent.' => 'Примечание: не указан системный email адрес, поэтому почта не будет отправлена.',
	'New User Defaults' => 'Параметры по умолчанию для новых пользователей',
	'Personal blog' => 'Персональный блог',
	'Check to have the system automatically create a new personal blog when a user is created in the system. The user will be granted a blog administrator role on the blog.' => 'Система автоматически создаёт новый блог, когда создаётся новый пользователь. Такому пользователю будет предоставлена роль администратора в этом блоге.',
	'Automatically create a new blog for each new user' => 'Автоматически создавать новый блог для каждого нового пользователя',
	'Personal blog clone source' => 'Блог, который будет клонирован',
	'Select a blog you wish to use as the source for new personal blogs. The new blog will be identical to the source except for the name, publishing paths and permissions.' => 'Выберите блог, который будет служить источником для новых блогов. Таким образом, новый блог будет идентичен источнику, за исключением названия, пути публикации и прав пользователей.',
	'Change blog' => 'Изменить блог',
	'Default Site URL' => 'URL по умолчанию',
	'Define the default site URL for new blogs. This URL will be appended with a unique identifier for the blog.' => 'Определите URL по умолчанию для новых блогов. Этот адрес будет использован как начало адреса для новых блогов.',
	'Default Site Root' => 'Путь публикации по умолчанию',
	'Define the default site root for new blogs. This path will be appended with a unique identifier for the blog.' => 'Укажите путь публикации по умолчанию для новых блогов. Новые блоги будут распологаться в подпапках этой директории.',
	'Default User Language' => 'Язык по умолчанию для пользователей',
	'Define the default language to apply to all new users.' => 'Укажите язык, который по умолчанию будет у всех новых пользователей.',
...
## tmpl/cms/edit_folder.tmpl
	...
	'Your folder changes have been made.' => 'Изменения папки сделаны.',
...
## tmpl/cms/cfg_trackbacks.tmpl
	...
	'Your TrackBack preferences have been saved.' => 'Параметры трекбэков сохранены.',
	...
	'If enabled, TrackBacks will be accepted from any source.' => 'Если активно, трекбэки будут приниматься от любого сайта.',
	...
	'Note: The above option is currently ignored since outbound pings are disabled system-wide.' => 'Примечание: в настоящее время эта опция игнорируется, так как исходящие пинги запрещены на системном уровне.',
	'Enable Internal TrackBack Auto-Discovery' => 'Для записей в этом блоге',

## tmpl/cms/list_category.tmpl
	'Your category changes and additions have been made.' => 'Изменения категории применены.',
	'You have successfully deleted the selected category.' => 'Выбранная категория удалена.',
	'categories' => 'Категории',
	'Delete selected category (x)' => 'Удалить выбранные категории (x)',
	'Create top level category' => 'Создать основную категорию',
	...
	'Move' => 'Переместить',
	'[quant,_1,TrackBack,TrackBacks]' => '[quant,_1,трекбэк,трекбэка,трекбэков]',
	'No categories could be found.' => 'Не найдено категорий.',

## tmpl/cms/cfg_web_services.tmpl
	'Web Services Settings' => 'Настройка веб-сервисов',
	'Six Apart Services' => 'Сервисы Six Apart',
	'Your TypePad token is used to access Six Apart services like its free Authentication service.' => 'TypePad-токен используется для доступа к службам Six Apart, например, к бесплатному сервису авторизации.',
...
## tmpl/cms/edit_role.tmpl
	...
	'[quant,_1,User,Users] with this role' => '[quant,_1,пользователь,пользователя,пользователей] с данной ролью',
...
## tmpl/cms/cfg_spam.tmpl
	...
	'Your spam preferences have been saved.' => 'Ваши защиты от спама сохранены.',
	'Auto-Delete Spam' => 'Автоматическое удаление спама',
	'If enabled, feedback reported as spam will be automatically erased after a number of days.' => 'Если эта опция активна, комментарии и трекбэки, определенные как спам, будет автоматически удаляться через указанное количество дней.',
...
## tmpl/cms/cfg_system_general.tmpl
	...
	'Test email was sent.' => 'Тестовое письмо отправлено',
	'System Email' => 'Системный email',
	'The email address used in the From: header of each email sent from the system.  The address is used in password recovery, commenter registration, comment, trackback notification and a few other minor events.' => 'Этот адрес будет использован в заголовке «От» в письмах, отправленных системой. Адрес также используется при восстановлении паролей, регистрации комментаторов, уведомлениях о комментариях, трекбэках и в некоторых других незначительных событиях.',
	'Debug Mode' => 'Режим отладки',
	'You can find an explanation of the various debug modes in the <a href="http://www.movabletype.org/documentation/developer/plugins/debug-mode.html">documentation</a>' => 'Вы можете найти описание различных режимов отладки в <a href="http://www.movabletype.org/documentation/developer/plugins/debug-mode.html">документации</a>.',
	'Performance Logging' => 'Журналирование производительности',
	'Turns on or off performance logging.' => 'Включить или выключить журналирование производительности.',
...
## tmpl/cms/list_folder.tmpl
	'Your folder changes and additions have been made.' => 'Изменения папки и дополнений выполнены.',
	'You have successfully deleted the selected folder.' => 'Выбранная папка успешно удалена.',
	'Delete selected folders (x)' => 'Удалить выбранную папку (x)',
...
## tmpl/cms/edit_commenter.tmpl
	...
	'View all comments with this URL address' => 'Посмотреть все комментарии с этим URL',
	'The trusted status of the commenter' => 'Статус доверенного у комментатора',
	'View all commenters' => 'Посмотреть всех комментаторов',

## tmpl/cms/preview_entry.tmpl
	'Preview [_1]' => 'Предпросмотр [_1]',
	'Re-Edit this [_1]' => 'Повторное редактирование [_1]',
	'Re-Edit this [_1] (e)' => 'Повторное редактирование [_1] (e)',
...
## tmpl/cms/list_association.tmpl
	'permission' => 'право',
	'permissions' => 'права',
	'Remove selected permissions (x)' => 'Удалить выбранные права',
	'Revoke Permission' => 'Отменить права',
	'[_1] <em>[_2]</em> is currently disabled.' => '[_1] <em>[_2]</em> в настоящее время отключен.',
	'Grant Permission' => 'Назначить права',
	'You can not create permissions for disabled users.' => 'Вы не можете назначить права для отключенных пользователей.',
	'Assign Role to User' => 'Назначить роль для пользователя',
	'Grant permission to a user' => 'Назначить права для пользователя',
	...
	'No permissions could be found.' => 'Права доступа не найдены.',

## tmpl/cms/list_asset.tmpl
	'You have successfully deleted the asset(s).' => 'Вы успешно удалили медиа.',
	'Show only assets where' => 'Показать медиа, у которых',
	'type' => 'тип',
...
## tmpl/cms/setup_initial_blog.tmpl
	'Create Your First Blog' => 'Создание вашего первого блога',
	'The blog name is required.' => 'Необходимо указать имя блога.',
...
## tmpl/cms/edit_ping.tmpl
	...
	'List &amp; Edit TrackBacks' => 'Список и редактирование трекбэков',
	'View Entry' => 'Посмотреть запись →',
...
## tmpl/cms/preview_strip.tmpl
	...
	'You are previewing the entry titled &ldquo;[_1]&rdquo;' => 'Вы просматриваете запись «[_1]»',
	'You are previewing the page titled &ldquo;[_1]&rdquo;' => 'Вы просматриваете страницу «[_1]»',
...
## tmpl/cms/edit_entry.tmpl
	...
	'<a href="[_2]">[quant,_1,trackback,trackbacks]</a>' => '<a href="[_2]">[quant,_1,трекбэк,трекбэка,трекбэков]</a>',
	...
	'Unlock this entry&rsquo;s output filename for editing' => 'Разблокировать имя файла для редактирования',
	...
	'Warning: Changing this entry\'s basename may break inbound links.' => 'Внимание: если вы измените имя файла, то потеряете входящие ссылки.',
	'close' => 'закрыть',
	'Accept' => 'Принять',
	...
	'No asset(s) associated with this [_1]' => 'Нет ассоциированного медиа', # проверить
	'The published order of these assets can be changed using [_1]template tag modifiers[_2].' => 'Порядок публикации этих медиа может быть изменён при помощи [_1]модификаторов тегов[_2].',
	...
	'Your entry screen preferences have been saved.' => 'Предпочтения страницы редактирования сохранены.',
	...
	'Fields' => 'Поля',
	'Metadata' => 'Метаданные',
	'Reset display options' => 'Сбросить параметры отображения',
...
## tmpl/wizard/optional.tmpl
	...
	'Mail address for test sending' => 'Адрес для отправки тестового письма',
...
## tmpl/wizard/cfg_dir.tmpl
	...
	'Your TempDir has been successfully configured. Click \'Continue\' below to continue configuration.' => 'Временный каталог сконфигурирован. Нажмите «Продолжить» для дальнейшей настройки.',
...
## tmpl/wizard/complete.tmpl
	...
	'Please use the configuration text below to create a file named \'config.cgi\' in the root directory of [_1] (the same directory in which index.cgi is found).' => 'Создайте файл «config.cgi», расположенный в корневой директории Melody [_1] (в этой директории находится скрипт index.cgi).',
	'The wizard was unable to save the [_1] configuration file.' => 'Помошнику не удалось создать файл конфигурации [_1].',
	'Confirm your [_1] home directory (the directory that contains index.cgi) is writable by your web server and then click \'Retry\'.' => 'Проверьте, является ли каталог [_1] (там находится index.cgi) доступным для записи и нажмите «Повторить».',
	...
	'To reconfigure the settings, click the \'Back\' button below.' => 'Чтобы изменить найстройки, нажмите на кнопку «Вернуться», или же нажмите «Продолжить».',
	'Show the config.cgi file generated by the wizard' => 'Показать файл config.cgi, сгенерированный помошником',
	'The config.cgi file has been created manually.' => 'Файл config.cgi был создан вручную.',
	'Retry' => 'Повторить',

## tmpl/wizard/start.tmpl
	'Configuration File Exists' => 'Найден файл конфигурации',
	'A configuration (config.cgi) file already exists, <a href="[_1]">sign in</a> to Melody.' => 'Файл конфигурации (config.cgi) уже существует, <a href="[_1]">авторизуйтесь</a> в Melody.',
...
## tmpl/wizard/configure.tmpl
	...
	'You must set your Database Name.' => 'Необходимо указать имя базы данных.',
	...
	'The name of your SQL database (this database must already exist).' => 'Имя SQL базы данных (она уже должна быть создана).',
	'The username to login to your SQL database.' => 'Имя пользователя для соединения с базой данных.',
	'The password to login to your SQL database.' => 'Пароль для соединения с базой данных.',
	'Show Advanced Configuration Options' => 'Показать дополнительные опции',
	'Database Port' => 'Порт сервера базы данных',
	'This can usually be left blank.' => 'Можно оставить пустым.',
	'Database Socket' => 'Сокет базы данных',
	'Publish Charset' => 'Кодировка публикации',
	'MS SQL Server driver must use either Shift_JIS or ISO-8859-1.  MS SQL Server driver does not support UTF-8 or any other character set.' => 'Драйвер сервера MS SQL должен использовать Shift_JIS или ISO-8859-1. Потому что MS SQL не поддерживает UTF-8 или другие кодировки.',
...
## plugins/TypePadAntiSpam/tmpl/system.tmpl
	'API Key' => 'API-ключ',
	'To enable this plugin, you\'ll need a free TypePad AntiSpam API key. You can <strong>get your free API key at [_1]antispam.typepad.com[_2]</strong>. Once you have your key, return to this page and enter it in the field below.' => 'Для включения этого плагина вам необходим бесплатный API-ключ для TypePad AntiSpam. Вы можете <strong>получить его на сайте [_1]antispam.typepad.com[_2]</strong>. Когда ключ будет у вас, вернитесь на эту страницу и укажите его в указанное ниже поле.',
...
## plugins/WXRImporter/WXRImporter.pl
	...
	'Download WP attachments via HTTP.' => 'Загрузить файлы WP через HTTP.',
...
## plugins/Markdown/SmartyPants.pl
	'Easily translates plain punctuation characters into \'smart\' typographic punctuation.' => 'Позволяет преобразовать обычный текст в текст с правильно оформленной пунктуацией (например: кавычки, тире, и т.д.).',
...
## plugins/MultiBlog/multiblog.pl
	...
	'Select to apply this trigger to all weblogs' => 'Нажмите, чтобы применить это условие ко всем блогам',
...
## plugins/MultiBlog/lib/MultiBlog.pm
	'The include_blogs, exclude_blogs, blog_ids and blog_id attributes cannot be used together.' => 'Атрибуты include_blogs, exclude_blogs, blog_ids не могут быть использованы вместе.',
	'The attribute exclude_blogs cannot take "all" for a value.' => 'Атрибубут exclude_blogs не может содержать значение «all».',
	'The value of the blog_id attribute must be a single blog ID.' => 'Значение атрибута blog_id должно содержать единственный ID блога.',
	'The value for the include_blogs/exclude_blogs attributes must be one or more blog IDs, separated by commas.' => 'Значения атрибутов include_blogs/exclude_blogs должны содержать один несколько ID блогов, разделённых запятыми.',
...
## plugins/MultiBlog/tmpl/blog_config.tmpl
	...
	'Enables use of the MTMultiBlog tag without include_blogs/exclude_blogs attributes. Comma-separated BlogIDs or \'all\' (include_blogs only) are acceptable values.' => 'Разрешить использование тега MTMultiBlog без атрибутов include_blogs/exclude_blogs. Правильные значения здесь — ID блогов, разделённые запятыми, или значение «all» (только для include_blogs).',
...
## plugins/StyleCatcher/lib/StyleCatcher/CMS.pm
	'Your mt-static directory could not be found. Please configure \'StaticFilePath\' to continue.' => 'Ваша директория mt-static не найдена. Пожалуйста, настройте StaticFilePath в config.cgi для продолжения.',
