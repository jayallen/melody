...
## default_templates/recover-password.mtml
	'A request has been made to change your password in Melody. To complete this process click on the link below to select a new password.' => 'Une requête a été faite pour changer votre mot de passe dans Melody. Pour terminer cliquez sur le lien ci-dessous pour choisir un nouveau mot de passe.',
...
## lib/MT/Upgrade.pm
	...
	'This role was generated by Melody upon upgrade.' => 'Ce rôle a été généré par Melody lors d\'une mise à jour.',
	...
	'I just finished installing Melody [_1]!' => 'Je viens d\'installer Melody [_1]!',
	'Welcome to my new blog powered by Melody. This is the first post on my blog and was created for me automatically when I finished the installation process. But that is ok, because I will soon be creating posts of my own!' => 'Bienvenue sur mon nouveau blog animé par Melody. Ceci est la première note de mon blog. Elle a été créée automatiquement lorsque j\'ai terminé mon installation. Mais je vais maintenant créer mes propres articles!',
	'Melody also created a comment for me as well so that I could see what a comment will look like on my blog once people start submitting comments on all the posts I will write.' => 'Melody a aussi créé un commentaire automatiquement pour me permettre de voir à quoi cela ressemblera lorsque mes lecteurs commenteront mes notes.',
...
## lib/MT/App/Comments.pm
	...
	'Invalid commenter login attempt from [_1] to blog [_2](ID: [_3]) which does not allow Melody native authentication.' => 'Tentative d\'identification échouée pour l\'auteur de commentaires [_1] sur le blog [_2](ID: [_3]) qui n\'autorise pas l\'authentification native de Melody.',
...
## lib/MT/App/Upgrader.pm
	...
	'No permissions. Please contact your administrator for upgrading Melody.' => 'Pas d\'autorisation. Contactez votre administrateur système Melody pour modifier vos privilèges.',
	'Melody has been upgraded to version [_1].' => 'Melody a été mis à jour à la version [_1].',
...
## lib/MT/App/Wizard.pm
	...
	'Sendmail' => 'Sendmail',
	'Test email from Melody Configuration Wizard' => 'Test email à partir de l\'Assistant de Configuration de Melody',
	'This is the test email sent by your new installation of Melody.' => 'Ceci est un email de test envoyé par votre nouvelle installation Melody.',
	'This module is needed to encode special characters, but this feature can be turned off using the NoHTMLEntities option in config.cgi.' => 'Ce module est nécessaire pour encoder les caractères spéciaux, mais cette option peut être désactivée en utilisant NoHTMLEntities dans config.cgi.',
	...
	'This module is required in search.cgi if you are running Melody on Perl older than Perl 5.8.' => 'Ce module est nécessaire pour search.cgi si vous utilisez Melody sur une version de Perl supérieur à 5.8.',
	...
	'CGI is required for all Melody application functionality.' => 'CGI est nécessaire pour toutes les fonctionnalités de l\'application Melody.',
...
## lib/MT/Util/Captcha.pm
	'Melody default CAPTCHA provider requires Image::Magick.' => 'Le fournisseur de CAPTCHA par défaut de Melody nécessite Image::Magick.',
...
## lib/MT/BackupRestore.pm
	...
	'Manifest file [_1] was not a valid Melody backup manifest file.' => 'Le fichier manifest [_1] n\'est pas un fichier manifest de sauvegarde Melody.',
...
## lib/MT/XMLRPCServer.pm
	...
	'Template methods are not implemented, due to differences between the Blogger API and the Melody API.' => 'Les méthodes de gabarit ne sont pas implémentées en raison d\'une différence entre l\'API Blogger et l\'API Melody.',
...
## lib/MT/CMS/Tools.pm
	...
	'Test email from Melody' => 'Tester l\'email depuis Melody', # Translate - New
	'This is the test email sent by your installation of Melody.' => 'Ceci est l\'email envoyé par votre installation de Melody', # Translate - New
	...
	'Successfully restored objects to Melody system by user \'[_1]\'' => 'Restauration avec succès des objets dans Melody par utilisateur \'[_1]\'',
	...
	'Uploaded file was not a valid Melody backup manifest file.' => 'Le fichier envoyé n\'était pas un fichier de sauvegarde manifest Melody valide.',
	...
	'Melody system was successfully backed up by user \'[_1]\'' => 'Melody a été sauvegardé avec succès par l\'utilisateur \'[_1]\'',
...
## lib/MT/App.pm
	...
	'Our apologies, but you do not have permission to access any blogs within this installation. If you feel you have reached this message in error, please contact your Melody system administrator.' => 'Désolé, mais vous n\'avez pas l\'authorisation d\'accéder aux blogs de cette installation. Si vous pensez qu\'il s\'agit d\'une erreur, merci de contacter votre administrateur Melody.',
...
## lib/MT/BackupRestore/BackupFileHandler.pm
	'Uploaded file was backed up from Melody but the different schema version ([_1]) from the one in this system ([_2]).  It is not safe to restore the file to this version of Melody.' => 'Le fichier téléchargé a été sauvegardé depuis Melody mais la version du schéma ([_1]) est différente de celle du système ([_2]). Il n\'est pas conseillé de restaurer le fichier vers cette version de Melody.',
	'[_1] is not a subject to be restored by Melody.' => '[_1] n\'est pas un sujet qui peut être restauré par Melody.',
...
## lib/MT.pm.pre
	...
	'Sign in to Melody with your[_1] Account[_2]' => 'Identifiez-vous dans Melody avec votre compte [_1] [_2]',
	...
	'Missing configuration file. Maybe you forgot to move config.cgi-original to config.cgi?' => 'Fichier de configuration manquant. Avez-vous oublié de déplacer config.cgi-original vers config.cgi?',
...
## tmpl/wizard/optional.tmpl
	...
	'Check your email to confirm receipt of a test email from Melody and then proceed to the next step.' => 'Vérifiez votre adresse email pour confirmer la réception d\'un email de test de Melody et ensuite passez à l\'étape suivante.',
	'Back' => 'Retour',
	'Continue' => 'Continuer',
	'Show current mail settings' => 'Montrer les paramètres d\'email actuels',
	'Periodically Melody will send email to inform users of new comments as well as other other events. For these emails to be sent properly, you must instruct Melody how to send email.' => 'Melody va envoyer périodiquement des emails afin d\'informer les utilisateurs des nouveaux commentaires et autres événements. Pour que ces emails puissent être envoyés correctement, veuillez spécifier la méthode que Melody va utiliser.',
...
## tmpl/wizard/complete.tmpl
	...
	'Please use the configuration text below to create a file named \'config.cgi\' in the root directory of [_1] (the same directory in which index.cgi is found).' => 'Créez un fichier nommé dans le répertoire racine de [_1] (le même qui contient index.cgi) ayant pour contenu le texte de configuration ci-dessous.',
	...
	'Confirm your [_1] home directory (the directory that contains index.cgi) is writable by your web server and then click \'Retry\'.' => 'Vérifiez que votre répertoire [_1] (celui qui contient index.cgi) est ouvert en écriture pour votre serveur web et cliquez sur Recommencer',
	...
	'Show the config.cgi file generated by the wizard' => 'Afficher le fichier config.cgi généré par l\'assistant',
	'The config.cgi file has been created manually.' => 'Le fichier config.cgi a été créé manuellement.',
	'Retry' => 'Recommencer',
...
## tmpl/wizard/start.tmpl
	...
	'A configuration (config.cgi) file already exists, <a href="[_1]">sign in</a> to Melody.' => 'Un fichier de configuration (config.cgi) existe déjà, <a href="[_1]">identifiez-vous</a> dans Melody.',
	...
	'Melody requires that you enable JavaScript in your browser. Please enable it and refresh this page to proceed.' => 'Pour utiliser Melody, vous devez activer les JavaScript sur votre navigateur. Merci de les activer et de relancer le navigateur pour commencer.',
	'This wizard will help you configure the basic settings needed to run Melody.' => 'Vous allez maintenant, grâce à cet assistant de configuration, mettre en place les paramètres de base afin d\'assurer le fonctionnement de Melody.',
	...
	'Melody ships with directory named [_1] which contains a number of important files such as images, javascript files and stylesheets.' => 'Melody est fourni avec un répertoire nommé [_1] contenant un nombre important de fichiers comme des images, fichiers javascripts et feuilles de style.',
	'The [_1] directory is in the main Melody directory which this wizard script resides, but due to your web server\'s configuration, the [_1] directory is not accessible in this location and must be moved to a web-accessible location (e.g., your web document root directory).' => 'Le répertoire [_1] est le répertoire principal de Melody contenant les scripts de cet assistant, mais à cause de la configuration de votre serveur web, le répertoire [_1] n\'est pas accessible à cette adresse et doit être déplacé vers un serveur web (par exemple, le répertoire document à la racine). ',
	'This directory has either been renamed or moved to a location outside of the Melody directory.' => 'Ce répertoire a été renommé ou déplacé en dehors du répertoire Melody.',
...
## tmpl/wizard/packages.tmpl
	...
	'The following Perl modules are required in order to make a database connection.  Melody requires a database in order to store your blog\'s data.  Please install one of the packages listed here in order to proceed.  When you are ready, click the \'Retry\' button.' => 'Les modules Perl suivants sont nécessaires pour réaliser une connexion à une base de données.  Melody nécessite une base de données pour stocker les données de votre blog.  Merci d\'installer un des packages listés ici avant de continuer.  quand vous êtes prêt, cliquez sur le bouton \'Réessayer\'.',
	'All required Perl modules were found.' => 'Tous les modules Perl obligatoires ont été trouvés.',
	'You are ready to proceed with the installation of Melody.' => 'Vous êtes prêt à procéder à l\'installation de Melody.',
	...
	'One or more Perl modules required by Melody could not be found.' => 'Un ou plusieurs modules Perl nécessaires pour Melody n\'ont pu être trouvés.',
	'The following Perl modules are required for Melody to run properly. Once you have met these requirements, click the \'Retry\' button to re-test for these packages.' => 'Les modules Perl suivants sont nécessaires au bon fonctionnement de Melody. Dès que vous disposez de ces éléments, cliquez sur le bouton \'Recommencer\' pour vérifier ces éléments..',
...
## tmpl/wizard/configure.tmpl
	...
	'Is your preferred database not listed? View the <a href="[_1]" target="_blank">Melody System Check</a> see if additional modules are necessary.' => 'Votre base de données préférée n\'est pas listée ? Regardez <a href="[_1]" target="_blank">Melody System Check</a> pour voir s\'il y a des modules additionnels nécessaires pour permettre son utilisation.',
	...
	'A default location of \'./db/mt.db\' will store the database file underneath your Melody directory.' => 'Un endroit par défaut \'./db/mt.db\' stockera le fichier de base de données dans votre répertoire Melody.',
...
## tmpl/cms/cfg_plugin.tmpl
	...
	'This plugin has not been upgraded to support Melody [_1]. As such, it may not be 100% functional. Furthermore, it will require an upgrade once you have upgraded to the next Melody major release (when available).' => 'Ce plugin n\'a pas été mis à jour pour supporter Melody [_1]. Ainsi, il n\'est peut-être pas fonctionnel à 100%. De plus, il nécessitera une mise à jour dès que vous aurez mis à jour Melody à la prochaine version majeure (quand elle sera disponible).',
...
## tmpl/cms/login.tmpl
	'Your Melody session has ended.' => 'Votre session Melody a été fermée.',
	'Your Melody session has ended. If you wish to sign in again, you can do so below.' => 'Votre session Melody est terminée. Si vous souhaitez vous identifier à nouveau, vous pouvez le faire ci-dessous.',
	'Your Melody session has ended. Please sign in again to continue this action.' => 'Votre session Melody est terminée. Merci de vous identifier à nouveau pour continuer cette action.',
	'Forgot your password?' => 'Vous avez oublié votre mot de passe ?',
	'Sign In (s)' => 'Connexion (s)',

## tmpl/cms/list_blog.tmpl
	'You have successfully deleted the blogs from the Melody system.' => 'Le blog a été correctement supprimé du système Melody.',
...
## tmpl/cms/dashboard.tmpl
	...
	'Image::Magick is either not present on your server or incorrectly configured. Due to that, you will not be able to use Melody\'s userpics feature. If you wish to use that feature, please install Image::Magick or use an alternative image driver.' => 'Image::Magick n\'est pas présent sur votre serveur ou est mal configué. À cause de cela, vous ne pouvez pas utiliser les avatars dans Melody. Si vous souhaitez utiliser cette fonctionnalité, veuillez installer Image::Magick ou utiliser un pilote d\'image alternatif.',
...
## tmpl/cms/cfg_trackbacks.tmpl
	...
	'Specify when Melody should notify you of new TrackBacks if at all.' => 'Spécifier quand Melody doit vous notifier les nouveaux trackbacks.',
	'On' => 'Activée',
...
## tmpl/cms/cfg_comments.tmpl
	...
	'Specify when Melody should notify you of new comments if at all.' => 'Spécifier quand Melody doit vous notifier les nouveaux commentaires.',
...
## tmpl/cms/cfg_system_users.tmpl
	...
	'Allow commenters to register to Melody' => 'Autoriser les auteurs de commentaires à s\'enregistrer dans Melody',
...
## tmpl/cms/edit_entry.tmpl
	...
	'Use <a href="http://blogit.typepad.com/">Blog It</a> to post to Melody from social networks like Facebook.' => 'Utiliser <a href="http://blogit.typepad.com/">Blog It</a> pour publier sur Melody depuis des réseaux sociaux comme Facebook.',
...
## tmpl/cms/include/footer.tmpl
	'This is a beta version of Melody and is not recommended for production use.' => 'Ceci est une version beta de Melody et n\'est pas recommandé pour une utilisation en production.',
...
## tmpl/cms/import.tmpl
	...
	'Transfer weblog entries into Melody from other Melody installations or even other blogging tools or export your entries to create a backup or copy.' => 'Transférer les notes dans Melody depuis une autre installation Melody ou à partir d\'un autre outil de publication de blogs afin de créer une sauvegarde ou une copie.',
...
## tmpl/cms/upgrade.tmpl
	...
	'While Melody may run, it is an <strong>untested and unsupported environment</strong>.  We strongly recommend upgrading to at least Perl [_1].' => 'Même si Melody semble fonctionner normalement, l\'application s\'exécute <strong>dans un environnement non testé et non supporté</strong>.  Nous vous recommandons fortement d\'installer une version de Perl supérieure ou égale à [_1].',
	...
	'A new version of Melody has been installed.  We\'ll need to complete a few tasks to update your database.' => 'Une nouvelle version de Melody a été installée. Nous avons besoin de faire quelques manipulations complémentaires pour mettre à jour votre base de données.',
	...
	'In addition, the following Melody components require upgrading or installation:' => 'De plus, les composants suivants de Melody nécessitent une mise à jour ou une installation :',
	'The following Melody components require upgrading or installation:' => 'Les composants suivants de Melody nécessitent une mise à jour ou une installation :',
	'Begin Upgrade' => 'Commencer la mise à jour',
	'Congratulations, you have successfully upgraded to Melody [_1].' => 'Félicitations, vous avez mis à jour Melody à la version [_1].',
	'Return to Melody' => 'Retourner à Melody',
	'Your Melody installation is already up to date.' => 'Vous disposez de la dernière version de Melody.',
...
## tmpl/cms/list_author.tmpl
	...
	'You have successfully deleted the user(s) from the Melody system.' => 'Vous avez supprimé avec succès les utilisateurs dans le système.',
	'The deleted user(s) still exist in the external directory. As such, they will still be able to login to Melody Enterprise.' => 'Les utilisateurs effacés existent encore dans le répertoire externe. En conséquence ils pourront encore s\'identifier dans Melody Entreprise',
	...
	'_NO_SUPERUSER_DISABLE' => 'Puisque vous êtes administrateur du système Melody, vous ne pouvez vous désactiver vous-même.',
...
## tmpl/cms/cfg_registration.tmpl
	...
	'Allow registration for Melody.' => 'Autoriser les enregistrements pour Melody.',
...
## tmpl/cms/cfg_web_services.tmpl
	...
	'When this blog is updated, Melody will automatically notify the selected sites.' => 'Quand ce blog est mis à jour, Melody notifiera automatiquement les sites suivants.',
...
## tmpl/cms/install.tmpl
	...
	'Before you can begin blogging, you must create an administrator account for your system. When you are done, Melody will then initialize your database.' => 'Avant de pouvoir commencer à bloguer, vous devez créer un compte administrateur pour votre système. Une fois cela fait, Melody initialisera ensuite votre base de données.',
...
## tmpl/cms/widget/new_user.tmpl
	'Welcome to Melody, the world\'s most powerful blogging, publishing and social media platform. To help you get started we have provided you with links to some of the more common tasks new users like to perform:' => 'Bienvenue dans Melody, la plateforme de blogs, de publication et de média social la plus puissante au monde. Afin de vous aider à démarrer avec Melody, nous vous proposons quelques liens vers les tâches les plus courantes que les nouveaux utilisateurs souhaitent réaliser :',
	'Write your first post' => 'Écrivez votre première note',
	'What would a blog be without content? Start your Melody experience by creating your very first post.' => 'Que serait un blog sans contenu ? Débutez votre expérience Melody en créant votre toute première note.',
	...
	'Explore what\'s new in Melody' => 'Découvrez ce qui est nouveau dans Melody',
	'Whether you\'re new to Melody or using it for the first time, learn more about what this tool can do for you.' => 'Que vous découvriez Melody ou que vous l\'utilisiez pour la première fois, découvrez ce que cet outil peut faire pour vous.',
...
## tmpl/cms/widget/mt_news.tmpl
	...
	'Pronet' => 'Pronet',
	'No Melody news available.' => 'Aucune actualité Melody n\'est disponible.',
	'No Learning Melody news available.' => 'Pas d\'actualité Apprendre Melody disponible.',
...
## tmpl/cms/widget/new_version.tmpl
	...
	'Congratulations, you have successfully installed Melody [_1]. Listed below is an overview of the new features found in this release.' => 'Félicitations, vous avez installé Melody [_1] avec succès. Voici, entre autres, une vue d\'ensemble des nouveautés apportées par cette nouvelle version.',
...
## tmpl/cms/widget/blog_stats.tmpl
	...
	'Nov.' => 'Nov.',
	'Dec.' => 'Déc.',
	'Melody was unable to locate your \'mt-static\' directory. Please configure the \'StaticFilePath\' configuration setting in your config.cgi file, and create a writable \'support\' directory underneath your \'mt-static\' directory.' => 'Melody n\'a pas pu localiser votre répertoire \'mt-static\'. Merci de configurer la variable de configuration \'StaticFilePath\' dans votre fichier config.cgi, et créez un répertoire \'support\' accessible en écriture dans le répertoire \'mt-static\'.',
	'Melody was unable to write to its \'support\' directory. Please create a directory at this location: [_1], and assign permissions that will allow the web server write access to it.' => 'Melody n\'a pas pu écrire dans son répertoire \'support\'. Merci de créer un répertoire à cet endroit : [_1], et de lui ajouter des droits qui permettent au serveur web d\'écrire dedans.',
...
## tmpl/cms/system_check.tmpl
	...
	'Users who have logged in within 90 days are considered <strong>active</strong> in Melody license agreement.' => 'Les utilisateurs qui se sont connectés dans les 90 derniers jours sont considérés comme <strong>actifs</strong> dans les accords de licence Melody',
	'Memcache Status' => 'Statut Memcache',
	'Server Model' => 'Modèle du serveur',
	'Melody could not find the script named \'check.cgi\'. To resolve this issue, please ensure that the check.cgi script exists and/or the CheckScript configuration parameter references it properly.' => 'Melody n\'a pu trouver le script nommé \'check.cgi\'. Pour résoudre ce problème, assurez-vous que le script check.cgi script existe et/ou que la configuration des paramètres de MTCheckScript le référence convenablement.',

## tmpl/cms/restore.tmpl
	'Restore from a Backup' => 'Restaurer à partir d\'une sauvegarde',
	'Perl module XML::SAX and/or its dependencies are missing - Melody can not restore the system without it.' => 'Le module Perl XML::SAX et/ou ses dépendances sont manquantes - Melody ne peut restaurer le système sans lui.',
	'Backup file' => 'Fichier de sauvegarde',
	'If your backup file is located on your computer, you can upload it here.  Otherwise, Melody will automatically look in the \'import\' folder of your Melody directory.' => 'Si votre fichier de sauvegarde est situé sur votre ordinateur, vous pouvez l\'envoyer ici.  Autrement, Melody cherchera automatiquement dans le répertoire \'import\' de votre répertoire Melody.',
	'Check this and files backed up from newer versions can be restored to this system.  NOTE: Ignoring Schema Version can damage Melody permanently.' => 'Cochez ceci et les fichiers sauvegardés à partir d\'une version plus récente pourront être restaurés dans ce système. NOTE : Ignorer la version du schéma peut endommager Melody de manière permanente.',
...
## tmpl/cms/cfg_archives.tmpl
	...
	'The path where your index files will be published. An absolute path (starting with \'/\') is preferred, but you can also use a path relative to the Melody directory. Example: /home/melody/public_html/blog' => 'Il s\'agit du chemin où vos fichiers d\'index seront publiés. Un chemin absolu (commençant par \'/\') est préférable, mais vous pouvez utiliser un chemin relatif au répertoire de Melody. Exemple : /home/melody/public_html/blog',
...
## tmpl/error.tmpl
	...
	'_ERROR_CGI_PATH' => 'Votre configuration de chemin CGI est invalide ou absente de vos fichiers de configuration Melody. Merci de consulter la base de connaissance',
...
## addons/Community.pack/lib/MT/Community/CMS.pm
	...
	'Following' => 'Suit',
	'Followers' => 'Suiveurs',
	'Welcome to the Melody Community Solution' => 'Bienvenue dans Melody Community Solution',
...
',
	'New design launched using Melody' => 'Nouveau design lancé en utilisant Melody',
...
',
	...
	'John Doe' => 'John Doe',
	'Great new site. I can\'t wait to try Melody. Congrats!' => 'Super nouveau site. Je suis impatient d\'essayer Melody. Félicitations !',
...
Base de recherche : [_2]",
	...
	'[_1] directive must be set to synchronize members of LDAP groups to Melody Enterprise.' => 'La directive [_1] doit être configurée pour synchroniser les membres des groupes LDAP avec Melody Enterprise.',
...
## addons/Enterprise.pack/tmpl/list_group.tmpl
	...
	'You have successfully deleted the groups from the Melody system.' => 'Vous avez supprimé les groupes du système Melody avec succès.',
...
## plugins/WXRImporter/tmpl/options.tmpl
	'Before you import WordPress posts to Melody, we recommend that you <a href=\'[_1]\'>configure your blog\'s publishing paths</a> first.' => 'Avant d\'importer des notes Wordpress dans Melody, nous vous recommandons d\'abord de <a href=\'[_1]\'>configurer les chemins de publication de votre blog</a>.',
...
## plugins/WidgetManager/WidgetManager.pl
	'Widget Manager version 1.1; This version of the plugin is to upgrade data from older version of Widget Manager that has been shipped with Melody to the Melody core schema.  No other features are included.  You can safely remove this plugin after installing/upgrading Melody.' => 'Widget Manager version 1.1; Cette version est destinée à la mise à jour des données des versions plus anciennes de Widget Manager, délivré avec Melody. Aucune autre fonction n\'est incluse. Vous pouvez supprimer ce plugin après avoir installé/mis à jour Melody.',
...
## plugins/Motion/config.yaml
	'A Melody theme with structured entries and action streams.' => 'Un thème Melody avec des notes structurées et des flux d\'actions.',
...
## plugins/Motion/templates/Motion/widget_about_ssite.mtml
	'About' => 'A propos de',
	'The Motion Template Set is a great example of the type of site you can build with Melody.' => 'Le jeu de gabarits Motion est un bel exemple du type de site que vous pouvez concevoir avec Melody.',
...
## plugins/mixiComment/mixiComment.pl
	'Allows commenters to sign in to Melody 4 using their own mixi username and password via OpenID.' => 'Permet aux auteurs de commentaires de s\'identifier sur Melody en utilisant leur nom d\'utilisateur mixi via OpenID.',
