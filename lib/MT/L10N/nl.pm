...
## php/lib/function.mtwidgetmanager.php
    ...
    'Error compiling widgetset [_1]' =>
      'Fout bij het compileren van widgetset [_1]',
...
## php/lib/thumbnail_lib.php
    'GD support has not been available. Please install GD support.' =>
      'GD ondersteuning niet beschikbaar.  Gelieve GD ondersteuning te installeren.',
...
## default_templates/comments.mtml
    ...
    'The data is modified by the paginate script' =>
      'De gegevens werden gewijzigd door het paginatie-script'
    ,    # Translate - New
...
## default_templates/notify-entry.mtml
    'A new [lc,_3] entitled \'[_1]\' has been published to [_2].' =>
      'Een [lc,_3] getiteld \'[_1]\' is gepubliceerd op [_2].',
...
## default_templates/comment_response.mtml
    ...
    'Your comment has been received and held for approval by the blog owner.'
      => 'Uw reactie is ontvangen en zal worden opgeslagen tot de eigenaar van deze weblog goedkeuring geeft voor publicatie.',
...
## default_templates/commenter_notify.mtml
    'This email is to notify you that a new user has successfully registered on the blog \'[_1]\'. Listed below you will find some useful information about this new user.'
      => 'Deze e-mail dient om u te melden dat een nieuwe gebruiker zich met succes registreerde op blog \'[_1]\'.  Hieronder leest u nuttige informatie over deze gebruiker.',
...
## default_templates/verify-subscribe.mtml
    'Thanks for subscribing to notifications about updates to [_1]. Follow the link below to confirm your subscription:'
      => 'Bedankt om u in te schrijven voor notificaties over updates van [_1].  Volg onderstaande link om uw inschrijving te bevestigen:',
...
## default_templates/new-ping.mtml
    'An unapproved TrackBack has been posted on your blog [_1], for entry #[_2] ([_3]). You need to approve this TrackBack before it will appear on your site.'
      => 'Er is een niet-gekeurde TrackBack binnengekomen op uw blog [_1], op bericht #[_2] ([_3]).  U moet deze TrackBack goedkeuren voor hij op uw site zal verschijnen.',
    'An unapproved TrackBack has been posted on your blog [_1], for category #[_2], ([_3]). You need to approve this TrackBack before it will appear on your site.'
      => 'Er is een niet-gekeurde TrackBack binnengekomen op uw blog [_1], op categorie #[_2] ([_3]).  U moet deze TrackBack goedkeuren voor hij op uw site zal verschijnen.',
    'A new TrackBack has been posted on your blog [_1], on entry #[_2] ([_3]).'
      => 'Een nieuw TrackBack is gepubliceerd op uw blog [_1], op bericht #[_2] ([_3]).',
    'A new TrackBack has been posted on your blog [_1], on category #[_2] ([_3]).'
      => 'Een nieuw TrackBack is gepubliceerd op uw blog [_1], op categorie #[_2] ([_3]).',
    'Excerpt'                  => 'Uittreksel',
    'Title'                    => 'Titel',
    'Blog'                     => 'Blog',
    'IP address'               => 'IP adres',
...
## default_templates/syndication.mtml
    ...
    'Subscribe to this blog\'s feed' =>
      'Inschrijven op de feed van deze weblog',
...
## default_templates/banner_footer.mtml
    '_POWERED_BY' =>
      'Aangedreven  door<br /><a href=\"http://www.sixapart.com/movabletype/\"><$MTProductName$></a>',
...
## default_templates/technorati_search.mtml
    ...
    '<a href=\'http://www.technorati.com/\'>Technorati</a> search' =>
      'Zoek op <a href=\'http://www.technorati.com/\'>Technorati</a>',
...
## default_templates/comment_throttle.mtml
    'If this was a mistake, you can unblock the IP address and allow the visitor to add it again by logging in to your Melody installation, going to Blog Config - IP Banning, and deleting the IP address [_1] from the list of banned addresses.'
      => 'Indien dit een vergissing was, kunt hu het IP adres deblokkeren en de bezoeker toestaan om het opnieuw toe te voegen door u aan te melden op uw Melody installatie, dan naar Blog Config te gaan en het IP adres [_1] te verwijderen uit de lijst van verbannen adressen.',
    ...
    'This has been done to prevent a malicious script from overwhelming your weblog with comments. The banned IP address is'
      => 'Dit wordt gedaan om te voorkomen dat kwaadwillige scripts uw weblog met reacties overstelpen. Het uitgesloten IP-adres is',
...
## default_templates/new-comment.mtml
    'An unapproved comment has been posted on your blog [_1], for entry #[_2] ([_3]). You need to approve this comment before it will appear on your site.'
      => 'Een niet gekeurde reactie is binnengekomen op uw weblog [_1], op bericht #[_2] ([_3]). U moet deze reactie eerst goedkeuren voor ze op uw site verschijnt.',
    'A new comment has been posted on your blog [_1], on entry #[_2] ([_3]).'
      => 'Een nieuwe reactie is gepubliceerd op uw blog [_1], op bericht #[_2] ([_3]).',
...
## default_templates/recover-password.mtml
    'A request has been made to change your password in Melody. To complete this process click on the link below to select a new password.'
      => 'Er is een verzoek ingediend om uw wachtwoord aan te passen in Melody.  Gelieve dit te bevestigen door op onderstaande link te klikken om een nieuw wachtwoord te kiezen.',
...
## default_templates/commenter_confirm.mtml
    ...
    'For your own security and to prevent fraud, we ask that you please confirm your account and email address before continuing. Once confirmed you will immediately be allowed to comment on [_1].'
      => 'Voor uw eigen veiligheid en om fraude te vermijden vragen we dat u deze account eerst bevestigt samen met uw e-mail adres.  Eens bevestigd kunt u meteen reageren op [_1].',
    ...
    'If you did not make this request, or you don\'t want to register for an account to comment on [_1], then no further action is required.'
      => 'Als u deze account niet heeft aangevraagd, of als u niet de bedoeling had te registreren om te kunnen reageren op [_1] dan hoeft u verder niets te doen.',
...
## lib/MT/Import.pm
    ...
    'Couldn\'t resolve import format [_1]' =>
      'Kon importformaat niet onderscheiden [_1]',
    'Melody'                         => 'Melody',
    'Another system (Melody format)' => 'Een ander systeem (Melody formaat)',
...
## lib/MT/TaskMgr.pm
    'Unable to secure lock for executing system tasks. Make sure your TempDir location ([_1]) is writable.'
      => 'Aanmaken van een lockfile mislukt om systeemtaken uit te kunnen voeren. Kijk naof uw TempDir locatie ([_1]) beschrijfbaar is.',
...
## lib/MT/Image.pm
    ...
    'Converting to [_1] failed: [_2]' =>
      'Converteren naar [_1] mislukt: [_2]',
...
## lib/MT/Template/Context.pm
    'The attribute exclude_blogs cannot take \'all\' for a value.' =>
      'Het attribuut exclude_blogs kan niet \'all\' hebben als waarde.',
    'You used an \'[_1]\' tag outside of the context of a author; perhaps you mistakenly placed it outside of an \'MTAuthors\' container?'
      => 'U gebruikten een \'[_1]\' tag buiten de context van een auteur; misschien plaatste u de tag per ongeluk buiten een \'MTAuthors\' container?',
    'You used an \'[_1]\' tag outside of the context of an entry; perhaps you mistakenly placed it outside of an \'MTEntries\' container?'
      => 'U gebruikte een \'[_1]\' tag buiten de context van een bericht; misschien plaatste u die tag per ongeluk buiten een \'MTEntries\' container?',
    'You used an \'[_1]\' tag outside of the context of a comment; perhaps you mistakenly placed it outside of an \'MTComments\' container?'
      => 'U gebruikte een \'[_1]\' tag buiten de context van een reactie; misschien plaatste u die tag per ongeluik buiten een \'MTComments\' container?',
    'You used an \'[_1]\' tag outside of the context of a ping; perhaps you mistakenly placed it outside of an \'MTPings\' container?'
      => 'U gebruikte een \'[_1]\' tag buiten de context van een ping;  mogelijk plaatste u die per ongeluk buiten een \'MTPings\' container?',
    'You used an \'[_1]\' tag outside of the context of an asset; perhaps you mistakenly placed it outside of an \'MTAssets\' container?'
      => 'U gebruikte een \'[_1]\' tag buiten de context van een mediabestand; misschien plaatste u dit per ongeluk buiten een \'MTAssets\' container?',
    'You used an \'[_1]\' tag outside of the context of a page; perhaps you mistakenly placed it outside of a \'MTPages\' container?'
      => 'U gebruikte een \'[_1]\' tag buiten de context van een pagina; misschien plaatste u dit per ongeluk buiten een \'MTPages\' container?',
...
## lib/MT/Template/ContextHandlers.pm
    ...
    'The \'[_2]\' attribute will only accept an integer: [_1]' =>
      'Het \'[_2]\' attribuut accepteert enkel een integer: [_1]'
    ,    # Translate - New
    ...
    'The MTCommentFields tag is no longer available; please include the [_1] template module instead.'
      => 'De MTCommentFields tag is niet meer beschikbaar; gelieve de [_1] sjabloonmodule te includeren ter vervanging.',
    ...
    'Can\'t find included template widget \'[_1]\'' =>
      'Kan geïncludeerd sjabloonwidget \'[_1]\' niet vinden',
...
## lib/MT/Upgrade.pm
    ...
    'This role was generated by Melody upon upgrade.' =>
      'Deze rol werd aangemaakt door Melody tijdens de upgrade.',
    ...
    'Welcome to my new blog powered by Melody. This is the first post on my blog and was created for me automatically when I finished the installation process. But that is ok, because I will soon be creating posts of my own!'
      => 'Welkom op mijn nieuwe weblog aangedreven door Melody.  Dit is het eerste bericht op mijn blog dat automatisch voor mij werd aangemaakt op het einde van het installatieproces.  Maar dat geeft niet, want binnenkort zal ik mijn eigen berichten beginnen schrijven!',
    'Melody also created a comment for me as well so that I could see what a comment will look like on my blog once people start submitting comments on all the posts I will write.'
      => 'Melody maakte ook al een reactie aan voor me zodat ik kan zien hoe een reactie er zal uitzien op mijn weblog zodra mensen beginnen te reageren op de berichten die ik zal schrijven.',
    ...
    'Can upload files, edit all entries/categories/tags on a blog and publish the blog.'
      => 'Kan bestanden opladen, alle berichten/categorieën/tags op een blog bewerken en de blog publiceren.',
    'Can create entries, edit their own, upload files and publish.' =>
      'Kan berichten aanmaken, eigen berichten bewerken, bestanden opladen en publiceren.',
    'Designer' => 'Designer',
    'Can edit, manage and publish blog templates.' =>
      'Kan blogsjablonen bewerken, beheren en opnieuw opbouwen.',
    'Webmaster' => 'Webmaster',
    'Can manage pages and publish blog templates.' =>
      'Kan pagina\'s beheren en blogsjablonen opnieuw opbouwen.',
    ...
    'Setting your permissions to administrator.' =>
      'Bezig uw permissies als administrator in te stellen.',
...
## lib/MT/Core.pm
    ...
    'Rich Text'            => 'Rich text',
    'Melody Default'       => 'Melody standaardinstelling',
    ...
    'Refreshes object summaries.' =>
      'Ververst samenvattingen van objecten.',    # Translate - New
    'Adds Summarize workers to queue.' =>
      'Voegt samenvattingswerkers toe aan de wachtrij.',    # Translate - New
    'zip'                       => 'zip',
    'tar.gz'                    => 'tar.gz',
    ...
    'Add Summary Watcher to queue' =>
      'Voeg samenvattingswaakhond toe aan de wachtrij',    # Translate - New
    'Junk Folder Expiration' => 'Vervaldatum spam-map',
    'Remove Temporary Files' => 'Tijdelijke bestanden verwijderen',
    'Remove Expired User Sessions' =>
      'Verlopen gebruikerssessies verwijderen',
    'Remove Expired Search Caches' =>
      'Verlopen zoekopdrachtencache verwijderen',
...
## lib/MT/App/Comments.pm
    ...
    'Invalid commenter login attempt from [_1] to blog [_2](ID: [_3]) which does not allow Melody native authentication.'
      => 'Ongeldige aanmeldpoging van een reageerder [_1] op blog [_2](ID: [_3]) waar geenMelody native authenticatie is toegelaten.',
    ...
    'Melody Account Confirmation' => 'Melody accountbevestiging',
    ...
    'Name and email address are required.' =>
      'Naam en e-mail adres zijn verplicht.',
...
## lib/MT/App/Search.pm
    ...
    'Search: failed storing results in cache.  [_1] is not available: [_2]' =>
      'Zoeken: opslaan resultaten in cache mislukt.  [_1] is niet beschikbar [_2]',
    ...
    'No alternate template is specified for the Template \'[_1]\'' =>
      'Er is geen alternatief sjabloon opgegeven voor sjabloon \'[_1]\'',
...
## lib/MT/App/Trackback.pm
    ...
    'You are pinging trackbacks too quickly. Please try again later.' =>
      'U bent te snel TrackBacks aan het pingen. Probeer het later opnieuw.',
    ...
    'New TrackBack Ping to Entry [_1] ([_2])' =>
      'Nieuwe TrackBack ping naar bericht [_1] ([_2])',
    'New TrackBack Ping to Category [_1] ([_2])' =>
      'Nieuwe TrackBack ping naar categorie [_1] ([_2])',

## lib/MT/App/Upgrader.pm
    'Failed to authenticate using given credentials: [_1].' =>
      'Authenticatie met de opgegeven aanmeldgegevens mislukt: [_1].',
    'You failed to validate your password.' =>
      'Het valideren van uw wachtwoord is mislukt.',
...
## lib/MT/App/Search/Legacy.pm
    'You are currently performing a search. Please wait until your search is completed.'
      => 'U bent momenteel al een zoekactie aan het uitvoeren.  Gelieve te wachten tot uw zoekopdracht voltooid is.',
    ...
    'Publishing results failed: [_1]' =>
      'Publicatie van resultaten mislukt: [_1]',
...
## lib/MT/App/Wizard.pm
    ...
    'An error occurred while attempting to connect to the database.  Check the settings and try again.'
      => 'Er deed zich een fout voor bij het verbinen met de database.  Controleer de instellingen en probeer opnieuw.',
    'SMTP Server' => 'SMTP server',
    'Sendmail'    => 'Sendmail',
    'Test email from Melody Configuration Wizard' =>
      'Test e-mail van de Melody Configuratiewizard',
    'This is the test email sent by your new installation of Melody.' =>
      'Dit is de test e-mail verstuurd door uw nieuwe installatie van Melody.',
    'This module is needed to encode special characters, but this feature can be turned off using the NoHTMLEntities option in config.cgi.'
      => 'Deze module is vereist als u speciale karacters wenst te encoderen, maar deze optie kan worden uitgeschakeld door de NoHTMLEntities optie te gebruiken in config.cgi',
    'This module is needed if you wish to use the TrackBack system, the weblogs.com ping, or the MT Recently Updated ping.'
      => 'Deze module is vereist als u het TrackBack systeem, de ping naar weblogs.com of de MT Recent Bijgewerkt ping wenst te gebruiken.',
    ...
    'This module is needed if you wish to use the MT XML-RPC server implementation.'
      => 'Deze module is vereist als u de MT XML-RPC serverimplementatie wenst te gebruiken.',
    ...
    'This module is needed to enable comment registration.' =>
      'Deze module is vereist om registraties bij reacties mogelijk te maken.',
    ...
    'This module and its dependencies are required in order to allow commenters to be authenticated by OpenID providers including Vox and LiveJournal.'
      => 'Deze module en de modules waar ze van afhangt zijn nodig om reageerders zichzelf te laten authenticeren via OpenID providers zoals o.a. Vox en LiveJournal.',
    'This module is required for sending mail via SMTP Server.' =>
      'Deze module is vereist om mail te versturen via een SMTP server.',
    'This module is used in test attribute of MTIf conditional tag.' =>
      'Deze module wordt gebruikt in een testattribuut van de MTIf conditionele tag.',
    ...
    'This module is required in search.cgi if you are running Melody on Perl older than Perl 5.8.'
      => 'Deze module wordt vereist door search.cgi als u Melody draait op een Perl versie ouder dan 5.8',
    'This module required for action streams.' =>
      'Deze module is vereist voor action streams.',    # Translate - New
    ...
    'CGI is required for all Melody application functionality.' =>
      'CGI is vereist voor alle functionaliteit van Melody.',
    'File::Spec is required for path manipulation across operating systems.'
      => 'File::Spec is vereist om paden te kunnen manipuleren op verschillende operating systemen.',
...
## lib/MT/App/CMS.pm
    ...
    '[_1] with comments in the last 7 days' =>
      '[_1] met reacties in de laatste 7 dagen',
    '[_1] posted between [_2] and [_3]' =>
      '[_1] gepubliceerd tussen [_2] en [_3]',
    ...
    'All TrackBacks in the last 7 days' =>
      'Alle TrackBacks in de afgelopen 7 dagen',
...
## lib/MT/App/ActivityFeeds.pm
    ...
    'Melody System Activity' => 'Melody systeemactiviteit',
    'Melody Debug Activity'  => 'Melody debugactiviteit',
...
## lib/MT/Author.pm
    'The approval could not be committed: [_1]' =>
      'De goedkeuring kon niet worden weggeschreven: [_1]',
...
## lib/MT/Util/Captcha.pm
    'Melody default CAPTCHA provider requires Image::Magick.' =>
      'Standaard CAPTCHA provider van Melody vereist Image::Magick.',
...
## lib/MT/BackupRestore.pm
    ...
    'Manifest file [_1] was not a valid Melody backup manifest file.' =>
      'Manifest-bestand [_1] was geen geldig Melody backup manifest-bestand.',
    'Manifest file: [_1]' => 'Manifestbestand: [_1]',
    'Path was not found for the file ([_1]).' =>
      'Geen pad gevonden voor het bestadn ([_1]).',
...
## lib/MT/DefaultTemplates.pm
    ...
    'Comment Listing (Dynamic)' =>
      'Lijst reacties (dynamisch)',    # Translate - New
    'Improved listing of comments.' =>
      'Verbeterde lijst met reacties',    # Translate - New
    ...
    'Displays errors for dynamically published templates.' =>
      'Toont fouten bij dynamisch gepubliceerde sjablonen.',
...
## lib/MT/XMLRPCServer.pm
    ...
    'Not privileged to set entry categories' =>
      'Geen rechten om berichtcategorieën in te stellen',
    'Not privileged to upload files' =>
      'Geen rechten om bestenden te uploaden',
    ...
    'Template methods are not implemented, due to differences between the Blogger API and the Melody API.'
      => 'Sjabloonmethodes zijn niet geïmplementeerd wegens het verschil tussen de Blogger API en de Melody API.',
...
## lib/MT/Template.pm
    ...
    'Template with the same name already exists in this blog.' =>
      'Er bestaat al een sjabloon met dezelfde naam in deze weblog.',
...
## lib/MT/Auth/TypeKey.pm
    ...
    'This weblog requires commenters to pass an email address. If you\'d like to do so you may log in again, and give the authentication service permission to pass your email address.'
      => 'Deze weblog vereist dat reageerders een e-mail adres opgeven.  Als u dat wenst kunt u zich opnieuw aanmelden en de authenticatiedienst toestemming verlenen om uw e-mail adres door te geven.',
    'Couldn\'t save the session' => 'Kon de sessie niet opslaan',
    'Couldn\'t get public key from url provided' =>
      'Kon geen publieke sleutel vinden via de opgegeven url',
    ...
    'TypePad signature verif\'n returned [_1] in [_2] seconds verifying [_3] with [_4]'
      => 'TypePad signatuur verificatie retourneerde [_1] in [_2] seconden bij het verifiëren van [_3] met [_4]',
    'The TypePad signature is out of date ([_1] seconds old). Ensure that your server\'s clock is correct'
      => 'De TypePad signatuur is vervallen ([_1] seconden oud).  Kijk na of de klok van uw server juist staat.',
...
## lib/MT/Mail.pm
    ...
    'Sending mail via SMTP requires that your server have Mail::Sendmail installed: [_1]'
      => 'Het versturen van e-mail via SMTP vereist dat op uw server Mail::Sendmail is geïnstalleerd: [_1]',
...
## lib/MT/CMS/Tag.pm
    ...
    'New name of the tag must be specified.' =>
      'Nieuwe naam van de tag moet opgegeven worden',
...
## lib/MT/CMS/Template.pm
    ...
    'You should not be able to enter 0 as the time.' =>
      'Het ingeven van 0 als tijdstip zou noet mogelijk moeten zijn.',
    ...
    'Cannot publish a global template.' =>
      'Kan geen globaal sjabloon publiceren.',    # Translate - New
...
## lib/MT/CMS/Category.pm
    ...
    'The category basename \'[_1]\' conflicts with another category. Top-level categories and sub-categories with the same parent must have unique basenames.'
      => 'Categoriebasisnaam \'[_1]\' conflicteert met een andere categoriewith another category. Hoofdcategorieën en subcategorieën met dezelfde ouder moeten een unieke basisnaam hebben.',
...
## lib/MT/CMS/User.pm
    ...
    'Invalid ID given for personal blog clone source ID.' =>
      'Ongeldig ID opgegeven als kloonbron voor een persoonlijke weblog.',
    'If personal blog is set, the default site URL and root are required.' =>
      'Als persoonlijke weblog is ingesteld, dan zijn de standaard URL en hoofdmap van de site vereist.',
    ...
    'Email Address is required for password recovery' =>
      'E-mail adres is vereist voor het terugvinden van een wachtwoord',
...
## lib/MT/CMS/Asset.pm
    ...
    'Before you can upload a file, you need to publish your blog.' =>
      'Voor u een bestand kunt opladen, moet u eerst uw weblog publiceren.',
    ...
    'File with name \'[_1]\' already exists. (Install File::Temp if you\'d like to be able to overwrite existing uploaded files.)'
      => 'Bestand met de naam \'[_1]\' bestaat al. (Installeer File::Temp als u bestaande bestanden wenst te kunnen overschrijven.)',
    'Error creating temporary file; please check your TempDir setting in your coniguration file (currently \'[_1]\') this location should be writable.'
      => 'Fout bij het aanmaken van een tijdelijk bestand; controleer de TempDir instelling in uw configuratiebestand (momenteel \'[_1]\'), deze locatie zou beschrijfbaar moeten zijn door de webserver.',
    'unassigned' => 'niet toegewezen',
    'File with name \'[_1]\' already exists; Tried to write to tempfile, but open failed: [_2]'
      => 'Bestand met de naam \'[_1]\' bestaat al; Poging tot schrijven naar tijdelijk bestand ondernomen, openen mislukt: [_2]',
...
## lib/MT/CMS/Blog.pm
    ...
    'Error: Melody cannot write to the template cache directory. Please check the permissions for the directory called <code>[_1]</code> underneath your blog directory.'
      => 'Fout: Melody kan niet schrijven in de sjablooncache map. Gelieve de permissies na te kijken van de map met de naam <code>[_1]</code> onder de map van uw weblog.',
    'Error: Melody was not able to create a directory to cache your dynamic templates. You should create a directory called <code>[_1]</code> underneath your blog directory.'
      => 'Fout: Melody kon geen map maken om uw dynamische sjablonen in te cachen. U moet een map aanmaken met de naam <code>[_1]</code> onder de map van uw weblog.',

## lib/MT/CMS/TrackBack.pm
    'Junk TrackBacks' => 'TrackBacks als spam markeren',
    'TrackBacks where <strong>[_1]</strong> is &quot;[_2]&quot;.' =>
      'TrackBacks waar <strong>[_1]</strong> gelijk is aan &quot;[_2]&quot;.',
...
## lib/MT/CMS/Dashboard.pm
    ...
    'Melody has undergone a significant overhaul in all aspects of performance. Memory utilization has been reduced, publishing times have been increased significantly and search is now 100x faster!'
      => 'Melody heeft een grondige revisie ondergaan van alle aspecten die met performantie te maken hebben.  Het geheugengebruik is gereduceerd, publicatietijden zijn verkort en zoeken gaat nu 100 keer sneller!',
    ...
    'Template module and widget content can now be cached in the database to dramatically speed up publishing.'
      => 'De inhoud van sjabloonmodules en widgets kan nu in de database gecached worden om publicatie te versnellen.',
    'Improved Template and Design Management' =>
      'Vereenvoudigd beheer van sjablonen en design',
    'The template editing interface has been enhanced to make designers more efficient at updating their site\'s design. The default templates have also been dramatically simplified to make it easier for you to edit and create the site you want.'
      => 'De interface om sjablonen mee te beheren is verbeterd om designers efficiënter te maken bij het bijwerken van het design van een site.  De standaardsjablonen zijn ook dramatisch vereenvoudigd om het makkelijker te maken om ze te bewerken om zo de site te bekomen die u wenst.',
    ...
    'Allow commenters on your blog to reply to each other increasing user engagement and creating more dynamic conversations.'
      => 'Geef reageerders op uw blog de optie om op elkaar te antwoorden, wat voor meer engagement en meer dynamische conversaties zorgt.',
...
## lib/MT/CMS/Common.pm
    ...
    'Finished! You can <a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">return to the blog listing</a> or <a href="javascript:void(0);" onclick="closeDialog(\'[_2]\');">configure the Site root and URL of the new blog</a>.'
      => 'Klaar! U kan nu <a href=\"javascript:void(0);\" onclick=\"closeDialog(\'[_1]\');\">terugkeren naar het overzicht van de blogs</a> of <a href=\"javascript:void(0);\" onclick=\"closeDialog(\'[_2]\');\">de siteroot en URL van de nieuwe blog configureren</a>',
    'Close'              => 'Sluiten',
    ...
    'This action can only be run on a single blog at a time.' =>
      'Deze actie kan enkel worden uitgevoerd op één blog tegelijk'
    ,    # Translate - New
    'Invalid blog_id' => 'Ongeldig blog_id',
    'The Site URL matches the original blog' =>
      'De site-URL komt overeen met de oorspronkelijke blog'
    ,    # Translate - New
    'You need to specify a Site URL' =>
      'U moet een site-URL opgeven',    # Translate - New
    'The Site Path matches the original blog' =>
      'Het sitepad komt overeen met de oorspronkelijke blog'
    ,                                   # Translate - New
    'You need to specify a Site Path' =>
      'U moet een sitepad opgeven',     # Translate - New
    'Entries must be cloned if trackbacks or comments are cloned' =>
      'Berichten moeten worden gekloond als trackbacks of reacties worden gekloond'
    ,                                   # Translate - New
    'Entries must be cloned if comments are cloned' =>
      'Berichten moeten worden gekloond als reacties worden gekloond'
    ,                                   # Translate - New
...
## lib/MT/CMS/AddressBook.pm
    ...
    'No email address for user \'[_1]\'' =>
      'Geen e-mail adres voor gebruiker \'[_1]\'',
    'No valid recipients found for the entry notification.' =>
      'Geen geldige ontvangers gevonden om op de hoogte te brengen van dit bericht.',
    '[_1] Update: [_2]' => '[_1] update: [_2]',
    'Error sending mail ([_1]); try another MailTransfer setting?' =>
      'Fout bij verzenden mail ([_1]); een andere MailTransfer instelling proberen?',
    'The value you entered was not a valid email address' =>
      'Wat u invulde was geen geldig e-mail adres',
    'The value you entered was not a valid URL' =>
      'Wat u invulde was geen geldige URL',
...
## lib/MT/CMS/Tools.pm
    'Email Address is required for password recovery.' =>
      'E-mail adres is vereist om het wachtwoord te kunnen terugvinden.',
    'User not found' => 'Gebruiker niet gevonden',
    'Error sending mail ([_1]); please fix the problem, then try again to recover your password.'
      => 'Fout bij verzenden van e-mail ([_1]);  gelieve het probleem op te lossen en probeer dan opnieuw om uw wachtwoord terug te vinden.',
    ...
    'You don\'t have a system email address configured.  Please set this first, save it, then try the test email again.'
      => 'U heeft nog geen systeem e-mail adres ingesteld.  Gelieve dit eerst in te stellen en probeer daarna opnieuw een test e-mail te versturen.'
    ,    # Translate - New
    'Please enter a valid email address' =>
      'Gelieve een geldig e-mail adres in te vullen',    # Translate - New
    'Test email from Melody' => 'Test e-mail van Melody',    # Translate - New
    'This is the test email sent by your installation of Melody.' =>
      'Dit is de test e-mail die aan u werd gestuurd door uw Melody installatie.'
    ,                                                        # Translate - New
    'Mail was not properly sent' =>
      'Mail werd niet goed verzonden',                       # Translate - New
    ...
    'Successfully restored objects to Melody system by user \'[_1]\'' =>
      'Objecten werden met succes teruggezet in het Melody systeem door gebruiker \'[_1]\'',
    ...
    'Uploaded file was not a valid Melody backup manifest file.' =>
      'Het opgeladen bestand was geen geldig Melody backup manifest bestand.',
    ...
    'Melody system was successfully backed up by user \'[_1]\'' =>
      'Melody systeem werd met succes gebackupt door gebruiker \'[_1]\'',
...
## lib/MT/CMS/Entry.pm
    ...
    'Same Basename has already been used. You should use an unique basename.'
      => 'Dezelfde basisnaam is al in gebruik.  U gebruikt best een unieke basisnaam.',
    ...
    'Invalid date \'[_1]\'; authored on dates must be in the format YYYY-MM-DD HH:MM:SS.'
      => 'Ongeldige datum \'[_1]\'; publicatiedatums moeten in het formaat JJJJ-MM-DD UU:MM:SS staan.',
    'Invalid date \'[_1]\'; authored on dates should be real dates.' =>
      'Ongeldige datum \'[_1]\'; berichtdatums moeten echte datums zijn.',
    ...
    '<a href="[_1]">QuickPost to [_2]</a> - Drag this link to your browser\'s toolbar then click it when you are on a site you want to blog about.'
      => '<a href="[_1]">QuickPost op [_2]</a> - Sleep deze link naar de gereedschapsbalk van uw browser en klik er vervolgens op wanneer u op een site bent waar u over wenst te bloggen.',
    'Entry \'[_1]\' (ID:[_2]) deleted by \'[_3]\'' =>
      'Bericht \'[_1]\' (ID:[_2]) verwijderd door \'[_3]\'',
...
## lib/MT/CMS/Comment.pm
    ...
    'Parent comment id was not specified.' =>
      'ID van ouder-reactie werd niet opgegeven.',
    ...
    'You don\'t have permission to approve this comment.' =>
      'U heeft geen toestemming om deze reactie goed te keuren.',
...
## lib/MT/App.pm
    'Invalid request: corrupt character data for character set [_1]' =>
      'Ongeldig verzoek: corrupte karakterdata voor karakterset [_1]',
    ...
    'Error creating directory [_1] for blog #[_2].' =>
      'Fout bij het aanmaken van map [_1] voor blog #[_2].',
    ...
    'Our apologies, but you do not have permission to access any blogs within this installation. If you feel you have reached this message in error, please contact your Melody system administrator.'
      => 'Onze excuses, maar u heeft geen permissies om toegang te krijgen tot één of meer blogs op deze installatie.  Als u meent dat u dit bericht onterecht te zien krijgt, gelieve uw Melody systeembeheerder te contacteren.',
    'This account has been disabled. Please see your system administrator for access.'
      => 'Deze account werd uitgeschakeld.  Contacteer uw systeembeheerder om weer toegang te krijgen.',
    ...
    'This account has been deleted. Please see your system administrator for access.'
      => 'Deze account werd verwijderd.  Contacteer uw systeembeheerder om weer toegang te krijgen.',
    ...
    'Something wrong happened when trying to process signup: [_1]' =>
      'Er ging iets mis bij het verwerken van de registratie: [_1]',
...
## lib/MT/BackupRestore/BackupFileHandler.pm
    'Uploaded file was backed up from Melody but the different schema version ([_1]) from the one in this system ([_2]).  It is not safe to restore the file to this version of Melody.'
      => 'Het geuploade bestand is een backup van Melody maar het databaseschema ([_1]) verschilt van dat in dit systeem ([_2]).  Het is niet veilig om dit bestand terug te zetten op deze versie van Melody.',
    '[_1] is not a subject to be restored by Melody.' =>
      '[_1] is geen item dat door Melody teruggezet moet worden.',
    ...
    'User with the same name as the name of the currently logged in ([_1]) found.  Skipped the record.'
      => 'Gebruiker met dezelfde naam gevonden als die van de momenteel ingelogde ([_1]).  Record overgeslagen.',
    'User with the same name \'[_1]\' found (ID:[_2]).  Restore replaced this user with the data backed up.'
      => 'Een gebruiker met dezelfde naam \'[_1]\' werd gevonden (ID:[_2]).  Restore verving deze gebruiker door de data uit de backup.',
...
## lib/MT.pm.pre
    ...
    'Sign in using your OpenID identity.' =>
      'Aanmelden met uw OpenID identiteit.',
    'OpenID is an open and decentralized single sign-on identity system.' =>
      'OpenID is een open en gedecentraliseerd single sign-on identiteitssysteem.',
    'Sign in'                          => 'Aanmelden',
    'Learn more about OpenID.'         => 'Meer weten over OpenID.',
    ...
    'Sign in to Melody with your[_1] Account[_2]' =>
      'Aanmelden bij Melody met uw[_1] Account[_2]',
    ...
    'Sign in or register with TypePad.' =>
      'Meld u aan of registreer bij TypePad',
    ...
    'If present, 3rd argument to add_callback must be an object of type MT::Component or MT::Plugin'
      => 'Indien aanwezig, moet het derde argument van add_callback een object zijn van het type MT::Component of MT::Plugin',
    '4th argument to add_callback must be a CODE reference.' =>
      '4th argument van add_callback moet een CODE referentie zijn.',
    ...
    'Missing configuration file. Maybe you forgot to move config.cgi-original to config.cgi?'
      => 'Ontbrekend configuratiebestand.  Misschien vergat u config.cgi-original te hernoemen naar config.cgi?',
    ...
    'livedoor'       => 'livedoor',
    'Hatena'         => 'Hatena',
    'Melody default' => 'Melody standaard',
...
## search_templates/default.tmpl
    'SEARCH FEED AUTODISCOVERY LINK PUBLISHED ONLY WHEN A SEARCH HAS BEEN EXECUTED'
      => 'AUTODISCOVERY LINK VOOR ZOEKFEED WORDT ENKEL GEPUBLICEERD WANNEER EEN ZOEKOPDRACHT IS UITGEVOERD',
    ...
    'No pages were found containing \'[_1]\'.' =>
      'Er werden geen berichten gevonden met \'[_1]\' in.',
    'By default, this search engine looks for all words in any order. To search for an exact phrase, enclose the phrase in quotes'
      => 'Standaard zoekt deze zoekmachine naar alle woorden in eender welke volgorde.  Om een precieze uitdrukking te vinden, moet ze tussen aanhalingstekens geplaatst worden',
    'The search engine also supports AND, OR, and NOT keywords to specify boolean expressions'
      => 'De zoekmachine ondersteunt ook AND, OR en NOT sleutelwoorden om booleaanse expressies mee op te geven',
    ...
    'If you use an RSS reader, you can subscribe to a feed of all future entries tagged \'[_1]\'.'
      => 'Als u een RSS lezer gebruikt, kunt u inschrijven op een feed met alle toekomstige berichten met de tag \'[_1]\'.',
    'If you use an RSS reader, you can subscribe to a feed of all future entries matching \'[_1]\'.'
      => 'Als u een RSS lezer gebruikt, kunt u inschrijven op een feed met alle toekomstige berichten met \'[_1]\' in.',
...
## search_templates/comments.tmpl
    ...
    'Select the time interval that you\'d like to search in, then click \'Find new comments\''
      => 'Selecteer het tijdsinterval waarin u wenst te zoeken en klik dan op \'Nieuwe reacties zoeken\'',
...
## tmpl/wizard/optional.tmpl
    ...
    'Check your email to confirm receipt of a test email from Melody and then proceed to the next step.'
      => 'Controleer uw e-mail om te bevestigen of uw een testmail van Melody heeft ontvangen en ga dan verder naar de volgende stap.',
    'Back'                       => 'Terug',
    'Continue'                   => 'Doorgaan',
    ...
    'Periodically Melody will send email to inform users of new comments as well as other other events. For these emails to be sent properly, you must instruct Melody how to send email.'
      => 'Melody zal af en toe e-mail versturen om gebruikers op de hoogte te brengen van nieuwe reacties en andere gebeurtenissen.  Om deze e-mails goed te kunnen versturen, moet u Melody vertellen hoe ze verstuurd moeten worden.',
    ...
    'Mail address for test sending' =>
      'E-mail adres om een testmail te sturen',
...
## tmpl/wizard/complete.tmpl
    ...
    'Please use the configuration text below to create a file named \'config.cgi\' in the root directory of [_1] (the same directory in which index.cgi is found).'
      => 'Gelieve de configuratietekst hieronder te gebruiken om een bestand mee aan te maken genaamd \'config.cgi\' in de hoofdmap van [_1] (dezelfde map waar u ook index.cgi in aantreft).',
    ...
    'Confirm your [_1] home directory (the directory that contains index.cgi) is writable by your web server and then click \'Retry\'.'
      => 'Controleer dat uw [_1] hoofdmap (de map waar index.cgi zich bevindt) beschrijfbaar is door de webserver en klik op \'Opnieuw\'.',
    'Congratulations! You\'ve successfully configured [_1].' =>
      'Proficiat! U heeft met succes [_1] geconfigureerd.',
    'Your configuration settings have been written to the following file:' =>
      'Uw configuratie-instellingen zijn opgeslagen in volgend bestand:',
    'To reconfigure the settings, click the \'Back\' button below.' =>
      'Om de instellingen opnieuw aan te passen, klik op de \'Terug\' knop hieronder.',
    'Show the config.cgi file generated by the wizard' =>
      'Toon het config.cgi bestand dat door de wizard is aangemaakt',
    'The config.cgi file has been created manually.' =>
      'Het config.cgi bestand werd met de hand aangemaakt.',
    'Retry' => 'Opnieuw',
...
## tmpl/wizard/cfg_dir.tmpl
    ...
    'Your TempDir has been successfully configured. Click \'Continue\' below to continue configuration.'
      => 'Uw TempDir is met succes ingesteld.  Klik op \'Doorgaan\' hieronder om verder te gaan met de configuratie.',
...
## tmpl/wizard/start.tmpl
    ...
    'A configuration (config.cgi) file already exists, <a href="[_1]">sign in</a> to Melody.'
      => 'Er bestaat al een configuratiebestand (config.cgi), U kunt <a href="[_1]">aanmelden</a> bij Melody.',
    ...
    'Melody requires that you enable JavaScript in your browser. Please enable it and refresh this page to proceed.'
      => 'Melody vereist dat JavaScript ingeschakeld is in uw browser.  Gelieve het in te schakelen en herlaad deze pagina om opnieuw te proberen.',
    'This wizard will help you configure the basic settings needed to run Melody.'
      => 'Deze wizard zal u helpen met het configureren van de basisinstellingen om Melody te doen werken.',
    '<strong>Error: \'[_1]\' could not be found.</strong>  Please move your static files to the directory first or correct the setting if it is incorrect.'
      => '<strong>Fout: \'[_1]\' werd niet gevonden.</strong>  Gelieve eerst uw statische bestanden in de map te plaatsen of pas de instelling aan als deze niet juist is.',
    ...
    'Melody ships with directory named [_1] which contains a number of important files such as images, javascript files and stylesheets.'
      => 'Melody wordt geleverd met een map genaamd [_1] die een aantal belangrijke bestanden bevat zoals afbeeldingen, javascript bestanden en stylesheets.',
    'The [_1] directory is in the main Melody directory which this wizard script resides, but due to your web server\'s configuration, the [_1] directory is not accessible in this location and must be moved to a web-accessible location (e.g., your web document root directory).'
      => 'De map [_1] bevindt zich in de hoofdmap van Melody waar ook dit wizard script zich bevindt, maar door de configuratie van uw webserver is de [_1] map niet toegankelijk op deze locatie en moet deze dus verplaatst worden naar een locatie die toegankelijk is vanop het web (m.a.w. uw document root map).',
    'This directory has either been renamed or moved to a location outside of the Melody directory.'
      => 'Deze map is ofwel van naam veranderd of is verplaatst naar een locatie buiten de Melody map.',
...
## tmpl/wizard/packages.tmpl
    ...
    'The following Perl modules are required in order to make a database connection.  Melody requires a database in order to store your blog\'s data.  Please install one of the packages listed here in order to proceed.  When you are ready, click the \'Retry\' button.'
      => 'Volgende Perl modules zijn vereist om een databaseconnectie te kunnen maken.  Melody heeft een database nodig om de gegevens van uw weblog in op te slaan.  Gelieve één van de packages hieronder te installeren om verder te kunnen gaan.  Wanneer u klaar bent, klik dan op de knop \'Opnieuw\'.',
    ...
    'You are ready to proceed with the installation of Melody.' =>
      'U bent klaar om verder te gaan met de installatie van Melody',
    ...
    'One or more Perl modules required by Melody could not be found.' =>
      'Eén of meer Perl modules vereist door Melody werden niet gevonden.',
    'The following Perl modules are required for Melody to run properly. Once you have met these requirements, click the \'Retry\' button to re-test for these packages.'
      => 'De onderstaande Perl modules zijn nodig voor de werking van Melody.  Eens uw systeem aan deze voorwaarden voldoet, klik op de \'Opnieuw\' knop om opnieuw te testen of deze modules geïnstalleerd zijn.',
    'Some optional Perl modules could not be found. You may continue without installing these optional Perl modules. They may be installed at any time if they are needed. Click \'Retry\' to test for the modules again.'
      => 'Een aantal optionele Perl modules konden niet worden gevonden.  U kunt verder gaan zonder deze optionele modules te installeren.  Ze kunnen op gelijk welk moment geïnstalleerd worden indien ze nodig zijn.  Klik op \'Opnieuw\' om opnieuw te testen of de modules aanwezig zijn.',
...
## tmpl/wizard/configure.tmpl
    ...
    'You must set your Database Name.' =>
      'U moet de naam van uw database instellen.',
    ...
    'Is your preferred database not listed? View the <a href="[_1]" target="_blank">Melody System Check</a> see if additional modules are necessary.'
      => 'Staat uw gewenste database er niet bij?  Kijk bij de <a href="[_1]" target="_blank">Melody systeemcontrole</a> of er bijkomende modules nodig zijn.',
    ...
    'A default location of \'./db/mt.db\' will store the database file underneath your Melody directory.'
      => 'Een standaardlocatie van \'./db/mt.db\' zal het databasebestadn opslaan onder uw Melody map.',
    ...
    'The name of your SQL database (this database must already exist).' =>
      'De naam van uw SQL database (deze database moet al bestaan).',
    'The username to login to your SQL database.' =>
      'De gebruikersnaam om in te loggen op uw SQL database.',
    'Password' => 'Wachtwoord',
    'The password to login to your SQL database.' =>
      'Het wachtwoord om in te loggen op uw SQL database.',
    ...
    'MS SQL Server driver must use either Shift_JIS or ISO-8859-1.  MS SQL Server driver does not support UTF-8 or any other character set.'
      => 'De MS SQL Server driver heeft ofwel Shift_JIS of ISO-8859-1 nodig.  De MS SQL Server driver ondersteunt noch UTF-8 noch een andere karakterset.',
...
## tmpl/wizard/blog.tmpl
    ...
    'In order to properly publish your blog, you must provide Melody with your blog\'s URL and the path on the filesystem where its files should be published.'
      => 'Om uw blog goed te kunnen publiceren, moet u aan Melody de URL van uw weblog en het pad op het bestandssysteem opgeven waar de bestanden gepubliceerd moeten worden.',
    ...
    'Your \'Publishing Path\' is the path on your web server\'s file system where Melody will publish all the files for your blog. Your web server must have write access to this directory.'
      => 'Uw \'publicatiepad\' is het pad op het bestandsysteem van uw webserver waar Melody alle bestanden zal publiceren van uw weblog.  Uw webserver moet schrijfrechten hebben op deze map. ',
...
## tmpl/cms/edit_role.tmpl
    ...
    '[quant,_1,User,Users] with this role' =>
      '[quant,_1,gebruiker,gebruikers] met deze rol',
...
## tmpl/cms/cfg_plugin.tmpl
    ...
    'Manually enable or disable plugin-system functionality. Re-enabling plugin-system functionality, will return all plugins to their original state.'
      => 'Manueel pluginsysteem functionaliteit in- of uitschakelen.  Pluginsysteem functionaliteit opnieuw inschakelen zal alle plugins weer in hun oorspronkelijke staat brengen.',
    ...
    'Are you sure you want to disable plugin functionality?' =>
      'Bent u zeker dat u plugin functionaliteit wenst uit te schakelen?',
    ...
    'Are you sure you want to enable plugin functionality? (This will re-enable any plugins that were not individually disabled.)'
      => 'Bent u zeker dat u plugin-functies weer wenst in te schakelen? (Hierdoor zullen alle plugins opnieuw actief worden die niet individueel uitgeschakeld waren.)',
    ...
    'This plugin has not been upgraded to support Melody [_1]. As such, it may not be 100% functional. Furthermore, it will require an upgrade once you have upgraded to the next Melody major release (when available).'
      => 'Deze plugin is niet bijgewerkt om Melody [_1] te ondersteunen.  Om die reden kan het zijn dat hij niet voor 100% werkt.  Bovendien zal er een upgrade nodig zijn wanneer u een upgrade uitvoert naar de volgende major versie van Melody (wanneer die beschikbaar komt).',
...
## tmpl/cms/login.tmpl
    'Your Melody session has ended.' => 'Uw Melody sessie is beëindigd.',
    'Your Melody session has ended. If you wish to sign in again, you can do so below.'
      => 'Uw Melody sessie is beëindigd.  Als u zich opnieuw wenst aan te melden, dan kan dat hieronder.',
    'Your Melody session has ended. Please sign in again to continue this action.'
      => 'Uw Melody sessie is beëindigd. Gelieve u opnieuw aan te melden om deze handeling voort te zetten.',
...
## tmpl/cms/edit_template.tmpl
    ...
    'Your template changes have been saved.' =>
      'De wijzigingen aan uw sjabloon zijn opgeslagen.',
...
## tmpl/cms/list_category.tmpl
    'Your category changes and additions have been made.' =>
      'Uw wijzigingen en toevoegingen aan de categorieën zijn uitgevoerd.',
    'You have successfully deleted the selected category.' =>
      'De geselecteerde categorie werd met succes verwijderd.',
    'categories' => 'categorieën',
    'Delete selected category (x)' =>
      'Geselecteerde categorie verwijderen (x)',
...
## tmpl/cms/dashboard.tmpl
    ...
    'The directory you have configured for uploading userpics is not writable. In order to enable users to upload userpics, please make the following directory writable by your web server: [_1]'
      => 'De map die u heeft ingesteld om avatars in te uploaden is niet beschrijfbaar.  Om gebruikers de optie te geven een avatar te uploaden, gelieve deze directory schrijfbaar te maken voor uw webserver: [_1]',
...
## tmpl/cms/cfg_trackbacks.tmpl
    ...
    'Your TrackBack preferences have been saved.' =>
      'Uw TrackBackvoorkeuren zijn opgeslagen',
    ...
    'If enabled, TrackBacks will be accepted from any source.' =>
      'Indien ingeschakeld zullen TrackBacks worden aanvaard van eender welke bron.',
    'TrackBack Policy' => 'TrackBack beleid',
    'Moderation'       => 'Moderatie',
    'Hold all TrackBacks for approval before they\'re published.' =>
      'Alle TrackBacks moeten eerst goedgekeurd worden voor ze worden gepubliceerd.',
    'Apply \'nofollow\' to URLs' => '\'nofollow\' toepassen op URL\'s',
    'This preference affects both comments and TrackBacks.' =>
      'Deze instelling heeft effect op reacties en TrackBacks',
    'If enabled, all URLs in comments and TrackBacks will be assigned a \'nofollow\' link relation.'
      => 'Indien ingeschakeld, zullen alle URL\'s in reacties en TrackBacks een \'nofollow\' linkrelatie toegewezen krijgen.',
    'E-mail Notification' => 'E-mail notificatie',
    'Specify when Melody should notify you of new TrackBacks if at all.' =>
      'Geef aan wanneer Melody u op de hoogte moet brengen van nieuwe TrackBacks, indien gewenst.',
    'On' => 'Aan',
    ...
    'If you turn on auto-discovery, when you write a new entry, any external links will be extracted and the appropriate sites automatically sent TrackBacks.'
      => 'Indien u auto-discovery inschakelt dan zullen telkens u een nieuw bericht schrijft er automatisch TrackBacks worden gestuurd naar de betreffende site voor alle links in uw bericht.',
    ...
    'Note: The above option may be affected since outbound pings are constrained system-wide.'
      => 'Opmerking: Bovenstaande optie kan beïnvloed zijn omdat uitgaande pings op systeemniveau beperkt zijn.',
    ...
    'Note: The above option is currently ignored since outbound pings are disabled system-wide.'
      => 'Opmerking: bovenstaande optie wordt momenteel genegeerd omdat uitgaande pings op systeemniveau uitgeschakeld zijn.',
...
## tmpl/cms/edit_widget.tmpl
    ...
    'Please use a unique name for this widget set.' =>
      'Gelieve een unieke naam voor deze widgetset te gebruiken',
    'Set Name' => 'Naam instellen',
    'Drag and drop the widgets you want into the Installed column.' =>
      'Klik en sleep de widgets die u wenst in de \'Geïnstalleerde widgets\' kolom.',
...
## tmpl/cms/cfg_system_general.tmpl
    ...
    'The email address used in the From: header of each email sent from the system.  The address is used in password recovery, commenter registration, comment, trackback notification and a few other minor events.'
      => 'Het e-mail adres gebruikt in de From: hader van elke e-mail verstuurd door het systeem.  Dit adres wordt gebruikt bij het terugvinden van wachtwoorden, registratie van reageerders, trackback- en berichtnotificaties en een aantal andere, minder belangrijke gebeurtenissen.',
    'Debug Mode' => 'Debugmodus',                         # Translate - New
    'You can find an explanation of the various debug modes in the' =>
      'U kunt meer informatie vinden over de verschillende debugmodi in de'
    ,                                                     # Translate - New
...
## tmpl/cms/view_rpt_log.tmpl
    ...
    'Showing all Schwartz errors' =>
      'Alle Schwartzfouten worden getoond',               # Translate - New
...
## tmpl/cms/list_member.tmpl
    'Are you sure you want to remove this role?' =>
      'Bent u zeker dat u deze rol wenst te verwijderen?',
...
## tmpl/cms/cfg_comments.tmpl
    ...
    'Comment authentication is not available because one of the needed modules, MIME::Base64 or LWP::UserAgent is not installed. Talk to your host about getting this module installed.'
      => 'Reactie-authenticatie is niet beschikbaar omdat één van de benodigde modules, MIME::Base64 of LWP::UserAgent niet is geïnstalleerd.  Praat met uw host om de module te doen installeren.',
    'Accept Comments' => 'Reacties aanvaarden',
    'If enabled, comments will be accepted.' =>
      'Indien ingeschakeld zullen reacties worden aanvaard.',
    ...
    'If enabled, users will be able to enter a limited set of HTML in their comments. If not, all HTML will be stripped out.'
      => 'Indien ingeschakeld zullen gebruikers een beperkte set HTML tags kunnen gebruiken in hun reacties.  Indien niet zal alle HTML verwijderd worden.',
    ...
    'Specifies the list of HTML tags allowed by default when cleaning an HTML string (a comment, for example).'
      => 'Geeft een lijst met HTML-tags op die standaard zijn toegestaan wanneer een HTML-string wordt schoongemaakt (bijv. een reactie).',
    ...
    'Disable \'nofollow\' for trusted commenters' =>
      '\'nofollow\' uitschakelen voor vertrouwde reageerders',
    'If enabled, the \'nofollow\' link relation will not be applied to any comments left by trusted commenters.'
      => 'Indien ingeschakeld, dan zal de \'nofollow\' linkrelatie niet worden toegepast op links in reacties achtergelaten door vertrouwde reageerders.',
    'Specify when Melody should notify you of new comments if at all.' =>
      'Geef aan wanneer Melody u op de hoogte moet brengen van reacties, indien gewenst.',
    ...
    'Select whether you want visitor comments displayed in ascending (oldest at top) or descending (newest at top) order.'
      => 'Selecteer of u reacties van bezoekers wilt weergeven in oplopende (oudste bovenaan) of aflopende (nieuwste bovenaan) volgorde.',
    'Ascending'      => 'Oplopend',
    'Descending'     => 'Aflopend',
    ...
    'If enabled, all non-linked URLs will be transformed into links to that URL.'
      => 'Indien ingeschakeld zullen alle URLs die nog geen link zijn automatisch omgezet worden in links naar die URL.',
    ...
    'No CAPTCHA provider is available in this system.  Please check to see if Image::Magick is installed, and CaptchaSourceImageBase directive points to captcha-source directory under mt-static/images.'
      => 'Er is geen CAPTCHA provider beschikbaar in dit systeem.  Gelieve te controleren of Image::Magick is geïnstalleerd en of de CaptchaSourceImageBase directief verwijst naar de captcha-source map onder mt-static/images.',
...
## tmpl/cms/cfg_system_users.tmpl
    ...
    'You must set a valid Default Site URL.' =>
      'U moet een geldige standaard hoofd-URL voor de site instellen.',
    'You must set a valid Default Site Root.' =>
      'U moet een geldige standaard weblogmap voor de site instellen.',
    ...
    'Allow commenters to register to Melody' =>
      'Geef reageerders de optie zich te registreren via Melody',
    'Notify the following administrators upon registration:' =>
      'Waarschuw volgende administrators bij registraties',
    'Select Administrators' => 'Selecteer administrators',
    'Clear'                 => 'Leegmaken',
    'Note: System Email Address is not set. Emails will not be sent.' =>
      'Noot: Systeem e-mailadres is niet ingesteld.  Er zullen geen e-mails worden verstuurd.',
    ...
    'Check to have the system automatically create a new personal blog when a user is created in the system. The user will be granted a blog administrator role on the blog.'
      => 'Kruis dit aan om het systeem automatisch een nieuwe persoonlijke blog aan te laten maken voor elke nieuwe gebruiker die wordt aangemaakt.  De gebruiker zal een blogadministrator rol krijgen op de blog.',
    'Automatically create a new blog for each new user' =>
      'Automatisch een nieuwe blog aanmaken voor elke nieuwe gebruiker',
    ...
    'Select a blog you wish to use as the source for new personal blogs. The new blog will be identical to the source except for the name, publishing paths and permissions.'
      => 'Selecteer een blog die u wenst te gebruiken als bron voor nieuw persoonlijke blogs.  De nieuwe blog zal identiek zijn aan de bron op de naam, publicatiepaden en permissies na.',
    ...
    'Define the default site URL for new blogs. This URL will be appended with a unique identifier for the blog.'
      => 'Stel de standaard site URL in voor nieuwe blogs.  Deze URL zal vervolledigd worden met een unieke identificatie voor de blog.',
    ...
    'Define the default site root for new blogs. This path will be appended with a unique identifier for the blog.'
      => 'Stel de standaard siteroot in voor nieuwe blogs.  Dit pad zal vervolledigd worden met een unieke identificatie voor de blog.',
    'Default User Language' => 'Standaard taal',
    'Define the default language to apply to all new users.' =>
      'Stel de standaard taal in voor nieuwe gebruikers',
...
## tmpl/cms/edit_entry.tmpl
    ...
    '<a href="[_2]">[quant,_1,comment,comments]</a>' =>
      '<a href="[_2]">[quant,_1,reactie,reacties]</a>',
    ...
    'Unlock this entry&rsquo;s output filename for editing' =>
      'Maak het mogelijk om de uitvoerbestandsnaam te wijzigen',
    ...
    'Warning: Changing this entry\'s basename may break inbound links.' =>
      'Waarschuwing: de basisnaam van het bericht aanpassen kan inkomende links breken.',
    'close'  => 'Sluiten',
    'Accept' => 'Aanvaarden',
    ...
    'The published order of these assets can be changed using template tag modifiers.'
      => 'De volgorde waarin deze mediabestanden worden gepubliceerd kan gewijzigd worden via attributen van de sjabloontags.'
    ,    # Translate - New
    ...
    'You have unsaved changes to this page that will be lost.' =>
      'U heeft niet opgeslagen wijzigingen aan deze pagina die verloren zullen gaan.',
    ...
    'Your entry screen preferences have been saved.' =>
      'Uw voorkeuren voor het berichtenscherm zijn opgeslagen.',
    'Are you sure you want to use the Rich Text editor?' =>
      'Bent u zeker dat u de Rich Text Editor wenst te gebruiken?',
    'Remove'                => 'Verwijder',
    ...
    'Use <a href="http://blogit.typepad.com/">Blog It</a> to post to Melody from social networks like Facebook.'
      => 'Gebruik <a href="http://blogit.typepad.com/">Blog It</a> om op Melody te publiceren vanop sociale netwerken zoals Facebook.',
    'None selected' => 'Geen geselecteerd',
...
## tmpl/cms/include/comment_table.tmpl
    ...
    'Report selected comments as Spam (j)' =>
      'Geselecteerde reacties verwijderen als spam (j)',
    'Report selected comments as Not Spam and Publish (j)' =>
      'Geselecteerde reacties rapporteren als niet-spam en publiceren (j)',
    'Not Spam' => 'Geen spam',
    'Are you sure you want to remove all comments reported as spam?' =>
      'Bent u zeker dat u alle reacties die als spam gemarkeerd zijn wenst te verwijderen?',
    'Delete all comments reported as Spam' =>
      'Alle reacties gerapporteerd als spam verwijderen',
    'Empty'                        => 'Leeg',
...
## tmpl/cms/include/member_table.tmpl
    ...
    'Are you sure you want to remove the selected user from this blog?' =>
      'Bent u zeker dat u de geselecteerde gebruiker wenst te verwijderen van deze weblog?',
    'Are you sure you want to remove the [_1] selected users from this blog?'
      => 'Bent u zeker dat u de [_1] geselecteerde gebruikers wenst te verwijderen van deze weblog?',
...
## tmpl/cms/include/import_end.tmpl
    ...
    'Make sure that you remove the files that you imported from the \'import\' folder, so that if/when you run the import process again, those files will not be re-imported.'
      => 'Verwijder zeker de bestanden waaruit u gegevens importeerde uit de \'import\' folder, zodat wanneer u het import proces ooit opnieuw draait deze bestanden niet nog eens worden geïmporteerd.',
...
## tmpl/cms/include/import_start.tmpl
    ...
    'Importing entries as user \'[_1]\'' =>
      'Berichten worden geïmporteerd als gebruiker \'[_1]\'',
...
## tmpl/cms/include/footer.tmpl
    'This is a beta version of Melody and is not recommended for production use.'
      => 'Dit is een betaversie van Melody, niet aangeraden voor productiegebruik.',
...
## tmpl/cms/include/ping_table.tmpl
    ...
    'Report selected [_1] as Spam (j)' =>
      'Geselecteerde [_1] als spam rapporteren (j)',
    'Report selected [_1] as Not Spam and Publish (j)' =>
      'Geselecteerde [_1] als niet-spam rapporteren en publiceren (j)',
    'Are you sure you want to remove all TrackBacks reported as spam?' =>
      'Bent u zeker dat u alle TrackBacks die als spam zijn gerapporteerd wenst te verwijderen?',
    'Deletes all [_1] reported as Spam' =>
      'Verwijdert alle [_1] die als spam gerapporteerd werden',
    'From'   => 'Van',
    'Target' => 'Doel',
    'Only show published TrackBacks' =>
      'Enkel gepubliceerde TrackBacks tonen',
...
## tmpl/cms/include/entry_table.tmpl
    ...
    'Republish selected entries (r)' =>
      'Geselecteerde berichten opnieuw publiceren (r)',
    'Delete selected entries (x)' =>
      'Geselecteerde berichten verwijderen (x)',
    'Save these pages (s)' => 'Deze pagina\'s opslaan',
    'Republish selected pages (r)' =>
      'Geselecteerde pagina\'s opnieuw publiceren (r)',
    ...
    'Only show unpublished entries' =>
      'Enkel ongepubliceerde berichten tonen',
    ...
    'No entries could be found. <a href="[_1]">Create an entry</a> now.' =>
      'Er werden geen berichten gevonden. Nu <a href="[_1]">een bericht aanmaken</a>.',
    'No page could be found. <a href="[_1]">Create a page</a> now.' =>
      'Er werden geen pagina\'s gevonden. Nu <a href="[_1]">een pagina aanmaken</a>.',
...
## tmpl/cms/include/backup_start.tmpl
    'Backing up Melody' => 'Backup maken van Melody',
...
## tmpl/cms/include/asset_upload.tmpl
    'Before you can upload a file, you need to publish your blog. [_1]Configure your blog\'s publishing paths[_2] and rebuild your blog.'
      => 'Voor u een bestand kunt opladen, moet u eerst uw blog publiceren. [_1]Stel het publicatiepad van uw blog in[_2] en publiceer uw blog opnieuw.',
    'Your system or blog administrator needs to publish the blog before you can upload files. Please contact your system or blog administrator.'
      => 'Uw systeem- of blogbeheerder moet de blog publiceren voor u bestanden kunt opladen.  Gelieve uw systeem- of blogbeheerder te contacteren.',
    'Close (x)'             => 'Sluiten (x)',
...
## tmpl/cms/setup_initial_blog.tmpl
    ...
    'Select the templates you wish to use for this new blog.' =>
      'Selecteer de sjablonen die u wenst te gebruiken voor deze nieuwe blog.',
...
## tmpl/cms/import.tmpl
    ...
    'Transfer weblog entries into Melody from other Melody installations or even other blogging tools or export your entries to create a backup or copy.'
      => 'Importeer weblogberichten in Melody uit andere Melody installaties of zelfs andere blogsystemen, of exporteer uw berichten om een backup of kopie te maken.',
    ...
    'If your import file is located on your computer, you can upload it here.  Otherwise, Melody will automatically look in the \'import\' folder of your Melody directory.'
      => 'Als uw importbestand zich nog op uw eigen computer bevindt, kunt u het hier opladen.  In het andere geval zal Melody automatisch kijken in de \'import\' map van uw Melody map.',
    ...
    'By default, Melody will attempt to automatically detect the character encoding of your import file.  However, if you experience difficulties, you can set it explicitly.'
      => 'Standaard zal Melody proberen om automatisch de karakter encodering van het importbestand te bepalen.  Mocht u echter problemen ondervinden, kunt u het ook uitdrukkelijk instellen.',
...
## tmpl/cms/cfg_spam.tmpl
    ...
    'Your spam preferences have been saved.' =>
      'Uw spamvoorkeuren zijn opgeslagen',
    ...
    'If enabled, feedback reported as spam will be automatically erased after a number of days.'
      => 'Indien ingeschakeld zal alle feedback die als spam is gemarkeerd automatisch verwijderd worden na een aantal dagen.',
...
## tmpl/cms/popup/pinged_urls.tmpl
    ...
    'To retry, include these TrackBacks in the Outbound TrackBack URLs list for your entry.'
      => 'Om opnieuw te proberen: zet deze TrackBacks in het veld voor uitgaande TrackBack URL\'s van uw bericht.',
...
## tmpl/cms/edit_folder.tmpl
    ...
    'Your folder changes have been made.' =>
      'De wijzigingen aan de map zijn uitgevoerd.',
...
## tmpl/cms/upgrade.tmpl
    ...
    'While Melody may run, it is an <strong>untested and unsupported environment</strong>.  We strongly recommend upgrading to at least Perl [_1].'
      => 'Hoewel Melody er misschien op draait, is het een <strong>ongetesten en niet ondersteunde omgeving</strong>.  We raden ten zeerste aan om minstens te upgraden tot Perl [_1].',
    ...
    'A new version of Melody has been installed.  We\'ll need to complete a few tasks to update your database.'
      => 'Er is een nieuwe versie van Melody geïnstalleerd.  Er moeten een aantal dingen gebeuren om uw database bij te werken.',
    'Information about this upgrade can be found <a href=\'[_1]\' target=\'_blank\'>here</a>.'
      => 'Informatie over deze upgrade kan <a href=\'[_1]\' target=\'_blank\'>hier</a> worden gevonden.',
    'In addition, the following Melody components require upgrading or installation:'
      => 'Bovendien hebben volgende Melody componenten een upgrade nodig of moeten ze geïnstalleerd worden:',
    'The following Melody components require upgrading or installation:' =>
      'Volgende Melody componenten hebben een upgrade nodig of moeten geïnstalleerd worden:',
    'Begin Upgrade' => 'Begin de upgrade',
    'Congratulations, you have successfully upgraded to Melody [_1].' =>
      'Proficiat, u heeft met succes een upgrade uitgevoerd aan Melody [_1].',
    'Return to Melody' => 'Terugkeren naar Melody',
    'Your Melody installation is already up to date.' =>
      'Uw Melody installation is al up-to-date.',

## tmpl/cms/edit_category.tmpl
    'Edit Category' => 'Categorie bewerken',
    'Your category changes have been made.' =>
      'Uw categoriewijzigingen zijn gemaakt.',
    ...
    'Unlock this category&rsquo;s output filename for editing' =>
      'De basisnaam van deze categorie bewerkbaar maken',
    'Warning: Changing this category\'s basename may break inbound links.' =>
      'Waarschuwing: de basisnaam van deze categorie veranderen kan inkomende links verbreken.',
    ...
    'Enter the URL(s) of the websites that you would like to send a TrackBack to each time you create an entry in this category. (Separate URLs with a carriage return.)'
      => 'Vul de URL(s) in van de websites waar u een TrackBack naartoe wenst te sturen elke keer u een bericht aanmaakt in deze categorie.  (Splits URL\'s van elkaar met een carriage return.)',
...
## tmpl/cms/dialog/recover.tmpl
    ...
    'Sign in to Melody (s)' => 'Aanmelden op Movable Tpe (s)',
    'Sign in to Melody'     => 'Aanmelden op Melody',
...
## tmpl/cms/dialog/asset_replace.tmpl
    'A file named \'[_1]\' already exists. Do you want to overwrite this file?'
      => 'Er bestaat reeds een bestand net de naam \'[_1]\'. Wilt u dit bestand overschrijven?',
...
## tmpl/cms/dialog/refresh_templates.tmpl
    ...
    'Deletes all existing templates and install the selected template set.' =>
      'Verwijdert alle bestaande sjablonen en installeert de geselecteerde set sjablonen.',
    ...
    'Deletes all existing templates and installs factory default template set.'
      => 'Verwijdert alle bestaande sjablonen en installeert de standaard sjabloonset uit de \'fabrieksinstellingen\'.',
...
## tmpl/cms/dialog/publishing_profile.tmpl
    ...
    'This new publishing profile will update all of your templates.' =>
      'Dit nieuwe publicatieprofiel zal de instellingen van al uw sjablonen aanpassen.',
...
## tmpl/cms/dialog/entry_notify.tmpl
    ...
    'Enter email addresses on separate lines, or comma separated.' =>
      'Vul e-mail adressen in op aparte regels of gescheiden door komma\'s.',
    ...
    '(Entry Body will be sent without any text formatting applied)' =>
      '(Romp van het bericht zal verstuurd worden zonder dat er tekstformattering op wordt toegepast)',
...
## tmpl/cms/dialog/adjust_sitepath.tmpl
    ...
    'You can not have spaces in the URL.' =>
      'Er mogen geen spaties in de URL staan.',
    'You can not have spaces in the path.' =>
      'Er mogen geen spaties in het pad staan.',
...
## tmpl/cms/dialog/clone_blog.tmpl
    ...
    'Overwrite Original Paths' =>
      'Oorspronkelijke paden overschrijven',                 # Translate - New
    'Preserve Original Paths' =>
      'Oorspronkelijke paden bewaren',                       # Translate - New
    'Exclusions' => 'Uitzonderingen',                        # Translate - New
    'Exclude Entries/Pages' =>
      'Berichten/pagina\'s uitsluiten',                      # Translate - New
    ...
    'Enter the new URL of your public website. Example: http://www.example.com/weblog/'
      => 'Vul de nieuwe URL in van uw publieke website.  Voorbeeld: http://www.voorbeeld.org/weblog/'
    ,                                                        # Translate - New
    'Enter a new path where your main index file will be located. Example: /home/melody/public_html/weblog'
      => 'Vul een nieuw pad in waar uw hoofdindexbestand zich zal bevinden.  Voorbeeld: /home/melody/public_html/weblog'
    ,                                                        # Translate - New
    'If this is set to the same path as the original blog, it will overwrite it.'
      => 'Als dit is ingesteld op hetzelfde pad als dat van de oorspronkelijke blog, dan zal dit overschreven worden.'
    ,                                                        # Translate - New
    ...
    'If this option is set, any matching path settings will overwrite the original blog.'
      => 'Als deze optie is ingesteld, zullen alle pad-instellingen die overeenkomen de oorspronkelijke blog overschrijven.'
    ,                                                        # Translate - New
    'Mark the settings that you want cloning to skip' =>
      'Kies de instellingen die overgeslagen moeten worden bij het klonen'
    ,                                                        # Translate - New
...
## tmpl/cms/list_author.tmpl
    ...
    'You have successfully deleted the user(s) from the Melody system.' =>
      'U heeft met succes de gebruiker(s) verwijderd uit het Melody systeem.',
    'The deleted user(s) still exist in the external directory. As such, they will still be able to login to Melody Enterprise.'
      => 'De verwijderde gebruiker(s) blijven bestaan in de externe directory. Om die reden zullen ze zich nog steeds kunnen aanmelden op Melody Enterprise.',
    'You have successfully synchronized users\' information with the external directory.'
      => 'U heeft met succes de gebruikersgegevens gesynchroniseerd met de externe directory.',
    ...
    'An error occured during synchronization.  See the <a href=\'[_1]\'>activity log</a> for detailed information.'
      => 'Er deed zich een fout voor tijdens de synchronisatie.  Kijk in het <a href=\'[_1]\'>activiteitenlog</a> voor gedetailleerde informatie.',
    'Enable selected users (e)' => 'Geselecteerde gebruikers activeren (E)',
    '_USER_ENABLE'              => 'Activeren',
    '_NO_SUPERUSER_DISABLE' =>
      'Omdat u een systeembeheerder bent in het Melody systeem, kunt u zichzelf niet desactiveren.',
...
## tmpl/cms/upgrade_runner.tmpl
    ...
    'Return to Melody (s)'       => 'Terugkeren naar Melody (s)',
...
## tmpl/cms/cfg_entry.tmpl
    ...
    'Specifies the default Entry Status when creating a new entry.' =>
      'Bepaalt de standaardstatus van een nieuw aangemaakt bericht',
...
## tmpl/cms/cfg_registration.tmpl
    ...
    'Allow registration for Melody.' => 'Laat registratie toe in Melody',
    ...
    'Note: You have selected to accept comments from authenticated commenters only but authentication is not enabled. In order to receive authenticated comments, you must enable authentication.'
      => 'Opmerking: u heeft ervoor gekozen om enkel reacties te aanvaarden van geauthenticeerde reageerders, maar authenticatie is niet ingeschakeld.  Om geauthenticeerde reacties te kunnen ontvangen, moet u authenticatie inschakelen.',
    'Native' => 'Ingebouwd',
    ...
    'If enabled, visitors must allow their TypePad account to share e-mail address when commenting.'
      => 'Indien ingeschakeld, moeten bezoekers die met hun TypePad account zijn aangemeld hun e-mail adres met u delen als ze een reactie willen achterlaten.',
    'One or more Perl modules may be missing to use this authentication method.'
      => 'Eén of meer Perl modules ontbreken mogelijk om deze authenticatiemethode te kunnen gebruiken.'
    ,    # Translate - New
    ...
    'Required module (Digest::SHA1) for OpenID commenter authentication is missing.'
      => 'Vereiste module (Digest::SHA1) voor OpenID reageerders-authenticatie ontbreekt.',
...
## tmpl/cms/edit_author.tmpl
    ...
    'Status of user in the system. Disabling a user removes their access to the system but preserves their content and history.'
      => 'Status van de gebruiker in het systeem.  Een gebruiker uitschakelen ontzegt hem/haar toegang tot het systeem maar bewaart content en geschiedenis.',
    ...
    'The URL of the site associated with this user. eg. http://www.movabletype.com/'
      => 'De URL van de site gekoppeld aan deze gebruiker, bv. http://www.movabletype.com/',
...
## tmpl/cms/list_comment.tmpl
    ...
    'No comments appeared to be spam.' =>
      'Er lijken geen berichten als spam gemarkeerd te zijn',
    '[_1] on entries created within the last [_2] days' =>
      '[_1] op berichten aangemaakt in de laatste [_2] dagen',
    '[_1] on entries created more than [_2] days ago' =>
      '[_1] op berichten aangemaakt langer dan [_2] dagen geleden',
...
## tmpl/cms/cfg_web_services.tmpl
    ...
    'Your TypePad token is used to access Six Apart services like its free Authentication service.'
      => 'Uw TypePad token wordt gebruikt om toegang te krijgen tot Six Apart services zoals de gratis authentiatiedienst.',
    ...
    'Please click the Save Changes button below to disable authentication.' =>
      'Gelieve op de knop \'Wijzigingen opslaan\' te drukken om authenticatie uit te schakelen.',
    ...
    'Please click the Save Changes button below to enable TypePad.' =>
      'Klik hieronder op de knop om de wijzigigen op te slaan en TypePad in te schakelen.',
    ...
    'When this blog is updated, Melody will automatically notify the selected sites.'
      => 'Wanneer deze weblog wordt bijgewerkt, zal Melody automatisch de geselecteerde sites op de hoogte brengen.',
    'Note: This option is currently ignored since outbound notification pings are disabled system-wide.'
      => 'Opmerking: deze instelling wordt momenteel genegeerd, omdat uitgaande notificatie-pings zijn uitgeschakeld op systeemniveau.',
    'Others:' => 'Andere:',
    '(Separate URLs with a carriage return.)' =>
      '(URL\'s van elkaar scheiden met een carriage return.)',
    ...
    'If you have received a recently updated key (by virtue of your purchase), enter it here.'
      => 'Als u een \'Recent bijgewerkt\' sleutel heeft ontvangen (door uw aankoop), vul die dan hier in.',
...
## tmpl/cms/edit_blog.tmpl
    ...
    'You must set your Site URL.' =>
      'U dient de URL van uw site in te stellen.',
    'Your Site URL is not valid.' => 'De URL van uw site is niet geldig.',
    'You can not have spaces in your Site URL.' =>
      'Er mogen geen spaties in de URL van uw site zitten.',
    'You can not have spaces in your Local Site Path.' =>
      'Er mogen geen spaties in het locale pad van uw site.',
    'Your Local Site Path is not valid.' =>
      'Het lokale pad van uw site is niet geldig.',
    'Enter the URL of your public website. Do not include a filename (i.e. exclude index.html). Example: http://www.example.com/weblog/'
      => 'Vul de URL in van uw publieke website.  Laat de bestandsnaam weg (m.a.w. laat index.html weg).  Voorbeeld: http://www.voorbeeld.com/blog/',
    'Enter the path where your main index file will be located. An absolute path (starting with \'/\') is preferred, but you can also use a path relative to the Melody directory. Example: /home/melody/public_html/weblog'
      => 'Vul het pad in waar uw hoofdindexbestand zich zal bevingen.  Een absoluut pad (dat begint met \'/\') verdient de voorkeur, maar u kunt ook een pad gebruiken relatief aan de Melody map.  Voorbeeld: /home/melody/public_html/weblog',
...
## tmpl/cms/list_tag.tmpl
    ...
    'An error occurred while testing for the new tag name.' =>
      'Er deed zich een fout voor bij het testen op de nieuwe tagnaam.',
...
## tmpl/cms/install.tmpl
    ...
    'Password recovery word/phrase is required.' =>
      'Woord/uitdrukking om uw wachtwoord terug te vinden is vereist.',
    ...
    'Before you can begin blogging, you must create an administrator account for your system. When you are done, Melody will then initialize your database.'
      => 'Voor u kunt beginnen blogggen, moet u een administrator-account aanmaken voor uw systeem.  Wanneer u klaar bent zal Melody uw database initialiseren.',
    ...
    'The email address used in the From: header of each email sent from the system.'
      => 'Het e-mail adres wordt gebruikt in de From: header van elk bericht dat door het systeem wordt verzonden.',
    'Use this as system email address' =>
      'Volgend systeem e-mail adres gebruiken',
...
## tmpl/cms/edit_comment.tmpl
    ...
    'View entry comment was left on' =>
      'Bekijk het bericht waar dit een reactie op is',
...
## tmpl/cms/cfg_system_feedback.tmpl
    ...
    'Your feedback preferences have been saved.' =>
      'Uw voorkeuren voor feedback zijn opgeslagen.',
    ...
    'Disable TrackBacks for all blogs' =>
      'TrackBacks uitschakelen op alle blogs',
    ...
    'This feature allows you to disable sending notification pings when a new entry is created.'
      => 'Met deze optie kunt u uitgaande notificatie-pings uitschakelen wanneer een nieuw bericht is aangemaakt.',
    'Disable notification pings for all blogs' =>
      'Notificatiepings uitschakelen op alle blogs',
    'Limit outbound TrackBacks and TrackBack auto-discovery for the purposes of keeping your installation private.'
      => 'Beperk uitgaande TrackBacks en TrackBack autodiscovery om uw installatie privé te houden.',
    ...
    'Only allow to blogs on this installation' =>
      'Enkel toestaan naar blogs op deze installatie',
    'Only allow the sites on the following domains:' =>
      'Enken toestaan naar sites op volgende domeinen:',
...
## tmpl/cms/widget/new_user.tmpl
    'Welcome to Melody, the world\'s most powerful blogging, publishing and social media platform. To help you get started we have provided you with links to some of the more common tasks new users like to perform:'
      => 'Welkom in Melody, het meest krachtige blog-, publicatie- en mediaplatform ter wereld.  Om u te helpen van start te gaan hebben we voor u enkele links voorzien naar de vaakst voorkomende handelingen die nieuwe gebruikers wensen uit te voeren:',
    ...
    'What would a blog be without content? Start your Melody experience by creating your very first post.'
      => 'Wat is een blog zonder inhoud?  Ervaar de kracht van Melody door uw eerste bericht te schrijven.',
    ...
    'Customize the look and feel of your blog quickly by selecting a design from one of our professionally designed themes.'
      => 'Pas snel en eenvoudig het uitzicht van uw weblog aan door te kiezen uit één van onze vele professioneel ontworpen thema\'s.',
    'Explore what\'s new in Melody' => 'Ontdek wat er nieuw is in Melody',
    'Whether you\'re new to Melody or using it for the first time, learn more about what this tool can do for you.'
      => 'Of u Melody nu voor de eerste keer gebruikt of u er al ervaring mee heeft, ontdek meer over wat het voor u kan doen.',

## tmpl/cms/widget/blog_stats_recent_entries.tmpl
    '[quant,_1,entry,entries] tagged &ldquo;[_2]&rdquo;' =>
      'quant,_1,entry,entries] getagd &ldquo;[_2]&rdquo;',
    '...'                         => '...',
    ...
    'View all entries tagged &ldquo;[_1]&rdquo;' =>
      'Alle berichten bekijken getagd als &ldquo;[_1]&rdquo;',
...
## tmpl/cms/widget/mt_news.tmpl
    ...
    'Pronet'                    => 'Pronet',
    'No Melody news available.' => 'Geen Melody nieuws beschikbaar.',
    'No Learning Melody news available.' =>
      'Geen Learning Melody nieuws beschikbaar.',
...
## tmpl/cms/widget/custom_message.tmpl
    ...
    'Melody User Manual'           => 'Gebruikershandleiding van Melody',
    'http://www.sixapart.com/movabletype/support' =>
      'http://www.sixapart.com/movabletype/support',
    'Melody Technical Support' => 'Melody technische ondersteuning',
    'Melody Community Forums'  => 'Melody community forums',
...
## tmpl/cms/widget/new_version.tmpl
    'What\'s new in Melody [_1]' => 'Nieuw in Melody [_1]',
    'Congratulations, you have successfully installed Melody [_1]. Listed below is an overview of the new features found in this release.'
      => 'Proficiat, u heeft met succes Melody [_1] geïnstalleerd.  Hieronder vindt u een overzicht van de nieuwe mogelijkheden in deze release.',
...
## tmpl/cms/widget/this_is_you.tmpl
    ...
    'You\'ve written <a href="[_1]">[quant,_2,entry,entries]</a> with <a href="[_3]">[quant,_4,comment,comments]</a>.'
      => 'U heeft <a href="[_1]">[quant,_2,bericht,berichten]</a> geschreven met <a href="[_3]">[quant,_4,reactie,reacties]</a>.',
    'You\'ve written [quant,_1,entry,entries] with <a href="[_2]">[quant,_3,comment,comments]</a>.'
      => 'U heeft [quant,_1,bericht,berichten] met <a href="[_2]">[quant,_3,reactie,reacties]</a>.',
    'You\'ve written [quant,_1,entry,entries] with [quant,_2,comment,comments].'
      => 'U heeft [quant,_1,bericht,berichten] geschreven met [quant,_2,reactie,reacties].',
    'You\'ve written <a href="[_1]">[quant,_2,entry,entries]</a>.' =>
      'U heeft <a href="[_1]">[quant,_2,bericht,berichten]</a> geschreven.',
    'You\'ve written [quant,_1,entry,entries].' =>
      'U heeft [quant,_1,bericht,berichten] geschreven.',
    'Edit your profile' => 'Bewerk uw profiel',

## tmpl/cms/widget/new_install.tmpl
    'Thank you for installing Melody' => 'Bedankt om Melody te installeren!',
    'Congratulations on installing Melody, the world\'s most powerful blogging, publishing and social media platform. To help you get started we have provided you with links to some of the more common tasks new users like to perform:'
      => 'Gelukwensen met de installatie van Melody, het krachtigste blog-, publicatie- en social mediaplatform ter wereld.  Om u te helpen van start te gaan hebben we enkele links verzameld naar de meest voorkomende dingen die nieuwe gebruikers willen doen:',
    ...
    'Start building your network of blogs and your community now. Invite users to join your blog and promote them to authors.'
      => 'Begin met het opbouwen van uw blognetwerk en uw gemeenschap.  Nodig gebruikers uit om lid te worden van uw blog en promoveer hen tot auteur.',
...
## tmpl/cms/widget/blog_stats.tmpl
    ...
    'Melody was unable to locate your \'mt-static\' directory. Please configure the \'StaticFilePath\' configuration setting in your config.cgi file, and create a writable \'support\' directory underneath your \'mt-static\' directory.'
      => 'Melody kon uw \'mt-static\' map niet vinden.  Gelieve de \'StaticFilePath\' directief in uw config.cgi file in te stellen en maak een beschrijfbare \'support\' map aan in uw \'mt-static\' map.',
    'Melody was unable to write to its \'support\' directory. Please create a directory at this location: [_1], and assign permissions that will allow the web server write access to it.'
      => 'Melody was niet in staat om te schrijven in de \'support\' map.  Gelieve een map aan te maken in deze locatie: [_1] en er genoeg permissies aan toe te kennen zodat de webserver er in kan schrijven.',
...
## tmpl/cms/restore_end.tmpl
    'Make sure that you remove the files that you restored from the \'import\' folder, so that if/when you run the restore process again, those files will not be re-restored.'
      => 'Verwijder de bestanden die u heeft teruggezet uit de map \'import\', om te vermijden dat ze opnieuw worden teruggezet wanneer u ooit het restore-proces opnieuw uitvoert.',
...
## tmpl/cms/system_check.tmpl
    ...
    'Users who have logged in within 90 days are considered <strong>active</strong> in Melody license agreement.'
      => 'Gebruikers die zich in de afgelopen 90 dagen hebben aangemeld worden als <strong>actief</strong> beschouwd voor de Melody licentieovereenkomst.',
    ...
    'Melody could not find the script named \'check.cgi\'. To resolve this issue, please ensure that the check.cgi script exists and/or the CheckScript configuration parameter references it properly.'
      => 'Melody kon het script met de naam \'check.cgi\' niet vinden.  Om dit probleem op te lossen, gelieve te controleren dat het check.cgi script bestaat en/of dat de MTCheckScript configuratieparameter er op de juiste manier naar verwijst.',
...
## tmpl/cms/restore.tmpl
    ...
    'Perl module XML::SAX and/or its dependencies are missing - Melody can not restore the system without it.'
      => 'Perl module XML::SAX ontbreekt en/of enkele modules waarvan deze afhankelijk is - Melody kan geen restore operatie uitvoeren zonder deze module.',
    ...
    'If your backup file is located on your computer, you can upload it here.  Otherwise, Melody will automatically look in the \'import\' folder of your Melody directory.'
      => 'Als uw backup-bestand zich op uw computer bevindt, kunt u het hier opladen.  In het andere geval zal Melody automatisch in de \'omport\' map kijken in uw Melody map.',
    'Check this and files backed up from newer versions can be restored to this system.  NOTE: Ignoring Schema Version can damage Melody permanently.'
      => 'Kruis dit aan en ook bestanden die gebackupt zijn van nieuwere versies van Melody kunnen teruggezet worden op dit systeem.  Opmerking: de schemaversie negeren kan Melody permanent beschadigen.',
    ...
    'Check this and existing global templates will be overwritten from the backup file.'
      => 'Kruis dit aan en bestaande globale sjablonen zullen worden overschreven vanuit het backup bestand.',
...
## tmpl/cms/list_folder.tmpl
    'Your folder changes and additions have been made.' =>
      'De wijzigingen en toevoegingen aan uw mappen zijn aangebracht.',
    'You have successfully deleted the selected folder.' =>
      'De geselecteerde map werden met succes verwijderd.',
...
## tmpl/cms/cfg_archives.tmpl
    'Error: Melody was not able to create a directory for publishing your blog. If you create this directory yourself, assign sufficient permissions that allow Melody to create files within it.'
      => 'Fout: Melody kon geen map maken om uw weblog in te publiceren.  Als u deze map zelf aanmaakt, ken er dan genoeg permissies aan toe zodat Melody er bestanden in kan aanmaken',
    'Your blog\'s archive configuration has been saved.' =>
      'De archiefinstellingen van uw weblog zijn opgeslagen.',
    'You have successfully added a new archive-template association.' =>
      'U hebt een nieuwe koppeling tussen een archief en een sjabloon toegevoegd.',
    'You may need to update your \'Master Archive Index\' template to account for your new archive configuration.'
      => 'Het kan zijn dat u uw \'Hoofdarchiefindex\' sjabloon moet bijwerken om rekening te houden met uw nieuwe archiefconfiguratie.',
    'The selected archive-template associations have been deleted.' =>
      'De geselecteerde koppelingen tussen een archief en een sjabloon zijn verwijderd.',
    'Warning: one or more of your templates is set to publish dynamically using PHP, however your server side include method may not be compatible with dynamic publishing.'
      => 'Waarschuwing: één of meer van uw sjablonen staan ingesteld om dynamisch gepubliceerd te worden met PHP, terwijl uw server side include methode mogelijk niet compatibel is met dynamisch publiceren.',
    ...
    'You must set Local Archive Path.' =>
      'U moet een lokaal archiefpad instellen.',
    ...
    'The URL of your website. Do not include a filename (i.e. exclude index.html). Example: http://www.example.com/blog/'
      => 'De URL van uw website.  Zet er geen bestandsnaam in (m.a.w. laat index.html weg).  Voorbeeld: http://www.voorbeeld.com/blog/',
    'Unlock this blog&rsquo;s site URL for editing' =>
      'Maak de site URL van deze weblog bewerkbaar',
    'Warning: Changing the site URL can result in breaking all the links in your blog.'
      => 'Waarschuwing: de site URL aanpassen kan tot gevolg hebben dat alle links naar uw weblog niet langer werken.',
    'The path where your index files will be published. An absolute path (starting with \'/\') is preferred, but you can also use a path relative to the Melody directory. Example: /home/melody/public_html/blog'
      => 'Het pad waar uw indexbestanden gepubliceerd zullen worden.  Een absoluut pad (beginnend met \'/\') verdient de voorkeur, maar u kunt ook een pad ingeven dat relatief is t.o.v. de Melody map.  Voorbeeld: /home/melody/public_html/blog',
    'Unlock this blog&rsquo;s site path for editing' =>
      'Maak het sitepad van deze weblog bewerkbaar',
    'Note: Changing your site root requires a complete publish of your site.'
      => 'Opmerking: De siteroot aanpassen vereist een volledige herpublicatie van uw site.',
    ...
    'Enter the URL of the archives section of your website. Example: http://archives.example.com/'
      => 'Geef de URL in van het archiefgedeelte van uw website.  Voorbeeld: http://archieven.voorbeeld.com/',
    'Unlock this blog&rsquo;s archive url for editing' =>
      'Maak de archief-URL van deze weblog bewerkbaar',
    ...
    'Enter the path where your archive files will be published. Example: /home/melody/public_html/archives'
      => 'Vul het pad in waar uw archiefbestanden gepubliceerd moeten worden.  Voorbeeld: /home/melody/public_html/archieven',
    ...
    'Requires the use of a cron job to publish pages in the background.' =>
      'Hiervoor is een cron job vereist die pagina\'s kan publiceren in de achtergrond.',
    'Use background publishing queue for publishing static pages for this blog'
      => 'Publicatiewachtrij in de achtergrond gebruiken om statische pagina\'s te publiceren op deze weblog.',
    ...
    'Enter the archive file extension. This can take the form of \'html\', \'shtml\', \'php\', etc. Note: Do not enter the leading period (\'.\').'
      => 'Voer de bestandsextensie voor het archief in. Dit kan zijn in de vorm van \'html\', \'shtml\', \'php\', enz. Opmerking: voer het eerste punt niet in (\'.\').',
    ...
    'Used for creating links to an archived entry (permalink). Select from the archive types used in this blogs archive templates.'
      => 'Gebruikt om links te leggen naar een gearchiveerd bericht (permalink).  Selecteer uit de archieftypes gebruikt in de archiefsjablonen van deze weblog.',
...
## tmpl/cms/restore_start.tmpl
    'Restoring Melody' => 'Melody terugzetten',
...
## tmpl/include/chromeless_footer.tmpl
    '<a href="[_1]">Melody</a> version [_2]' =>
      '<a href="[_1]">Melody</a> versie [_2]',

## tmpl/error.tmpl
    'Missing Configuration File' => 'Ontbrekend configuratiebestand',
    '_ERROR_CONFIG_FILE' =>
      'Uw Melody configuratiebestand ontbreekt of kan niet gelezen worden. Gelieve het deel <a href=\"#\">Installation and Configuration</a> van de handleiding van Melody te raadplegen voor meer informatie.',
    'Database Connection Error' => 'Databaseverbindingsfout',
    '_ERROR_DATABASE_CONNECTION' =>
      'Uw database instellingen zijn ofwel ongeldig ofwel ontbreken ze in uw Melody configuratiebestand. Bekijk het deel <a href=\"#\">Installation and Configuration</a> van de Melody handleiding voor meer informatie.',
    'CGI Path Configuration Required' => 'CGI-pad configuratie vereist',
    '_ERROR_CGI_PATH' =>
      'Uw CGIPath configuratieinstelling is ofwel ongeldig ofwel ontbreekt ze in uw Melody configuratiebestand. Bekijk het deel <a href=\"#\">Installation and Configuration</a> van de Melody handleiding voor meer informatie.',
...
## tmpl/feeds/login.tmpl
    'Melody Activity Log' => 'Melody activiteitlog',
...
## addons/Community.pack/lib/MT/App/Community.pm
    ...
    '[_1] registered to Melody.'    => '[_1] geregistreerd bij Melody',
...
## addons/Community.pack/lib/MT/Community/CMS.pm
    ...
    'Welcome to the Melody Community Solution' =>
      'Welkom op de Melody Community Solution',
    'The Community Solution gives you to the tools to build a successful community with active, engaged conversations. Some key features to explore:'
      => 'De Community Solution geeft u de middelen in handen om een succesvolle gemeenschap uit te bouwen met actieve, geëngageerde conversaties.  Hieronder staan de belangrijkste mogelijkheden opgesomd:',
    'Friends and Followers' => 'Vrienden en volgers',
    'Allow registered members to maintain a list of friends across your community'
      => 'Laat geregistreerde leden een lijst bijhouden van hun vrienden in uw community',
...
## addons/Community.pack/templates/global/new_entry_email.mtml
    'A new entry \'[_1]([_2])\' has been posted on your blog [_3].' =>
      'Een nieuw bericht  \'[_1]([_2])\' werd gepubliceerd op uw blog [_3].',
...
## addons/Community.pack/templates/global/password_reset_form.mtml
    ...
    'Your password has been changed, and the new password has been sent to your email address ([_1]).'
      => 'Uw wachtwoord is veranderd en het nieuwe wachtwoord is naar uw e-mailadres ([_1]) gestuurd.',
...
## addons/Community.pack/templates/global/email_verification_email.mtml
    ...
    'If you did not make this request, or you don\'t want to register for an account to [_1], then no further action is required.'
      => 'Als u hier niet zelf om gevraagd heeft, of u wenst geen account te registreren op [_1], dan is er niets dat u verder hoeft te doen.',
...
## addons/Community.pack/templates/blog/entry_response.mtml
    ...
    'Return to the <a href="[_1]">blog\'s main index</a>.' =>
      'Terugkeren naar de <a href="[_1]">hoofdpagina van de blog</a>.',
...
## addons/Community.pack/templates/blog/entry_form.mtml
    ...
    'You don\'t have permission to post.' =>
      'U heeft geen permissie om een bericht te publiceren.',
...
## addons/Community.pack/templates/forum/entry_response.mtml
    ...
    'Return to the <a href="[_1]">forum\'s homepage</a>.' =>
      'Terugkeren naar de <a href="[_1]">hoofdpagina van het forum</a>.',
...
## addons/Commercial.pack/config.yaml
    ...
    'Themes that are compatible with the Professional Website template set.'
      => 'Designs die compatibel zijn met de Professionele Website sjabloonset.',
...
## addons/Commercial.pack/lib/MT/Commercial/Util.pm
    'Could not install custom field [_1]: field attribute [_2] is required' =>
      'Kon gepersonaliseerd veld [_1] niet installeren: attribuut [_2] is vereist voor dit veld',
    'Could not install custom field [_1] on blog [_2]: the blog already has a field [_1] with a conflicting type'
      => 'Kon gepersonaliseerd veld [_1] niet installeren op blog [_2]: er is op die blog al een veld [_1] van een conflicterend type',
    'Blog [_1] using template set [_2]' =>
      'Blog [_1] gebruik set sjablonen [_2]',
    'About' => 'Over',
    '_PTS_REPLACE_THIS' =>
      '<p><strong>Vervang de voorbeeldtekst door uw eigen informatie.</strong></p>',
    '_PTS_SAMPLE_ABOUT' => '
...
',
    'New design launched using Melody' =>
      'Nieuw design gelanceerd met Melody',
    '_PTS_SAMPLE_NEWDESIGN' => '
<p>Onze website zit in een volledig nieuw kleedje dankzij <a href="http://www.movabletype.com/">Melody</a> en de Universele Set Sjablonen. Met de Universele Set Sjablonen kan iedereen in een paar minuten van start gaan met een nieuwe website op Melody. Dit alles in slechts een paar klikken. Maak een nieuwe blog aan, selecteer de Universele Set Sjablonen en publiceer de site.  Voila: on nieuwe website!. Bedankt Melody!</p>
',
    ...
    'Great new site. I can\'t wait to try Melody. Congrats!' =>
      'Geweldige nieuwe site.  Ik kan niet wachten om Melody zelf te proberen.  Proficiat!',
    'Created entry and comment \'[_1]\'' =>
      'Bericht en reactie \'[_1]\' aangemaakt',
...
## addons/Commercial.pack/lib/CustomFields/App/CMS.pm
    ...
    'Please enter all allowable options for this field as a comma delimited list'
      => 'Gelieve alle toegestane waarden voor dit veld in te vullen als een lijst gescheiden door komma\'s',
    ...
    'The basename \'[_1]\' is already in use.' =>
      'De basisnaam \'[_1]\' is al in gebruik',
...
## addons/Commercial.pack/tmpl/edit_field.tmpl
    ...
    'Please ensure all required fields (highlighted) have been filled in.' =>
      'Gelieve te controleren dat alle verplichte velden (gekleurd) ingevuld zijn.',
    'System Object' => 'Systeemobject',
    'Select the system object this field is for' =>
      'Selecteer het systeemobject waar dit veld voor dient',
    'Select...' => 'Selecteer...',
    'Required?' => 'Verplicht?',
    'Should a value be chosen or entered into this field?' =>
      'Moet er een waarde gekozen of ingevuld worden in dit veld?',
    'Default' => 'Standaard',
    'You will need to first save this field in order to set a default value'
      => 'U moet dit veld eerst opslaan om een standaardwaarde te kunnen instellen',
    '_CF_BASENAME' => 'Basename',
    'The basename is used for entering custom field data through a 3rd party client. It must be unique.'
      => 'De basisnaam wordt gebruikt om gepersonaliseerde veld informatie in te voeren via een cliënt van derden.  Hij moet uniek zijn.',
    ...
    'Warning: Changing this field\'s basename may require changes to existing templates.'
      => 'Waarschuwing: het aanpassen van de basisnaam van deze tag vereist mogelijk aanpassingen aan bestaande sjablonen.',
    'Template Tag' => 'Sjabloontag',
    'Create a custom template tag for this field.' =>
      'Maak een gepersonaliseerde sjabloontag aan voor dit veld',
...
## addons/Enterprise.pack/config.yaml
    ...
    'Microsoft SQL Server Database (UTF-8 support)' =>
      'Microsoft SQL Server database (UTF-8 ondersteuning)',
...
## addons/Enterprise.pack/lib/MT/Enterprise/BulkCreation.pm
    ...
    'Invalid password recovery phrase: [_1]' =>
      'Ongeldig woord of uitdrukking om wachtwoord terug te vinden: [_1]',
    'Invalid weblog name: [_1]' => 'Ongeldige weblognaam: [_1]',
    'Invalid weblog description: [_1]' =>
      'Ongeldige weblogbeschrijving: [_1]',
    ...
    'A user with the same name was found.  Register was not processed: [_1]'
      => 'Een gebruiker met dezelfde naam werd al gevonden.  Registratie niet verwerkt: [_1]',
...
## addons/Enterprise.pack/lib/MT/Enterprise/CMS.pm
    ...
    'You can not create associations for disabled groups.' =>
      'U kunt geen associaties aanmaken voor uitgeschakelde groepen',
    ...
    'Melody Enterprise has just attempted to disable your account during synchronization with the external directory. Some of the external user management settings must be wrong. Please correct your configuration before proceeding.'
      => 'Melody Enterprise probeerde net uw account uit te schakelen tijdens synchronisatie met de externe directory.  Er moet een fout zitten in de instellingen voor extern gebruikersbeheer.  Gelieve uw configuratie bij te stellen voor u verder gaat.',
    ...
    'No record found in the file.  Make sure the file uses CRLF as the line ending character.'
      => 'Geen records gevonden in bestand.  Controleer dat het bestand CRLF gebruikt om regels mee af te sluiten.',
...
## addons/Enterprise.pack/lib/MT/Auth/LDAP.pm
    ...
    'Failed login attempt by user \'[_1]\' deleted from LDAP.' =>
      'Mislukte aanmeldpoging van gebruiker \'[_1]\' verwijderd uit de LDAP.',
    ...
    "Failed login attempt by user \'[_1]\'. A user with that\nusername already exists in the system with a different UUID."
      => "Aanmelden mislukt van gebruiker \'[_1]\'.  Een gebruiker met die
gebruikersnaam bestaat al in het systeem met een andere UUID.",
    ...
    'The following users\' information were modified:' =>
      'Gebruikersinformaie van deze gebruikers werd aangepast:',
    ...
    'Synchronization of groups can not be performed without LDAPGroupIdAttribute and/or LDAPGroupNameAttribute is set.'
      => 'Synchronisatie van groepen kan niet worden uitgevoerd zonder dat LDAPGroupIdAttribute en/of LDAPGroupNameAttribute ingesteld is.',
    ...
    'The following groups\' information were modified:' =>
      'De informatie van volgende groepen werd gewijzigd.',
    'No LDAP group was found using given filter.' =>
      'Er werd geen LDAP groep gevonden met de opgegeven filter.',
    "Filter used to search for groups: [_1]\nSearch base: [_2]" =>
      "Filter gebruikt om te zoeken naar groepen: [_1]
Zoekbasis: [_2]",
    '(none)' => '(Geen)',
    ...
    '[_1] directive must be set to synchronize members of LDAP groups to Melody Enterprise.'
      => '´[_1] directief moet ingesteld zijn om leden van een LDAP groep te synchroniseren naar Melody Enterprise',
    ...
    'Memberships of the group \'[_2]\' (#[_3]) has been changed in synchronizing with external directory.'
      => 'Lidmaatschappen van de groep \'[_2]\' (#[_3] zijn gewijzigd tijdens het synchroniseren met de externe directory.',
    'LDAPUserGroupMemberAttribute must be set to enable synchronize members of groups.'
      => 'LDAPUserGroupMemberAttribuut moet ingesteld zijn om synchronisatie tussen de leden van groepen toe te staan.',
...
## addons/Enterprise.pack/lib/MT/LDAP.pm
    ...
    'More than one user with the same name found on LDAP: [_1]' =>
      'Meer dan één gebruiker gevonden met dezelfde naam op LDAP: [_1]',
...
## addons/Enterprise.pack/tmpl/dialog/select_groups.tmpl
    ...
    'Before you can do this, you need to create some groups. <a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">Click here</a> to create a group.'
      => 'Voor u dit kunt doen, moet u eerst een paar groepen aanmaken. <a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">Klik hier</a> om een groep aan te maken.',
...
## addons/Enterprise.pack/tmpl/list_group.tmpl
    ...
    'You have successfully disabled the selected group(s).' =>
      'De geselecteerde groep(en) werden met suuces uitgeschakeld.',
    'You have successfully enabled the selected group(s).' =>
      'De geselecteerde groep(en) werden met suuces ingeschakeld.',
    'You have successfully deleted the groups from the Melody system.' =>
      'De geselecteerde groep werd verwijderd uit het Melody systeem.',
    'You have successfully synchronized groups\' information with the external directory.'
      => 'U heeft met succes groepsinformatie gesynchroniseerd met de externe directory.',
    'The user <em>[_1]</em> is currently disabled.' =>
      'De gebruiker <em>[_1]</em> is momenteel niet actief.',
    'You can not add disabled users to groups.' =>
      'U kunt geen uitgeschakelde gebruikers toevoegen aan een groep.',
    'Add [_1] to another group' => 'Voeg [_1] toe aan een andere groep',
    'Create Group'              => 'Groep aanmaken',
    'You did not select any [_1] to remove.' =>
      'U selecteerde geen [_] om te verwijderen.',
    'Are you sure you want to remove this [_1]?' =>
      'Bent u zeker dat u deze [_1] wenst te verwijderen?',
    'Are you sure you want to remove the [_1] selected [_2]?' =>
      'Bent u zeker dat u de [_1] geselecteerde [_2] wenst te verwijderen?',
...
## addons/Enterprise.pack/tmpl/create_author_bulk_end.tmpl
    ...
    'An error occurred during the updating process. Please check your CSV file.'
      => 'Er deed zich een probleem voor tijdens het updateproces.  Controleer uw CSV bestand.',
...
## addons/Enterprise.pack/tmpl/list_group_member.tmpl
    ...
    'You have successfully deleted the users.' =>
      'De geselecteerde gebruikers werden verwijderd',
    'You have successfully added new users to this group.' =>
      'U heeft met succes nieuwe gebruikers toegevoegd aan deze groep.',
    'You have successfully synchronized users\' information with external directory.'
      => 'U heeft met succes de gebruikersinformatie gesynchroniseerd met een externe directory.',
    'Some ([_1]) of the selected users could not be re-enabled because they were no longer found in LDAP.'
      => 'Enkele ([_1]) van de geselecteerde gebruikers konden niet opnieuw worden ingeschakeld omdat ze niet meer werden gevonden in de LDAP.',
    'You have successfully removed the users from this group.' =>
      'U heeft met succes de gebruikers verwijderd uit deze groep.',
    'Group Disabled' => 'Groep uitgeschakeld',
    'You can not add users to a disabled group.' =>
      'U kunt geen leden toevoegen aan een uitgeschakelde groep.',
    ...
    'Showing only users whose [_1] is [_2].' =>
      'Enkel gebruikers waarvan de [_1] [_2] is.',
    'Show'                     => 'Tonen',
    'all'                      => 'alle',
    'only'                     => 'enkel',
    ...
    'Are you sure you want to remove this [_1] from this group?' =>
      'Bent u zeker dat u deze [_1] wenst te verwijderen uit deze groep?',
    'Are you sure you want to remove the [_1] selected [_2] from this group?'
      => 'Bent u zeker dat u de [_1] geselecteerde [_2] wenst te verwijderen uit deze groep?',
...
## addons/Enterprise.pack/tmpl/cfg_ldap.tmpl
    ...
    'Click \'Continue\' below to configure the External User Management settings.'
      => 'Klik hieronder op \'Doorgaan\' om de instellingen voor extern gebruikersbeheer te configureren.',
    'Click \'Continue\' below to configure your LDAP attribute mappings.' =>
      'Klik hieronder op \'Doorgaan\' om uw LDAP attribute mappings in te stellen.',
    ...
    'To finish with the configuration wizard, press \'Continue\' below.' =>
      'Om naar het einde van de configuratiewizard te gaan, klik hieronder op \'Doorgaan\'.',
    ...
    'The name of SASL Mechanism to use for both binding and authentication.'
      => 'De naam van het SASL mechanisme dat gebruikt moet worden bij het binden en de authenticatie.',
...
## addons/Enterprise.pack/tmpl/edit_group.tmpl
    ...
    'Status of group in the system. Disabling a group removes its members&rsquo; access to the system but preserves their content and history.'
      => 'Status van de groep in het systeem.  Een groep uitschakelen heft de toegang tot het systeem op van de groepsleden maar bewaart wel hun inhoud en geschiedenis.',
    ...
    'Enter a description for your group.' =>
      'Vul een beschrijving in voor uw groep.',
    'Created on' => 'Aangemaakt',
...
## plugins/Markdown/SmartyPants.pl
    'Easily translates plain punctuation characters into \'smart\' typographic punctuation.'
      => 'Vertaalt op eenvoudige menier gewone punctuatie in \'slimme\' typografische punctuatie.',
...
## plugins/WXRImporter/tmpl/options.tmpl
    'Before you import WordPress posts to Melody, we recommend that you <a href=\'[_1]\'>configure your blog\'s publishing paths</a> first.'
      => '\n	Voor u WordPress berichten importeert in Melody, raden we aan om eerst <a href=\'[_1]\'>de publicatiepaden van uw weblog in te stellen</a>.',
...
## plugins/TypePadAntiSpam/tmpl/system.tmpl
    ...
    'To enable this plugin, you\'ll need a free TypePad AntiSpam API key. You can <strong>get your free API key at [_1]antispam.typepad.com[_2]</strong>. Once you have your key, return to this page and enter it in the field below.'
      => 'Om deze plugin te kunnen inschakelen heeft u een gratis TypePad AntiSpam API sleutel nodig.  U kunt uw <strong>gratis API sleutel afhalen op [_1]antispam.typepad.com[_2]</strong>.  Zodra u uw sleutel heeft, moet u terugkeren naar deze pagina en hem hieronder invullen.',
...
## plugins/TypePadAntiSpam/TypePadAntiSpam.pl
    'TypePad AntiSpam is a free service from Six Apart that helps protect your blog from comment and TrackBack spam. The TypePad AntiSpam plugin will send every comment or TrackBack submitted to your blog to the service for evaluation, and Melody will filter items if TypePad AntiSpam determines it is spam. If you discover that TypePad AntiSpam incorrectly classifies an item, simply change its classification by marking it as "Spam" or "Not Spam" from the Manage Comments screen, and TypePad AntiSpam will learn from your actions. Over time the service will improve based on reports from its users, so take care when marking items as "Spam" or "Not Spam."'
      => 'TypePad AntiSpam is een gratis service van Six Apart die helpt uw blog te beschermen tegen spam in uw reacties en TrackBacks.  De TypePad AntiSpam plugin verstuurt elke reactie of TrackBack die ontvangen wordt op uw blog door naar de service waar ze dan beoordeeld worden.  Melody zal items filteren als TypePad AntiSpam bepaalt dat ze spam zijn.  Als u merkt dat TypePad AntiSpam items niet correct classificeert dan kunt u de classificatie eenvoudigweg aanpassen door ze als "Spam" of "Geen Spam" te markeren vanop het scherm voor reactiebeheer.  TypePad AntiSpam zal dan leren uit uw acties.  Na verloop van tijd wordt de service dus altijd maar beter, gebaseerd op rapporten van gebruikers, dus let op voor u iets als "Spam" of "Geen Spam" markeert!',
...
## plugins/StyleCatcher/config.yaml
    'StyleCatcher lets you easily browse through styles and then apply them to your blog in just a few clicks. To find out more about Melody styles, or for new sources for styles, visit the <a href=\'http://www.sixapart.com/movabletype/styles\'>Melody styles</a> page.'
      => 'Met StyleCatcher kunt u makkelijk een keuze maken tussen stijlen om ze daarna op uw blog toe te passen in een paar klikken.  Om meer te weten over Melody stijlen, of om een bron te vinden van nog meer stijlen, bezoek de <a href=\'http://www.sixapart.com/movabletype/styles\'>Melody styles</a> pagina.',
    'MT 4 Style Library' => 'MT 4 Stijlenbibliotheek',
    'A collection of styles compatible with Melody 4 default templates.' =>
      'Een verzameling stijlen compatibel met de standaardsjablonen van Melody 4.',
    'Styles' => 'Stijlen',
...
## plugins/StyleCatcher/tmpl/view.tmpl
    ...
    'Error loading themes! -- [_1]' =>
      'Fout bij het laden van thema\'s! -- [_1]',
...
## plugins/spamlookup/tmpl/url_config.tmpl
    ...
    'Exclude URLs from comments published within last [_1] days.' =>
      'URL\'s uitsluiten van reacties gepubliceerd in de laastste [_1] dagen.',
...
## plugins/MultiBlog/lib/MultiBlog.pm
    'The include_blogs, exclude_blogs, blog_ids and blog_id attributes cannot be used together.'
      => 'De include_blogs, exclude_blogs, blog_ids en blog_id attributen kunnen niet samen gebruikt worden.',
    'The attribute exclude_blogs cannot take "all" for a value.' =>
      'Het attribuut exclude_blogs kan niet "all" als waarde hebben.',
    'The value of the blog_id attribute must be a single blog ID.' =>
      'De waarde van het blog_id attribuut moet één Blog ID zijn.',
    'The value for the include_blogs/exclude_blogs attributes must be one or more blog IDs, separated by commas.'
      => 'De waarde voor de include_blogs/exclude_blogs attributen moet één of meer Blog ID\'s zijn, gescheiden door komma\'s.',
...
## plugins/MultiBlog/multiblog.pl
    ...
    'Select to apply this trigger to all weblogs' =>
      'Selecteer dit om de trigger toe te passen op alle weblogs',
...
## plugins/MultiBlog/tmpl/blog_config.tmpl
    ...
    'Enables use of the MTMultiBlog tag without include_blogs/exclude_blogs attributes. Comma-separated BlogIDs or \'all\' (include_blogs only) are acceptable values.'
      => 'Maakt het mogelijk om de MTMultiBlog tag te gebruiken zonder include_blogs/exclude_blogs attributen.  Toegestane waarden zijn BlogID\'s gescheden door komma\'s of \'all\' (enkel bij include_blogs).',
...
## plugins/WidgetManager/WidgetManager.pl
    'Widget Manager version 1.1; This version of the plugin is to upgrade data from older version of Widget Manager that has been shipped with Melody to the Melody core schema.  No other features are included.  You can safely remove this plugin after installing/upgrading Melody.'
      => 'Widget Manager versie 1.1: Deze versie van de plugin dient om data van de oudere versie van Widget Manager die met Melody werd meegeleverd over te zetten naar de kern van Melody.  Er zitten geen andere opties in.  Deze plugin kan zonder problemen verwijderd worden na de installatie/upgrade van Melody.',
    'Moving storage of Widget Manager [_1]...' =>
      'Opslagruimte van Widget Manager aan het overzetten [_1]...',
...
## plugins/feeds-app-lite/tmpl/msg.tmpl
    ...
    'An error occurred processing [_1]. Check <a href="javascript:void(0)" onclick="closeDialog(\'http://www.feedvalidator.org/check.cgi?url=[_2]\')">here</a> for more detail and please try again.'
      => 'Er deed zich een fout voor bij het verwerken van [_1]. Kijk dit <a href="javascript:void(0)" onclick="closeDialog(\'http://www.feedvalidator.org/check.cgi?url=[_2]\')">hier</a> na voor meer details en probeer opnieuw.',
    ...
    'You may now <a href="javascript:void(0)" onclick="closeDialog(\'[_2]\')">edit &ldquo;[_1]&rdquo;</a> or include the widget in your blog using <a href="javascript:void(0)" onclick="closeDialog(\'[_3]\')">WidgetManager</a> or the following MTInclude tag:'
      => 'U kunt nu dit widget <a href="javascript:void(0)" onclick="closeDialog(\'[_2]\')">&ldquo;[_1]&rdquo; bewerken</a> of includeren in uw blog met behulp van <a href="javascript:void(0)" onclick="closeDialog(\'[_3]\')">WidgetManager</a> of volgende MTInclude tag:',
    'You may now <a href="javascript:void(0)" onclick="closeDialog(\'[_2]\')">edit &ldquo;[_1]&rdquo;</a> or include the widget in your blog using the following MTInclude tag:'
      => 'U kunt nu dit widget <a href="javascript:void(0)" onclick="closeDialog(\'[_2]\')">&ldquo;[_1]&rdquo; bewerken</a> of includeren in uw weblog met behulp van volgende MTInclude tag:',
...
## plugins/feeds-app-lite/mt-feeds.pl
    'Feeds.App Lite helps you republish feeds on your blogs. Want to do more with feeds in Melody? <a href="http://code.appnel.com/feeds-app" target="_blank">Upgrade to Feeds.App</a>.'
      => 'Feeds.App Lite maakt het mogelijk feeds te herpubliceren op uw blog.  Meer doen met feeds in Melody? <a href="http://code.appnel.com/feeds-app" target="_blank">Upgraden naar Feeds.App</a>.',
...
## plugins/CommunityActionStreams/config.yaml
    'Action streams for community events: add entry, add comment, add favorite, follow user.'
      => 'Action streams voor community events: bericht toevoegen, reactie toevoegen, favoriet toevoegen, gebruiker volgen.',

## plugins/Motion/config.yaml
    'A Melody theme with structured entries and action streams.' =>
      'Een Melody thema met gestructureerde berichten en action streams.',
    'Adjusting field types for embed custom fields...' =>
      'Veldtypes aan het aanpassen voor gepersonaliseerde velden van type embed...',
    'Updating favoriting namespace for Motion...' =>
      'Favoriting namespace aan het bijwerken voor Motion...',
    ...
    'Main Column Posting Form (All Media)' =>
      'Hoofdkolom publicatieformulier (alle media)',
    'Main Column Posting Form (Text Only, Like Twitter)' =>
      'Hoofdkolom publicatieformulier (enkel tekst, zoals Twitter)',
...
## plugins/Motion/lib/Motion/Search.pm
    'This module works with MT::App::Search.' =>
      'Deze module werkt met MT::App::Search.',
    'Specify the blog_id of a blog that has Motion template set.' =>
      'Geef het blog_id op van een blog die de Motion sjabloonset gebruikt.',
...
## plugins/Motion/templates/Motion/widget_popular_entries.mtml
    'posted by <a href="[_1]">[_2]</a> on [_3]' =>
      'gepubliceerd door <a href="[_1]">[_2]</a> op [_3]',
...
## plugins/Motion/templates/Motion/widget_about_ssite.mtml
    ...
    'The Motion Template Set is a great example of the type of site you can build with Melody.'
      => 'De Motion sjabloonset is een goed voorbeeld van het soort site dat met Melody gebouwd kan worden.',
...
## plugins/Motion/templates/Motion/single_entry.mtml
    'By [_1] <span class="date">on [_2]</span>' =>
      'Door [_1] <span class="date">op [_2]</span>',
    ...
    'Note: This post is being held for approval by the site owner.' =>
      'Opmerking: dit bericht wordt tegengehouden tot de eigenaar van de site het goedkeurt.',
    '<a href="[_1]">Most recent comment by <strong>[_2]</strong> on [_3]</a>'
      => '<a href="[_1]">Recentste reactie van <strong>[_2]</strong> op [_3]</a>',
...
## plugins/Motion/templates/Motion/javascript.mtml
    'Please select a file to post.' =>
      'Gelieve een bestand te kiezen om te publiceren.',
    'You selected an unsupported file type.' =>
      'U selecteerde een type bestand dat niet wordt ondersteund.',
...
## plugins/Motion/templates/Motion/widget_elsewhere.mtml
    'Are you sure you want to remove the [_1] from your profile?' =>
      'Zeker om [_1] van uw profiel verwijderen?',
    'Your user name or ID is required.' =>
      'Uw gebruikersnaam of ID is vereist.',
...
## plugins/Motion/templates/Motion/widget_main_column_registration.mtml
    '<a href="javascript:void(0)" onclick="[_1]">Sign In</a>' =>
      '<a href="javascript:void(0)" onclick="[_1]">Aanmelden</a>',
    'Not a member? <a href="[_1]">Register</a>' =>
      'Nog geen lid? <a href="[_1]">Registreer nu</a>',
    '(or <a href="javascript:void(0)" onclick="[_1]">Sign In</a>)' =>
      '(of <a href="javascript:void(0)" onclick="[_1]">meld u aan</a>)',
...
## plugins/Motion/templates/Motion/widget_main_column_posting_form.mtml
    ...
    'Only GIF, JPEG and PNG image files are supported.' =>
      'Enkel GIF, JPEG en PNG afbeeldingsbestanden worden ondersteund.',
    'Select audio file' => 'Selecteer audiobestand',
    'Only MP3 audio files are supported.' =>
      'Alleen MP3 audiobestanden worden ondersteund.',
...
## plugins/Motion/templates/Motion/comments.mtml
    ...
    '[_1] [_2]in reply to comment from [_3][_4]' =>
      '[_1] [_2]als antwoord op reactie van [_3][_4]',
...
## plugins/Motion/templates/Motion/actions.mtml
    ...
    '[_1] favorited [_2] on [_3]' =>
      '[_1] markeerde [_2] als favoriet op [_3]',
...
## plugins/FacebookCommenters/plugin.pl
    ...
    '{*actor*} commented on the blog post <a href="{*post_url*}">{*post_title*}</a>.'
      => '{*actor*} reageerde op blogbericht <a href="{*post_url*}">{*post_title*}</a>.',
    'Could not register story template with Facebook: [_1]. Did you enter the correct application secret?'
      => 'Kon verhaalsjabloon niet registreren bij Facebook: [_1].  Vulde u het correcte applicatiegeheim in?',
    'Could not register story template with Facebook: [_1]' =>
      'Kon verhaalsjabloon niet registreren bij Facebook: [_1].',
    'Facebook' => 'Facebook',
...
## plugins/mixiComment/mixiComment.pl
    'Allows commenters to sign in to Melody 4 using their own mixi username and password via OpenID.'
      => 'Laat reageerders zich aanmelden op Melody met hun eigen mixi gebruikersnaam en wachtwoord via OpenID.',
    'Sign in using your mixi ID' => 'Aanmelden met uw mixi ID',
    'Click the button to sign in using your mixi ID' =>
      'Klik op de knop om aan te melden met uw mixi ID',
    'mixi' => 'mixi',
...
## plugins/ActionStreams/streams.yaml
    ...
    'The games in your collection you\'re currently playing' =>
      'De spelletjes in uw collectie die u momenteel aan het spelen bent',
    'Comments you have made on the web' =>
      'Reacties die u elders op het web heeft achtergelaten',
    'Colors'             => 'Kleuren',
    ...
    'Palettes you saved as favorites' =>
      'Paletten die u heeft opgeslagen als favorieten',
    ...
    'Books on your "to-read" shelf' =>
      'Boeken op uw \'te lezen\' boekenplank',
    'Reading' => 'Aan het lezen',
    'Books on your "currently-reading" shelf' =>
      'Boeken op uw \'momenteel aan het lezen\' boekenplank',
    'Read'                         => 'Gelezen',
    ...
    'Photos you posted that were approved' =>
      'Foto\'s die u publiceerde en die werden goedgekeurd',
    'Recent events' => 'Recente gebeurtenissen',
    'Events from your recent events feed' =>
      'Gebeurtenissen uit uw feed met recente gebeurtenissen',
    'Apps you use' => 'Applicaties die u gebruikt',
    'The applications you saved as ones you use' =>
      'De applicaties die u heeft opgeslagen als applicaties die u gebruikt',
    'Videos you saved as watched' =>
      'Video\'s die u heeft opgeslagen als bekeken',
    'Jaikus'            => 'Jaikus',
    'Jaikus you posted' => 'Jaikus die u publiceerde',
    'Games you saved as favorites' =>
      'Spelletjes die u heeft opgeslagen als favorieten',
    ...
    'Songs you recently listened to (High spam potential!)' =>
      'Liedjes waar u recent naar geluisterd heeft (hoge kans op spam!)',
    'Loved Tracks' => 'Geliefde tracks',
    'Songs you marked as "loved"' =>
      'Tracks waarvan u heeft aangegeven dat u ervan houdt',
    ...
    'The events you said you\'ll be attending' =>
      'De evenementen waarvan u gezegd hebt dat u er zal zijn',
    'Your public posts to your journal' =>
      'Uw publieke berichten op uw dagboek',
    'Queue' => 'Wachtrij',
    'Movies you added to your rental queue' =>
      'Films toegevoegd aan uw huurwachtrij',
    ...
    'Songs you marked as favorites' =>
      'Liedjes die u heeft aangemerkt als favorieten',
    'Favorite Artists' => 'Favoriete artiesten',
    'Artists you marked as favorites' =>
      'Artiesten die u heeft aangemerkt als favorieten',
    'Stations'                    => 'Zenders',
    ...
    'Articles you liked (your votes must be public)' =>
      'Artikels die u heeft aangemerkt als favorieten',
    'Dislikes' => 'Afgekeurd',
    'Articles you disliked (your votes must be public)' =>
      'Artikels waar u een afkeer voor heeft laten blijken (stemmen moeten publiek zijn)',
    'Slideshows you saved as favorites' =>
      'Diavoorstellingen die u als favorieten heeft opgeslagen',
...
## plugins/ActionStreams/services.yaml
    ...
    'You can find your Facebook userid within your profile URL.  For example, http://www.facebook.com/profile.php?id=24400320.'
      => 'U kunt uw Facebook userid terugvinden in de URL van uw profiel.  Bijvoorbeeld, http://www.facebook.com/profile.php?id=24400320.',
    'FFFFOUND!' => 'FFFFOUND',
    'Flickr'    => 'Flickr',
    'Enter your Flickr userid which contains "@" in it, e.g. 36381329@N00.  Flickr userid is NOT the username in the URL of your photostream.'
      => 'Vul uw Flickr userid in (dit bevat een "@", bijvoorbeeld 36381329@N00). Het Flickr userid is niet de gebruikersnaam in uw photostream',
    ...
    'You can find your Goodreads userid within your profile URL. For example, http://www.goodreads.com/user/show/123456.'
      => 'U kunt uw Goodreads userid vinden in de URL van uw profiel.  Bijvoorbeeld http://www.goodreads.com/user/show/123456.',
    ...
    'You can find your istockphoto userid within your profile URL.  For example, http://www.istockphoto.com/user_view.php?id=1234567.'
      => 'U kunt uw iStockPhoto userid vinden in de URL van uw profiel.  Bijvoorbeeld, http://www.istockphoto.com/user_view.php?id=1234567.',
    'IUseThis'        => 'iUseThis',
    ...
    'To find your Netflix RSS ID, click "RSS" at the bottom of any page on the Netflix site, then copy and paste in your "Queue" link.'
      => 'Om uw Netflix RSS ID terug te vinden, moet u op "RSS" klikken onderaan éénder welke pagina op de Netflix site en dan uw "Queue" link knippen en plakken.',
    'Netvibes'           => 'Netvibes',
    'Newsvine'           => 'Newsvine',
    'Ning'               => 'Ning',
    ...
    'You can find your orkut uid within your profile URL. For example, http://www.orkut.com/Main#Profile.aspx?rl=ls&uid=1234567890123456789'
      => 'U kunt uw Orkut uid terugvinden in de URL van uw profiel.  Bijvoorbeeld, http://www.orkut.com/Main#Profile.aspx?rl=ls&uid=1234567890123456789',
    'Pandora'           => 'Pandora',
    ...
    'You can find your p0pulist user id within your Hot List URL. for example, http://p0pulist.com/list/hot_list/10000'
      => 'U kunt uw p0pulist userid terugvinden in de URL van uw Hot List.  Bijvoorbeeld, http://p0pulist.com/list/hot_list/10000',
    'Pownce'      => 'Pownce',
    'Reddit'      => 'Reddit',
    'Skype'       => 'Skype',
    ...
    'You can find your SonicLiving userid within your share&subscribe URL. For example, http://sonicliving.com/user/12345/feeds'
      => 'U kunt uw SonicLiving userid vinden in uw share&subscribe URL.  Bijvoorbeeld, http://sonicliving.com/user/12345/feeds',
    'Steam'       => 'Steam',
    'StumbleUpon' => 'StumbleUpon',
    'Tabblo'      => 'Tabblo',
    'Blank should be replaced by positive sign (+).' =>
      'Blank moet vervangen worden met een plusteken (+)',
    'Tribe' => 'Tribe',
    'You can find your tribe userid within your profile URL.  For example, http://people.tribe.net/dcdc61ed-696a-40b5-80c1-e9a9809a726a.'
      => 'U kunt uw tribe userid terugvingen in de URL van uw profiel.  Bijvoorbeeld, http://people.tribe.net/dcdc61ed-696a-40b5-80c1-e9a9809a726a.',
    'Tumblr'        => 'Tumblr',
    'Twitter'       => 'Twitter',
    ...
    'You can find your VIRB userid within your home URL.  For example, http://www.virb.com/backend/2756504321310091/your_home.'
      => 'U kunt uw VIRB userid in uw home URL terugvinden.  Bijvoorbeeld, http://www.virb.com/backend/2756504321310091/your_home.',
    'Vox name'           => 'Vox-naam',
    'Website'            => 'Website',
    'Xbox Live\''        => 'Xbox Live\'',
    'Gamertag'           => 'Gamertag',
...
## plugins/ActionStreams/config.yaml
    'Manages authors\' accounts and actions on sites elsewhere around the web'
      => 'Beheert account en acties van de auteurs elders op het web',
    'Are you sure you want to hide EVERY event in EVERY action stream?' =>
      'Bent u zeker dat u ELKE gebeurtenis in ELKE action stream wenst te verbergen?',
    'Are you sure you want to show EVERY event in EVERY action stream?' =>
      'Bent u zeker dat u ELKE gebeurtenis in ELKE action stream wenst te tonen?',
    'Deleted events that are still available from the remote service will be added back in the next scan. Only events that are no longer available from your profile will remain deleted. Are you sure you want to delete the selected event(s)?'
      => 'Verwijderde gebeurtenissen die nog steeds beschikbaar zijn via de externe service zullen opnieuw worden toegevoegd bij de volgende scan. Enkel gebeurtenissen die niet meer op uw profiel voorkomen zullen verwijderd blijven.  Bent u zeker dat u de geselecteerde gebeurtenis(sen) wenst te verwijderen?',
    ...
    'Enabling default action streams for selected profiles...' =>
      'Standaard action streams inschakelen voor geselecteerde profielen...',

## plugins/ActionStreams/lib/ActionStreams/Upgrade.pm
    'Updating classification of [_1] [_2] actions...' =>
      'Classificatie bij aan het werken voor [_1] [_2] acties...',
    'Renaming "[_1]" data of [_2] [_3] actions...' =>
      '"[_1] gegevens van [_2] [_3] acties een nieuwe naam aan het geven...',
...
## plugins/ActionStreams/lib/ActionStreams/Event.pm
    '[_1] updating [_2] events for [_3]' =>
      '[_1] [_2] evenementen aan het bijwerken voor [_3]',
    'Error updating events for [_1]\'s [_2] stream (type [_3] ident [_4]): [_5]'
      => 'Fout bij het updaten van evenementen voor [_1]\'s [_2] stream (type [_3] ident [_4]: [5]',
    'Could not load class [_1] for stream [_2] [_3]: [_4]' =>
      'Kon klasse [_1] voor stream [_2] [_3] niet laden: [_4]',
    'No URL to fetch for [_1] results' =>
      'Geen URL binnen te halen voor [_1] resultaten',
...
## plugins/ActionStreams/tmpl/dialog_edit_profile.tmpl
    ...
    'Edit a profile on a social networking or instant messaging service.' =>
      'Bewerk een profiel op een sociaal netwerk of instant messaging dienst.',
    'Service' => 'Service',
    'Enter your account on the selected service.' =>
      'Vul uw account op de geselecteerde service in.',
    'For example:'   => 'Bijvoorbeeld:',
    'Action Streams' => 'Action Streams',
    'Select the action streams to collect from the selected service.' =>
      'Selecteer de action streams die opgehaald moeten worden van de geselecteerde service.',
    'No streams are available for this service.' =>
      'Geen streams beschikbaar van deze service',

## plugins/ActionStreams/tmpl/other_profiles.tmpl
    'The selected profile was added.' =>
      'Het geselecteerde profiel werd toegevoegd.',
    'The selected profiles were removed.' =>
      'De geselecteerde profielen werden verwijderd.',
    'The selected profiles were scanned for updates.' =>
      'De geselecteerde profielen werden gescand op updates.',
    'The changes to the profile have been saved.' =>
      'De wijzigingen aan het profiel werden opgeslagen.',
    'Add Profile' => 'Prfiel toevoegen',
    'profile'     => 'profiel',
    'profiles'    => 'profielen',
    'Delete selected profiles (x)' =>
      'Geselecteerde profielen verwijderen (x)',
...
## plugins/ActionStreams/tmpl/dialog_add_profile.tmpl
    'Add a profile on a social networking or instant messaging service.' =>
      'Voeg een profiel toe op een sociaal netwerk of een instant messaging dienst.',
    'Select a service where you already have an account.' =>
      'Selecteer een service waar u reeds een account heeft.',
    'Add Profile (s)' => 'Profiel Toevoegen (s)',

## plugins/ActionStreams/tmpl/list_profileevent.tmpl
    'The selected events were deleted.' =>
      'De geselecteerde gebeurtenissen werden verwijderd.',
    'The selected events were hidden.' =>
      'De geselecteerde gebeurtenissen werden verborgen.',
    'The selected events were shown.' =>
      'De geselecteerde gebeurtenissen werden weergegeven.',
    'All action stream events were hidden.' =>
      'Alle actions streams gebeurtenissen werden verborgen.',
    'All action stream events were shown.' =>
      'Alle action stream gebeurtenissen werden weergegeven.',
    'event'  => 'gebeurtenis',
    'events' => 'gebeurtenissen',
    'Hide selected events (h)' =>
      'Geselecteerde gebeurtenissen verbergen (h)',
    'Hide'                      => 'Verbergen',
...
## plugins/ActionStreams/tmpl/blog_config_template.tmpl
    ...
    'If selected, this blog\'s indexes will be rebuilt when new action stream events are discovered.'
      => 'Indien geselecteerd zullen de indexen van deze blog opnieuw worden gepubliceerd telkens nieuwe action stream gebeurtenissen worden ontdekt.',
    'Enable rebuilding' => 'Herpubliceren toestaan',

    'Extension changed from [_1] to [_2]' =>
      'Extensie gewijzigd van [_1] in [_2]',    # Translate - New
    '[_1] changed from [_2] to [_3]' =>
      '[_1] gewijzigd van [_2] in [_3]',        # Translate - New
    '\'[_1]\' edited the template \'[_2]\' in the blog \'[_3]\'' =>
      '\'[_1]\' wijzigde sjabloon \'[_2]\' in de blog \'[_3]\''
    ,                                           # Translate - New
    '\'[_1]\' edited the global template \'[_2]\'' =>
      '\'[_1]\' wijzigde het globale sjabloon \'[_2]\'',    # Translate - New
    'Entries must be cloned if comments and trackbacks are cloned' =>
      'Berichten moeten worden gekloond als reacties en trackbacks worden gekloond'
    ,                                                       # Translate - New
    'Test e-mail was successfully sent to [_1]' =>
      'Test e-mail met succes verzonden naar [_1]',         # Translate - New
    'These setting(s) are overridden by a value in the MT configuration file: [_1]. Remove the value from the configuration file in order to control the value on this page.'
      => 'Volgende instelling(en) worden genegeerd wegens een waarde in het MT configuratiebestand: [_1].  Haal de instelling weg uit het configuratiebestand om ze vanop deze pagina te kunnen beheren.'
    ,                                                       # Translate - New
    ...
    'Performance logging is on' =>
      'Performantielogging staat aan',                      # Translate - New
    'Performance logging is off' =>
      'Performantielogging staat uit',                      # Translate - New
    'Performance log path is [_1]' =>
      'Performantielogpad is [_1]',                         # Translate - New
    'Performance log threshold is [_1]' =>
      'Performantielogdrempel is [_1]',                     # Translate - New
    ...
    'This is set to the same URL as the original blog.' =>
      'Dit staat ingesteld op dezelfde URL als de oorspronkelijke blog.'
    ,                                                       # Translate - New
    'This will overwrite the original blog.' =>
      'Dit zal de oorspronkelijke blog overschrijven.',     # Translate - New
    'No such template' => 'Sjabloon bestaat niet',          # Translate - New
    'template_id cannot be a global template' =>
      'template_id mag geen systeemsjabloon zijn',          # Translate - New
    'Output file cannot be asp or php' =>
      'Uitvoerbestand mag geen asp of php zijn',            # Translate - New
    'You must pass a valid archive_type with the template_id' =>
      'U moet een geldig archieftype doorgeven met het template_id'
    ,                                                       # Translate - New
    'Template must have identifier entry_listing for non-Index archive types'
      => 'Sjabloon moet de identifier \'entry_listing\' hebben voor niet-index archieftypes'
    ,                                                       # Translate - New
    'Blog file extension cannot be asp or php for these archives' =>
      'Blogextensie kan niet asp of php zijn voor deze archieven'
    ,                                                       # Translate - New
    'Template must have identifier main_index for Index archive type' =>
      'Sjabloon moet de identifier \'main_index\' hebben voor het index archieftype'
    ,                                                       # Translate - New
    'Add New' => 'Nieuw toevogen',                          # Translate - Case
    'No asset(s) associated with this [_1]' =>
      'Geen mediabestan(en) geassociëerd met [_1]',        # Translate - New
