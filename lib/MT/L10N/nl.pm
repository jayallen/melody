...
## lib/MT/Upgrade.pm
	...
	'This role was generated by Melody upon upgrade.' => 'Deze rol werd aangemaakt door Melody tijdens de upgrade.',
...
## lib/MT/App/Comments.pm
	...
	'Invalid commenter login attempt from [_1] to blog [_2](ID: [_3]) which does not allow Melody native authentication.' => 'Ongeldige aanmeldpoging van een reageerder [_1] op blog [_2](ID: [_3]) waar geenMelody native authenticatie is toegelaten.',
...
## lib/MT/App/Upgrader.pm
	...
	'No permissions. Please contact your administrator for upgrading Melody.' => 'Geen permissies.  Gelieve uw administrator te contacteren om Melody te upgraden.',
	'Melody has been upgraded to version [_1].' => 'Melody is bijgewerkt tot versie [_1]',
...
## lib/MT/App/Wizard.pm
	...
	'CGI is required for all Melody application functionality.' => 'CGI is vereist voor alle functionaliteit van Melody.',
...
## lib/MT/Util/Captcha.pm
	'Melody default CAPTCHA provider requires Image::Magick.' => 'Standaard CAPTCHA provider van Melody vereist Image::Magick.',
...
## lib/MT/BackupRestore.pm
	...
	'Manifest file [_1] was not a valid Melody backup manifest file.' => 'Manifest-bestand [_1] was geen geldig Melody backup manifest-bestand.',
...
## lib/MT/XMLRPCServer.pm
	...
	'Template methods are not implemented, due to differences between the Blogger API and the Melody API.' => 'Sjabloonmethodes zijn niet geïmplementeerd wegens het verschil tussen de Blogger API en de Melody API.',
...
## lib/MT/CMS/Tools.pm
	...
	'This is the test email sent by your installation of Melody.' => 'Dit is de test e-mail die aan u werd gestuurd door uw Melody installatie.', # Translate - New
	...
	'Successfully restored objects to Melody system by user \'[_1]\'' => 'Objecten werden met succes teruggezet in het Melody systeem door gebruiker \'[_1]\'',
	...
	'Uploaded file was not a valid Melody backup manifest file.' => 'Het opgeladen bestand was geen geldig Melody backup manifest bestand.',
	'Blog(s) (ID:[_1]) was/were successfully backed up by user \'[_2]\'' => 'Blog(s) (ID:[_1]) werden met succes gebackupt door gebruiker \'[_2]\'',
	'Melody system was successfully backed up by user \'[_1]\'' => 'Melody systeem werd met succes gebackupt door gebruiker \'[_1]\'',
...
## lib/MT/App.pm
	...
	'Our apologies, but you do not have permission to access any blogs within this installation. If you feel you have reached this message in error, please contact your Melody system administrator.' => 'Onze excuses, maar u heeft geen permissies om toegang te krijgen tot één of meer blogs op deze installatie.  Als u meent dat u dit bericht onterecht te zien krijgt, gelieve uw Melody systeembeheerder te contacteren.',
...
## lib/MT/BackupRestore/BackupFileHandler.pm
	'Uploaded file was backed up from Melody but the different schema version ([_1]) from the one in this system ([_2]).  It is not safe to restore the file to this version of Melody.' => 'Het geuploade bestand is een backup van Melody maar het databaseschema ([_1]) verschilt van dat in dit systeem ([_2]).  Het is niet veilig om dit bestand terug te zetten op deze versie van Melody.',
	'[_1] is not a subject to be restored by Melody.' => '[_1] is geen item dat door Melody teruggezet moet worden.',
...
## lib/MT.pm.pre
	...
	'Sign in to Melody with your[_1] Account[_2]' => 'Aanmelden bij Melody met uw[_1] Account[_2]',
...
## tmpl/wizard/optional.tmpl
	...
	'Check your email to confirm receipt of a test email from Melody and then proceed to the next step.' => 'Controleer uw e-mail om te bevestigen of uw een testmail van Melody heeft ontvangen en ga dan verder naar de volgende stap.',
	'Back' => 'Terug',
	'Continue' => 'Doorgaan',
	'Show current mail settings' => 'Toon alle huidige mailinstellingen',
	'Periodically Melody will send email to inform users of new comments as well as other other events. For these emails to be sent properly, you must instruct Melody how to send email.' => 'Melody zal af en toe e-mail versturen om gebruikers op de hoogte te brengen van nieuwe reacties en andere gebeurtenissen.  Om deze e-mails goed te kunnen versturen, moet u Melody vertellen hoe ze verstuurd moeten worden.',
...
## tmpl/wizard/start.tmpl
	...
	'Melody ships with directory named [_1] which contains a number of important files such as images, javascript files and stylesheets.' => 'Melody wordt geleverd met een map genaamd [_1] die een aantal belangrijke bestanden bevat zoals afbeeldingen, javascript bestanden en stylesheets.',
	'The [_1] directory is in the main Melody directory which this wizard script resides, but due to your web server\'s configuration, the [_1] directory is not accessible in this location and must be moved to a web-accessible location (e.g., your web document root directory).' => 'De map [_1] bevindt zich in de hoofdmap van Melody waar ook dit wizard script zich bevindt, maar door de configuratie van uw webserver is de [_1] map niet toegankelijk op deze locatie en moet deze dus verplaatst worden naar een locatie die toegankelijk is vanop het web (m.a.w. uw document root map).',
	'This directory has either been renamed or moved to a location outside of the Melody directory.' => 'Deze map is ofwel van naam veranderd of is verplaatst naar een locatie buiten de Melody map.',
...
## tmpl/wizard/packages.tmpl
	...
	'One or more Perl modules required by Melody could not be found.' => 'Eén of meer Perl modules vereist door Melody werden niet gevonden.',
	'The following Perl modules are required for Melody to run properly. Once you have met these requirements, click the \'Retry\' button to re-test for these packages.' => 'De onderstaande Perl modules zijn nodig voor de werking van Melody.  Eens uw systeem aan deze voorwaarden voldoet, klik op de \'Opnieuw\' knop om opnieuw te testen of deze modules geïnstalleerd zijn.',
...
## tmpl/wizard/configure.tmpl
	...
	'Is your preferred database not listed? View the <a href="[_1]" target="_blank">Melody System Check</a> see if additional modules are necessary.' => 'Staat uw gewenste database er niet bij?  Kijk bij de <a href="[_1]" target="_blank">Melody systeemcontrole</a> of er bijkomende modules nodig zijn.',
	...
	'A default location of \'./db/mt.db\' will store the database file underneath your Melody directory.' => 'Een standaardlocatie van \'./db/mt.db\' zal het databasebestadn opslaan onder uw Melody map.',
...
## tmpl/cms/cfg_plugin.tmpl
	...
	'This plugin has not been upgraded to support Melody [_1]. As such, it may not be 100% functional. Furthermore, it will require an upgrade once you have upgraded to the next Melody major release (when available).' => 'Deze plugin is niet bijgewerkt om Melody [_1] te ondersteunen.  Om die reden kan het zijn dat hij niet voor 100% werkt.  Bovendien zal er een upgrade nodig zijn wanneer u een upgrade uitvoert naar de volgende major versie van Melody (wanneer die beschikbaar komt).',
...
## tmpl/cms/login.tmpl
	...
	'Your Melody session has ended. If you wish to sign in again, you can do so below.' => 'Uw Melody sessie is beëindigd.  Als u zich opnieuw wenst aan te melden, dan kan dat hieronder.',
	'Your Melody session has ended. Please sign in again to continue this action.' => 'Uw Melody sessie is beëindigd. Gelieve u opnieuw aan te melden om deze handeling voort te zetten.',
	'Forgot your password?' => 'Uw wachtwoord vergeten?',
	'Sign In (s)' => 'Aanmelden (s)',

## tmpl/cms/list_blog.tmpl
	'You have successfully deleted the blogs from the Melody system.' => 'U heeft met succes de blogs verwijderd uit het Melody systeem.',
...
## tmpl/cms/dashboard.tmpl
	...
	'Image::Magick is either not present on your server or incorrectly configured. Due to that, you will not be able to use Melody\'s userpics feature. If you wish to use that feature, please install Image::Magick or use an alternative image driver.' => 'Image::Magick is ofwel niet geïnstalleerd op uw server of niet juist ingesteld.  Hierdoor kunt u de opties van Melody voor gebruikersafbeeldingen niet gebruiken.  Als u deze opties toch wenst te kunnen gebruiken, gelieve dan Image::Magick correct te installeren of gebruik een alternatieve driver voor afbeeldingen',
...
## tmpl/cms/cfg_trackbacks.tmpl
	...
	'Specify when Melody should notify you of new TrackBacks if at all.' => 'Geef aan wanneer Melody u op de hoogte moet brengen van nieuwe TrackBacks, indien gewenst.',
	'On' => 'Aan',
...
## tmpl/cms/cfg_comments.tmpl
	...
	'Specify when Melody should notify you of new comments if at all.' => 'Geef aan wanneer Melody u op de hoogte moet brengen van reacties, indien gewenst.',
...
## tmpl/cms/cfg_system_users.tmpl
	...
	'Allow commenters to register to Melody' => 'Geef reageerders de optie zich te registreren via Melody',
...
## tmpl/cms/edit_entry.tmpl
	...
	'Use <a href="http://blogit.typepad.com/">Blog It</a> to post to Melody from social networks like Facebook.' => 'Gebruik <a href="http://blogit.typepad.com/">Blog It</a> om op Melody te publiceren vanop sociale netwerken zoals Facebook.',
	'None selected' => 'Geen geselecteerd',
...
## tmpl/cms/include/footer.tmpl
	'This is a beta version of Melody and is not recommended for production use.' => 'Dit is een betaversie van Melody, niet aangeraden voor productiegebruik.',
...
## tmpl/cms/import.tmpl
	...
	'Transfer weblog entries into Melody from other Melody installations or even other blogging tools or export your entries to create a backup or copy.' => 'Importeer weblogberichten in Melody uit andere Melody installaties of zelfs andere blogsystemen, of exporteer uw berichten om een backup of kopie te maken.',
	...
	'If your import file is located on your computer, you can upload it here.  Otherwise, Melody will automatically look in the \'import\' folder of your Melody directory.' => 'Als uw importbestand zich nog op uw eigen computer bevindt, kunt u het hier opladen.  In het andere geval zal Melody automatisch kijken in de \'import\' map van uw Melody map.',
	'More options' => 'Meer opties',
	'Import File Encoding' => 'Encodering importbestand',
	'By default, Melody will attempt to automatically detect the character encoding of your import file.  However, if you experience difficulties, you can set it explicitly.' => 'Standaard zal Melody proberen om automatisch de karakter encodering van het importbestand te bepalen.  Mocht u echter problemen ondervinden, kunt u het ook uitdrukkelijk instellen.',
...
## tmpl/cms/upgrade.tmpl
	...
	'While Melody may run, it is an <strong>untested and unsupported environment</strong>.  We strongly recommend upgrading to at least Perl [_1].' => 'Hoewel Melody er misschien op draait, is het een <strong>ongetesten en niet ondersteunde omgeving</strong>.  We raden ten zeerste aan om minstens te upgraden tot Perl [_1].',
	'Do you want to proceed with the upgrade anyway?' => 'Wenst u toch door te gaan met de upgrade?',
	'Yes (s)' => 'Ja (s)',
	'View MT-Check (x)' => 'Bekijk MT-Check (x)',
	'A new version of Melody has been installed.  We\'ll need to complete a few tasks to update your database.' => 'Er is een nieuwe versie van Melody geïnstalleerd.  Er moeten een aantal dingen gebeuren om uw database bij te werken.',
	...
	'In addition, the following Melody components require upgrading or installation:' => 'Bovendien hebben volgende Melody componenten een upgrade nodig of moeten ze geïnstalleerd worden:',
	'The following Melody components require upgrading or installation:' => 'Volgende Melody componenten hebben een upgrade nodig of moeten geïnstalleerd worden:',
	'Begin Upgrade' => 'Begin de upgrade',
	'Congratulations, you have successfully upgraded to Melody [_1].' => 'Proficiat, u heeft met succes een upgrade uitgevoerd aan Melody [_1].',
	'Return to Melody' => 'Terugkeren naar Melody',
	'Your Melody installation is already up to date.' => 'Uw Melody installation is al up-to-date.',
...
## tmpl/cms/list_author.tmpl
	...
	'You have successfully deleted the user(s) from the Melody system.' => 'U heeft met succes de gebruiker(s) verwijderd uit het Melody systeem.',
	'The deleted user(s) still exist in the external directory. As such, they will still be able to login to Melody Enterprise.' => 'De verwijderde gebruiker(s) blijven bestaan in de externe directory. Om die reden zullen ze zich nog steeds kunnen aanmelden op Melody Enterprise.',
	...
	'_NO_SUPERUSER_DISABLE' => 'Omdat u een systeembeheerder bent in het Melody systeem, kunt u zichzelf niet desactiveren.',
...
## tmpl/cms/cfg_web_services.tmpl
	...
	'When this blog is updated, Melody will automatically notify the selected sites.' => 'Wanneer deze weblog wordt bijgewerkt, zal Melody automatisch de geselecteerde sites op de hoogte brengen.',
...
## tmpl/cms/edit_blog.tmpl
	...
	'Enter the path where your main index file will be located. An absolute path (starting with \'/\') is preferred, but you can also use a path relative to the Melody directory. Example: /home/melody/public_html/weblog' => 'Vul het pad in waar uw hoofdindexbestand zich zal bevingen.  Een absoluut pad (dat begint met \'/\') verdient de voorkeur, maar u kunt ook een pad gebruiken relatief aan de Melody map.  Voorbeeld: /home/melody/public_html/weblog',
...
## tmpl/cms/install.tmpl
	...
	'Before you can begin blogging, you must create an administrator account for your system. When you are done, Melody will then initialize your database.' => 'Voor u kunt beginnen blogggen, moet u een administrator-account aanmaken voor uw systeem.  Wanneer u klaar bent zal Melody uw database initialiseren.',
...
## tmpl/cms/widget/new_user.tmpl
	'Welcome to Melody, the world\'s most powerful blogging, publishing and social media platform. To help you get started we have provided you with links to some of the more common tasks new users like to perform:' => 'Welkom in Melody, het meest krachtige blog-, publicatie- en mediaplatform ter wereld.  Om u te helpen van start te gaan hebben we voor u enkele links voorzien naar de vaakst voorkomende handelingen die nieuwe gebruikers wensen uit te voeren:',
	'Write your first post' => 'Schrijf uw eerste bericht',
	'What would a blog be without content? Start your Melody experience by creating your very first post.' => 'Wat is een blog zonder inhoud?  Ervaar de kracht van Melody door uw eerste bericht te schrijven.',
	...
	'Explore what\'s new in Melody 4' => 'Ontdek wat er nieuw is in Melody 4',
	'Whether you\'re new to Melody or using it for the first time, learn more about what this tool can do for you.' => 'Of u Melody nu voor de eerste keer gebruikt of u er al ervaring mee heeft, ontdek meer over wat het voor u kan doen.',
...
## tmpl/cms/widget/mt_news.tmpl
	...
	'No Learning Melody news available.' => 'Geen Learning Melody nieuws beschikbaar.',
...
## tmpl/cms/widget/new_version.tmpl
	...
	'Congratulations, you have successfully installed Melody [_1]. Listed below is an overview of the new features found in this release.' => 'Proficiat, u heeft met succes Melody [_1] geïnstalleerd.  Hieronder vindt u een overzicht van de nieuwe mogelijkheden in deze release.',
...
## tmpl/cms/restore.tmpl
	...
	'Perl module XML::SAX and/or its dependencies are missing - Melody can not restore the system without it.' => 'Perl module XML::SAX ontbreekt en/of enkele modules waarvan deze afhankelijk is - Melody kan geen restore operatie uitvoeren zonder deze module.',
	'Backup file' => 'Bestand backuppen',
	'If your backup file is located on your computer, you can upload it here.  Otherwise, Melody will automatically look in the \'import\' folder of your Melody directory.' => 'Als uw backup-bestand zich op uw computer bevindt, kunt u het hier opladen.  In het andere geval zal Melody automatisch in de \'omport\' map kijken in uw Melody map.',
	'Check this and files backed up from newer versions can be restored to this system.  NOTE: Ignoring Schema Version can damage Melody permanently.' => 'Kruis dit aan en ook bestanden die gebackupt zijn van nieuwere versies van Melody kunnen teruggezet worden op dit systeem.  Opmerking: de schemaversie negeren kan Melody permanent beschadigen.',
...
## tmpl/cms/cfg_archives.tmpl
	'Error: Melody was not able to create a directory for publishing your blog. If you create this directory yourself, assign sufficient permissions that allow Melody to create files within it.' => 'Fout: Melody kon geen map maken om uw weblog in te publiceren.  Als u deze map zelf aanmaakt, ken er dan genoeg permissies aan toe zodat Melody er bestanden in kan aanmaken',
	...
	'The path where your index files will be published. An absolute path (starting with \'/\') is preferred, but you can also use a path relative to the Melody directory. Example: /home/melody/public_html/blog' => 'Het pad waar uw indexbestanden gepubliceerd zullen worden.  Een absoluut pad (beginnend met \'/\') verdient de voorkeur, maar u kunt ook een pad ingeven dat relatief is t.o.v. de Melody map.  Voorbeeld: /home/melody/public_html/blog',
...
## tmpl/include/chromeless_footer.tmpl
	'<a href="[_1]">Melody</a> version [_2]' => '<a href="[_1]">Melody</a> versie [_2]',

## tmpl/error.tmpl
	'Missing Configuration File' => 'Ontbrekend configuratiebestand',
	'_ERROR_CONFIG_FILE' => 'Uw Melody configuratiebestand ontbreekt of kan niet gelezen worden. Gelieve het deel <a href=\"#\">Installation and Configuration</a> van de handleiding van Melody te raadplegen voor meer informatie.',
	'Database Connection Error' => 'Databaseverbindingsfout',
	'_ERROR_DATABASE_CONNECTION' => 'Uw database instellingen zijn ofwel ongeldig ofwel ontbreken ze in uw Melody configuratiebestand. Bekijk het deel <a href=\"#\">Installation and Configuration</a> van de Melody handleiding voor meer informatie.',
	'CGI Path Configuration Required' => 'CGI-pad configuratie vereist',
	'_ERROR_CGI_PATH' => 'Uw CGIPath configuratieinstelling is ofwel ongeldig ofwel ontbreekt ze in uw Melody configuratiebestand. Bekijk het deel <a href=\"#\">Installation and Configuration</a> van de Melody handleiding voor meer informatie.',
...
## addons/Community.pack/lib/MT/Community/CMS.pm
	...
	'Following' => 'Volgt',
	'Followers' => 'Volgers',
	'Welcome to the Melody Community Solution' => 'Welkom op de Melody Community Solution',
...
',
	'New design launched using Melody' => 'Nieuw design gelanceerd met Melody',
...
',
	...
	'Great new site. I can\'t wait to try Melody. Congrats!' => 'Geweldige nieuwe site.  Ik kan niet wachten om Melody zelf te proberen.  Proficiat!',
...
Zoekbasis: [_2]",
	...
	'[_1] directive must be set to synchronize members of LDAP groups to Melody Enterprise.' => '´[_1] directief moet ingesteld zijn om leden van een LDAP groep te synchroniseren naar Melody Enterprise',
...
## addons/Enterprise.pack/tmpl/list_group.tmpl
	...
	'You have successfully deleted the groups from the Melody system.' => 'De geselecteerde groep werd verwijderd uit het Melody systeem.',
...
## plugins/StyleCatcher/config.yaml
	'StyleCatcher lets you easily browse through styles and then apply them to your blog in just a few clicks. To find out more about Melody styles, or for new sources for styles, visit the <a href=\'http://www.sixapart.com/movabletype/styles\'>Melody styles</a> page.' => 'Met StyleCatcher kunt u makkelijk een keuze maken tussen stijlen om ze daarna op uw blog toe te passen in een paar klikken.  Om meer te weten over Melody stijlen, of om een bron te vinden van nog meer stijlen, bezoek de <a href=\'http://www.sixapart.com/movabletype/styles\'>Melody styles</a> pagina.',
	'MT 4 Style Library' => 'MT 4 Stijlenbibliotheek',
	'A collection of styles compatible with Melody 4 default templates.' => 'Een verzameling stijlen compatibel met de standaardsjablonen van Melody 4.',
	'Styles' => 'Stijlen',
...
## plugins/WidgetManager/WidgetManager.pl
	'Widget Manager version 1.1; This version of the plugin is to upgrade data from older version of Widget Manager that has been shipped with Melody to the Melody core schema.  No other features are included.  You can safely remove this plugin after installing/upgrading Melody.' => 'Widget Manager versie 1.1: Deze versie van de plugin dient om data van de oudere versie van Widget Manager die met Melody werd meegeleverd over te zetten naar de kern van Melody.  Er zitten geen andere opties in.  Deze plugin kan zonder problemen verwijderd worden na de installatie/upgrade van Melody.',
...
## plugins/feeds-app-lite/mt-feeds.pl
	'Feeds.App Lite helps you republish feeds on your blogs. Want to do more with feeds in Melody? <a href="http://code.appnel.com/feeds-app" target="_blank">Upgrade to Feeds.App</a>.' => 'Feeds.App Lite maakt het mogelijk feeds te herpubliceren op uw blog.  Meer doen met feeds in Melody? <a href="http://code.appnel.com/feeds-app" target="_blank">Upgraden naar Feeds.App</a>.',
...
## plugins/Motion/config.yaml
	'A Melody theme with structured entries and action streams.' => 'Een Melody thema met gestructureerde berichten en action streams.',
...
## plugins/Motion/templates/Motion/widget_about_ssite.mtml
	'About' => 'Over',
	'The Motion Template Set is a great example of the type of site you can build with Melody.' => 'De Motion sjabloonset is een goed voorbeeld van het soort site dat met Melody gebouwd kan worden.',
...
## plugins/mixiComment/mixiComment.pl
	'Allows commenters to sign in to Melody 4 using their own mixi username and password via OpenID.' => 'Laat reageerders zich aanmelden op Melody met hun eigen mixi gebruikersnaam en wachtwoord via OpenID.',
