...
%Lexicon = (
    ...
    'DBI and DBD::SQLite2 are required if you want to use the SQLite 2.x database backend.' => 'DBIとDBD::SQLite2は、SQLite 2.xを使ってブログのデータを管理するために必要です。',
    ...
    'Required' => '必要',
    'Optional' => 'オプション',
    'Archive::Tar is required in order to archive files in backup/restore operation.' => 'Archive::Tarは、バックアップ・復元機能においてtar.gz形式で圧縮・解凍をするときに必要になります。',
    'IO::Compress::Gzip is required in order to compress files in backup/restore operation.' => 'IO::Compress::Gzipは、バックアップ・復元機能においてtar.gz形式で圧縮をするときに必要になります。',
    'IO::Uncompress::Gunzip is required in order to decompress files in backup/restore operation.' => 'IO::Uncompress::Gunzipは、バックアップ・復元機能においてtar.gz形式で圧縮をするときに必要になります。',
    'Archive::Zip is required in order to archive files in backup/restore operation.' => 'Archive::Zipは、バックアップ・復元機能においてzip形式で圧縮・解凍をするときに必要になります。',
    'XML::SAX and/or its dependencies is required in order to restore.' => 'XML::SAXとその依存モジュールは復元機能を利用するときに必要です。',
    ...
    'Image' => '画像',
    'Actual Dimensions' => '実際のサイズ',
    '[_1] wide, [_2] high' => '幅:[_1] - 高さ:[_2]',
    'Error scaling image: [_1]' => '画像のサイズを変更できませんでした: [_1]',
    'Error creating thumbnail file: [_1]' => 'サムネールファイルを作成できませんでした: [_1]',
    'Can\'t load asset #[_1]' => 'アイテム (ID: [_1])をロードできません。',
    'Permission denied setting image defaults for blog #[_2]' => 'ブログ (ID: [_1]) に対して画像のデフォルト設定を保存する権限がありません。',
    ## lib/MT/Request.pm
    ## lib/MT/Atom.pm
    ## lib/MT/Trackback.pm
    ...
    'You did not set your weblog Archive Path' => 'ブログのアーカイブ・パスを設定してください。',
    'You did not set your weblog Site Root' => 'ブログのサイト・パスを設定してください。',

    ## lib/MT/Task.pm
    ## lib/MT/BackupRestore.pm
    '[_1]#[_2] has been backed up.' => '[_1]#[_2]をバックアップしました。',
    'No manifest file could be found in your import directory [_1].' => 'ディレクトリ[_1]にマニフェスト・ファイルが見つかりませんでした。',
    'Can\'t open [_1].' => '[_1]を開けません。',
    'Manifest file [_1] was not a valid Movable Type backup manifest file.' => '[_1]はMovable Typeのマニフェストファイルではありません。',
    "Manifest file: [_1]\n" => "マニフェストファイル: [_1]\n",
    'ID for the asset was not set.' => 'アイテムのIDが設定されていません。',
    'The asset ([_1]) was not restored.' => 'アイテム([_1])を復元できませんでした。',
    'Path was not found for the asset ([_1]).' => 'アイテム([_1])のパスが見つかりません。',
    'Copying [_1] to [_2]...' => '[_1]を[_2]へコピーしています...',
    'Failed: ' => '失敗しました: ',
    'Done.' => '完了',
    ...
    'Uploaded file was not a valid Movable Type backup manifest file.' => 'ファイルはMovable Typeのマニフェスト・ファイルではありません。',
    ## lib/MT/Bootstrap.pm
    ...
    'Can\'t load template' => 'テンプレートをロードできません。',
    'No such user \'[_1]\'' => '「[_1]」というユーザーは存在しません',
    'To enable comment registration, you need to add a TypeKey token in your weblog config or user profile.' => 'コメント登録機能を使うには、TypeKeyトークンをブログ、もしくはユーザーのプロフィールで設定する必要があります。',
    'You used an \'[_1]\' tag outside of the context of an asset; perhaps you mistakenly placed it outside of an \'MTAssets\' container?' => '[_1]タグがアイテム（Asset）のコンテキスト外で使われました。MTAssetsコンテナタグの外に配置できません。',
    ...
    'Creating new user (\'[_1]\')...' => '新しい投稿者[_1]を登録します。',
    "failed\n" => "失敗しました。\n",
    "ok (ID [_1])\n" => "完了しました。(ID: [_1])\n",
    "ok\n" => "完了しました。\n",
    'Saving user failed: [_1]' => '投稿者の保存に失敗しました: [_1]',
    'Assigning permissions for new user...' => '新しい投稿者の権限を設定します。',
    ...
    'Failed login attempt by disabled user \'[_1]\'' => 'ユーザー([_1])がログインに失敗しました。',
    'Invalid timestamp format' => 'タイムスタンプの書式が正しくありません',
    'No web services password assigned.  Please see your user profile to set it.' => 'Webサービス・パスワードが設定されていません。投稿者のプロフィールから設定を行ってください。',
    ...
    'User does not have privileges' => '権限が設定されていません',
    ...
    'Creating initial weblog and user records...' => 'ブログと管理者の初期値を登録します。',
    ...
    'Assigning user types...' => 'ユーザーの種類を適用しています...',
    'Assigning user status...' => 'ユーザーに状態を適用しています...',
    ...
    'Updating user web services passwords...' => '投稿者のWebサービスパスワードを更新しています...',
    ...
    'Custom ([_1])' => 'カスタム ([_1])',
    'This role was generated by Movable Type upon upgrade.' => 'このロールはMovable Typeのアップグレード時に自動作成されました。',
    ...
    'Invalid ID given for personal weblog clone source ID.' => '新しく作成するブログの複製元のブログIDが不正です。',
    'Create New Role' => 'ロールを新規作成',
    'Role name cannot be blank.' => 'ロール名は空白にはできません。',
    'Another role already exists by that name.' => '同名のロールがすでに存在します。',
    'You cannot define a role without permissions.' => '権限のないロールは作成できません。',
    'Weblog Administrator' => 'ブログ管理者',
    'Can administer the weblog.' => 'ブログを管理できます。',
    'Designer' => 'デザイナ',
    'Can edit, manage and rebuild weblog templates.' => 'ブログのテンプレートを編集し、管理し、再構築できます。',
    'Editor' => '編集者',
    'Can edit all entries/categories/tags on a weblog and rebuild.' => 'ブログのすべてのエントリ、カテゴリ、タグを編集し、再構築できます。',
    'Editor (can upload)' => '編集者（アップロード）',
    'Can upload files, edit all entries/categories/tags on a weblog and rebuild.' => 'ブログにファイルをアップロードし、すべてのエントリ、カテゴリ、タグを編集し、再構築できます。',
    'Publisher' => '発行人',
    'Can upload files, edit all entries/categories/tags on a weblog, rebuild and send notifications.' => 'ブログにファイルをアップロードし、すべてのエントリ、カテゴリ、タグを編集し、再構築し、通知を送信できます。',
    'Writer' => '投稿者',
    'Can create entries and edit their own.' => 'ブログのエントリーを作成し、自分のエントリーを編集できます。',
    'Writer (can upload)' => '投稿者（アップロード）',
    'Can create entries, edit their own and upload files.' => 'ブログにファイルをアップロードし、エントリーを作成し、自分のエントリーを編集できます。',
    ...
    'Alias for [_1] is looping in the configuration.' => '[_1]でAlias設定が循環しています。',
    ## lib/MT/Template.pm
    ...
    '[_1] records processed...' => '[_1]件のデータを処理しました...',
    '[_1] records processed.' => '[_1]件のデータを処理しました。',
    'Cloning entries for weblog...' => 'ブログのエントリーを複製しています...',
    'Cloning categories for weblog...' => 'ブログのカテゴリーを複製しています...',
    'Cloning entry placements for weblog...' => 'ブログのカテゴリーとエントリーの関連付けを複製しています...',
    'Cloning comments for weblog...' => 'ブログのコメントを複製しています...',
    'Cloning TrackBacks for weblog...' => 'ブログのトラックバックを複製しています...',
    'Cloning templates for weblog...' => 'ブログのテンプレートを複製しています...',
    'Cloning permissions for weblog:' => 'ブログの権限を複製しています:',
    'Cloning associations for weblog:' => 'ブログの関連付けを複製しています:',
    'Cloning entry tags for weblog...' => 'ブログのエントリー・タグを複製しています...',
    'Cloning TrackBack pings for weblog...' => 'ブログの送信トラックバックを複製しています...',
    'Cloning template maps for weblog...' => 'ブログのテンプレート・マッピングを複製しています...',

    ## lib/MT/Placement.pm
    ## lib/MT/PluginData.pm
    ## lib/MT/AtomServer.pm
    ## lib/MT/Author.pm
    'Can\'t approve/ban non-COMMENTER user' => '承認/禁止はコメント投稿者にしか設定できません。',
    ...
    'Warnings and Log Messages' => '警告とログメッセージ',
    ## lib/MT/Util.pm
    ...
    'Invalid username \'[_1]\' in password recovery attempt' => 'パスワードの再設定ができません。ログイン名([_1])が誤っています。',
    'User name or birthplace is incorrect.' => 'ログイン名またはパスワード再設定用のフレーズが正しくありません。',
    'User has not set birthplace; cannot recover password' => 'パスワード再設定用のフレーズが設定されていないので、パスワードの再設定ができません',
    'Invalid attempt to recover password (used birthplace \'[_1]\')' => 'パスワードの再設定ができません。パスワード再設定用のフレーズ([_1])が誤っています。',
    'User does not have email address' => 'メールアドレスが登録されていません',
    'Password was reset for user \'[_1]\' (user #[_2]). Password was sent to the following address: [_3]' => '「[_1] (ID: [_2])」のパスワードを再設定し、[_3]宛にメールを送りました。',
    ...
    'New Weblog' => '新規ブログ',
    'Select' => '選択',
    'Create New User' => 'ユーザーを新規登録',
    'User requires username' => 'ログイン名が入力されていません。',
    'User requires password' => 'パスワードが入力されていません。',
    'User requires password recovery word/phrase' => 'パスワード再設定用のフレーズが入力されていません',
    ...
    'Asset \'[_1]\' created by \'[_2]\'' => '[_2]がアイテム「[_1]」を作成しました。',
    'Asset \'[_1]\' (ID:[_2]) deleted by \'[_3]\'' => '[_3]がアイテム「[_1]」(ID: [_2])を削除しました。',
    ...
    'No email address for user \'[_1]\'' => 'ユーザー「[_1]」にはメールアドレスが設定されていません',
    ...
    'Before you can upload a file, you need to publish your weblog.' => 'ブログの公開設定をしないとファイルをアップロードできません。',
    'Error saving asset: [_1]' => 'アイテムを保存できませんでした: [_1]',
    'Select Weblogs' => 'ブログを選択',
    'Weblogs Selected' => '選択されたブログ',
    'Type a weblog name to filter the choices below.' => 'ブログ名を入力してフィルタリングします。',
    'Select Users' => 'ユーザーを選択',
    'Users Selected' => '選択されたユーザー',
    'Type a username to filter the choices below.' => 'ユーザー名を入力してフィルタリング: ',
    'Select Roles' => 'ロールを選択',
    'Role Name' => 'ロール名',
    'Roles Selected' => '選択されたロール',
    'Create an Association' => '関連付けを新規作成',
    'Backup & Restore' => 'バックアップ/復元',
    'You must select what you want to backup.' => 'バックアップの対象を選択してください。',
    '[_1] is not a number.' => '[_1]は数値ではありません。',
    'Choose weblogs to backup.' => 'バックアップするブログを選択してください。',
    'Archive::Tar is required to archive in tar.gz format.' => 'tar.gz形式で圧縮するにはArchive::Tarが必要です。',
    'IO::Compress::Gzip is required to archive in tar.gz format.' => 'tar.gz形式で圧縮するにはIO::Compress::Gzipが必要です。',
    'Archive::Zip is required to archive in zip format.' => 'zip形式で圧縮するにはArchive::Zipが必要です。',
    'Backup' => 'バックアップ',
    'Specified file was not found.' => '指定されたファイルが見つかりません。',
    'Restore' => '復元',
    'Uploaded file was invalid: [_1]' => 'アップロードされたファイルが不正です: [_1]',
    'Upload manifest file via the other form.' => 'マニフェストファイルは別のフォームからアップロードしてください。',
    'Please use xml, tar.gz, zip, or manifest as a file extension.' => 'ファイルの拡張子をxml、tar.gz、zip、manifestのどれかにしてください。',
    'Some [_1] were not restored because their parent objects were not restored.' => 'いくつかの[_1]が復元されませんでした。親オブジェクトが見つかりませんでした。',
    'Some objects were not restored because their parent objects were not restored.  Detailed information is in the <a href="[_1]">activity log</a>.' => '親オブジェクトが見つからないので復元できなかったオブジェクトがあります。詳細は<a href="[_1]">ログ</a>を参照してください。',
    'Successfully restored objects to Movable Type system by user \'[_1]\'' => 'ユーザー「[_1]」がMovable Typeシステムのオブジェクトを復元しました。',
    '[_1] is not a directory.' => '[_1]はディレクトリではありません。',
    'MT::Asset#[_1]: ' => 'MT::Asset#[_1]: ',
    'Some of the actual files for assets could not be restored.' => 'アイテムの実際のファイルをいくつか復元できませんでした。',
    ...
    'delete' => '削除',
    'remove' => '削除',
    'You did not select any [_1] to [_2].' => '[_1]する[_2]が選択されていません。',
    'Are you certain you want to remove this role? By doing so you will be taking away the permissions currently assigned to any users associated with this role.' => 'このロールを本当に削除してもよろしいですか? 削除するとこのロールを通じて関連付けられているユーザーから権限を剥奪することになります。',
    'Are you certain you want to remove these [_1] roles? By doing so you will be taking away the permissions currently assigned to any users associated with these roles.' => 'ロールを本当に削除してもよろしいですか? 削除するとこれらのロールを通じて関連付けられているユーザーから権限を剥奪することになります。',
    'Are you sure you want to [_2] this [_1]?' => 'この[_1]を[_2]してよろしいですか?',
    ...
    'Clone Weblog' => 'ブログを複製する',
    'No weblog was selected to clone.' => '複製するブログが選択されていません。',
    'This action can only be run for a single weblog at a time.' => 'この動作は1度に1つのブログに対してのみ行えます。',
    'Invalid blog_id' => 'ブログIDが不正です。',
    'Clones a weblog and all of its contents.' => 'ブログとそのすべてのコンテンツを複製します。',
    'Cloning Weblog' => 'ブログの複製',
    'Finished! You can <a href=\'[_1]\'>return to the weblogs listing</a> or <a href=\'[_2]\'>view the new weblog</a>.' => '完了しました。<a href=\'[_1]\'>ブログの一覧に戻る</a>かまたは<a href=\'[_2]\'>新しいブログ</a>を見ることができます。',
    'If you want to change the SitePath and SiteURL, <a href=\'[_1]\'>click here</a>.' => '作成されたブログのサイト・パスとサイトURLを変更したい場合は<a href=\'[_1]\'>こちら</a>。',
    ...
    '_GENL_USAGE_PROFILE' => 'ユーザーのプロフィールを編集します。ログイン名、パスワードが編集されたときには、ログイン権限は自動的に更新されます。変更後、再度ログインする必要はありません。',
    'Profile' => 'プロフィール',
    'Permissions' => '権限',
    ...
    '_USER_ENABLED' => '有効',
    '_USER_DISABLED' => '無効',
    'Status of user in the system. Disabling a user removes their access to the system but preserves their content and history.' => 'システム上でのユーザーの状態。無効にするとログインできなくなります。',
    'Save profile for this user (s)' => 'このユーザーのプロフィールを保存 (S)',
    ## tmpl/cms/cfg_system_general.tmpl
    'You must set a valid Default Site URL.' => '既定のサイトURLを正しく設定してください。',
    'You must set a valid Default Site Root.' => '既定のサイト・パスを正しく設定してください。',
    'This screen allows you to set system-wide new user defaults.' => 'システム全体での新しいユーザーの既定値を設定できます。',
    'New User Defaults' => '新しいユーザーの既定値',
    'Default Site URL' => '既定のサイトURL',
    'Define the default site URL for new weblogs. This URL will be appended with a unique identifier for the weblog.' => '新しいブログのサイトURLの既定値です。このURLにブログごとにユニークな識別子が追加されます。',
    'Default Site Root' => '既定のサイト・パス',
    'Define the default site root for new weblogs. This path will be appended with a unique identifier for the weblog.' => '新しいブログのサイト・パスの既定値です。このパスにブログごとにユニークな識別子が追加されます。',
    'Default User Language' => 'ユーザーの既定の言語',
    'Define the default language to apply to all new users.' => 'ユーザーに既定で設定される言語を指定します。',
    'Default Timezone:' => '既定のタイムゾーン',
    'Default Tag Delimiter:' => '既定のタグ区切り',
    'Define the default delimiter for entering tags.' => 'タグを入力するときに使う区切り記号の既定値を指定します。',
    ...
    'Click on a comment to edit it. To perform any other action, check the checkbox of one or more comments and click the appropriate button or select a choice of actions from the dropdown to the right.' => 'コメントをクリックして編集できます。その他の操作を行うには対象となるコメントのチェックボックスをオンにしてボタンをクリックするか、右側のプルダウンからアクションを選択します。',
    'Click on a Trackback to edit it. To perform any other action, check the checkbox of one or more Trackbacks and click the appropriate button or select a choice of actions from the dropdown to the right.' => 'トラックバックをクリックして編集できます。その他の操作を行うには対象となるトラックバックのチェックボックスをオンにしてボタンをクリックするか、右側のプルダウンからアクションを選択します。',
    ...
    ## tmpl/cms/asset_image_options.tmpl
    'Display Image in Entry' => '画像をエントリーに表示',
    'Alignment' => '配置',
    'Align Image Left' => '画像を左側に配置',
    'Left' => '左',
    'Align Image Center' => '画像を中央に配置',
    'Center' => '中央',
    'Align Image Right' => '画像を右側に配置',
    'Right' => '右',
    'Create Thumbnail' => 'サムネール画像の作成',
    'Width' => '幅',
    'Link image to full-size version in a popup window.' => 'ポップアップ・ウィンドウの画像をオリジナルの画像にリンク',
    'Remember these settings' => '設定を保存',
    ...
    'Site URL' => 'サイトURL',
    'Unlock this weblog\'s site URL for editing' => 'このブログのサイトURLを編集できるようにする',
    'Warning: Changing the site URL can result in breaking all the links in your weblog.' => 'サイトURLを変更するとブログ内のリンクがリンク切れになることがあります。',
    ...
    'The URL of your website. Do not include a filename (i.e. exclude index.html).' => 'このブログを公開するサイトのURLを入力してください。ファイル名 (index.htmlなど) は入力しないでください。',
    'Example:' => '例: ',
    ...
    'Unlock this weblog\'s site path for editing' => 'このブログのサイト・パスを編集できるようにする',
    'Warning: Changing the site root can result in breaking all the links in your weblog.' => 'サイト・パスを変更するとブログ内のリンクがリンク切れになることがあります。',
    'The path where your index files will be published. An absolute path (starting with \'/\') is preferred, but you can also use a path relative to the Movable Type directory.' => 'メインページ (index.html) を置くパス名を入力してください。絶対パス (/で始まる) をお勧めしますが、Movable Typeがインストールされた場所からの相対パスも使えます。',
    ...
    'Build all templates statically' => 'すべてスタティックHTMLで出力',
    'Build only Archive Templates dynamically' => 'アーカイブのみダイナミック・パブリッシング',
    'Set each template\'s Build Options separately' => 'テンプレートごとに選択',
    'Build all templates dynamically' => 'すべてダイナミック・パブリッシング',
    ...
    'Unlock this weblog\'s archive url for editing' => 'このブログのアーカイブURLを編集できるようにする',
    'Warning: Changing the archive URL can result in breaking all the links in your weblog.' => 'アーカイブURLを変更するとブログ内のリンクがリンク切れになることがあります。',
    'Warning: Changing the archive path can result in breaking all the links in your weblog.' => 'アーカイブ・パスを変更するとブログ内のリンクがリンク切れになることがあります。',
    'Optional Settings for Dynamic Publishing:' => 'ダイナミック・パブリッシングのオプション',
    ...
    'Popup Image' => 'ポップアップ',
    'Embedded Image' => '埋め込み',
    'Asset Options' => 'アイテムのオプション',
    'Create a new entry using this uploaded file.' => 'アップロードされたファイルを使ってエントリーを投稿',
    'Finish' => '完了',
    ## tmpl/cms/association_actions.tmpl
    'Remove selected assocations (x)' => '選択された関連付けを削除(X)',
    'Remove' => '削除',
    'association' => '関連付け',
    'associations' => '関連付け',
    ## tmpl/cms/dialog_restore_upload.tmpl
    'Canceling the process will create orphaned objects.  Are you sure you want to cancel the restore operation?' => 'プロセスを途中で終了するとオブジェクトが正しく復元れません。復元を強制終了しますか？',
    'Restore Multiple Files' => '複数ファイルの復元',
    'Restoring' => '復元',
    'Please upload the following file' => '次のファイルをアップロードしてください。',
    'Upload:' => 'アップロード:',

    ## tmpl/cms/author_actions.tmpl
    'Enable selected users (e)' => '選択されたユーザーを有効化(E)',
    'Disable selected users (d)' => '選択されたユーザーを無効化(D)',
    '_USER_ENABLE' => '有効',
    '_USER_DISABLE' => '無効',
    '_NO_SUPERUSER_DISABLE' => 'Movable Typeのシステム管理者は自分自身を無効にはできません。',
    ## tmpl/cms/edit_template.tmpl
    'You must set the Template Name.' => 'テンプレとの名前を設定してください。',
    ...
    '_ASSETS_DESCRIPTION' => 'システムにアップロードされたアイテムの一覧です。',
    'You have successfully deleted the asset(s).' => 'アイテムを削除しました。',
    'Upload New File' => 'ファイルを新規にアップロードする',
    'Show images.' => '画像を表示する',
    '(Showing all assets.)' => 'すべて (条件を変更する)',
    'Showing only assets where [_1] is [_2].' => '[_1]が[_2]のアイテムのみを表示',
    'assets where' => 'アイテム‐検索条件:',
    'assets.' => 'アイテム',
    'type' => '種類',
    'Type' => '種類',
    'Size' => 'サイズ',
    'Created On' => '作成日時',
    'View File' => 'ファイルを見る',
    'No assets could be found.' => 'アイテムが見つかりませんでした。',
    ...
    'Privileges' => '権限',
    'Create and manage roles and associations.' => 'ロールと関連付けの一覧です。',
    'Assets' => 'アイテム',
    'Multi-weblog assets listing.' => 'すべてのアイテムの一覧です。',
    'Backup' => 'バックアップ',
    'Backup and Restore your system.' => 'システムをバックアップ・復元できます。',

    ## tmpl/cms/dialog_list_assets.tmpl
    'Select the image you would like to insert, or upload a new one.' => '挿入する画像を選択するか、またはアップロードしてください。',
    'Select the file you would like to insert, or upload a new one.' => '挿入するファイルを選択するか、またはアップロードしてください。',
    'Upload New Asset' => '新しいアイテムをアップロード',
    ...
    'All data restored successfully!' => 'すべてのデータを復元しました。',
    'Make sure that you remove the files that you restored from the \'import\' folder, so that if/when you run the restore process again, those files will not be re-restored.' => '復元の終わったファイルをimportフォルダから削除してください。次回再度復元の対象になる危険があります。',
    'An error occurred during the restore process: [_1] Please check your restore file.' => '復元中にエラーが発生しました: [_1] バックアップのファイルを確認してください。',
    ...
    'Role Name' => 'ロール名',
    'Roles with the same permissions' => '同じ権限を持つロール',
    ...
    'Select the type of rebuild you would like to perform. Note: This will not rebuild any templates you have chosen to not automatically rebuild with index templates.' => '再構築する対象を選んでください。注意: 自動的に再構築しないように設定されているインデックス・テンプレートはここでは再構築されません。',
    '(Click the Cancel button if you do not want to rebuild any files.)' => '(再構築を行わない場合は、「取り消し」ボタンをクリックしてください)',
    'Rebuild All Files' => 'すべてを再構築',
    'Index Template: [_1]' => 'インデックス・テンプレート: [_1]',
    'Rebuild Indexes Only' => 'インデックス・テンプレートを再構築',
    'Rebuild [_1] Archives Only' => 'アーカイブのみを再構築: [_1]',
    'Rebuild (r)' => '再構築 (R)',
    ## tmpl/cms/asset_actions.tmpl
    'Delete selected assets (x)' => '選択されたアイテムを削除(X)',
    'asset' => 'アイテム',
    'assets' => 'アイテム',
    ...
    'System Permissions' => 'システム管理権限',
    'Weblog Associations' => '関連付けるブログ',
    ...
    'Your login name.' => 'ログインの際に入力する名称です。',
    'The name used by this user to login.' => 'このユーザーが、ログインの際に入力する名称です。',
    'Your published name.' => '投稿が公開される際に表示される名称です。',
    'The user\'s published name.' => 'このユーザーの投稿が、公開される際に表示される名称です。',
    'Your email address.' => 'メールアドレスです。',
    'The user\'s email address.' => 'このユーザーのメールアドレスです。',
    'Website URL' => 'ウェブサイトURL',
    'The URL of your website. (Optional)' => 'ウェブサイトのURLです（オプション）。',
    'The URL of this user\'s website. (Optional)' => 'このユーザーのウェブサイトのURLです（オプション）。',
    'Your preferred language.' => '表示用の言語です。',
    'The user\'s preferred language.' => 'このユーザーが選択した、表示用の言語です。',
    'Your preferred delimiter for entering tags.' => 'タグ入力時の区切り文字です。',
    'The user\'s preferred delimiter for entering tags.' => 'このユーザーが選択した、タグ入力時の区切り文字です。',
    'Select a password for yourself.' => '新しいパスワードを入力してください。',
    'Select a password for the user.' => '新しいパスワードを入力してください。',
    'This word or phrase will be required to recover the password if you forget it.' => '入力内容はパスワードを忘れて再設定するときに必要になります。',
    'This word or phrase will be required to recover the password if the user forgets it.' => '入力内容はユーザーがパスワードを忘れて再設定するときに必要になります。',
    'Save this user (s)' => 'ユーザーの情報を保存する',

    ## tmpl/cms/list_association.tmpl
    'User Disabled' => '無効なユーザー',
    '_USAGE_ASSOCIATIONS' => '関連付けを表示したり新しく作成できます。',
    'You have successfully removed the association(s).' => '関連付けを削除しました。',
    'You have successfully created the association(s).' => '関連付けを作成しました。',
    'Add user to a weblog' => 'ブログにユーザーを関連付け',
    'You can not create associations for disabled users.' => '無効なユーザーに関連付けを作成することはできません。',
    'Add [_1] to a weblog' => 'ブログに[_1]を関連付け',
    'Assign role to a new user' => '新しいユーザーにロールを関連付け',
    'Assign Role to User' => 'ユーザーへの関連付けを新規作成',
    'Add a user to this weblog' => 'このブログにユーザーを追加',
    'Create a User Association' => 'ユーザーの関連付けを作成',
    'User' => 'ユーザー',
    'Role' => 'ロール',
    'In Weblog' => 'ブログ',
    'Created On' => '作成日時',
    'No associations could be found.' => '関連付けが見つかりませんでした。',
    ...
    'Importing entries as user \'[_1]\'' => 'ユーザー名「[_1]」で読み込んでいます。 ',
    'Creating new users for each user found in the blog' => '読み込む記事に設定されているユーザーを新たに作成します。',
    ...
    'The name used by this user to login.' => 'このユーザーが、ログインの際に入力する名称です。',
    'The user\'s email address.' => 'このユーザーのメールアドレスです。',
    'The user\'s preferred language.' => 'このユーザーが、選択した表示用の言語です。',
    ...
    ## tmpl/cms/dialog_restore_start.tmpl
    'Restoring [_1]...' => '[_1]を復元しています...',

    ## tmpl/cms/backup_end.tmpl
    'All of the data has been backed up successfully!' => 'すべてのデータがバックアップされました。',
    'Filename' => 'ファイル名',
    'Download This File' => 'このファイルをダウンロードする',
    '_BACKUP_TEMPDIR_WARNING' => '指定された内容が[_1]ディレクトリにバックアップされました。上記のファイルを[_1]からダウンロードしてから、<strong>すぐに削除</strong>してください。バックアップファイルには重大な機密情報が含まれています。',
    '_BACKUP_DOWNLOAD_MESSAGE' => 'バックアップ・ファイルのダウンロードがすぐに始まります。もし始まらない場合は、<a href=\'#\' onclick=\'submit_form()\'>ここをクリック</a>して開始してください。バックアップ・ファイルのダウンロードは1度のバックアップにつき1度しか行えません。',
    # 'An error occurred during the backup process: [_1]' => '',
    ## tmpl/cms/author_table.tmpl
    'Name' => '名前',
    'Only show enabled users' => '有効なユーザーだけを表示',
    'Only show disabled users' => '無効なユーザーだけを表示',
    ...
    'List Associations and Roles' => '関連付けとロールの一覧',
    ...
    'List Users' => 'ユーザー一覧',
    'Users' => 'ユーザー',
    'Backup this weblog' => 'このブログのバックアップ',
    ...
    'Upgrade Check' => 'アップグレードの確認',
    'Your Movable Type installation is already up to date.' => 'Movable Typeはすでに最新の状態です。',

    ## tmpl/cms/dialog_grant_role.tmpl
    'You need to create some roles.' => 'ロールを作成してください。',
    'Before you can do this, you need to create some roles. <a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">Click here</a> to create a role.' => '実行する前にロールを作成する必要があります。 <a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">ここをクリックして</a>ロールを作成してください。',
    'You need to create some users.' => 'ユーザーを作成してください。',
    'Before you can do this, you need to create some users. <a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">Click here</a> to create a user.' => '実行する前にユーザーを作成する必要があります。 <a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">ここをクリックして</a>ユーザーを作成してください。',
    'You need to create some weblogs.' => 'ブログを作成してください。',
    'Before you can do this, you need to create some weblogs. <a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">Click here</a> to create a weblog.' => '実行する前にブログを作成する必要があります。 <a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">ここをクリックして</a>ブログを作成してください。',
    ...
    '_USAGE_AUTHORS_1' => '現在登録されているユーザーの一覧です。名前をクリックすると、それぞれのユーザーのプロフィールを編集できます。チェックボックスにチェックしてから「削除」ボタンをクリックすると、ユーザーを削除できます。　注意：特定のブログに関する権限をはずす場合は、ユーザーとブログとの関連を消してください。「削除」ボタンを使うと、ユーザーをシステムから削除します。',
    'You have successfully deleted the authors from the Movable Type system.' => '投稿者をMovable Typeのシステムから削除しました。',
    'Created By' => '作成者: ',
    'Last Entry' => '最後の投稿日時',
    'You have successfully enabled the selected user(s).' => '選択されたユーザーを有効にしました。',
    'You have successfully disabled the selected user(s).' => '選択されたユーザーを無効にしました。',
    'You have successfully deleted the user(s) from the Movable Type system.' => 'ユーザーをMovable Typeのシステムから削除しました。',
    '(Showing all users.)' => 'すべて(条件を変更する)',
    'Showing only users whose [_1] is [_2].' => '[_1]が[_2] (条件を変更する)',
    'users.' => 'ユーザー',
    'users where' => 'ユーザー‐検索条件: ',
    '_USER_STATUS_CAPTION' => '状態',
    'Only show enabled users' => '有効なユーザーだけを表示',
    'Only show disabled users' => '無効なユーザーだけを表示',
    ## tmpl/cms/delete_confirm.tmpl
    'Are you sure you want to permanently delete the [quant,_1,user] from the system?' => '[quant,_1,人,人]のユーザーをシステムから完全に削除してよろしいですか?',
    ...
    '_USAGE_CATEGORY_PING_URL' => 'この URL は、このカテゴリーのエントリーに対するトラックバックを受け付けるためのものです。受け付けたトラックバックの一覧をメインページのテンプレートで利用したいときは、トラックバックに関連するタグのヘルプを参照してください。',
    ...
    ## tmpl/cms/backup_restore.tmpl
    'None selected.' => '選択されていません。',
    'This option allows you to choose exactly what you want to backup.' => 'このオプションではバックアップする対象を選択できます。',
    ...
    'Everything' => 'すべて',
    'Choose weblogs to backup' => 'ブログを選択',
    'Type of archive format' => 'アーカイブ形式',
    'Don\'t compress' => '圧縮しない',
    'Number of megabytes per file' => 'ファイルごとのサイズ(MB)',
    'Don\'t Divide' => '分割しない',
    'Approximate file size per backup file.' => '個々のバックアップファイルのおおよそのサイズ',
    'Make Backup' => 'バックアップ',
    'Make Backup (b)' => 'バックアップ(B)',
    'Perl module XML::SAX and/or its dependencies are missing - Movable Type can not restore the system without it.' => 'XML::SAXまたはその依存モジュールが見つかりません。これらのモジュールがインストールされていないとMovable Typeのシステムは復元できません。',
    ...
    'Upload Manifest File (m)' => 'マニフェストファイルのアップロード(M)',
    ...
    ## tmpl/cms/backup_start.tmpl
    'Backup...' => 'バックアップ',
    'Backing up Movable Type' => 'Movable Typeをバックアップします',
    ...
    'Restoring...' => '復元..',
    'Restoring Movable Type' => 'Movable Typeを復元しています',
    ## tmpl/cms/role_actions.tmpl
    'Delete selected roles (x)' => '選択されたロールを削除(X)',
    'role' => 'ロール',
    'roles' => 'ロール',
    ...
    'Ownership of imported entries:' => '読み込んだエントリーのユーザー',
    'Preserve original user' => '元のユーザーを保持する',
    'If you choose to preserve the ownership of the imported entries and any of those users must be created in this installation, you must define a default password for those new accounts.' => '読み込まれたエントリーのユーザーの情報を使う場合、新しいユーザーが作成されることがあります。そのときのために既定のパスワードを指定します。',
    'Default password for new users:' => '新しいユーザーに設定するパスワード',
    'You will be assigned the user of all imported entries.  If you wish the original user to keep ownership, you must contact your MT system administrator to perform the import so that new users can be created if necessary.' => '現在のユーザーの情報で読み込みます。元のユーザー名で読み込む場合は、システム管理者に相談し、必要であれば該当するユーザーを事前に作成してから読み込んでください。',
    ...
    'From this screen, you can view information about and manage many aspects of your system across all weblogs.' => 'システム全体の各種情報を表示し、変更できます。',    ## tmpl/cms/list_role.tmpl
    '_USAGE_ROLES' => 'システムに登録されているロールを表示し、新しく作成できます。名前をクリックして詳細を表示できます。',
    'You have successfully deleted the role(s).' => 'ロールを削除しました。',
    'Members' => 'メンバー',
    'Groups' => 'グループ',
    'Grant a new role' => 'ロールを新規に関連付け',
    'Grant another role to [_1]' => '[_1]にロールを関連付け',
    '_USER_STATUS_CAPTION' => '状態',
    'Via Group' => '経由グループ',
    'Role Is Active' => '有効なロール',
    'Role Not Being Used' => '使用されていないロール',
    'No roles could be found.' => 'ロールが見つかりませんでした。',
    ## tmpl/cms/listing_panel.tmpl
    'Step [_1] of [_2]' => 'ステップ [_1]/[_2]',
    'View All' => 'すべて表示',
    'Go to [_1]' => '[_1]へ移動',
    'Confirm' => '確定',
    'Sorry, there were no results for your search. Please try searching again.' => '検索結果がありませんでした。検索をやり直してください。',
    'Sorry, there is no data for this object set.' => 'このオブジェクトセットにはデータがありません。',
    ...
    'Path:' => 'パス: ',
    'Upload' => 'アップロード',
    'You need to configure your weblog.' => '先にブログを設定してください。',
    'Before you can upload a file, you need to publish your weblog. <a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">Click here</a> to configure your weblog\'s publishing paths and rebuild your weblog.' => 'ファイルをアップロードする前にブログの公開設定をしてください。<a href="javascript:void(0);" onclick="closeDialog(\'[_1]\');">ここをクリック</a>してブログの公開設定を行い、ブログを再構築してください。',
    'Upload New File' => '新しいファイルのアップロード',
    'Choose a file from your computer to upload' => 'コンピュータからアップロードするファイルを選択',
    'File to Upload' => 'アップロードするファイル',
    'Click the button below and select a file on your computer to upload.' => '下のボタンをクリックしてアップロードするファイルをコンピュータから選択してください。',
