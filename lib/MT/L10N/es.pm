...
## check.cgi
    ...
    'The check.cgi script provides you with information on your system\'s configuration and determines whether you have all of the components you need to run Melody.' => '', # Translate - New
    'The version of Perl installed on your server ([_1]) is lower than the minimum supported version ([_2]). Please upgrade to at least Perl [_2].' => '', # Translate - New
    'Melody configuration file was not found.' => 'No se encontro el archivo de configuración de Melody',
    ...
    '(Probably) Running under cgiwrap or suexec' => '(Probablemente) ejecutandose bajo cgiwrap o suexec',
    '[_1] [_2] Modules' => '[_1] [_2] Módulos',
    'The following modules are <strong>optional</strong>. If your server does not have these modules installed, you only need to install them if you require the functionality that the module provides.' => '', # Translate - New
    'Some of the following modules are required by the various data storage options in Melody. In order run the system, your server needs to have DBI and at least one of the other modules installed.' => '', # Translate - New
    'Either your server does not have <a href="[_2]">[_1]</a> installed, the version that is installed is too old, or [_1] requires another module that is not installed.' => '', # Translate - New
    'Your server does not have <a href="[_2]">[_1]</a> installed, or [_1] requires another module that is not installed.' => '', # Translate - New
    'Please consult the installation instructions for help in installing [_1].' => '', # Translate - New
    'The DBD::mysql version you have installed is known to be incompatible with Melody. Please install the current release available from CPAN.' => '', # Translate - New
    'The $mod is installed properly, but requires an updated DBI module. Please see note above regarding the DBI module requirements.' => '', # Translate - New
    ...
    'Your server has all of the required modules installed; you do not need to perform any additional module installations. Continue with the installation instructions.' => '', # Translate - New
    'CGI is required for all Melody application functionality.' => 'El CGI es requerido para todas las funciones del Sistema Melody.',
    'Class::Accessor is required for all Melody application functionality.' => '', # Translate - New
    'Class::Trigger is required for all Melody application functionality.' => '', # Translate - New
    'Data::ObjectDriver is required for all Melody application functionality.' => '', # Translate - New
    'Image::Size is required for file uploads (to determine the size of uploaded images in many different formats).' => '', # Translate - New
    'YAML::Tiny is required for all Melody application functionality.' => '', # Translate - New
    'DBI is required to store data in database.' => 'DBI es necesario para guardar información en bases de datos.',
    'DBI and DBD::mysql are required if you want to use the MySQL database backend.' => '', # Translate - New
    'DBI and DBD::Pg are required if you want to use the PostgreSQL database backend.' => '', # Translate - New
    'DBI and DBD::SQLite are required if you want to use the SQLite database backend.' => '', # Translate - New
    'DBI and DBD::SQLite2 are required if you want to use the SQLite 2.x database backend.' => '', # Translate - New
    'Archive::Tar is required in order to archive files in backup/restore operation.' => '', # Translate - New
    'Archive::Zip is required in order to archive files in backup/restore operation.' => '', # Translate - New
    '' => '', # Translate - New
    'Cache::Memcached and memcached server/daemon is required in order to use memcached as caching mechanism used by Melody.' => '', # Translate - New
    'Crypt::DSA is optional; if it is installed, comment registration sign-ins will be accelerated.' => '', # Translate - New
    ...
    'Digest::SHA1 and its dependencies are required in order to allow commenters to be authenticated by OpenID providers including Vox and LiveJournal.' => '', # Translate - New
    ...
    'HTML::Entities is needed to encode some characters, but this feature can be turned off using the NoHTMLEntities option in the configuration file.' => '', # Translate - New
    'HTML::Parser is optional; It is needed if you wish to use the TrackBack system, the weblogs.com ping, or the Melody Recently Updated ping.' => '', # Translate - New
    'IO::Compress::Gzip is required in order to compress files in backup/restore operation.' => '', # Translate - New
    'IO::Uncompress::Gunzip is required in order to decompress files in backup/restore operation.' => '', # Translate - New
    'This module is needed if you would like to be able to use NetPBM as the image driver for Melody.' => '', # Translate - New
    'Image::Magick is optional; It is needed if you would like to be able to create thumbnails of uploaded images.' => '', # Translate - New
    'LWP is optional; It is needed if you wish to use the TrackBack system, the weblogs.com ping, or the Melody Recently Updated ping.' => '', # Translate - New
    'Mail::Sendmail is required for sending mail via SMTP Server.' => '', # Translate - New
    'SOAP::Lite is optional; It is needed if you wish to use the Melody XML-RPC server implementation.' => '', # Translate - New
    'XML::Atom is required in order to use the Atom API.' => '', # Translate - New
    'XML::LibXML is required in order to use the Atom API.' => '', # Translate - New
    'XML::SAX and/or its dependencies is required in order to restore.' => '', # Translate - New
...
## default_templates/recover-password.mtml
    'A request has been made to change your password in Movable Type. To complete this process click on the link below to select a new password.' => 'Se ha hecho una petición para cambiar tu contraseña en Melody. Para terminar este proceso, has click en el siguiente link para usar una nueva contraseña.',
...
## default_templates/comment_throttle.mtml
    'If this was a mistake, you can unblock the IP address and allow the visitor to add it again by logging in to your Movable Type installation, going to Blog Config - IP Banning, and deleting the IP address [_1] from the list of banned addresses.' => 'Si esto ha sido un error, puede desbloquear la dirección IP y permitir al visitante registrarse nuevamente, eliminando la dirección IP [_1] en el listado de IP bloqueadas en Configuración del Blog - Bloqueo de IP. ',
...
## default_templates/comments.mtml
    ...
    'The data is modified by the paginate script' => 'Los datos están modificados por el script de paginación',
...
## lib/MT/BackupRestore/BackupFileHandler.pm
    'Uploaded file was not a valid Movable Type backup manifest file.' => 'El archivo enviado no es un archivo valido de manifiesto de respaldo de Melody.',
    'Uploaded file was backed up from Movable Type but the different schema version ([_1]) from the one in this system ([_2]).  It is not safe to restore the file to this version of Movable Type.' => 'El archivo cargado fue respaldado desde Melody, pero en un una versión de esquema distinto ([_1]) y en el sistema se tiene la ([_2]).  No es seguro restaurar el archivo en esta versión de Melody.',
    '[_1] is not a subject to be restored by Movable Type.' => '[_1] no esta sujeto a ser restaurado por Melody.',
...
## lib/MT/Core.pm
    ...
    'Adds Summarize workers to queue.' => 'Añade trabajadores a la cola para los resúmenes.',
    'zip' => 'zip',
    'tar.gz' => 'tar.gz',
    ...
    'Add Summary Watcher to queue' => 'Añadir un vigilante de resúmenes a la cola',
...
## lib/MT/Upgrade.pm
    ...
    'Migrating Nofollow plugin settings...' => 'Migrando ajustes del plugin Nofollow...',
    ...
    'This role was generated by Movable Type upon upgrade.' => 'Este rol fue creado por Melody después de una actualización.',
    ...
    'I just finished installing [_1] [_2]!' => '¡Acabo de finalizar la instalación de [_1] [_2]!',
    'Welcome to my new blog powered by [_1]. This is the first post on my blog and was created for me automatically when I finished the installation process. But that is ok, because I will soon be creating posts of my own!' => 'Bienvenido a mi nuevo blog de [_1]. Esta es la primera entrada en mi blog y fue creada automáticamente al finalizar el proceso de instalación. ¡Pronto crearé mis propias entradas!',
    'Movable Type also created a comment for me as well so that I could see what a comment will look like on my blog once people start submitting comments on all the posts I will write.' => 'Melody también creo un comentario por mi para ver como lucen los comentarios en mi blog una vez que la gente comience a enviar comentarios en las entradas que escriba.',
    ...
    'Renaming PHP plugin file names...' => 'Renombrando los archivos del plugin de PHP...',
    ...
    'Plugin \'[_1]\' upgraded successfully to version [_2] (schema version [_3]).' => 'Plugin \'[_1]\' actualizado con éxito a la versión [_2] (versión del esquema [_3]).',
    'User \'[_1]\' upgraded plugin \'[_2]\' to version [_3] (schema version [_4]).' => 'Usuario \'[_1]\' actualizó el plugin \'[_2]\' a la versión [_3] (versión del esquema [_4]).',
    'Plugin \'[_1]\' installed successfully.' => 'El plugin \'[_1]\' se actualizó correctamente.',
    'User \'[_1]\' installed plugin \'[_2]\', version [_3] (schema version [_4]).' => 'Usuario \'[_1]\' instaló el plugin \'[_2]\', versión [_3] (versión del esquema [_4]).',
...
## lib/MT/CMS/System.pm
    ...
    'You don\'t have a system email address configured.  Please set this first, save it, then try the test email again.' => 'No tiene configurado la dirección de correo del sistema. Por favor, configúrela, guárdela e intente de nuevo enviar el correo de prueba.',
    ...
    'This is the test email sent by your installation of Movable Type.' => 'Este es el email enviado por su instalación de Melody.',
    'Mail was not properly sent' => 'El correo no se envió correctamente',
    'Test e-mail was successfully sent to [_1]' => 'El correo de prueba se envió correctamente a [_1]',
    'These setting(s) are overridden by a value in the MT configuration file: [_1]. Remove the value from the configuration file in order to control the value on this page.' => 'Estas opciones están redefinidas por un valor en el fichero de configuración de MT: [_1]. Para controlar el valor en esta página, elimine el valor del fichero de configuración.',
    ...
    'Performance log path is [_1]' => 'La ruta de los históricos de rendimiento es [_1]',
    ...
    'System Settings Changes Took Place' => 'Se realizaron cambios en la configuración del sistema',
...
## lib/MT/CMS/Dashboard.pm
    ...
    'Movable Type has undergone a significant overhaul in all aspects of performance. Memory utilization has been reduced, publishing times have been increased significantly and search is now 100x faster!' => 'Melody ha sufrido una revisón extensiva en todos los aspectos para mejorar el desempeño. ¡El uso de memoria se ha reducido, los tiempos de publicación se han minimizado y las busquedas son 100 veces más rápidas!',
...
## lib/MT/CMS/Common.pm
    ...
    'This action can only be run on a single blog at a time.' => 'Esta acción solo puede realizarse en un solo blog a la vez.',
    'Invalid blog_id' => 'blog_id no válido',
    'You need to specify a Site URL' => 'Debe especificar la URL del sitio',
    'You need to specify a Site Path' => 'Debe especificar una ruta para el sitio',
    'Entries must be cloned if comments and trackbacks are cloned' => 'Las entradas deben clonarse si se clonan los comentarios y trackbacks',
    ...
    'Saving snapshot failed: [_1]' => 'Falló el guardado de la instantanea: [_1]',
...
## lib/MT/CMS/Tools.pm
    ...
    'Successfully restored objects to Movable Type system by user \'[_1]\'' => 'Se han restaurado exitosamente los objetos en el sistema por el usuario \'[_1]\'',
    ...
    'Movable Type system was successfully backed up by user \'[_1]\'' => 'Melody fue respaldado satisfactoriamente por el usuario \'[_1]\'',
...
## lib/MT/CMS/Blog.pm
    ...
    'Error: Movable Type cannot write to the template cache directory. Please check the permissions for the directory called <code>[_1]</code> underneath your blog directory.' => 'Error: Melody no puede escribir en el directorio de cache de las plantillas. Por favor verifique los permisos para este directorio llamado <code>[_1]</code> dentro del directorio de su blog.',
    'Error: Movable Type was not able to create a directory to cache your dynamic templates. You should create a directory called <code>[_1]</code> underneath your blog directory.' => 'Error: Melody no puede crear el directorio de cache para las plantillas dinámicas. Debe crear un directorio llamado <code>[_1]</code> dentro del directorio de su blog.',
...
## lib/MT/CMS/Asset.pm
    ...
    'The file ([_1]) you uploaded is not allowed.' => 'El archivo cargado ([_1]) no esta permitido.',
...
## lib/MT/CMS/Template.pm
    ...
    'Could not clone template: [_1]' => 'No se ha podido clonar la plantilla: [_1]',
    'Cannot publish a global template.' => 'No se puede publicar una plantilla global.',
    'template' => 'plantilla',
...
## lib/MT/Entry.pm
    'Load of author \'[_1]\' failed: [_2]' => 'Fallo la carga del autor \'[_1]\': [_2]',
...
## lib/MT/BackupRestore.pm
    ...
    'Manifest file [_1] was not a valid Movable Type backup manifest file.' => 'El archivo de Manifiesto [_1] no es un archivo de manifiesto válido de respaldo de Melody.',
...
## lib/MT/App.pm
    'Malformed page_action data found for mode "[_1]" (Key: [_2]). Skipping page_actions.' => 'Se encontraron datos malformados de page_action para el modo "[_1]". Se ignorará page_actions.',
    ...
    'Our apologies, but you do not have permission to access any blogs within this installation. If you feel you have reached this message in error, please contact your Movable Type system administrator.' => 'Disculpe, pero no tiene permisos para acceder a ningún blog en esta instalación. Si creé que esto es un error, por favor contacte al administrador del sistema.',
...
## lib/MT/Revisable.pm
    'Bad RevisioningDriver config \'[_1]\': [_2]' => 'Hay un error en la configuración de RevisioningDriver \'[_1]\': [_2]',
    'Revision not found: [_1]' => 'Revisión no encontrada: [_1]',
    'There aren\'t the same types of objects, expecting two [_1]' => 'No hay objetos del mismo tipo, se esperaban dos [_1]',
...
## lib/MT/Bootstrap.pm
    'Enable DebugMode for more details.' => 'Para más detalles habilitar el modo de Test email from [_1] (DebugMode)',
...
## lib/MT/Template/Context.pm
    'You are using a deprecated template tag: [_0]' => 'Se ha utilizado una etiqueta descontinuada: [_0]',
...
## lib/MT/XMLRPCServer.pm
    ...
    'Template methods are not implemented, due to differences between the Blogger API and the Movable Type API.' => 'Los métodos de plantilla no han sido implentados aún, debido a diferencias entre la API de Blogger y la de Movable Type',

## lib/MT/Util/Captcha.pm
    'Movable Type default CAPTCHA provider requires Image::Magick.' => 'El proveedor de CAPTCHA redeterminado de Melody require Image::Magick.',
...
## lib/MT/App/Wizard.pm
    ...
    'Sendmail' => 'Sendmail',
    'Test email from [_1] Configuration Wizard' => 'Mensaje de comprobación del asistente de configuración de [_1]',
    'This is the test email sent by your new installation of [_1].' => 'Este es el mensaje de comprobación enviado por su nueva instalación de [_1].',
    'This module is needed to encode special characters, but this feature can be turned off using the NoHTMLEntities option in config.cgi.' => 'Este módulo es necesario para codificar caracteres especiales, pero se puede desactivar esta característica utilizando la opción NoHTMLEntities en config.cgi.',
    ...
    'This module is required by certain MT plugins available from third parties.' => 'Este módulo lo necesitan algunos plugins de MT de terceras partes.',
    ...
    'This module is required in search.cgi if you are using a version of Perl older than Perl 5.8.' => 'Este modulo es requerido en search.cgi si estás usando una versión de Perl anterior a la 5.8 ',
    ...
    'CGI is required for all application functionality.' => 'El módulo CGI es requerido por la apliación',
...
## lib/MT/App/Comments.pm
    ...
    'Invalid commenter login attempt from [_1] to blog [_2](ID: [_3]) which does not allow Movable Type native authentication.' => 'Intento de inicio de sesión invalido desde [_1] al blog [_2](ID: [_3]) el cual no permite la atenticación nativa de Melody.',
    ...
    'Movable Type Account Confirmation' => 'Confirmación de cuenta de Melody',
...
## lib/MT/App/Upgrader.pm
    ...
    'No permissions. Please contact your administrator for upgrading Movable Type.' => 'Sin permiso. Por favor contacte a su administrador para actualizar Melody.',
    'Movable Type has been upgraded to version [_1].' => 'Melody ha sido actualizado a la versión [_1].',
...
## lib/MT/App/Search.pm
    ...
    'You must pass a valid archive_type with the template_id' => 'Debe pasar un tipo de archivo (archive_type) válido con el template_id',
    'Template must have identifier entry_listing for non-Index archive types' => 'La plantilla debe tener un identificador entry_listing para los tipos de archivos que no sean índices',
    'Blog file extension cannot be asp or php for these archives' => 'El fichero del blog no puede ser asp o php para estos archivos',
    'Template must have identifier main_index for Index archive type' => 'La plantilla debe tener un identificador main_index para el tipo de archivos índices',
...
## lib/MT/Asset.pm
    ...
    'Location' => 'Lugar',
    'Could not create asset cache path: [_1]' => 'No se ha podido crear la carpeta del cache de archivos multimedia en:[_1] ',
...
## lib/MT.pm
    ...
    'Sign in to Movable Type with your[_1] Account[_2]' => 'Ingresar a Melody usando su [_1] cuenta [_2]',
    ...
    'Missing configuration file. Maybe you forgot to move config.cgi-original to config.cgi?' => 'No se encontro el archivo de configuración. ¿Quizás olvidó renombrar mt-config.cgi-original a mt-config.cgi?',
    'Plugin error: [_1] [_2]' => 'Error en el plugin: [_1] [_2]',
    'You are using a plugin ([_1]) that uses a deprecated plugin file format (.pl)' => 'Está utilizando un plugin ([_1]) que usa un formato de archivo descontinuado (.pl).',
    'Bad directory found in plugin initialization: [_1]' => 'Se encontro un direcotrio dañado en la inicialización del plugin: [_1]',
    'Loading template \'[_1]\' failed.' => 'Fallo cargando la plantilla \'[_1]\'.',
    'http://github.com/openmelody/melody/wiki/' => 'http://github.com/openmelody/melody/wiki/',
    'OpenID' => 'OpenID',
...
## tmpl/include/chromeless_footer.tmpl
    '<a href="[_1]">Melody</a> version [_2]' => '<a href="[_1]">Melody</a> versión [_2]',

## tmpl/error.tmpl
    'Missing Configuration File' => 'Fichero de configuración no encontrado',
    '_ERROR_CONFIG_FILE' => 'El fichero de configuración de Your Melody no existe o no se puede leer correctamente. Por favor, consulte la sección <a href="javascript:void(0)">Instalación y configuración</a> del manual de Melody manual para más información.',
    'Database Connection Error' => 'Error de conexión a la base de datos',
    '_ERROR_DATABASE_CONNECTION' => 'Las opciones de configuración de su base de datos o son incorrectas o no están presentes en el fichero de configuración de Melody. Por favor, consulte la sección <a href="javascript:void(0)">Instalación y configuración</a> del manual de Melody para más información',
    'CGI Path Configuration Required' => 'Se necesita la configuración de la ruta de CGI',
    '_ERROR_CGI_PATH' => 'La opción de configuración CGIPath no es válida o no se encuentra en el fichero de configuración de Melody. Por favor, consulte la sección <a href="javascript:void(0)">Instalación y configuración</a> del manual de Melody manual para más información.',

## tmpl/wizard/blog.tmpl
    'Setup Your First Blog' => 'Configure su primer blog',
    'In order to properly publish your blog, you must provide Melody with your blog\'s URL and the path on the filesystem where its files should be published.' => 'Para poder publicar tu blog, debes de proveer a Melody la URL de tu blog y la ruta en el sistema de archivos donde se deben de publicar los archivos.',
    'My First Blog' => 'Mi primer blog',
    'Publishing Path' => 'Ruta de publicación',
    'Your \'Publishing Path\' is the path on your web server\'s file system where Melody will publish all the files for your blog. Your web server must have write access to this directory.' => 'La \'Ruta de Publicación\' es la ruta en el sistema de archivos del servidor donde Melody publicará todos los archivos de tu blog. Tu servidor web debe tener permisos de escritura en este directorio.',
    'Back' => 'Volver',
    'Continue' => 'Continuar',
...
## tmpl/wizard/start.tmpl
    ...
    'A configuration (config.cgi) file already exists, <a href="[_1]">sign in</a> to Melody.' => 'Ya existe un archivo de configuración (config.cgi), <a href="[_1]>inicie sesión</a> en Melody.',
    ...
    'Melody requires that you enable JavaScript in your browser. Please enable it and refresh this page to proceed.' => 'Melody necesita que JavaScript esté disponible en el navegador. Por favor, active JavaScript y recargue esta página para continuar.',
    'This wizard will help you configure the basic settings needed to run Melody.' => 'Este asistente le ayudará a configurar las opciones básicas necesarias para ejecutar Melody.',
    'Language' => 'Idioma',
    ...
    'Melody ships with directory named [_1] which contains a number of important files such as images, javascript files and stylesheets.' => 'Melody viene con un directorio nombrado [_1] el cual contiene un número de archivos importantes tales como imágenes, archivos javascript y hojas de estilo en cascadas.',
    'The [_1] directory is in the main Melody directory which this wizard script resides, but due to your web server\'s configuration, the [_1] directory is not accessible in this location and must be moved to a web-accessible location (e.g., your web document root directory).' => 'El directorio [_1] está en el directorio principal de Melody que recide en el script de instalación, pero depende de la configuración de su web server, el directorio [_1] no es accesible en este lugar y debe ser removido a un lugar de web accesible (e.g., su documento de raíz del directorio web)',
    'This directory has either been renamed or moved to a location outside of the Melody directory.' => 'Este directorio o se ha renombrado o movido a un lugar fuera del directorio de Melody.',
...
## tmpl/wizard/packages.tmpl
    ...
    'The following Perl modules are required in order to make a database connection.  Melody requires a database in order to store your blog\'s data.  Please install one of the packages listed here in order to proceed.  When you are ready, click the \'Retry\' button.' => 'Los siguientes módulos de Perl son necesarios para la conexión con la base de datos. Melody necesita una base de datos para guardar los datos del blog. Por favor, instale los paquetes listados aquí para continuar. Cuando lo haya hecho, haga clic en el botón \'Reintentar\'.',
    'All required Perl modules were found.' => 'Se encontraron todos los módulos de Perl necesarios.',
    'You are ready to proceed with the installation of Melody.' => 'Está listo para continuar con la instalación de Melody.',
    ...
    'One or more Perl modules required by Melody could not be found.' => 'No se encontraron uno o varios módulos de Perl necesarios.',
    'The following Perl modules are required for Melody to run properly. Once you have met these requirements, click the \'Retry\' button to re-test for these packages.' => 'Los siguientes módulos de Perl son necesarios para que Melody se ejecute correctamente. Una vez los haya instalado, haga clic en el botón \'Reintentar\' para realizar la comprobación nuevamente.',
...
## tmpl/wizard/optional.tmpl
    ...
    'Check your email to confirm receipt of a test email from Melody and then proceed to the next step.' => 'Compruebe su correo para confirmar la recepción del mensaje de prueba de Melody y luego continúe con el paso siguiente.',
    'Show current mail settings' => 'Mostrar configuración actual del correo',
    'Periodically Melody will send email to inform users of new comments as well as other other events. For these emails to be sent properly, you must instruct Melody how to send email.' => 'Periódicamente, Melody enviará un correo para informar a los usuarios sobre los nuevos comentarios y otros eventos. Para que estos correos se envíen correctamente, debe decirle a Melody cómo enviarlos.',
...
## tmpl/wizard/complete.tmpl
    ...
    'Please use the configuration text below to create a file named \'config.cgi\' in the root directory of [_1] (the same directory in which index.cgi is found).' => 'Utilice por favor el texto de la configuración abajo para crear un archivo nombrado \'config.cgi\' en la raíz del directorio de [_1] (el mismo directorio en el cual se encuentra index.cgi).',
    ...
    'Confirm your [_1] home directory (the directory that contains index.cgi) is writable by your web server and then click \'Retry\'.' => 'Confirme el servidor web puede escribir en el directorio de inicio de [_1] (el directorio que contiene index.cgi) y luego haga clic en \'Reintentar\'.',
    ...
    'Show the config.cgi file generated by the wizard' => 'Mostrar el archivo config.cgi generado por el asistente de instalación',
    'The config.cgi file has been created manually.' => 'El fichero config.cgi fue creado manualmente.',
...
## tmpl/wizard/configure.tmpl
    ...
    'Is your preferred database not listed? View the <a href="[_1]" target="_blank">Melody System Check</a> see if additional modules are necessary.' => '¿Su base de datos preferida no está en la lista? Consulte la <a href="[_1]" target="_blank">Comprobación del Sistema de Melody</a> para ver si se necesitan otros módulos.',
    ...
    'A default location of \'./db/mt.db\' will store the database file underneath your Melody directory.' => 'La base de datos se guarda por defecto en \'./db/mt.db\' bajo el directorio de Melody.',
...
## tmpl/cms/prefs/sys_users.tmpl
    ...
    'Allow commenters to register to Melody' => 'Permitir el registro de comentaristas en Melody',
...
## tmpl/cms/prefs/registration.tmpl
    ...
    'One or more Perl modules may be missing to use this authentication method.' => 'Uno o más módulos de Perl podrían necesitar este método de autentificación.',
...
## tmpl/cms/prefs/general.tmpl
    ...
    'Note: Revision History is currently disabled at the system level.' => 'Nota: El historial de revisiones esta deshabilitado nivel del sistema.',
    'Revision history' => 'Historial de revisiones',
...
## tmpl/cms/prefs/trackbacks.tmpl
    ...
    'Specify when Melody should notify you of new TrackBacks if at all.' => 'Especifica si Melody debe notificarle sobre los nuevos TrackBacks en su sitio.',
    'On' => 'Activar',
...
## tmpl/cms/prefs/sys_general.tmpl
    ...
    'You can find an explanation of the various debug modes in the <a href="http://www.movabletype.org/documentation/developer/plugins/debug-mode.html">documentation</a>' => 'Puede encontrar una explicación de los diferentes modos de depuración en la <a href="http://www.movabletype.org/documentation/developer/plugins/debug-mode.html">documentación</a>',
    'Performance Logging' => 'Histórico de rendimiento',
    'Turns on or off performance logging.' => 'Activa o desactiva el histórico de rendimiento.',
    'Log Paths' => 'Rutas de los históricos',
    'Paths where logs are placed.' => 'Las rutas donde se sitúan los ficheros de los históricos.',
    'Logging Threshold' => 'Umbral de los históricos',
    'Logging threshold for the App' => 'Umbral de los históricos de la aplicación',
    'Enable this setting to have Melody track revisions made by users to entries, pages and templates.' => 'Habilite esta opción para que Melody lleve revisiones hechas por los usuarios en las entradas, páginas y plantillas.',
...
## tmpl/cms/prefs/web_services.tmpl
    ...
    'When this blog is updated, Melody will automatically notify the selected sites.' => 'Cuandos este blog es actulalizado, Melody noficara automaticamente a los sitios seleccionados.',
...
## tmpl/cms/prefs/publishing.tmpl
    ...
    'The path where your index files will be published. An absolute path (starting with \'/\') is preferred, but you can also use a path relative to the Melody directory. Example: /home/melody/public_html/blog' => 'Ruta donde se hubicará el archivo de indice (index) principal. Se recomienda usar una ruta absoluta (empezando con \'/\'), también puede utilizar una ruta relativa al directorio de Melody. Ejemplo: /home/melody/public_html/blog',
...
## tmpl/cms/prefs/comments.tmpl
    ...
    'Specify when Melody should notify you of new comments if at all.' => 'Especifica cuando Melody debe notificarle sobre nuevos comentarios.',
...
## tmpl/cms/widget/new_version.tmpl
    ...
    'Congratulations, you have successfully installed Melody [_1]. Listed below is an overview of the new features found in this release.' => 'Felicidades, ha instalado exitosamente Melody [_1]. Abajo se lista una breve descripción de las nuevas características encontradas en esta versión.',
...
## tmpl/cms/widget/blog_stats.tmpl
    ...
    'Nov.' => 'Nov.',
    'Dec.' => 'Dic.',
    'Melody was unable to locate your \'mt-static\' directory. Please configure the \'StaticFilePath\' configuration setting in your config.cgi file, and create a writable \'support\' directory underneath your \'mt-static\' directory.' => 'Melody no ha podido encontrar su directorio \'mt-static\'. Por favor configure de manera adecuada la opción de configuración \'StaticFilePath\' en su archivo config.cgi, y creé un directorio llamado \'support\' con permisos de escritura dentro del directorio \'mt-static\'.',
    'Melody was unable to write to its \'support\' directory. Please create a directory at this location: [_1], and assign permissions that will allow the web server write access to it.' => 'Melody no pudo escribir en el directorio \'support\'. Por favor creee el directoro en este lugar: [_1], y asigne permisos de escritura al servidor web sobre este directorio.',
...
## tmpl/cms/widget/new_install.tmpl
    ...
    'Congratulations on installing [_1], the world\'s most powerful blogging, publishing and social media platform. To help you get started we have provided you with links to some of the more common tasks new users like to perform:' => 'Felicidades por la instalación de [_1], la plataforma más potente del mundo en publicación de blogs y como plataforma para medios sociales. Para ayudarle a comenzar, le proveemos algunos enlaces a las tareas más comunes que los nuevos usuarios suelen realizar:',
    'Write your first post' => 'Escribir la primera entrada',
    'What would a blog be without content? Start your [_1] experience by creating your very first post.' => '¿Qué sería un blog sin contenido? Empiece su experiencia en [_1] creando la primera entrada.',
    ...
    'Whether you\'re new to [_1] or using it for the first time, learn more about what this tool can do for you.' => 'Tanto si es la primera vez que usa [_1], como si ya es un usuario con experiencia, aprenda qué es lo que puede hacer esta herramienta por usted.',

## tmpl/cms/widget/this_is_you.tmpl
    'This is you' => 'Este es usted',
    'Your <a href="[_1]">last entry</a> was [_2] in <a href="[_3]">[_4]</a>.' => 'La <a href="[_1]">última entrada</a> fue [_2] en <a href="[_3]">[_4]</a>.',
...
## tmpl/cms/widget/mt_news.tmpl
    ...
    'No Learning Melody news available.' => 'No hay noticias de Aprendiendo Melody',
...
## tmpl/cms/widget/new_user.tmpl
    'Welcome to Melody, the world\'s most powerful blogging, publishing and social media platform. To help you get started we have provided you with links to some of the more common tasks new users like to perform:' => 'Bienvenido a Melody, la plataforma social de blogs y publicación más potente del mundo. Para ayudarle a comenzar, le ofrecemos algunos enlaces con las tareas más comunes que los nuevos usuarios suelen realizar:',
    'What would a blog be without content? Start your Melody experience by creating your very first post.' => '¿Qué sería de un blog sin su contenido? Comienze su nueva experiencia con Melody creando su primer entrada.',
    'Explore what\'s new in Melody' => 'Explora lo nuevo en Melody',
    'Whether you\'re new to Melody or using it for the first time, learn more about what this tool can do for you.' => 'Si estos son sus primeros pasos en Melody puede aprnder más acerca de lo que esta herramienta puede hacer por usted.',
...
## tmpl/cms/cfg_system_general.tmpl
    ...
    'The email address where you want to send test email to.' => 'Esta es la dirección donde se enviará el correo de prueba.',
...
## tmpl/cms/include/footer.tmpl
    'This is a beta version of [_1] and is not recommended for production use.' => 'Esta es una versión beta de [_1] y no serecomienda su uso para producción',
    ...
    'Wiki' => 'Wiki',
    'http://getsatisfaction.com/openmelody' => 'http://getsatisfaction.com/openmelody',
    'Support' => 'Soporte',
    'http://openmelody.org/contribute/feedback' => 'http://openmelody.org/contribute/feedback',
...
## tmpl/cms/system_check.tmpl
    ...
    'Users who have logged in within 90 days are considered <strong>active</strong> in Melody license agreement.' => 'Usuarios que han inciado sesión en los últimos 90 días son considerados <strong>activos</strong> en el acuerdo de licencia de Medoly.',
...
## tmpl/cms/edit_template.tmpl
    ...
    'This template has been cloned ([_1]).' => 'Se ha clonado la plantilla ([_1]).',
    'Revision: <strong>[_1]</strong>' => 'Revisión: <strong>[_1]</strong>',
    'View revisions of this template' => 'Ver las revisiones de esta plantilla',
    'View revisions' => 'Ver las revisiones',
    'No revision(s) associated with this template' => 'No hay revisiones asociadas a esta plantilla',
    'Useful Links' => 'Enlaces útiles',
...
## tmpl/cms/login.tmpl
    ...
    'Your Melody session has ended. If you wish to sign in again, you can do so below.' => 'Su sesión en Melody ha terminado. Si desea iniciar sesión de nuevo, puede hacerlo en la parte inferior.',
    'Your Melody session has ended. Please sign in again to continue this action.' => 'Su sesión en Melody ha terminado. Por favor inicie sesión nuevamente para poder continuar con esta acción.',
    'Sign In (s)' => 'Iniciar Sesión (s)',

## tmpl/cms/import.tmpl
    'You must select a blog to import.' => 'Debe seleccionar un blog a importar.',
    'Transfer weblog entries into Melody from other Melody installations or even other blogging tools or export your entries to create a backup or copy.' => 'Trasnfiere entradas de blog hacia Melody desde otras instalaciones de Melody u otras herramientas para blogs. Además puede exportar sus entradas para crear un respaldo o una copia.',
    ...
    'You will be assigned the user of all imported entries.  If you wish the original user to keep ownership, you must contact your MT system administrator to perform the import so that new users can be created if necessary.' => 'Se le asignarán todas las entradas importadas. Si desea que las entradas mantengan los propietarios originales, debe contacar con su administrador de Melody para que él realice la importación y así se puedan crear los nuevos usuarios en caso de ser necesario.',
    'Upload import file (optional)' => 'Subir fichero de importación (opcional)',
    'If your import file is located on your computer, you can upload it here.  Otherwise, Melody will automatically look in the \'import\' folder of your Melody directory.' => 'Si el archivo de importación se encuentra en su computadora, puede subirlo aquí. Si no, Melody buscara automaticamente en la carpeta \'import\' del dictorio de Melody.',
    'More options' => 'Más opciones',
    'Import File Encoding' => 'Codificación del fichero de importación',
    'By default, Melody will attempt to automatically detect the character encoding of your import file.  However, if you experience difficulties, you can set it explicitly.' => 'Melody tratará de detectar de forma automática la codificación de caracteres de su archivo de importación.  Sin embargo, si usted encunentra dificulatades, puede indicarla directamente.',
...
## tmpl/cms/upgrade.tmpl
    ...
    'While [_1] may run, it is an <strong>untested and unsupported environment</strong>.  We strongly recommend upgrading to at least Perl [_2].' => 'Aunque [_1] podría ejecutarse, <strong>esta configuración no está probada ni soportada</strong>.  Le recomendamos que actualice Perl a la versión [_2].',
    ...
    'A new version of [_1] has been installed.  We\'ll need to complete a few tasks to update your database.' => 'Se ha instalado una nueva versión de [_1]. Debemos realizar algunas tareas para actualizar su base de datos.',
    ...
    'In addition, the following [_1] components require upgrading or installation:' => 'Además, los siguientes componentes de [_1] necesitan actualización o instalación:',
    'The following [_1] components require upgrading or installation:' => 'Los siguientes componentes de [_1] necesitan actualización o instalación:',
    'Begin Upgrade' => 'Comenzar actualización',
    'Congratulations, you have successfully upgraded to [_1] [_2].' => 'Felicidades, actualizó con éxito a [_1] [_2].',
    'Return to [_1]' => 'Volver a [_1]',
    'Your [_1] installation is already up to date.' => 'Su instalación de [_1] ya está actualizada.',
...
## tmpl/cms/install.tmpl
    ...
    'Before you can begin blogging, you must create an administrator account for your system. When you are done, [_1] will then initialize your database.' => 'Antes de poder comenzar a publicar, debe crear una cuenta de administrador para el sistema. Cuando lo haya hecho, [_1] inicializará la base de datos.',
...
## tmpl/cms/dialog/clone_blog.tmpl
    ...
    'This is set to the same URL as the original blog.' => 'La URL coincide con la original del blog.',
    ...
    'Enter the new URL of your public website. Example: http://www.example.com/weblog/' => 'Introduzca la nueva URL de su sitio web público. Ejemplo: http://www.ejemplo.com/weblog/',
    'Enter a new path where your main index file will be located. Example: /home/melody/public_html/weblog' => 'Introduzca la nueva ruta donde se situará el fichero índice. Ejemplo: /home/melody/public_html/weblog',
    'Clone Settings' => 'Configuración de la clonación',
    'Mark the settings that you want cloning to skip' => 'Marque las opciones que desee excluir de la clonación',
...
## tmpl/cms/dialog/list_revision.tmpl
    'Select the revision to populate the values of the Edit screen.' => 'Seleccione la revisión para iniciar los valores en la pantalla de edición.',
...
## tmpl/cms/edit_entry.tmpl
    ...
    'Restored revision (Date:[_1]).  The current status is: [_2]' => 'Restored revision (Date:[_1]). El estado actual es: [_2]',
    'Some of tags in the revision could not be loaded because they have been removed.' => 'Algunas etiquetas en la revision pudieran no ser cargadas debido a que fueron eliminadas.',
    'Some [_1] in the revision could not be loaded because they have been removed.' => 'Algunas [_1] en la revision pudieran no ser cargadas debido a que fueron eliminadas.',
    ...
    'No revision(s) associated with this [_1]' => 'No hay revisiones asociadas a esta [_1]',
    ...
    'Add New' => 'Añadir nuevo',
    'No asset(s) associated with this [_1]' => 'No existe/n elemento/s asociados a [_1]',
    'The published order of these assets can be changed using [_1]template tag modifiers[_2].' => 'Se puede modificar el orden publicado de estos elementos utilizando los [_1]modificadores de etiquetas de plantilla[_2]',
    ...
    'Use <a href="http://blogit.typepad.com/">Blog It</a> to post to Melody from social networks like Facebook.' => 'Utilice <a href="http://blogit.typepad.com/">Blog It</a> para publicar en Melody desde redes socialse como Facebook.',
...
## tmpl/cms/list_author.tmpl
    ...
    'You have successfully deleted the user(s) from the Melody system.' => 'Ha eliminado al usuario del sistema.',
    'The deleted user(s) still exist in the external directory. As such, they will still be able to login to Melody Enterprise.' => 'El usuario eliminado aún existe en el directorio externo. De tal manera que aun puede iniciar sesión en Movable Type Enterprise.',
    ...
    '_NO_SUPERUSER_DISABLE' => 'No puede deshabilitarse porque es un administrador del sistema de Melody',
...
## tmpl/cms/setup_initial_blog.tmpl
    ...
    'In order to properly publish your blog, you must provide [_1] with your blog\'s URL and the path on the filesystem where its files should be published.' => 'Para publicar correctamente el blog, debe proveer a [_1] la URL del blog y la ruta en el sistema donde se publicarán sus ficheros.',
    'Your \'Publishing Path\' is the path on your web server\'s file system where [_1] will publish all the files for your blog. Your web server must have write access to this directory.' => 'La \'Ruta de publicación\' es la ruta en el sistema de archivos del servidor donde [_1] publicará todos los ficheros del blog. El servidor web debe poder escribir en este directorio.',
...
## tmpl/cms/list_blog.tmpl
    'You have successfully deleted the blogs from the Melody system.' => 'Has eliminado satisfactoriamente los blogs de Melody.',
...
## tmpl/cms/cfg_plugin.tmpl
    ...
    'Your plugins have been reconfigured. Since you\'re running in a persistent application environment, you will need to restart your web server for these changes to take effect.' => 'Sus plugins han sido reconfigurados. Debido a que la apliación sé está ejecutando en un ambiente persistente, necesita reiniciar su servidor web para que los cambios tengan efecto.',
    ...
    'No plugins with blog-level configuration settings are installed.' => 'No hay plugins instalados con configuración a nivel del sistema.',
...
## tmpl/cms/dashboard.tmpl
    ...
    'Image::Magick is either not present on your server or incorrectly configured. Due to that, you will not be able to use Melody\'s userpics feature. If you wish to use that feature, please install Image::Magick or use an alternative image driver.' => 'Image::Magick no se encuentra en su sistema o es configurado de forma incorrecta. Debido a esto, no podrá utilizar la característica de imágenes de usuario en Melody. Si desea utilizar esta característica, por favor instale Image::Magick  o algun driver de imagenes alternativo.',
    'Your dashboard is empty!' => '¡Su panel de control está vacío!',

## tmpl/cms/restore.tmpl
    'Restore from a Backup' => 'Resturar una copia de seguridad',
    'Perl module XML::SAX and/or its dependencies are missing - Melody can not restore the system without it.' => 'Falta el módulo de Perl XML::SAX y/o sus dependencias - Melody no puede restaruar el sistema sin él.',
    'Backup file' => 'Hacer copia de seguridad del archivo',
    'If your backup file is located on your computer, you can upload it here.  Otherwise, Melody will automatically look in the \'import\' folder of your Melody directory.' => 'Si su archivo de respaldo se encuentra en su computadora, puede subirlo aquí. Si no, Melody buscará automaticamente en la carpeta \'import\' en el directorio de Melody.',
    'Check this and files backed up from newer versions can be restored to this system.  NOTE: Ignoring Schema Version can damage Melody permanently.' => 'Si se habilita esta opción los archivos archivos respaldados en versiones más nuevas podrán ser restauradas en el sistema.  NOTA: Ignorar la versión del esquema podría dañar permanentemente su instalación de Melody.',
...
## tmpl/cms/sanity_check.tmpl
    'Melody could not find the script named \'check.cgi\'. To resolve this issue, please ensure that the check.cgi script exists and/or the CheckScript configuration parameter references it properly.' => 'Melody no pudo encontrar el script llamado \'check.cgi\'. Para resolver este incidente, por favor asegurese que el script mt-check.cgi existsa y/o el parametro de configuración CheckScript este referenciandolo correctamente.',
...
## tmpl/cms/cfg_archives.tmpl
    ...
    'Error: Melody was not able to create a directory for publishing your blog. If you create this directory yourself, assign sufficient permissions that allow Melody to create files within it.' => 'Error: Melody no pudo crear el directorio para publicar su blog. Si ha creado este directorio por usted mismo, assigne los permios suficientes que permitan a Melody crear los archivos en el.',
...
## tmpl/cms/list_plugin.tmpl
    ...
    'Are you sure you want to disable plugin functionality?' => '¿Está seguro de querer desactivar la funcinalidad de los plugins?',
    'Disable this plugin?' => '¿Desactivar este plugin?',
    'Are you sure you want to enable plugin functionality? (This will re-enable any plugins that were not individually disabled.)' => '¿Está seguro de querer artivar la funcionalidad de los plugins?  (Esto reactivará cada plugin que no haya sido desactivado individualmente.)',
    'Enable this plugin?' => '¿Activar este plugin?',
    'No plugins have been found in the system.' => 'NO se ha encontrado ningun plugin en el sistema',
    'Version' => 'Versión',
    'plugin' => 'plugin',
    'plugins' => 'plugins',
    'Disable selected plugins (a)' => 'Deshabilitar los plugins seleccionados',
    'Disable' => 'deshabilitar',
...
## tmpl/cms/resources.tmpl
    'Resouces Provided by Plugins' => 'Recursos que provistos por los Plugins',
    'Tags:' => 'Etiquetas:',
...
## tmpl/cms/edit_blog.tmpl
    ...
    'Enter the path where your main index file will be located. An absolute path (starting with \'/\') is preferred, but you can also use a path relative to the Melody directory. Example: /home/melody/public_html/weblog' => 'Ingrese la ruta donde se hubicará el archivo de indice (index) principal. Se recomienda usar una ruta absoluta (empezando con \'/\'), también puede utilizar una ruta relativa al directorio de Melody.   Ejemplo: /home/melody/public_html/weblog',
...
## addons/MultiBlog.plugin/config.yaml
    'MultiBlog allows you to publish content from other blogs and define publishing rules and access controls between them. This version of MultiBlog has been enhanced with bug fixes and abilities to work with Melody.' => 'Multiblog le permite publicar el contenido de otros blogs y definiar las reglas de publicación y controles de acceso entre ellos. ESta versión de Multiblog a sido extendida con correciones para funcionar correctamente con Melody',
...
## addons/DePoClean.plugin/templates/search_results.mtml
    'Header' => 'Cabecera',
    'Search Results for' => 'Resultados de la busqueda para', # Translate - New
    'Entry Details' => 'Detalles de la entrada',
    'Footer' => 'Pie',

## addons/DePoClean.plugin/templates/flickr.mtml
    'To show a Flickr user gallery, you must specify a Flickr user ID in Theme Options.' => 'Para mostrar la galería de usuario. debe especificar un ID de usuario de Flickr en las opciones del tema.', # Translate - New
    'To show a Flickr photoset gallery, you must specify a Flickr user ID in Theme Options.' => 'Para mostrar la galería de fotos. debe especificar un ID de usuario de Flickr en las opciones del tema.', # Translate - New
    'To show a Flickr group gallery, you must specify a Flickr group ID in Theme Options.' => 'Para mostrar la galería de grupo. debe especificar un ID de usuario de Flickr en las opciones del tema.', # Translate - New
    'To show a Flickr favorites gallery, you must specify a Flickr user ID in Theme Options.' => 'Para mostrar la galería de favoritos. debe especificar un ID de usuario de Flickr en las opciones del tema.', # Translate - New
...
## addons/DePoClean.plugin/templates/footer.mtml
    ...
    'DePo Clean Theme for Melody' => 'Tema DePo Clean para Melody', # Translate - New
...
## addons/DePoClean.plugin/templates/archives.mtml
    ...
    'View all posts filed under' => 'Ver todas las entradas bajo', # Translate - New
...
## addons/DePoClean.plugin/config.yaml
    ...
    'Number of comments in comment feed' => 'Número de comentarios en la feed de comentarios',
    'Number of entries on the main page' => 'Número de entradas en la página principal',
    'Number of entries on the listing pages' => 'Número de entradas en el listado de páginas',
    'Number of entries in the search results' => 'Número de entradas en los resultados de la búsqueda',
...
## addons/ThemeManager.plugin/tmpl/paypal_donate.mtml
    ...
    'PayPal - The safer, easier way to pay online!' => 'Paypal - ¡La manera más fácil y segura para pagar en línea.!',

## addons/ThemeManager.plugin/tmpl/templates_unlinked.mtml
    'Templates for this theme have been unlinked; you can now freely edit them.' => 'Las plantillas de este tema han sido desligadas; pude editarlas libremente.',
...
## addons/ThemeManager.plugin/tmpl/theme_select.mtml
    ...
    'The template_set dropdown selector for creating a new blog couldn\'t be found.' => 'No se ha encontrado el selector ',
...
## addons/ThemeManager.plugin/tmpl/theme_details.mtml
    'Part of the plugin <strong></strong>' => 'Parte del plugin <strong>[_1]</strong>',
    'No description is supplied for this theme.' => 'No se hay descripción para este tema',
    'Theme Home' => 'Temas',
...
## addons/ThemeManager.plugin/tmpl/save_widgetsets.mtml
    '<strong>Widget Sets</strong> have been modified from their default on this blog. If you are re-applying this theme to upgrade, you probably <em>should</em> save the Widget Sets so your blog continues to work as expected. If you are applying a different theme it\'s possible your Widget Sets won\'t work with the new theme, and <em>should not</em> be saved.' => 'Los <strong>Conjuntos de Widgets</strong> han sido modificados en este blog. Si está re-aplicando este tema a una actualilzación,  seguramente <em>debería</em> guardar los conjuntos de Widgets para que su blog siga funcionando correctamente. Si esta usando un tema diferente, es posible que sus conjuntos de Widgets no funcionen en este nuevo tema, y <em>no debería</em> de guardarlos.',
    'Save the Widget Sets in this blog.' => 'Guardar los conjuntos de Widgets en este blog.',
    '<strong>Widgets</strong> have been modified from their default on this blog. If you are re-applying this theme to upgrade, you probably <em>should</em> save the Widgets so your blog continues to work as expected. If you are applying a different theme it\'s possible your Widgets won\'t work with the new theme, and <em>should not</em> be saved.' => 'Los <strong>Widgets</strong> han sido modificados en este blog. Si está re-aplicando este tema a una actualilzación,  seguramente <em>debería</em> guardar los conjuntos de Widgets para que su blog siga funcionando correctamente. Si esta usando un tema diferente, es posible que sus Widgets no funcionen en este nuevo tema, y <em>no debería</em> de guardarlos.',
    'Save the Widgets in this blog.' => 'Guardar los Widgets en este blog.',
    'Apply (s)' => 'Aplicar (s)',
    'Apply' => 'Aplicar',

## addons/ThemeManager.plugin/tmpl/edit_templates.mtml
    'Templates for this theme are <strong>linked</strong>. This makes it easy to upgrade the theme (should the designer create a new version) and it ensures that your blog works as the designer intended. However, this also means that you can <em>not</em> simply edit the templates.' => 'Las plantillas de este tema estan <strong>ligadas</strong>. Esto hace que sea fácil actualizar el tema (el diseñador debe crear una nueva versión) y asegura que su blog trabaja de la forma en que el diseñador lo penso.',
    'Unlinking</strong> the templates for this theme will allow you to edit them however you see fit. However, it also means that automatically upgrading this theme to a newer version is not possible. After unlinking the templates, if you would like to use an upgraded version of the theme you will need to apply it with the Theme Chooser, which would overwrite your template changes and may lose the Theme Options you&rsquo;ve already set.' => 'Desligar</strong> las plantillas para este tema permitira editarlas para satisfacer sus necesidades. Sin embargo esto significa que ya no se podra actualizar este tema a una nueva versión. Después de desligar las plantillas, si desea utiliar una verión actualizada del tema, necesitará aplicarlo por medio del Selector de temas (Theme Chooser), el cual sobrescribirá los cambios  en sus plantillas y todas las opciones del tema guardadas.',
    'Are you sure you want to unlink templates from this theme? This operation can not be undone.' => '¿Está seguro qué desea desvincular las plantillas de este tema? Esta operación no se puede deshacer.',
    'Yes, edit templates' => 'Si, editar plantillas',
    'No, cancel (x)' => 'NO, Cancelar (x)',

## addons/ThemeManager.plugin/tmpl/select_language.mtml
    'This template set has been translated into several languages. Select a language to be applied for the installation of this theme&rsquo;s template set.' => 'Esta plantilla ha sido traducida a varios idiomas. Seleccione el idioma que se apicará para la instalación de este conjunto de plantillas del tema.',
...
## addons/ThemeManager.plugin/tmpl/theme_dashboard.mtml
    ...
    'The directory for storing theme thumbnails is not writable. In order to display a preview of the current theme on your site, please make the following directory writable by your web server: [_1]' => 'El directorio para guardar las imagenes en miniatura de los temas es de solo lectura. Para poder guardar la vista previa de los temas en tu sitio, por favor da permisos de escritura en la siguiente carpeta del servidor web: [_1]',
    'About this Theme' => 'Acerca de este tema',
    'Customization' => 'Personalización',
    'Change Theme' => 'Cambiar tema',
    'on' => 'Activar',
    'and the' => 'y el',
    'theme by making a donation to them through PayPal:' => 'tema haciendo una donación por medio de PayPal:',
...
## addons/ThemeManager.plugin/tmpl/theme_setup.mtml
    'You have saved your theme options.' => 'Has guardado las opciones del tema',
    'The [_1] theme has fields that are marked <em>required</em>. Required fields must be filled-in to make the theme work as intended or publish correctly. All of the below fields are required; after setup is complete be sure to visit Theme Options to set any other fields.' => 'El tema [_1] tiene campos marcados como <em>obligatorios</em>. Los campos obligatorios deben de ser llenados para que el tema pueda funcionar de la forma debida o que pueda ser publicado correctamente. Todos los campos mostrados abajo son obligatorios; después de que la información este completa, viste las Opciones del Tema para llenar los demás campos.',
    'The theme [_1] has been applied to this blog. You will need to' => 'El tema [_1] ha sido aplicado en este blog. Necesita',
    'the blog to see the new theme on your site' => 'el blog para ver el nuevo tema aplicado a su sitio.',
    ', though you may want to verify all [_1] are configured properly first' => ', sin embargo tal vez antes, quiera verificar que todo [_1] este configurado correctamente',
...
## addons/ThemeManager.plugin/lib/ThemeManager/TemplateInstall.pm
    'Select a theme template set to create a new blog with, or use the' => 'Seleccione un conjunto de plantillas de tema para crear un nuevo blog con el, o user el',
    'visual chooser' => 'selector visual',
    'Translate templates to the selected language.' => 'Traducir las plantillas al lenguaje seleccionado.',
    'The blog language controls date and time display.</div>' => 'El lenguaje del blog controla la forma en que se muestran la fecha y hora</div>',
    'Could not update template map for \'
                                . \'template [_1].' => 'No se pudo actualizar el mapa de plantillas para la plantilla [_1].',
    'Could not update template map for template [_1].' => 'No se pudo actualizar el mapa de pantillas para la plantilla [_1].',
...
## addons/ThemeManager.plugin/lib/ThemeManager/Plugin.pm
    ...
    'Theme Manager could not find a plugin corresponding to the template set currently applied to this blog. Skipping this blog for saving widget sets.' => 'El administrador de temas no pudo encontrar un plugin correspondiente al conjunto de plantillas (template set) que se aplicó en este blog. Se salta este blog sin guardar su conjunto de widgets.',
    'Global Options' => 'Opciones Globales',
    'Unknown config type encountered: [_1]' => 'Se encontro un tipo de configuración desconocido: [_1]',
    'Refresh Custom Fields' => 'Refrescar Custom fields (campos personalizados)',
    'Edit Theme Options' => 'Editar las opciones del tema',
    'Create Widgets and organize Widget Sets' => 'Créa Widgets y organiza los conjuntos de Widgets',
...
## addons/ConfigAssistant.pack/lib/ConfigAssistant/Util.pm
    ...
    'Unable to upload to blog site path without blog context.' => 'No se puede subir a la ruta del sitio sin un blog context.',
    'Unable to upload to blog archive path without blog context.' => 'No se puede subir a la ruta del archivo sin un blog context.',
    'Extra path must be a relative path \'[_1]\'' => 'La ruta extra debe de ser una ruta relativa \'[_1]\'',

## addons/ConfigAssistant.pack/lib/ConfigAssistant/Static.pm
    'Plugin \'[_1]\' upgraded successfully to version [_2] (static version [_3]).' => 'El plugin \'[_1]\' se actualizo correctamente a la versión [_2] (versión estática [_3]).',

## addons/ConfigAssistant.pack/lib/ConfigAssistant/Plugin.pm
    'The plugin you specified \'[_2]\' in \'[_1]\' could not be found.' => 'El plugin que ha indicado \'[_2]\' en \'[_1]\' no fue encontrado.',
    'The plugin you specified \'[_2]\' in \'[_1]\' has not registered a static directory. Please use <mt:StaticWebPath> instead.' => 'El plugin que ha indicado \'[_2]\' en \'[_1]\' no ha registrado una ruta estática. Por favor utilice <mt:StaticWebPath>.',
    'The plugin you specified in \'[_1]\' has not registered a static directory. Please use <mt:StaticFilePath> instead.' => 'El plugin que ha indicado \'[_2]\' en \'[_1]\' no ha registrado una ruta estática. Por favor utilice <mt:StaticFilePath>.',
...
## addons/ConfigAssistant.pack/config.yaml
    'Movable Type Factory Default\'' => 'Opciones predeterminadas de fábrica\'',
