...
## lib/MT/App/Wizard.pm
	...
	'This module is required in mt-search.cgi if you are running Melody on Perl older than Perl 5.8.' => 'mt-search.cgi necesita este módulo si está usando Melody con una versión de Perl más antigua de la 5.8.',
    ...
    'This module is required in mt-search.cgi if you are using a version of Perl older than Perl 5.8.' => 'Este modulo es requerido en mt-search.cgi si estás usando una versión de Perl anterior a la 5.8 ', # Translate - New
...
## tmpl/wizard/start.tmpl
	...
	'A configuration (mt-config.cgi) file already exists, <a href="[_1]">sign in</a> to Melody.' => 'Una configuración del archivo (mt-config,cgi) existe, <a href="[_1]>identificarse</a> a Melody.',
...
## tmpl/cms/widget/blog_stats.tmpl
	...
	'Nov.' => 'Nov.',
	'Dec.' => 'Dic.',
	'Melody was unable to locate your \'mt-static\' directory. Please configure the \'StaticFilePath\' configuration setting in your mt-config.cgi file, and create a writable \'support\' directory underneath your \'mt-static\' directory.' => 'Melody no pudo localizar el directorio \'mt-static\'. Por favor, configure la opción \'StaticFilePath\' en el fichero mt-config.cgi y cree un directorio \'support\' en el que se pueda escribir dentro del directorio \'mt-static\'.',
...
## tmpl/cms/system_check.tmpl
	...
	'Melody could not find the script named \'mt-check.cgi\'. To resolve this issue, please ensure that the mt-check.cgi script exists and/or the CheckScript configuration parameter references it properly.' => 'Melody no ha podido encontrar el script nombrado \'mt-check.cgi\'. Para resolver este problema, asegurese de que el script mt-check.cgi script existe y/o que la configuración de los parámetros de MTCheckScript este correctamente referenciado.',
