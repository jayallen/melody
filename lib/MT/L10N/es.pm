...
## default_templates/recover-password.mtml
	'A request has been made to change your password in Melody. To complete this process click on the link below to select a new password.' => 'Se ha recibido una petición para cambiar su contraseña de Melody. Para completar el proceso y seleccionar una nueva contraseña, haga clic en el enlace.',
...
## lib/MT/Import.pm
	...
	'Melody' => 'Melody',
	'Another system (Melody format)' => 'Otro sistema (formato Melody)',
...
## lib/MT/Bootstrap.pm
    ...
    'Enable DebugMode for more details.' => 'Para más detalles habilitar el modo de Test email from [_1] (DebugMode)', # Translate - New
...
## lib/MT/Template/Context.pm
    ...
    'You are using a deprecated template tag: [_0]' => 'Se ha utilizado una etiqueta descontinuada: [_0]', # Translate - New
...
## lib/MT/Upgrade.pm
	...
	'This role was generated by Melody upon upgrade.' => 'Este rol fue generado por Melody durante la actualización.',
...
## lib/MT/Core.pm
	...
	'Melody Default' => 'Predefinido de Melody',
...
## lib/MT/App/Comments.pm
	...
	'Invalid commenter login attempt from [_1] to blog [_2](ID: [_3]) which does not allow Melody native authentication.' => 'Intento de identificación de comentarista no válido desde [_1] en el blog [_2](ID: [_3]) que no permite la autentificación nativa de Melody.',
	...
	'Melody Account Confirmation' => 'Confirmación de cuenta - Melody',
...
## lib/MT/App/Upgrader.pm
	...
	'No permissions. Please contact your administrator for upgrading Melody.' => 'Sin permisos. Por favor, contacte con su administrador para la actualización de Melody.',
	'Melody has been upgraded to version [_1].' => 'Melody ha sido actualizado a la versión [_1].',
...
## lib/MT/App/Wizard.pm
	...
	'This module is required in search.cgi if you are running Melody on Perl older than Perl 5.8.' => 'search.cgi necesita este módulo si está usando Melody con una versión de Perl más antigua de la 5.8.',
    ...
    'This module is required in search.cgi if you are using a version of Perl older than Perl 5.8.' => 'Este modulo es requerido en search.cgi si estás usando una versión de Perl anterior a la 5.8 ', # Translate - New
    'CGI is required for all application functionality.' => 'El módulo CGI es requerido por la apliación', # Translate - New
...
## lib/MT/App/CMS.pm
	...
	'Melody News' => 'Noticias de Melody',
...
## lib/MT/App/ActivityFeeds.pm
	...
	'Melody Debug Activity' => 'Actividad de depuración de Melody',
...
## lib/MT/Util/Captcha.pm
	'Melody default CAPTCHA provider requires Image::Magick.' => 'El proveedor predefinido de CAPTCHA de Melody necesita Image::Magick',
...
## lib/MT/BackupRestore.pm
	...
	'Manifest file [_1] was not a valid Melody backup manifest file.' => 'El fichero [_1] no es un fichero válido de manifiesto para copias de seguridad de Melody.',
...
## lib/MT/XMLRPCServer.pm
	...
	'Template methods are not implemented, due to differences between the Blogger API and the Melody API.' => 'Los métodos de las plantillas no están implementados, debido a las diferencias entre Blogger API y Melody API.',
...
## lib/MT/CMS/Template.pm
	...
	'Failed.' => 'Fallo.',
    'Could not clone template: [_1]' => 'No se ha podido clonar la plantilla: [_1]', # Translate - New
...
## lib/MT/CMS/Asset.pm
	...
	'<' => '<',
	'/' => '/',
    'Could not create asset cache path: [_1]' => 'No se ha podido crear la carpeta del cache de archivos multimedia en:[_1] ', # Translate - New
...
## lib/MT/CMS/Dashboard.pm
	...
	'Melody has undergone a significant overhaul in all aspects of performance. Memory utilization has been reduced, publishing times have been increased significantly and search is now 100x faster!' => 'Se ha realizado una importante revisión en todos los aspectos relacionados con el rendimiento de Melody. ¡Se ha reducido la utilización de memoria, el tiempo de publicación y ahora la búsqueda es 100 veces más rápida!',
...
## lib/MT/CMS/Tools.pm
	...
	'Test email from Melody' => 'Correo de prueba de Melody', # Translate - New
	'This is the test email sent by your installation of Melody.' => 'Este es el correo de prueba enviado por su instalación de Melody.', # Translate - New
	...
	'Successfully restored objects to Melody system by user \'[_1]\'' => 'El usuario \'[_1]\' restauró objetos en el sistema Melody con éxito.',
	...
	'Uploaded file was not a valid Melody backup manifest file.' => 'El fichero transferido no era un fichero no válido de manifiesto de copia de seguridad de Melody.',
	...
	'Melody system was successfully backed up by user \'[_1]\'' => 'El usuario \'[_1]\' realizó con éxito una copia de seguridad del sistema de Melody',
...
## lib/MT/BackupRestore/BackupFileHandler.pm
	'Uploaded file was backed up from Melody but the different schema version ([_1]) from the one in this system ([_2]).  It is not safe to restore the file to this version of Melody.' => 'El fichero transferido es una copia de seguridad de Melody pero con una versión del esquema de datos diferente ([_1]) al de este sistema ([_2]). No es seguro restaurar el fichero en esta versión de Melody.',
	'[_1] is not a subject to be restored by Melody.' => '[_1] no es un elemento para ser restaurado por Melody.',
...
## lib/MT.pm.pre
	...
	'Sign in to Melody with your[_1] Account[_2]' => 'Identifíquese en Melody con su cuenta [_1] [_2]',
	...
	'Missing configuration file. Maybe you forgot to move config.cgi-original to config.cgi?' => 'Archivo de configuración no encontrado. ¿Quizás olvidó renombrar config.cgi-original a config.cgi?',
...
## tmpl/wizard/start.tmpl
	...
	'A configuration (config.cgi) file already exists, <a href="[_1]">sign in</a> to Melody.' => 'Una configuración del archivo (config.cgi) existe, <a href="[_1]>identificarse</a> a Melody.',
...
## tmpl/cms/cfg_plugin.tmpl
	'System Plugin Settings' => 'Configuración de los plugins del sistema',
    'Plugin Preferences' => 'Configuración de los plugins', # Translate - New
	'Useful links' => 'Enlaces útiles',
	'http://plugins.movabletype.org/' => 'http://plugins.movabletype.org/',
	'Find Plugins' => 'Buscar plugins',
	'Plugin System' => 'Plugins del sistema',
	'Manually enable or disable plugin-system functionality. Re-enabling plugin-system functionality, will return all plugins to their original state.' => 'Activa o desactiva manualmente las funcionalidades de los plugins del sistema. La reactivación de los plugins del sistema hace que los plugins vuelvan a su estado original.',
	'Disable plugin functionality' => 'Desactivar las funciones de las plugins',
	'Disable Plugins' => 'Desactivar plugins',
	'Enable plugin functionality' => 'Activar las funciones de las plugins',
	...
	'Your plugins have been reconfigured. Since you\'re running mod_perl, you will need to restart your web server for these changes to take effect.' => 'Se reconfiguraron los plugins. Debido a que está ejecutando mod_perl, deberá reiniciar el servidor web para que estos cambios tengan efecto.',
	...
	'This plugin has not been upgraded to support Melody [_1]. As such, it may not be 100% functional. Furthermore, it will require an upgrade once you have upgraded to the next Melody major release (when available).' => 'Este plugin no se ha actualizado para soportar Melody [_1]. Por tanto, podría no ser 100% funcional. Además, necesitará una actualización cuando se actualice a la siguiente versión superior de Melody (cuando esté disponible).',
...
## tmpl/cms/login.tmpl
	'Your Melody session has ended.' => 'Finalizó su sesión en Melody.',
	'Your Melody session has ended. If you wish to sign in again, you can do so below.' => 'Su sesión de Melody finalizó. Si desea identificarse de nuevo, hágalo abajo.',
	'Your Melody session has ended. Please sign in again to continue this action.' => 'Su sesión de Melody finalizó. Por favor, identifíquese de nuevo para continuar con esta acción.',
	'Forgot your password?' => '¿Olvidó su contraseña?',
	'Sign In (s)' => 'Identifíquese (s)',

## tmpl/cms/list_blog.tmpl
	'You have successfully deleted the blogs from the Melody system.' => 'Eliminó correctamente los weblogs.',
...
## tmpl/cms/dashboard.tmpl
	...
	'Image::Magick is either not present on your server or incorrectly configured. Due to that, you will not be able to use Melody\'s userpics feature. If you wish to use that feature, please install Image::Magick or use an alternative image driver.' => 'Image::Magick no está presente en el servidor o no está instalado correctamente. Por esa razón, no podrá usar los avatares de usuarios en Melody. Si desea utilizar esta característica, por favor, instale Image::Magick o algún controlador alternativo de imágenes.',
...
## tmpl/cms/cfg_trackbacks.tmpl
	...
	'Specify when Melody should notify you of new TrackBacks if at all.' => 'Especifica cuándo Melody debe notificarle nuevos TrackBacks, .',
	'On' => 'Activar',
...
## tmpl/cms/cfg_comments.tmpl
	...
	'Specify when Melody should notify you of new comments if at all.' => 'Especifica cuándo Melody debe notificarle de nuevos comentarios, cuando haya.',
...
## tmpl/cms/cfg_system_users.tmpl
	...
	'Allow commenters to register to Melody' => 'Permitir que los comentaristas se registren en Melody',
...
## tmpl/cms/edit_entry.tmpl
	...
	'Use <a href="http://blogit.typepad.com/">Blog It</a> to post to Melody from social networks like Facebook.' => 'Utilice <a href="http://blogit.typepad.com/">Blog It</a> para publicar en Melody desde redes sociales como Facebook.',
...
## tmpl/cms/include/footer.tmpl
	'This is a beta version of [_1] and is not recommended for production use.' => 'Esta es una versión beta de [_1] y no serecomienda su uso para producción', # Translate - New
    'OpenMelody.org' => 'OpenMelody.org', # Translate - New
    'http://plugins.movabletype.org/' => 'http://plugins.movabletype.org/',
    'Documentation' => 'Documentación',
    'http://wiki.openmelody.org/' => 'http://wiki.openmelody.org/', # Translate - New
    'Wiki' => 'Wiki',
    'http://getsatisfaction.com/openmelody' => 'http://getsatisfaction.com/openmelody', # Translate - New
    'Support' => 'Soporte',
    'http://openmelody.org/contribute/feedback' => 'http://openmelody.org/contribute/feedback', # Translate - New
...
## tmpl/cms/include/backup_start.tmpl
	'Backing up Melody' => 'Haciendo copia de seguridad de Melody',
...
## tmpl/cms/import.tmpl
	...
	'Transfer weblog entries into Melody from other Melody installations or even other blogging tools or export your entries to create a backup or copy.' => 'Transfiere las entradas de un weblog en Melody desde otras instalaciones de Melody o incluso otras herramientas de blogs, o exporta sus entradas para crear una copia de seguridad.',
...
## tmpl/cms/cfg_spam.tmpl
    ...
    'Spam Preferences' => 'Configuración del spam', # Translate - New
...
## tmpl/cms/dialog/recover.tmpl
	...
	'Go Back (x)' => 'Volver',
	'Sign in to Melody (s)' => 'Identifíquese en Melody (s)',
	'Sign in to Melody' => 'Identifíquese en Melody',
...
## tmpl/cms/list_author.tmpl
	...
	'You have successfully deleted the user(s) from the Melody system.' => 'Ha borrado con éxito el/los usuario/s seleccionado/s del sistema de Melody.',
	'The deleted user(s) still exist in the external directory. As such, they will still be able to login to Melody Enterprise.' => 'Este usuario borrado aún existe en el directorio externo. Como tal, aún podrán acceder a Melody Enterprise.',
...
## tmpl/cms/cfg_registration.tmpl
	...
	'Allow registration for Melody.' => 'Permitir el registro en Melody.',
...
## tmpl/cms/cfg_web_services.tmpl
	...
	'When this blog is updated, Melody will automatically notify the selected sites.' => 'Cuando se actualice el blog, Melody notificará automáticamente a los sitios seleccionados.',
...
## tmpl/cms/edit_blog.tmpl
	...
	'Enter the path where your main index file will be located. An absolute path (starting with \'/\') is preferred, but you can also use a path relative to the Melody directory. Example: /home/melody/public_html/weblog' => 'Introduzca la ruta donde se situará el fichero índice principal. Se aconseja una ruta absoluta (que comienzan con \'/\'), pero también puede especificar una ruta relativa al directorio de Melody. Ejemplo: /home/melody/public_html/weblog',
...
## tmpl/cms/install.tmpl
    ...
    'Welcome to [_1]' => 'Bienvenido a [_1]', # Translate - New
...
## tmpl/cms/widget/new_user.tmpl
	...
	'What would a blog be without content? Start your [_1] experience by creating your very first post.' => '¿Qué sería un blog sin contenidos? Empiece su experiencia en [_1] creando la primera entrada.',
...
## tmpl/cms/widget/mt_news.tmpl
	...
	'Pronet' => 'Pronet',
	'No Melody news available.' => 'No hay noticias de Melody disponibles.',
	'No Learning Melody news available.' => 'No hay noticias de Learning Melody disponibles.',
...
## tmpl/cms/widget/custom_message.tmpl
	...
	'Melody User Manual' => 'Manual del usuario de Melody',
	...
	'Melody Community Forums' => 'Foros comunitarios de Melody',
...
## tmpl/cms/widget/new_version.tmpl
	'What\'s new in Melody [_1]' => 'Novedades en Melody [_1]',
	'Congratulations, you have successfully installed Melody [_1]. Listed below is an overview of the new features found in this release.' => '¡Felicidades, ha instalado con éxito Melody [_1]! Debajo encontrará un resumen de las nuevas funciones de esta versión.',
...
## tmpl/cms/widget/blog_stats.tmpl
	...
	'Nov.' => 'Nov.',
	'Dec.' => 'Dic.',
	'Melody was unable to locate your \'mt-static\' directory. Please configure the \'StaticFilePath\' configuration setting in your config.cgi file, and create a writable \'support\' directory underneath your \'mt-static\' directory.' => 'Melody no pudo localizar el directorio \'mt-static\'. Por favor, configure la opción \'StaticFilePath\' en el fichero config.cgi y cree un directorio \'support\' en el que se pueda escribir dentro del directorio \'mt-static\'.',
	'Melody was unable to write to its \'support\' directory. Please create a directory at this location: [_1], and assign permissions that will allow the web server write access to it.' => 'Melody no pudo escribir en el directorio \'support\'. Por favor, cree un directorio en este lugar: [_1], y asígnele permisos para permitir que el servidor web pueda acceder y escribir en él.',
...
## tmpl/cms/system_check.tmpl
	...
	'Users who have logged in within 90 days are considered <strong>active</strong> in Melody license agreement.' => 'Los usuarios que se hayan identificado a lo largo de los últimos 90 días son considerados como activos según la licence Melody.',
	'Memcache Status' => 'Estado de memcache',
	'Server Model' => 'Modelo de servidor',
	'Melody could not find the script named \'check.cgi\'. To resolve this issue, please ensure that the check.cgi script exists and/or the CheckScript configuration parameter references it properly.' => 'Melody no ha podido encontrar el script nombrado \'check.cgi\'. Para resolver este problema, asegurese de que el script check.cgi script existe y/o que la configuración de los parámetros de MTCheckScript este correctamente referenciado.',

## tmpl/cms/restore.tmpl
	'Restore from a Backup' => 'Resturar una copia de seguridad',
	'Perl module XML::SAX and/or its dependencies are missing - Melody can not restore the system without it.' => 'El módulo de Perl XML::SAX y/o sus dependencias no se encuentran - Melody no puede restaurar el sistema sin él.',
	'Backup file' => 'Hacer copia de seguridad del fichero',
	'If your backup file is located on your computer, you can upload it here.  Otherwise, Melody will automatically look in the \'import\' folder of your Melody directory.' => 'Si su fichero de copia de seguridad está situado en su PC, puede subirlo desde aquí. Si no, Melody comprobará automáticamente la carpeta \'import\' en el directorio de Melody.',
	'Check this and files backed up from newer versions can be restored to this system.  NOTE: Ignoring Schema Version can damage Melody permanently.' => 'Activa esta opción y los ficheros con copias de seguridad de versiones más recientes podrán restaurarse en este sistema. NOTA: Ignorar la versión del esquema puede dañar Melody permanentemente.',
...
## tmpl/cms/cfg_archives.tmpl
	...
	'The path where your index files will be published. An absolute path (starting with \'/\') is preferred, but you can also use a path relative to the Melody directory. Example: /home/melody/public_html/blog' => 'La ruta donde se publicarán los ficheros índice. Se aconseja una ruta absoluta (las que comienzan con \'/\'), pero también puede usar rutas relativas al directorio de Melody. Ejemplo: /home/melody/public_html/blog',
...
## addons/Community.pack/lib/MT/App/Community.pm
	...
	'[_1] registered to Melody.' => '[_1] se registró en Melody.',
...
## addons/Community.pack/lib/MT/Community/CMS.pm
	...
	'Welcome to the Melody Community Solution' => 'Bienvenido a la Community Solution de Melody',
...
',
	'New design launched using Melody' => 'Nuevo diseño lanzado utilizando Melody',
	'_PTS_SAMPLE_NEWDESIGN' => '
<p>Nuestro sitio tiene un nuevo diseño gracias a <a href="http://www.movabletype.com/">Melody</a> y el Conjunto de Plantillas Universal. Este conjunto le permite a cualquier persona poner en marcha un nuevo web con Melody. Es realmente fácil, y solo con un par de clics. Seleccione un nombre para su nuevo sitio, seleccione el Conjunto de Plantillas Universal y publique. ¡Voilà! El nuevo sitio. ¡Gracias Melody!</p>
',
	'Could not create entry: [_1]' => 'No se pudo crear la entrada: [_1]',
	'John Doe' => 'Pobrecito Hablador',
	'Great new site. I can\'t wait to try Melody. Congrats!' => 'Gran sitio. ¡Estoy impaciente por probar Melody, felicidades!',
...
## addons/Enterprise.pack/lib/MT/Enterprise/CMS.pm
	...
	'Melody Enterprise has just attempted to disable your account during synchronization with the external directory. Some of the external user management settings must be wrong. Please correct your configuration before proceeding.' => 'Melody Enterprise acaba de intentar deshabilitar su cuenta durante una sincronización con el directorio externo. Algunas de las opciones de configuración de la administración externa de usuarios deben ser incorrectas. Por favor, corrija la configuración antes de continuar.',
...
Búsqueda base: [_2]",
	...
	'[_1] directive must be set to synchronize members of LDAP groups to Melody Enterprise.' => 'La instrucción [_1] debe ser completada para sincronizar los miembros de los grupos LDAP en MT Enterprise.',
...
## addons/Enterprise.pack/tmpl/list_group.tmpl
	...
	'You have successfully deleted the groups from the Melody system.' => 'Usted ha borrado con suceso los grupos del sistema Melody.',
...
## plugins/WXRImporter/tmpl/options.tmpl
	'Before you import WordPress posts to Melody, we recommend that you <a href=\'[_1]\'>configure your blog\'s publishing paths</a> first.' => 'Antes de importar las entradas de WordPress a Melody, le recomendamos que primero <a href=\'[_1]\'>configure las rutas de publicación del blog</a>.',
...
## plugins/StyleCatcher/config.yaml
	'StyleCatcher lets you easily browse through styles and then apply them to your blog in just a few clicks. To find out more about Melody styles, or for new sources for styles, visit the <a href=\'http://www.sixapart.com/movabletype/styles\'>Melody styles</a> page.' => 'StyleCatcher le permite navegar fácilmente por los estilos y aplicarlos a su blog fácilmente. Para más información sobre los estilos de Melody, o para encontrar más repositorios de estilos, visite la página de <a href=\'http://www.sixapart.com/movabletype/styles\'>estilos de Melody</a>.',
	'MT 4 Style Library' => 'Librería de estilos de MT 4',
	'A collection of styles compatible with Melody 4 default templates.' => 'Una colección de estilos compatible con las plantillas predefinidas de Melody.',
	'Styles' => 'Estilos',
...
## plugins/WidgetManager/WidgetManager.pl
	'Widget Manager version 1.1; This version of the plugin is to upgrade data from older version of Widget Manager that has been shipped with Melody to the Melody core schema.  No other features are included.  You can safely remove this plugin after installing/upgrading Melody.' => 'Administrador de Widgets versión 1.1; Esta versión del plugin actualiza los datos de la versiones antiguas del Adminstrador de Widgets que venía con Melody al esquema interno de Melody. No se han incluído otras características. Puede borrar este plugin sin problemas después de instalar o actualizar Melody.',
...
## plugins/Motion/config.yaml
	'A Melody theme with structured entries and action streams.' => 'Tema de Melody con entradas estructuradas y torrentes de acciones.',
...
## plugins/Motion/templates/Motion/widget_about_ssite.mtml
	'About' => 'Sobre mi',
	'The Motion Template Set is a great example of the type of site you can build with Melody.' => 'El conjunto de plantillas de Motion es un buen ejemplo del tipo de sitio que puede hacer con Melody.',
...
## plugins/mixiComment/mixiComment.pl
	'Allows commenters to sign in to Melody 4 using their own mixi username and password via OpenID.' => 'Permite a los comentaristas identificarse en Melody 4 usando su propio usuario y contraseña de mixi vía OpenID.',
...
## plugins/ActionStreams/tmpl/blog_config_template.tmpl
    ...
    'Plugins &amp; Addons' => 'Plugins y Addons', # Translate - New    
    'Sanity Check' => 'Verificación del sistema ', # Translate - New

## tmpl/cms/include/cfg_content_nav.tmpl
    'Compose' => 'Visualización', # Translate - New
    'Login & Sign-up' => 'Autentificación y Registro', # Translate - New
    'Web Services' => 'Servicios web',

## tmpl/cms/list_plugin.tmpl
    'Installed Add-Ons &amp; Plugins' => 'Plugins y Add-Ons instalados', # Translate - New    
    'No plugins have been found in the system.' => 'NO se ha encontrado ningun plugin en el sistema', # Translate - New
    'Version' => 'Versión', # Translate - New
    'plugin' => 'plugin', # Translate - New
    'plugins' => 'plugins', # Translate - Case
    'Disable selected plugins (a)' => 'Deshabilitar los plugins seleccionados', # Translate - New
    'Disable' => 'deshabilitar', # Translate - Case
    'Enabled Plugins' => 'Plugins habilitados', # Translate - New
    'Enable selected plugins (a)' => 'Habilitar los plugins seleccionados', # Translate - New
    'Enable' => 'Habilitar', # Translate - Case
    'Disabled Plugins' => 'Plugins deshabilitados', # Translate - New
   
## tmpl/cms/resources.tmpl
    'Resouces Provided by Plugins' => 'Recursos que provistos por los Plugins', # Translate - New    

##revisar todas estas traducciones, puesto que no se en donde van muchas de ellas y sin el contexto correcto, no se si podrian referirse a otra cosa.

    ## addons/PubSubHubbub.plugin/tmpl/config.tmpl
    'PubSubHubbub Hub(s)' => 'PubSubHubbub Hub(s)', # Translate - New
    'List the other hub URL(s) you want to ping, one URL for each line. Google\'s http://pubsubhubbub.appspot.com/ can be used as a public hub.' => 'Lista de hub URL(s) a las que deseas hacer ping, una por cada línea. La url http://pubsubhubbub.appspot.com/ de Google puede ser usada como hub público.', # Translate - New

## addons/ConfigAssistant.plugin/tmpl/entry_list.mtml
    'Select Image' => 'Seleccionar una imagen', # Translate - New
    'Select Entry' => 'Seleccionar una entrada', # Translate - New
    'Select (s)' => 'Seleccionar (s)', # Translate - New
    'Select' => 'Seleccionar', # Translate - New
    'No entries could be found.' => 'No hay entradas', # Translate - New

## addons/ConfigAssistant.plugin/tmpl/theme_options.tmpl
    'Theme Options' => 'Opciones del tema', # Translate - New
    'Edit Theme Options' => 'Editar las opciones del tema', # Translate - New
    'You have saved your theme options.' => 'Has guardado las opciones del tema', # Translate - New
    
## addons/ConfigAssistant.plugin/lib/ConfigAssistant/Init.pm
    'Failed to find [_1]::[_2]' => 'No se pudo encontrar [_1]::[_2]', # Translate - New
    
## addons/ConfigAssistant.plugin/config.yaml
    'Theme Options\'' => 'Opcions del tema', # Translate - New

## addons/ConfigAssistant.plugin/lib/ConfigAssistant/Plugin.pm
    'No entry #[_1]' => 'No existe la entrada #[_1]', # Translate - New
    'No edit_field' => 'Sin edit_field', # Translate - New
